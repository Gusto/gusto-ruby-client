...
* [list](#list) - Get all the admins at a company
...
res = s.admins.list(company_id="<id>", page=7685.78, per=5472.72, x_gusto_api_version=::OpenApiSDK::Shared::VersionHeader::TWO_THOUSAND_AND_TWENTY_FOUR_04_01)
