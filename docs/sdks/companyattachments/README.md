...
res = s.company_attachments.create(company_id="<id>", x_gusto_api_version=::OpenApiSDK::Shared::VersionHeader::TWO_THOUSAND_AND_TWENTY_FOUR_04_01, request_body=::OpenApiSDK::Operations::PostV1CompaniesAttachmentRequestBody.new(
  document: ::OpenApiSDK::Operations::Document.new(
    file_name: "example.file",
    content: "0xae921BE031".encode(),
  ),
  category: ::OpenApiSDK::Operations::Category::COMPLIANCE,
))
