...
module GustoEmbedded
  ...
  class EmployeeTaxSetup
    ...
    sig { params(employee_uuid: ::String, x_gusto_api_version: T.nilable(Models::Operations::GetV1EmployeesEmployeeIdFederalTaxesHeaderXGustoAPIVersion), timeout_ms: T.nilable(Integer), http_headers: T.nilable(T::Hash[T.any(String, Symbol), String])).returns(Models::Operations::GetV1EmployeesEmployeeIdFederalTaxesResponse) }
    def get_federal_taxes(employee_uuid:, x_gusto_api_version: nil, timeout_ms: nil, http_headers: nil)
      # get_federal_taxes - Get federal taxes for an employee
      ...
      if Utils.match_status_code(http_response.status, ['200'])
        if Utils.match_content_type(content_type, 'application/json')
          ...
          obj = Crystalline.unmarshal_json(JSON.parse(response_data), Crystalline::Union.new(Models::Shared::EmployeeFederalTaxPre2020, Models::Shared::EmployeeFederalTaxRev2020))
    ...
    sig { params(request_body: Models::Operations::PutV1EmployeesEmployeeIdFederalTaxesRequestBody, employee_uuid: ::String, x_gusto_api_version: T.nilable(Models::Operations::PutV1EmployeesEmployeeIdFederalTaxesHeaderXGustoAPIVersion), timeout_ms: T.nilable(Integer), http_headers: T.nilable(T::Hash[T.any(String, Symbol), String])).returns(Models::Operations::PutV1EmployeesEmployeeIdFederalTaxesResponse) }
    def update_federal_taxes(request_body:, employee_uuid:, x_gusto_api_version: nil, timeout_ms: nil, http_headers: nil)
      # update_federal_taxes - Update federal taxes for an employee
    ...
    sig { params(employee_uuid: ::String, x_gusto_api_version: T.nilable(Models::Operations::GetV1EmployeesEmployeeIdStateTaxesHeaderXGustoAPIVersion), timeout_ms: T.nilable(Integer), http_headers: T.nilable(T::Hash[T.any(String, Symbol), String])).returns(Models::Operations::GetV1EmployeesEmployeeIdStateTaxesResponse) }
    def get_state_taxes(employee_uuid:, x_gusto_api_version: nil, timeout_ms: nil, http_headers: nil)
    ...
    sig { params(employee_state_taxes_request: Models::Shared::EmployeeStateTaxesRequest, employee_uuid: ::String, x_gusto_api_version: T.nilable(Models::Operations::PutV1EmployeesEmployeeIdStateTaxesHeaderXGustoAPIVersion), timeout_ms: T.nilable(Integer), http_headers: T.nilable(T::Hash[T.any(String, Symbol), String])).returns(Models::Operations::PutV1EmployeesEmployeeIdStateTaxesResponse) }
    def update_state_taxes(employee_state_taxes_request:, employee_uuid:, x_gusto_api_version: nil, timeout_ms: nil, http_headers: nil)
