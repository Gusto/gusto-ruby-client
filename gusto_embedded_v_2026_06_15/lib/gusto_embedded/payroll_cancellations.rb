...
module GustoEmbedded
  ...
  class PayrollCancellations
    ...
    sig { params(security: Models::Operations::PostV1PayrollBatchesSecurity, request_body: Models::Operations::PostV1PayrollBatchesRequestBody, x_gusto_api_version: T.nilable(Models::Operations::PostV1PayrollBatchesHeaderXGustoAPIVersion), timeout_ms: T.nilable(Integer), http_headers: T.nilable(T::Hash[T.any(String, Symbol), String])).returns(Models::Operations::PostV1PayrollBatchesResponse) }
    def post_v1_payroll_batches(security:, request_body:, x_gusto_api_version: nil, timeout_ms: nil, http_headers: nil)
    ...
    sig { params(security: Models::Operations::GetV1PayrollBatchesPayrollBatchUuidSecurity, payroll_batch_uuid: ::String, x_gusto_api_version: T.nilable(Models::Operations::GetV1PayrollBatchesPayrollBatchUuidHeaderXGustoAPIVersion), timeout_ms: T.nilable(Integer), http_headers: T.nilable(T::Hash[T.any(String, Symbol), String])).returns(Models::Operations::GetV1PayrollBatchesPayrollBatchUuidResponse) }
    def get_v1_payroll_batches_payroll_batch_uuid(security:, payroll_batch_uuid:, x_gusto_api_version: nil, timeout_ms: nil, http_headers: nil)
