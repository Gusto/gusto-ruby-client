...
module GustoEmbedded
  ...
  class AchTransactions
    ...
    sig { params(request: Models::Operations::GetAchTransactionsRequest, timeout_ms: T.nilable(Integer), http_headers: T.nilable(T::Hash[T.any(String, Symbol), String])).returns(Models::Operations::GetAchTransactionsResponse) }
    def get_all(request:, timeout_ms: nil, http_headers: nil)
      ...
      url = Utils.generate_url(
        Models::Operations::GetAchTransactionsRequest,
        base_url,
      ...
      query_params = Utils.get_query_params(Models::Operations::GetAchTransactionsRequest, request, nil)
      ...
      if Utils.match_status_code(http_response.status, ['200'])
        if Utils.match_content_type(content_type, 'application/json')
          ...
          obj = Crystalline.unmarshal_json(JSON.parse(response_data), Crystalline::Array.new(Models::Shared::AchTransaction))
          response = Models::Operations::GetAchTransactionsResponse.new(
            status_code: http_response.status,
            content_type: content_type,
            raw_response: http_response,
            ach_transaction_list: T.unsafe(obj)
          )
