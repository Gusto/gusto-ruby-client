...
module GustoEmbedded
  ...
  class EmployeePaymentMethods
    ...
    sig { params(employee_id: ::String, x_gusto_api_version: T.nilable(Models::Operations::GetV1EmployeesEmployeeIdBankAccountsHeaderXGustoAPIVersion), page: T.nilable(::Integer), per: T.nilable(::Integer), timeout_ms: T.nilable(Integer), http_headers: T.nilable(T::Hash[T.any(String, Symbol), String])).returns(Models::Operations::GetV1EmployeesEmployeeIdBankAccountsResponse) }
    def get_bank_accounts(employee_id:, x_gusto_api_version: nil, page: nil, per: nil, timeout_ms: nil, http_headers: nil)
      # get_bank_accounts - List employee bank accounts
      # Returns all employee bank accounts.
      #
      # scope: `employee_payment_methods:read`
      #
      # If set, this operation will use `company_access_auth` from the global security.
      request = Models::Operations::GetV1EmployeesEmployeeIdBankAccountsRequest.new(
      ...
      url = Utils.generate_url(
        Models::Operations::GetV1EmployeesEmployeeIdBankAccountsRequest,
        base_url,
      ...
      query_params = Utils.get_query_params(Models::Operations::GetV1EmployeesEmployeeIdBankAccountsRequest, request, nil)
      ...
      if Utils.match_status_code(http_response.status, ['200'])
        if Utils.match_content_type(content_type, 'application/json')
          ...
          obj = Crystalline.unmarshal_json(JSON.parse(response_data), Crystalline::Array.new(Models::Shared::EmployeeBankAccount))
          response = Models::Operations::GetV1EmployeesEmployeeIdBankAccountsResponse.new(
            status_code: http_response.status,
            content_type: content_type,
            raw_response: http_response,
            employee_bank_accounts: T.unsafe(obj)
          )
