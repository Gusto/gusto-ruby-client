...
module GustoEmbedded
  ...
  class FederalTaxDetails
    ...
    sig { params(company_id: ::String, x_gusto_api_version: T.nilable(Models::Operations::GetV1CompaniesCompanyIdFederalTaxDetailsHeaderXGustoAPIVersion), timeout_ms: T.nilable(Integer), http_headers: T.nilable(T::Hash[T.any(String, Symbol), String])).returns(Models::Operations::GetV1CompaniesCompanyIdFederalTaxDetailsResponse) }
    def get(company_id:, x_gusto_api_version: nil, timeout_ms: nil, http_headers: nil)
      # get - Get a company's federal tax details
      ...
      request = Models::Operations::GetV1CompaniesCompanyIdFederalTaxDetailsRequest.new(
      ...
      url = Utils.generate_url(
        Models::Operations::GetV1CompaniesCompanyIdFederalTaxDetailsRequest,
        base_url,
      ...
      if Utils.match_status_code(http_response.status, ['200'])
        if Utils.match_content_type(content_type, 'application/json')
          ...
          obj = Crystalline.unmarshal_json(JSON.parse(response_data), Models::Shared::FederalTaxDetails)
          response = Models::Operations::GetV1CompaniesCompanyIdFederalTaxDetailsResponse.new(
            status_code: http_response.status,
            content_type: content_type,
            raw_response: http_response,
            federal_tax_details: T.unsafe(obj)
          )
    ...
    sig { params(federal_tax_details_update: Models::Shared::FederalTaxDetailsUpdate, company_id: ::String, x_gusto_api_version: T.nilable(Models::Operations::PutV1CompaniesCompanyIdFederalTaxDetailsHeaderXGustoAPIVersion), timeout_ms: T.nilable(Integer), http_headers: T.nilable(T::Hash[T.any(String, Symbol), String])).returns(Models::Operations::PutV1CompaniesCompanyIdFederalTaxDetailsResponse) }
    def update(federal_tax_details_update:, company_id:, x_gusto_api_version: nil, timeout_ms: nil, http_headers: nil)
      # update - Update a company's federal tax details
      ...
      #
      # If set, this operation will use `company_access_auth` from the global security.
      request = Models::Operations::PutV1CompaniesCompanyIdFederalTaxDetailsRequest.new(
        company_id: company_id,
      ...
      base_url = Utils.template_url(url, params)
      url = Utils.generate_url(
        Models::Operations::PutV1CompaniesCompanyIdFederalTaxDetailsRequest,
        base_url,
        '/v1/companies/{company_id}/federal_tax_details',
        request
      )
      headers = Utils.get_headers(request)
      headers = T.cast(headers, T::Hash[String, String])
      req_content_type, data, form = Utils.serialize_request_body(request, false, false, :federal_tax_details_update, :json)
      ...
      if Utils.match_status_code(http_response.status, ['200'])
        if Utils.match_content_type(content_type, 'application/json')
          ...
          response_data = http_response.env.response_body
          obj = Crystalline.unmarshal_json(JSON.parse(response_data), Models::Shared::FederalTaxDetails)
          response = Models::Operations::PutV1CompaniesCompanyIdFederalTaxDetailsResponse.new(
            status_code: http_response.status,
            content_type: content_type,
            raw_response: http_response,
            federal_tax_details: T.unsafe(obj)
