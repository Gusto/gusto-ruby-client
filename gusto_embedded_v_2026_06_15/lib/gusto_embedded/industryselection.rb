...
module GustoEmbedded
  ...
  class IndustrySelection
    ...
    sig { params(company_id: ::String, x_gusto_api_version: T.nilable(Models::Operations::GetV1CompanyIndustryHeaderXGustoAPIVersion), timeout_ms: T.nilable(Integer), http_headers: T.nilable(T::Hash[T.any(String, Symbol), String])).returns(Models::Operations::GetV1CompanyIndustryResponse) }
    ...
    sig { params(company_industry_selection_required_body: Models::Shared::CompanyIndustrySelectionRequiredBody, company_id: ::String, x_gusto_api_version: T.nilable(Models::Operations::PutV1CompanyIndustryHeaderXGustoAPIVersion), timeout_ms: T.nilable(Integer), http_headers: T.nilable(T::Hash[T.any(String, Symbol), String])).returns(Models::Operations::PutV1CompanyIndustryResponse) }
    def update(company_industry_selection_required_body:, company_id:, x_gusto_api_version: nil, timeout_ms: nil, http_headers: nil)
      ...
      headers = Utils.get_headers(request)
      headers = T.cast(headers, T::Hash[String, String])
      req_content_type, data, form = Utils.serialize_request_body(request, false, false, :company_industry_selection_required_body, :json)
