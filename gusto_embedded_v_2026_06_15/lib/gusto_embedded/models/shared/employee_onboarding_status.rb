  ...
  module Models
    module Shared
      ...
      class EmployeeOnboardingStatus
        ...
        sig { params(uuid: ::String, onboarding_status: T.nilable(::String), onboarding_steps: T.nilable(T::Array[Models::Shared::EmployeeOnboardingStatusOnboardingStep]), blockers: T.nilable(T::Array[Models::Shared::Blockers])).void }
