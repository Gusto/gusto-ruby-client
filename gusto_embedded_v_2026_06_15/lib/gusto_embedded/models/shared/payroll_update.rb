  ...
  module Models
    module Shared
      ...
      class PayrollUpdate
        ...
        field :employee_compensations, Crystalline::Array.new(Models::Shared::PayrollUpdateEmployeeCompensations), { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('employee_compensations'), required: true } }
        # The payment schedule tax rate the payroll is based on. Only relevant for off-cycle payrolls.
        field :withholding_pay_period, Crystalline::Nilable.new(Models::Shared::WithholdingPayPeriod), { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('withholding_pay_period'), 'decoder': ::GustoEmbedded::Utils.enum_from_string(Models::Shared::WithholdingPayPeriod, true) } }
        ...
        sig { params(employee_compensations: T::Array[Models::Shared::PayrollUpdateEmployeeCompensations], withholding_pay_period: T.nilable(Models::Shared::WithholdingPayPeriod), skip_regular_deductions: T.nilable(T::Boolean), fixed_withholding_rate: T.nilable(T::Boolean)).void }
        def initialize(employee_compensations:, withholding_pay_period: nil, skip_regular_deductions: nil, fixed_withholding_rate: nil)
