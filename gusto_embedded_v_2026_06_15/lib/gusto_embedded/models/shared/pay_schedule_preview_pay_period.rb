  ...
  module Models
    module Shared
      ...
      class PaySchedulePreviewPayPeriod
        ...
        field :run_payroll_by, ::Date, { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('run_payroll_by'), required: true, 'decoder': ::GustoEmbedded::Utils.date_from_iso_format(false) } }
