  ...
  module Models
    module Shared
      ...
      class ReverseWireTransaction
        ...
        #
        field :status, Models::Shared::ReverseWireTransactionStatus, { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('status'), required: true, 'decoder': ::GustoEmbedded::Utils.enum_from_string(Models::Shared::ReverseWireTransactionStatus, false) } }
        # The direction of the payment. Reverse wires are always debits from the company's account.
        field :payment_direction, Models::Shared::ReverseWireTransactionPaymentDirection, { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('payment_direction'), required: true, 'decoder': ::GustoEmbedded::Utils.enum_from_string(Models::Shared::ReverseWireTransactionPaymentDirection, false) } }
        # The date the reverse wire record was created.
        field :created_at, ::String, { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('created_at'), required: true } }
        ...
        field :payment_event_type, Crystalline::Nilable.new(Models::Shared::ReverseWireTransactionPaymentEventType), { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('payment_event_type'), 'decoder': ::GustoEmbedded::Utils.enum_from_string(Models::Shared::ReverseWireTransactionPaymentEventType, true) } }
        ...
        sig { params(company_uuid: ::String, amount: ::String, status: Models::Shared::ReverseWireTransactionStatus, payment_direction: Models::Shared::ReverseWireTransactionPaymentDirection, created_at: ::String, bank_name: T.nilable(::String), payment_event_type: T.nilable(Models::Shared::ReverseWireTransactionPaymentEventType), payment_event_uuid: T.nilable(::String), payment_event_check_date: T.nilable(::String)).void }
        def initialize(company_uuid:, amount:, status:, payment_direction:, created_at:, bank_name: nil, payment_event_type: nil, payment_event_uuid: nil, payment_event_check_date: nil)
