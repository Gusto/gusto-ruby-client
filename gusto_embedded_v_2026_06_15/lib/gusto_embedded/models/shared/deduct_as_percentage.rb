  ...
  module Models
    module Shared
      ...
      class DeductAsPercentage
        ...
        field :default_value, Crystalline::Nilable.new(Models::Shared::BenefitTypeRequirementsDeductAsPercentageDefaultValue), { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('default_value') } }
        ...
        sig { params(required: T.nilable(T::Boolean), editable: T.nilable(T::Boolean), default_value: T.nilable(Models::Shared::BenefitTypeRequirementsDeductAsPercentageDefaultValue), choices: T.nilable(T::Array[::String])).void }
