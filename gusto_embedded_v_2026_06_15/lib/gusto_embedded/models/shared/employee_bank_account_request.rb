  ...
  module Models
    module Shared
      ...
      class EmployeeBankAccountRequest
        ...
        field :account_type, Models::Shared::EmployeeBankAccountRequestAccountType, { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('account_type'), required: true, 'decoder': ::GustoEmbedded::Utils.enum_from_string(Models::Shared::EmployeeBankAccountRequestAccountType, false) } }
        ...
        sig { params(routing_number: ::String, account_number: ::String, account_type: Models::Shared::EmployeeBankAccountRequestAccountType, name: ::String).void }
