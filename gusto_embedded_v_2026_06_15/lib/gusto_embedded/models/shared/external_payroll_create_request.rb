  ...
  module Models
    module Shared
      ...
      class ExternalPayrollCreateRequest
        ...
        field :payment_period_start_date, ::Date, { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('payment_period_start_date'), required: true, 'decoder': ::GustoEmbedded::Utils.date_from_iso_format(false) } }
        # The end date of the external payroll payment period.
        field :payment_period_end_date, ::Date, { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('payment_period_end_date'), required: true, 'decoder': ::GustoEmbedded::Utils.date_from_iso_format(false) } }
