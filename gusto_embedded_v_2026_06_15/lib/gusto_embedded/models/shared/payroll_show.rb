  ...
  module Models
    module Shared
      ...
      class PayrollShow
        ...
        field :employee_compensations, Crystalline::Nilable.new(Crystalline::Array.new(Models::Shared::EmployeeCompensations)), { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('employee_compensations') } }
        ...
        sig { params(payroll_deadline: T.nilable(::DateTime), check_date: T.nilable(::String), processed: T.nilable(T::Boolean), uuid: T.nilable(::String), payroll_uuid: T.nilable(::String), company_uuid: T.nilable(::String), off_cycle: T.nilable(T::Boolean), auto_payroll: T.nilable(T::Boolean), external: T.nilable(T::Boolean), final_termination_payroll: T.nilable(T::Boolean), pay_period: T.nilable(Models::Shared::PayrollPayPeriodType), payroll_status_meta: T.nilable(Models::Shared::PayrollPayrollStatusMetaType), totals: T.nilable(Models::Shared::PayrollTotalsType), company_taxes: T.nilable(T::Array[Models::Shared::PayrollCompanyTaxesType]), payroll_taxes: T.nilable(T::Array[Models::Shared::PayrollTaxesType]), payment_speed_changed: T.nilable(Models::Shared::PayrollPaymentSpeedChangedType), created_at: T.nilable(::DateTime), submission_blockers: T.nilable(T::Array[Models::Shared::PayrollSubmissionBlockerType]), credit_blockers: T.nilable(T::Array[Models::Shared::PayrollCreditBlockerType]), employee_compensations: T.nilable(T::Array[Models::Shared::EmployeeCompensations]), processed_date: T.nilable(::String), calculated_at: T.nilable(::DateTime), off_cycle_reason: T.nilable(Models::Shared::OffCycleReasonType), withholding_pay_period: T.nilable(Models::Shared::PayrollWithholdingPayPeriodType), skip_regular_deductions: T.nilable(T::Boolean), fixed_withholding_rate: T.nilable(T::Boolean), processing_request: T.nilable(Models::Shared::PayrollProcessingRequest), partner_owned_disbursement: T.nilable(T::Boolean)).void }
        def initialize(payroll_deadline: nil, check_date: nil, processed: nil, uuid: nil, payroll_uuid: nil, company_uuid: nil, off_cycle: nil, auto_payroll: nil, external: nil, final_termination_payroll: nil, pay_period: nil, payroll_status_meta: nil, totals: nil, company_taxes: nil, payroll_taxes: nil, payment_speed_changed: nil, created_at: nil, submission_blockers: nil, credit_blockers: nil, employee_compensations: nil, processed_date: nil, calculated_at: nil, off_cycle_reason: nil, withholding_pay_period: nil, skip_regular_deductions: nil, fixed_withholding_rate: nil, processing_request: nil, partner_owned_disbursement: nil)
