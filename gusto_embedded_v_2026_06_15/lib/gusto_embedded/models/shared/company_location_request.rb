  ...
  module Models
    module Shared
      ...
      class CompanyLocationRequest
        ...
        sig { params(street_1: ::String, city: ::String, state: ::String, zip: ::String, phone_number: ::String, mailing_address: T.nilable(T::Boolean), filing_address: T.nilable(T::Boolean), street_2: T.nilable(::String), country: T.nilable(::String)).void }
        def initialize(street_1:, city:, state:, zip:, phone_number:, mailing_address: nil, filing_address: nil, street_2: nil, country: 'USA')
          @street_1 = street_1
          @city = city
          @state = state
          @zip = zip
