  ...
  module Models
    module Shared
      ...
      class TokenInfo
        ...
        #
        field :resource, Crystalline::Nilable.new(Models::Shared::Resource), { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('resource') } }
        ...
        #
        field :resource_owner, Crystalline::Nilable.new(Models::Shared::ResourceOwner), { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('resource_owner') } }

        sig { params(scope: T.nilable(::String), resource: T.nilable(Models::Shared::Resource), resource_owner: T.nilable(Models::Shared::ResourceOwner)).void }
