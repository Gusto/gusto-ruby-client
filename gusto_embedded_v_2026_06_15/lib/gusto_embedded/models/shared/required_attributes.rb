  ...
  module Models
    module Shared
      ...
      class RequiredAttributes
        ...
        field :key, Crystalline::Nilable.new(Models::Shared::ChildSupportDataKey), { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('key'), 'decoder': ::GustoEmbedded::Utils.enum_from_string(Models::Shared::ChildSupportDataKey, true) } }
