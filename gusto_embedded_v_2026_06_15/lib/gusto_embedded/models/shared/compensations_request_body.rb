  ...
  module Models
    module Shared
      ...
      class CompensationsRequestBody
        ...
        field :rate, ::String, { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('rate'), required: true } }
        # The unit accompanying the compensation rate. If the employee is an owner, rate should be 'Paycheck'.
        field :payment_unit, Models::Shared::CompensationsRequestBodyPaymentUnit, { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('payment_unit'), required: true, 'decoder': ::GustoEmbedded::Utils.enum_from_string(Models::Shared::CompensationsRequestBodyPaymentUnit, false) } }
        ...
        field :flsa_status, Models::Shared::FlsaStatusType, { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('flsa_status'), required: true, 'decoder': ::GustoEmbedded::Utils.enum_from_string(Models::Shared::FlsaStatusType, false) } }
        ...
        field :minimum_wages, Crystalline::Nilable.new(Crystalline::Array.new(Models::Shared::CompensationsRequestBodyMinimumWages)), { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('minimum_wages') } }

        sig { params(rate: ::String, payment_unit: Models::Shared::CompensationsRequestBodyPaymentUnit, flsa_status: Models::Shared::FlsaStatusType, effective_date: T.nilable(::String), title: T.nilable(::String), adjust_for_minimum_wage: T.nilable(T::Boolean), minimum_wages: T.nilable(T::Array[Models::Shared::CompensationsRequestBodyMinimumWages])).void }
