  ...
  module Models
    module Shared
      ...
      class JobsCreateRequestBody
        ...
        # The job title.
        field :title, Crystalline::Nilable.new(::String), { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('title'), required: true } }
        ...
        sig { params(hire_date: ::String, title: T.nilable(::String), two_percent_shareholder: T.nilable(T::Boolean), state_wc_covered: T.nilable(T::Boolean), state_wc_class_code: T.nilable(::String)).void }
        def initialize(hire_date:, title: nil, two_percent_shareholder: nil, state_wc_covered: nil, state_wc_class_code: nil)
          @hire_date = hire_date
          @title = title
