  ...
  module Models
    module Shared
      ...
      class CompanyHomeAddress
        ...
        sig { params(street_1: T.nilable(::String), city: T.nilable(::String), state: T.nilable(::String), zip: T.nilable(::String), country: T.nilable(::String), street_2: T.nilable(::String)).void }
