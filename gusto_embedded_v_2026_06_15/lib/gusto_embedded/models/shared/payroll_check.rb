  ...
  module Models
    module Shared
      ...
      class PayrollCheck
        ...
        sig { params(payroll_uuid: T.nilable(::String), printing_format: T.nilable(::String), request_uuid: T.nilable(::String), status: T.nilable(::String), employee_check_number_mapping: T.nilable(T::Array[Models::Shared::EmployeeCheckNumberMapping]), starting_check_number: T.nilable(::Integer)).void }
