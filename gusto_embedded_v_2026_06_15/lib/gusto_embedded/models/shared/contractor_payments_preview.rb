  ...
  module Models
    module Shared
      ...
      class ContractorPaymentsPreview
        ...
        field :expected_debit_date, Crystalline::Nilable.new(::Date), { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('expected_debit_date'), 'decoder': ::GustoEmbedded::Utils.date_from_iso_format(true) } }
