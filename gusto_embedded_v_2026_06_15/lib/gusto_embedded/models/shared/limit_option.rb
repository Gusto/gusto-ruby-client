  ...
  module Models
    module Shared
      ...
      class LimitOption
        ...
        field :default_value, Crystalline::Nilable.new(Models::Shared::BenefitTypeRequirementsLimitOptionDefaultValue), { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('default_value') } }
        ...
        sig { params(required: T.nilable(T::Boolean), editable: T.nilable(T::Boolean), default_value: T.nilable(Models::Shared::BenefitTypeRequirementsLimitOptionDefaultValue), choices: T.nilable(T::Array[::String])).void }
