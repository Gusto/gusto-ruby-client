  ...
  module Models
    module Shared
      ...
      class JobsUpdateRequestBody
        ...
        sig { params(version: ::String, hire_date: T.nilable(::String), two_percent_shareholder: T.nilable(T::Boolean), title: T.nilable(::String), state_wc_covered: T.nilable(T::Boolean), state_wc_class_code: T.nilable(::String)).void }
        def initialize(version:, hire_date: nil, two_percent_shareholder: nil, title: nil, state_wc_covered: nil, state_wc_class_code: nil)
          @version = version
          @hire_date = hire_date
