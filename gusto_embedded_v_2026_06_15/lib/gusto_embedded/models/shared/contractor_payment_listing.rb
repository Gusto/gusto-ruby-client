  ...
  module Models
    module Shared
      ...
      class ContractorPaymentListing
        ...
        # The payment method.
        field :payment_method, Crystalline::Nilable.new(Models::Shared::ContractorPaymentListingPaymentMethod), { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('payment_method'), 'decoder': ::GustoEmbedded::Utils.enum_from_string(Models::Shared::ContractorPaymentListingPaymentMethod, true) } }
        ...
        field :status, Crystalline::Nilable.new(Models::Shared::ContractorPaymentListingStatus), { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('status'), 'decoder': ::GustoEmbedded::Utils.enum_from_string(Models::Shared::ContractorPaymentListingStatus, true) } }
        ...
        field :wage_type, Crystalline::Nilable.new(Models::Shared::ContractorPaymentListingWageType), { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('wage_type'), 'decoder': ::GustoEmbedded::Utils.enum_from_string(Models::Shared::ContractorPaymentListingWageType, true) } }
        ...
        sig { params(uuid: ::String, check_date: T.nilable(::Date), bonus: T.nilable(::String), hours: T.nilable(::String), hourly_rate: T.nilable(::String), payment_method: T.nilable(Models::Shared::ContractorPaymentListingPaymentMethod), reimbursement: T.nilable(::String), status: T.nilable(Models::Shared::ContractorPaymentListingStatus), wage: T.nilable(::String), wage_type: T.nilable(Models::Shared::ContractorPaymentListingWageType), wage_total: T.nilable(::String)).void }
        def initialize(uuid:, check_date: nil, bonus: nil, hours: nil, hourly_rate: nil, payment_method: nil, reimbursement: nil, status: nil, wage: nil, wage_type: nil, wage_total: nil)
          @uuid = uuid
