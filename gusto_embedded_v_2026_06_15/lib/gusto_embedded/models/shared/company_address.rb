  ...
  module Models
    module Shared
      ...
      class CompanyAddress
        ...
        sig { params(street_1: T.nilable(::String), city: T.nilable(::String), state: T.nilable(::String), zip: T.nilable(::String), inactive: T.nilable(T::Boolean), active: T.nilable(T::Boolean), street_2: T.nilable(::String), country: T.nilable(::String)).void }
        def initialize(street_1: nil, city: nil, state: nil, zip: nil, inactive: nil, active: nil, street_2: nil, country: 'USA')
          @street_1 = street_1
          @city = city
          @state = state
          @zip = zip
