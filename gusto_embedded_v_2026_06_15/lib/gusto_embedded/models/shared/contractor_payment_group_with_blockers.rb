  ...
  module Models
    module Shared
      ...
      class ContractorPaymentGroupWithBlockers
        ...
        field :status, Crystalline::Nilable.new(Models::Shared::ContractorPaymentGroupWithBlockersStatus), { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('status'), 'decoder': ::GustoEmbedded::Utils.enum_from_string(Models::Shared::ContractorPaymentGroupWithBlockersStatus, true) } }
        ...
        field :totals, Crystalline::Nilable.new(Models::Shared::ContractorPaymentGroupWithBlockersTotals), { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('totals') } }
        ...
        sig { params(uuid: T.nilable(::String), company_uuid: T.nilable(::String), check_date: T.nilable(::String), debit_date: T.nilable(::String), status: T.nilable(Models::Shared::ContractorPaymentGroupWithBlockersStatus), submission_blockers: T.nilable(T::Array[Models::Shared::PayrollSubmissionBlockerType]), credit_blockers: T.nilable(T::Array[Models::Shared::PayrollCreditBlockerType]), totals: T.nilable(Models::Shared::ContractorPaymentGroupWithBlockersTotals), creation_token: T.nilable(::String), partner_owned_disbursement: T.nilable(T::Boolean)).void }
        def initialize(uuid: nil, company_uuid: nil, check_date: nil, debit_date: nil, status: nil, submission_blockers: nil, credit_blockers: nil, totals: nil, creation_token: nil, partner_owned_disbursement: nil)
          @uuid = uuid
