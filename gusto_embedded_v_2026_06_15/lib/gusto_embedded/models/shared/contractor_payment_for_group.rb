  ...
  module Models
    module Shared
      ...
      class ContractorPaymentForGroup
        ...
        # The payment method.
        field :payment_method, Crystalline::Nilable.new(Models::Shared::ContractorPaymentForGroupPaymentMethod), { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('payment_method'), 'decoder': ::GustoEmbedded::Utils.enum_from_string(Models::Shared::ContractorPaymentForGroupPaymentMethod, true) } }
        ...
        field :status, Crystalline::Nilable.new(Models::Shared::ContractorPaymentForGroupStatus), { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('status'), 'decoder': ::GustoEmbedded::Utils.enum_from_string(Models::Shared::ContractorPaymentForGroupStatus, true) } }
        ...
        field :wage_type, Crystalline::Nilable.new(Models::Shared::ContractorPaymentForGroupWageType), { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('wage_type'), 'decoder': ::GustoEmbedded::Utils.enum_from_string(Models::Shared::ContractorPaymentForGroupWageType, true) } }
        ...
        sig { params(uuid: T.nilable(::String), contractor_uuid: T.nilable(::String), bonus: T.nilable(::String), hours: T.nilable(::String), payment_method: T.nilable(Models::Shared::ContractorPaymentForGroupPaymentMethod), reimbursement: T.nilable(::String), status: T.nilable(Models::Shared::ContractorPaymentForGroupStatus), hourly_rate: T.nilable(::String), may_cancel: T.nilable(T::Boolean), wage: T.nilable(::String), wage_type: T.nilable(Models::Shared::ContractorPaymentForGroupWageType), wage_total: T.nilable(::String), invoice_number: T.nilable(::String), memo: T.nilable(::String)).void }
        def initialize(uuid: nil, contractor_uuid: nil, bonus: nil, hours: nil, payment_method: nil, reimbursement: nil, status: nil, hourly_rate: nil, may_cancel: nil, wage: nil, wage_type: nil, wage_total: nil, invoice_number: nil, memo: nil)
          @uuid = uuid
