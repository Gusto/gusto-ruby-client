  ...
  module Models
    module Shared
      ...
      class UnprocessedPayroll
        ...
        sig { params(payroll_deadline: T.nilable(::DateTime), check_date: T.nilable(::String), processed: T.nilable(T::Boolean), uuid: T.nilable(::String), payroll_uuid: T.nilable(::String), company_uuid: T.nilable(::String), off_cycle: T.nilable(T::Boolean), auto_payroll: T.nilable(T::Boolean), external: T.nilable(T::Boolean), pay_period: T.nilable(Models::Shared::PayrollPayPeriodType), created_at: T.nilable(::DateTime), processed_date: T.nilable(::String), calculated_at: T.nilable(::DateTime), off_cycle_reason: T.nilable(Models::Shared::OffCycleReasonType), partner_owned_disbursement: T.nilable(T::Boolean)).void }
        def initialize(payroll_deadline: nil, check_date: nil, processed: nil, uuid: nil, payroll_uuid: nil, company_uuid: nil, off_cycle: nil, auto_payroll: nil, external: nil, pay_period: nil, created_at: nil, processed_date: nil, calculated_at: nil, off_cycle_reason: nil, partner_owned_disbursement: nil)
