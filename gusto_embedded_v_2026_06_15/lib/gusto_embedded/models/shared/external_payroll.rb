  ...
  module Models
    module Shared
      ...
      class ExternalPayroll
        ...
        field :status, Crystalline::Nilable.new(Models::Shared::ExternalPayrollStatus), { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('status'), 'decoder': ::GustoEmbedded::Utils.enum_from_string(Models::Shared::ExternalPayrollStatus, true) } }
        ...
        sig { params(uuid: ::String, company_uuid: T.nilable(::String), check_date: T.nilable(::String), payment_period_start_date: T.nilable(::String), payment_period_end_date: T.nilable(::String), status: T.nilable(Models::Shared::ExternalPayrollStatus), external_payroll_items: T.nilable(T::Array[Models::Shared::ExternalPayrollItems]), applicable_earnings: T.nilable(T::Array[Models::Shared::ApplicableEarnings]), applicable_taxes: T.nilable(T::Array[Models::Shared::ApplicableTaxes]), metadata: T.nilable(Models::Shared::ExternalPayrollMetadata), applicable_benefits: T.nilable(T::Array[Models::Shared::ApplicableBenefits])).void }
