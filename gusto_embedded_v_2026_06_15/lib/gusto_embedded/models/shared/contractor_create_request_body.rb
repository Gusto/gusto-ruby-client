  ...
  module Models
    module Shared
      ...
      class ContractorCreateRequestBody
        ...
        #
        field :wage_type, Models::Shared::ContractorCreateRequestBodyWageType, { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('wage_type'), required: true, 'decoder': ::GustoEmbedded::Utils.enum_from_string(Models::Shared::ContractorCreateRequestBodyWageType, false) } }
        ...
        # The contractor type.
        field :type, Crystalline::Nilable.new(Models::Shared::ContractorCreateRequestBodyType), { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('type'), 'decoder': ::GustoEmbedded::Utils.enum_from_string(Models::Shared::ContractorCreateRequestBodyType, true) } }
