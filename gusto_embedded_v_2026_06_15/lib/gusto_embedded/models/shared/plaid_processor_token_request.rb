  ...
  module Models
    module Shared
      ...
      class PlaidProcessorTokenRequest
        ...
        field :owner_type, Models::Shared::OwnerType, { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('owner_type'), required: true, 'decoder': ::GustoEmbedded::Utils.enum_from_string(Models::Shared::OwnerType, false) } }
