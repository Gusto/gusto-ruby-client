  ...
  module Models
    module Shared
      ...
      class PeopleBatchResults
        ...
        field :status, Models::Shared::PeopleBatchResultsStatus, { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('status'), required: true, 'decoder': ::GustoEmbedded::Utils.enum_from_string(Models::Shared::PeopleBatchResultsStatus, false) } }
        # The timestamp when the batch was submitted.
        field :submitted_at, Crystalline::Nilable.new(::DateTime), { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('submitted_at'), 'decoder': ::GustoEmbedded::Utils.datetime_from_iso_format(true) } }
