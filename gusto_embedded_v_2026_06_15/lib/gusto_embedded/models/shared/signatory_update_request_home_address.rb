  ...
  module Models
    module Shared
      ...
      class SignatoryUpdateRequestHomeAddress
        ...
        sig { params(street_1: T.nilable(::String), street_2: T.nilable(::String), city: T.nilable(::String), state: T.nilable(::String), zip: T.nilable(::String), country: T.nilable(::String)).void }
