  ...
  module Models
    module Shared
      ...
      class ContractorUpdateRequestBody
        ...
        def initialize(version:, wage_type: nil, start_date: nil, hourly_rate: nil, email: nil, first_name: nil, last_name: nil, middle_initial: nil, ssn: nil, business_name: nil, ein: nil, is_active: nil, type: Models::Shared::ContractorUpdateRequestBodyType::INDIVIDUAL, self_onboarding: false, file_new_hire_report: false, work_state: nil)
          @version = version
          @wage_type = wage_type
