  ...
  module Models
    module Shared
      ...
      class PayrollShowHourlyCompensations
        ...
        #
        field :breakdowns, Crystalline::Nilable.new(Crystalline::Array.new(Models::Shared::PayrollShowBreakdowns)), { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('breakdowns') } }

        sig { params(name: T.nilable(::String), hours: T.nilable(::String), amount: T.nilable(::String), job_uuid: T.nilable(::String), compensation_multiplier: T.nilable(::Float), flsa_status: T.nilable(::String), breakdowns: T.nilable(T::Array[Models::Shared::PayrollShowBreakdowns])).void }
