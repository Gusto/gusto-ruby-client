  ...
  module Models
    module Shared
      ...
      class PayrollUnprocessed
        ...
        field :employee_compensations, Crystalline::Nilable.new(Crystalline::Array.new(Models::Shared::PayrollUnprocessedEmployeeCompensationsType)), { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('employee_compensations') } }
        ...
        field :fixed_compensation_types, Crystalline::Nilable.new(Crystalline::Array.new(Models::Shared::PayrollFixedCompensationTypesType)), { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('fixed_compensation_types') } }
        ...
        field :withholding_pay_period, Crystalline::Nilable.new(Models::Shared::PayrollWithholdingPayPeriodType), { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('withholding_pay_period'), 'decoder': ::GustoEmbedded::Utils.enum_from_string(Models::Shared::PayrollWithholdingPayPeriodType, true) } }
        ...
        #
        field :workweeks, Crystalline::Nilable.new(Crystalline::Array.new(Models::Shared::PayrollUnprocessedWorkweeks)), { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('workweeks') } }
        ...
        sig { params(payroll_deadline: T.nilable(::DateTime), check_date: T.nilable(::String), processed: T.nilable(T::Boolean), uuid: T.nilable(::String), payroll_uuid: T.nilable(::String), company_uuid: T.nilable(::String), off_cycle: T.nilable(T::Boolean), auto_payroll: T.nilable(T::Boolean), external: T.nilable(T::Boolean), final_termination_payroll: T.nilable(T::Boolean), pay_period: T.nilable(Models::Shared::PayrollPayPeriodType), payroll_status_meta: T.nilable(Models::Shared::PayrollPayrollStatusMetaType), employee_compensations: T.nilable(T::Array[Models::Shared::PayrollUnprocessedEmployeeCompensationsType]), payment_speed_changed: T.nilable(Models::Shared::PayrollPaymentSpeedChangedType), created_at: T.nilable(::DateTime), fixed_compensation_types: T.nilable(T::Array[Models::Shared::PayrollFixedCompensationTypesType]), processed_date: T.nilable(::String), calculated_at: T.nilable(::DateTime), off_cycle_reason: T.nilable(Models::Shared::OffCycleReasonType), withholding_pay_period: T.nilable(Models::Shared::PayrollWithholdingPayPeriodType), skip_regular_deductions: T.nilable(T::Boolean), fixed_withholding_rate: T.nilable(T::Boolean), workweeks: T.nilable(T::Array[Models::Shared::PayrollUnprocessedWorkweeks]), processing_request: T.nilable(Models::Shared::PayrollProcessingRequest), partner_owned_disbursement: T.nilable(T::Boolean)).void }
        def initialize(payroll_deadline: nil, check_date: nil, processed: nil, uuid: nil, payroll_uuid: nil, company_uuid: nil, off_cycle: nil, auto_payroll: nil, external: nil, final_termination_payroll: nil, pay_period: nil, payroll_status_meta: nil, employee_compensations: nil, payment_speed_changed: nil, created_at: nil, fixed_compensation_types: nil, processed_date: nil, calculated_at: nil, off_cycle_reason: nil, withholding_pay_period: nil, skip_regular_deductions: nil, fixed_withholding_rate: nil, workweeks: nil, processing_request: nil, partner_owned_disbursement: nil)
