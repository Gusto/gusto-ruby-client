  ...
  module Models
    module Shared
      ...
      class Employees
        ...
        field :benefit_deduction, Crystalline::Nilable.new(::String), { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('benefit_deduction') } }
        # The sum of company contribution for this employee given the period of time and the benefit type.
        field :benefit_contribution, Crystalline::Nilable.new(::String), { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('benefit_contribution') } }
        ...
        field :payroll_benefits, Crystalline::Nilable.new(Crystalline::Array.new(Models::Shared::PayrollBenefits)), { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('payroll_benefits') } }

        sig { params(uuid: T.nilable(::String), company_benefit_deduction: T.nilable(::String), company_benefit_contribution: T.nilable(::String), benefit_deduction: T.nilable(::String), benefit_contribution: T.nilable(::String), gross_pay: T.nilable(::String), imputed_pay: T.nilable(::String), payroll_benefits: T.nilable(T::Array[Models::Shared::PayrollBenefits])).void }
