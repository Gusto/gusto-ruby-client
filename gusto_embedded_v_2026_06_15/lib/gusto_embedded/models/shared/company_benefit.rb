  ...
  module Models
    module Shared
      ...
      class CompanyBenefit
        ...
        field :source, Crystalline::Nilable.new(Models::Shared::Source), { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('source'), 'decoder': ::GustoEmbedded::Utils.enum_from_string(Models::Shared::Source, true) } }
        ...
        field :catch_up_type, Crystalline::Nilable.new(Models::Shared::CatchUpType), { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('catch_up_type'), 'decoder': ::GustoEmbedded::Utils.enum_from_string(Models::Shared::CatchUpType, true) } }

        sig { params(uuid: ::String, version: T.nilable(::String), enrollment_count: T.nilable(::Integer), company_uuid: T.nilable(::String), benefit_type: T.nilable(::Integer), description: T.nilable(::String), source: T.nilable(Models::Shared::Source), deletable: T.nilable(T::Boolean), supports_percentage_amounts: T.nilable(T::Boolean), responsible_for_employer_taxes: T.nilable(T::Boolean), responsible_for_employee_w2: T.nilable(T::Boolean), active: T.nilable(T::Boolean), partner_name: T.nilable(::String), catch_up_type: T.nilable(Models::Shared::CatchUpType)).void }
        def initialize(uuid:, version: nil, enrollment_count: nil, company_uuid: nil, benefit_type: nil, description: nil, source: nil, deletable: nil, supports_percentage_amounts: nil, responsible_for_employer_taxes: nil, responsible_for_employee_w2: nil, active: true, partner_name: nil, catch_up_type: nil)
          @uuid = uuid
          @version = version
