  ...
  module Models
    module Shared
      ...
      class HolidayPayPolicy
        ...
        field :federal_holidays, Models::Shared::FederalHolidays, { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('federal_holidays'), required: true } }
        ...
        sig { params(version: ::String, company_uuid: ::String, federal_holidays: Models::Shared::FederalHolidays, employees: T::Array[Models::Shared::HolidayPayPolicyEmployees]).void }
