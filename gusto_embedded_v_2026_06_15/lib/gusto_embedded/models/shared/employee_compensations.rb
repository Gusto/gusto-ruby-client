  ...
  module Models
    module Shared
      ...
      class EmployeeCompensations
        ...
        #
        field :custom_withholdings, Crystalline::Nilable.new(Models::Shared::PayrollShowCustomWithholdings), { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('custom_withholdings') } }
        ...
        #
        field :pay_adjustments, Crystalline::Nilable.new(Crystalline::Array.new(Models::Shared::PayAdjustments)), { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('pay_adjustments') } }
        ...
        sig { params(employee_uuid: T.nilable(::String), excluded: T.nilable(T::Boolean), fixed_compensations: T.nilable(T::Array[Models::Shared::PayrollShowFixedCompensations]), hourly_compensations: T.nilable(T::Array[Models::Shared::PayrollShowHourlyCompensations]), paid_time_off: T.nilable(T::Array[Models::Shared::PayrollShowPaidTimeOff]), reimbursements: T.nilable(T::Array[Models::Shared::PayrollShowReimbursements]), custom_withholdings: T.nilable(Models::Shared::PayrollShowCustomWithholdings), version: T.nilable(::Object), deductions: T.nilable(T::Array[Models::Shared::PayrollShowDeductions]), taxes: T.nilable(T::Array[Models::Shared::PayrollShowTaxes]), benefits: T.nilable(T::Array[Models::Shared::PayrollShowBenefits]), pay_adjustments: T.nilable(T::Array[Models::Shared::PayAdjustments]), additional_properties: T.nilable(T::Hash[Symbol, ::Object]), first_name: T.nilable(::String), preferred_first_name: T.nilable(::String), last_name: T.nilable(::String), gross_pay: T.nilable(::String), net_pay: T.nilable(::String), check_amount: T.nilable(::String), payment_method: T.nilable(Models::Shared::PayrollShowPaymentMethod), memo: T.nilable(::String)).void }
        def initialize(employee_uuid: nil, excluded: nil, fixed_compensations: nil, hourly_compensations: nil, paid_time_off: nil, reimbursements: nil, custom_withholdings: nil, version: nil, deductions: nil, taxes: nil, benefits: nil, pay_adjustments: nil, additional_properties: nil, first_name: nil, preferred_first_name: nil, last_name: nil, gross_pay: nil, net_pay: nil, check_amount: nil, payment_method: nil, memo: nil)
