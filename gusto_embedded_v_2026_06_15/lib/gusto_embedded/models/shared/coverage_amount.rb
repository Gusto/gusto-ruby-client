  ...
  module Models
    module Shared
      ...
      class CoverageAmount
        ...
        field :default_value, Crystalline::Nilable.new(Models::Shared::BenefitTypeRequirementsCoverageAmountDefaultValue), { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('default_value') } }
        ...
        sig { params(required: T.nilable(T::Boolean), editable: T.nilable(T::Boolean), default_value: T.nilable(Models::Shared::BenefitTypeRequirementsCoverageAmountDefaultValue), choices: T.nilable(T::Array[::String])).void }
