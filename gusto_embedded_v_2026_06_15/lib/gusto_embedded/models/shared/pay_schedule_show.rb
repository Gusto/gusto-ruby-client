  ...
  module Models
    module Shared
      ...
      class PayScheduleShow
        ...
        def initialize(uuid:, version:, frequency: nil, anchor_pay_date: nil, anchor_end_of_pay_period: nil, custom_name: nil, auto_payroll: nil, active: nil, day_1: nil, day_2: nil, name: nil, auto_payroll_enablement_blockers: nil, workweek_start_day: nil)
          @uuid = uuid
          @version = version
          @frequency = frequency
