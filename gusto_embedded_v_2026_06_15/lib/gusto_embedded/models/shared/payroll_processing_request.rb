  ...
  module Models
    module Shared
      ...
      class PayrollProcessingRequest
        ...
        field :status, Crystalline::Nilable.new(Models::Shared::PayrollProcessingRequestStatus), { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('status'), 'decoder': ::GustoEmbedded::Utils.enum_from_string(Models::Shared::PayrollProcessingRequestStatus, true) } }
