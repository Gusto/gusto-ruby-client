  ...
  module Models
    module Shared
      ...
      class Contractor
        ...
        field :type, Crystalline::Nilable.new(Models::Shared::ContractorType), { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('type'), 'decoder': ::GustoEmbedded::Utils.enum_from_string(Models::Shared::ContractorType, true) } }
        ...
        field :dismissal_cancellation_eligible, Crystalline::Nilable.new(Crystalline::Boolean.new), { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('dismissal_cancellation_eligible') } }
        # Whether the contractor's pending rehire can be cancelled.
        field :rehire_cancellation_eligible, Crystalline::Nilable.new(Crystalline::Boolean.new), { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('rehire_cancellation_eligible') } }
        ...
        field :payment_method, Crystalline::Nilable.new(Models::Shared::ContractorPaymentMethod1), { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('payment_method'), 'decoder': ::GustoEmbedded::Utils.enum_from_string(Models::Shared::ContractorPaymentMethod1, true) } }
        ...
        field :department_title, Crystalline::Nilable.new(::String), { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('department_title') } }
        ...
        sig { params(uuid: ::String, company_uuid: T.nilable(::String), wage_type: T.nilable(Models::Shared::ContractorWageType), version: T.nilable(::String), type: T.nilable(Models::Shared::ContractorType), start_date: T.nilable(::String), hourly_rate: T.nilable(::String), onboarded: T.nilable(T::Boolean), onboarding_status: T.nilable(Models::Shared::OnboardingStatus), has_ssn: T.nilable(T::Boolean), dismissal_cancellation_eligible: T.nilable(T::Boolean), rehire_cancellation_eligible: T.nilable(T::Boolean), is_active: T.nilable(T::Boolean), first_name: T.nilable(::String), last_name: T.nilable(::String), middle_initial: T.nilable(::String), business_name: T.nilable(::String), ein: T.nilable(::String), has_ein: T.nilable(T::Boolean), email: T.nilable(::String), address: T.nilable(Models::Shared::Address), file_new_hire_report: T.nilable(T::Boolean), work_state: T.nilable(::String), payment_method: T.nilable(Models::Shared::ContractorPaymentMethod1), department_uuid: T.nilable(::String), department: T.nilable(::String), department_title: T.nilable(::String), dismissal_date: T.nilable(::String), upcoming_employment: T.nilable(Models::Shared::UpcomingEmployment), member_portal_invitation_status: T.nilable(Models::Shared::MemberPortalInvitationStatus), partner_portal_invitation_sent: T.nilable(T::Boolean)).void }
