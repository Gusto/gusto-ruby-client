  ...
  module Models
    module Shared
      ...
      class ContractorPaymentBody
        ...
        field :date, ::Date, { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('date'), required: true, 'decoder': ::GustoEmbedded::Utils.date_from_iso_format(false) } }
        ...
        field :payment_method, Crystalline::Nilable.new(Models::Shared::ContractorPaymentBodyPaymentMethod), { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('payment_method'), 'decoder': ::GustoEmbedded::Utils.enum_from_string(Models::Shared::ContractorPaymentBodyPaymentMethod, true) } }

        sig { params(contractor_uuid: ::String, date: ::Date, wage: T.nilable(::String), hours: T.nilable(::String), bonus: T.nilable(::String), reimbursement: T.nilable(::String), invoice_number: T.nilable(::String), memo: T.nilable(::String), payment_method: T.nilable(Models::Shared::ContractorPaymentBodyPaymentMethod)).void }
        def initialize(contractor_uuid:, date:, wage: nil, hours: nil, bonus: nil, reimbursement: nil, invoice_number: nil, memo: nil, payment_method: Models::Shared::ContractorPaymentBodyPaymentMethod::DIRECT_DEPOSIT)
