  ...
  module Models
    module Shared
      ...
      class EmployeeHomeAddressHistoryEntry
        ...
        sig { params(active: T.nilable(T::Boolean), uuid: T.nilable(::String), effective_date: T.nilable(::Date), street_1: T.nilable(::String), street_2: T.nilable(::String), city: T.nilable(::String), state: T.nilable(::String), zip: T.nilable(::String), country: T.nilable(::String)).void }
        def initialize(active: nil, uuid: nil, effective_date: nil, street_1: nil, street_2: nil, city: nil, state: nil, zip: nil, country: 'USA')
          @active = active
          @uuid = uuid
