  ...
  module Models
    module Operations
      ...
      class GetV1CompaniesCompanyIdPayrollsPayrollIdRequest
        ...
        def initialize(company_id:, payroll_id:, include: nil, page: nil, per: nil, sort_by: nil, x_gusto_api_version: Models::Operations::GetV1CompaniesCompanyIdPayrollsPayrollIdHeaderXGustoAPIVersion::TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15)
