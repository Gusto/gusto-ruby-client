  ...
  module Models
    module Operations
      ...
      class PostV1CompaniesCompanyIdPeopleBatchesHomeAddress
        ...
        field :work_from_home, Crystalline::Nilable.new(Crystalline::Boolean.new), { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('work_from_home') } }

        sig { params(street_1: ::String, city: ::String, state: ::String, zip: ::String, street_2: T.nilable(::String), country: T.nilable(::String), work_from_home: T.nilable(T::Boolean)).void }
