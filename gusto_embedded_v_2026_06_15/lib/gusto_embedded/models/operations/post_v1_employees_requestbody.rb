  ...
  module Models
    module Operations
      ...
      class PostV1EmployeesRequestBody
        ...
        field :date_of_birth, Crystalline::Nilable.new(::Date), { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('date_of_birth'), 'decoder': ::GustoEmbedded::Utils.date_from_iso_format(true) } }
        ...
        sig { params(first_name: ::String, last_name: ::String, middle_initial: T.nilable(::String), work_email: T.nilable(::String), date_of_birth: T.nilable(::Date), ssn: T.nilable(::String), preferred_first_name: T.nilable(::String), self_onboarding: T.nilable(T::Boolean), email: T.nilable(::String)).void }
        def initialize(first_name:, last_name:, middle_initial: nil, work_email: nil, date_of_birth: nil, ssn: nil, preferred_first_name: nil, self_onboarding: nil, email: nil)
