  ...
  module Models
    module Operations
      ...
      class GetV1CompaniesCompanyIdPaySchedulesPreviewRequest
        ...
        field :frequency, Models::Operations::Frequency, { 'query_param': { 'field_name': 'frequency', 'style': 'form', 'explode': true } }
        # The first date that employees on this pay schedule are paid with Gusto.
        field :anchor_pay_date, ::Date, { 'query_param': { 'field_name': 'anchor_pay_date', 'style': 'form', 'explode': true } }
        # The last date of the first pay period. This can be the same date as the anchor pay date.
        field :anchor_end_of_pay_period, ::Date, { 'query_param': { 'field_name': 'anchor_end_of_pay_period', 'style': 'form', 'explode': true } }
        ...
        def initialize(company_id:, frequency:, anchor_pay_date:, anchor_end_of_pay_period:, day_1: nil, day_2: nil, end_date: nil, pay_schedule_uuid: nil, x_gusto_api_version: Models::Operations::GetV1CompaniesCompanyIdPaySchedulesPreviewHeaderXGustoAPIVersion::TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15)
