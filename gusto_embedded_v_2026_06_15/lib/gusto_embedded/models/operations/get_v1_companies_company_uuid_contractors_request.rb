  ...
  module Models
    module Operations
      ...
      class GetV1CompaniesCompanyUuidContractorsRequest
        ...
        def initialize(company_uuid:, search_term: nil, sort_by: nil, onboarded: nil, onboarded_active: nil, terminated: nil, terminated_today: nil, include: nil, page: nil, per: nil, x_gusto_api_version: Models::Operations::GetV1CompaniesCompanyUuidContractorsHeaderXGustoAPIVersion::TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15)
