  ...
  module Models
    module Operations
      ...
      class SystemAccessTokenRequest
        ...
        field :grant_type, Models::Operations::RequestBodyGrantType, { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('grant_type'), required: true, 'decoder': ::GustoEmbedded::Utils.enum_from_string(Models::Operations::RequestBodyGrantType, false) } }

        sig { params(client_id: ::String, client_secret: ::String, grant_type: Models::Operations::RequestBodyGrantType).void }
