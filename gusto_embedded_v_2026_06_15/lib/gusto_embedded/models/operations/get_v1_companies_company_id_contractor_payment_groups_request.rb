  ...
  module Models
    module Operations
      ...
      class GetV1CompaniesCompanyIdContractorPaymentGroupsRequest
        ...
        def initialize(company_id:, start_date: nil, end_date: nil, page: nil, per: nil, x_gusto_api_version: Models::Operations::GetV1CompaniesCompanyIdContractorPaymentGroupsHeaderXGustoAPIVersion::TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15)
