  ...
  module Models
    module Operations
      ...
      class GetV1CompaniesCompanyIdCompanyBenefitsRequest
        ...
        def initialize(company_id:, active: nil, enrollment_count: nil, benefit_type: nil, x_gusto_api_version: Models::Operations::GetV1CompaniesCompanyIdCompanyBenefitsHeaderXGustoAPIVersion::TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15)
