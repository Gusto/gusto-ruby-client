  ...
  module Models
    module Operations
      ...
      class GetV1WebhookSubscriptionVerificationTokenUuidRequest
        ...
        def initialize(webhook_subscription_uuid:, x_gusto_api_version: Models::Operations::GetV1WebhookSubscriptionVerificationTokenUuidHeaderXGustoAPIVersion::TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15)
