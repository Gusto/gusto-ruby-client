  ...
  module Models
    module Operations
      ...
      class GetV1CompaniesCompanyIdPayrollsRequest
        ...
        field :payroll_types, Crystalline::Nilable.new(Crystalline::Array.new(Models::Operations::QueryParamPayrollTypes)), { 'query_param': { 'field_name': 'payroll_types', 'style': 'form', 'explode': false } }
        ...
        sig { params(company_id: ::String, processing_statuses: T.nilable(T::Array[Models::Operations::ProcessingStatuses]), payroll_types: T.nilable(T::Array[Models::Operations::QueryParamPayrollTypes]), processed: T.nilable(T::Boolean), include_off_cycle: T.nilable(T::Boolean), include: T.nilable(T::Array[Models::Operations::GetV1CompaniesCompanyIdPayrollsQueryParamInclude]), start_date: T.nilable(::String), end_date: T.nilable(::String), date_filter_by: T.nilable(Models::Operations::DateFilterBy), page: T.nilable(::Integer), per: T.nilable(::Integer), sort_order: T.nilable(Models::Operations::QueryParamSortOrder), x_gusto_api_version: T.nilable(Models::Operations::GetV1CompaniesCompanyIdPayrollsHeaderXGustoAPIVersion)).void }
        def initialize(company_id:, processing_statuses: nil, payroll_types: nil, processed: nil, include_off_cycle: nil, include: nil, start_date: nil, end_date: nil, date_filter_by: nil, page: nil, per: nil, sort_order: nil, x_gusto_api_version: Models::Operations::GetV1CompaniesCompanyIdPayrollsHeaderXGustoAPIVersion::TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15)
