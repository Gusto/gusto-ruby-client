  ...
  module Models
    module Operations
      ...
      class GetInformationRequestsRequest
        ...
        def initialize(company_uuid:, sort_by: nil, x_gusto_api_version: Models::Operations::GetInformationRequestsHeaderXGustoAPIVersion::TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15)
