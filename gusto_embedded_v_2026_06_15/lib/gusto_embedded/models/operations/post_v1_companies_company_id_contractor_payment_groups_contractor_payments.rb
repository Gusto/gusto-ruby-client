...
module GustoEmbedded
  module Models
    module Operations
      ...
      class PostV1CompaniesCompanyIdContractorPaymentGroupsContractorPayments
        extend T::Sig
        ...
        field :payment_method, Crystalline::Nilable.new(Models::Operations::PostV1CompaniesCompanyIdContractorPaymentGroupsPaymentMethod), { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('payment_method'), 'decoder': ::GustoEmbedded::Utils.enum_from_string(Models::Operations::PostV1CompaniesCompanyIdContractorPaymentGroupsPaymentMethod, true) } }

        sig { params(contractor_uuid: T.nilable(::String), wage: T.nilable(::String), hours: T.nilable(::String), bonus: T.nilable(::String), reimbursement: T.nilable(::String), invoice_number: T.nilable(::String), memo: T.nilable(::String), payment_method: T.nilable(Models::Operations::PostV1CompaniesCompanyIdContractorPaymentGroupsPaymentMethod)).void }
        def initialize(contractor_uuid: nil, wage: nil, hours: nil, bonus: nil, reimbursement: nil, invoice_number: nil, memo: nil, payment_method: Models::Operations::PostV1CompaniesCompanyIdContractorPaymentGroupsPaymentMethod::DIRECT_DEPOSIT)
