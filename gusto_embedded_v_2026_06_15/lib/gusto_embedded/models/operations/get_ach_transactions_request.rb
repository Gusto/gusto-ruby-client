  ...
  module Models
    module Operations
      ...
      class GetAchTransactionsRequest
        ...
        def initialize(company_uuid:, contractor_payment_uuid: nil, payroll_uuid: nil, transaction_type: nil, payment_direction: nil, page: nil, per: nil, x_gusto_api_version: Models::Operations::XGustoAPIVersion::TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15)
