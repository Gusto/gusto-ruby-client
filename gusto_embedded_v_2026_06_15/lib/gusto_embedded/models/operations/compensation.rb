  ...
  module Models
    module Operations
      ...
      class Compensation
        ...
        field :payment_unit, Models::Operations::PaymentUnit, { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('payment_unit'), required: true, 'decoder': ::GustoEmbedded::Utils.enum_from_string(Models::Operations::PaymentUnit, false) } }
        ...
        field :flsa_status, Models::Operations::FlsaStatus, { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('flsa_status'), required: true, 'decoder': ::GustoEmbedded::Utils.enum_from_string(Models::Operations::FlsaStatus, false) } }

        sig { params(rate: ::String, payment_unit: Models::Operations::PaymentUnit, flsa_status: Models::Operations::FlsaStatus).void }
