  ...
  module Models
    module Operations
      ...
      class GetV1EmployeesEmployeeIdEmployeeBenefitsRequest
        ...
        def initialize(employee_id:, page: nil, per: nil, include: nil, x_gusto_api_version: Models::Operations::GetV1EmployeesEmployeeIdEmployeeBenefitsHeaderXGustoAPIVersion::TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15)
