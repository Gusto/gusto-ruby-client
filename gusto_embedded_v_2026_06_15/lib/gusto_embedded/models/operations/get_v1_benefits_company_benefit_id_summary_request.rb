  ...
  module Models
    module Operations
      ...
      class GetV1BenefitsCompanyBenefitIdSummaryRequest
        ...
        def initialize(company_benefit_id:, start_date: nil, end_date: nil, detailed: nil, x_gusto_api_version: Models::Operations::GetV1BenefitsCompanyBenefitIdSummaryHeaderXGustoAPIVersion::TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15)
