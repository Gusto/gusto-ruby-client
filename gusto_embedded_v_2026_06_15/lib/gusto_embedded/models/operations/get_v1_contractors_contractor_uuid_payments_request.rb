  ...
  module Models
    module Operations
      ...
      class GetV1ContractorsContractorUuidPaymentsRequest
        ...
        def initialize(contractor_uuid:, sort_by: nil, page: nil, per: nil, x_gusto_api_version: Models::Operations::GetV1ContractorsContractorUuidPaymentsHeaderXGustoAPIVersion::TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15)
