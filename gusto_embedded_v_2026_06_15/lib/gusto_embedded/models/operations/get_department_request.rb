  ...
  module Models
    module Operations
      ...
      class GetDepartmentRequest
        ...
        def initialize(department_uuid:, x_gusto_api_version: Models::Operations::GetDepartmentHeaderXGustoAPIVersion::TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15)
