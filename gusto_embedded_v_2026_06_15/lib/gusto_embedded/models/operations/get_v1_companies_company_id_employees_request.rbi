...
class GustoEmbedded::Models::Operations::GetV1CompaniesCompanyIdEmployeesRequest
  ...
  def location_uuid(); end
  def location_uuid=(str_); end
  def payroll_uuid(); end
  def payroll_uuid=(str_); end
  def search_term(); end
  def search_term=(str_); end
  def sort_by(); end
  ...
  def onboarded_active(); end
  def onboarded_active=(str_); end
  def terminated(); end
  def terminated=(str_); end
  def terminated_today(); end
  def terminated_today=(str_); end
  def uuids(); end
  def uuids=(str_); end
  def page(); end
  def page=(str_); end
