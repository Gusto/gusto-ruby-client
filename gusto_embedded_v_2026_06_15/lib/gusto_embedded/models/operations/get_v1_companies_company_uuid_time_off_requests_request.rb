  ...
  module Models
    module Operations
      ...
      class GetV1CompaniesCompanyUuidTimeOffRequestsRequest
        ...
        def initialize(company_uuid:, employee_uuids: nil, status: nil, start_date: nil, end_date: nil, sort_order: nil, page: nil, per: nil, x_gusto_api_version: Models::Operations::GetV1CompaniesCompanyUuidTimeOffRequestsHeaderXGustoAPIVersion::TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15)
