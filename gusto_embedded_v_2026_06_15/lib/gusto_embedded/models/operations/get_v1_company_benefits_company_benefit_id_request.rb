  ...
  module Models
    module Operations
      ...
      class GetV1CompanyBenefitsCompanyBenefitIdRequest
        ...
        sig { params(company_benefit_id: ::String, with_employee_benefits: T.nilable(T::Boolean), include: T.nilable(Models::Operations::Include), x_gusto_api_version: T.nilable(Models::Operations::GetV1CompanyBenefitsCompanyBenefitIdHeaderXGustoAPIVersion)).void }
        def initialize(company_benefit_id:, with_employee_benefits: nil, include: nil, x_gusto_api_version: Models::Operations::GetV1CompanyBenefitsCompanyBenefitIdHeaderXGustoAPIVersion::TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15)
