  ...
  module Models
    module Operations
      ...
      class GetV1CompaniesCompanyIdEmployeesRequest
        ...
        def initialize(company_id:, location_uuid: nil, payroll_uuid: nil, search_term: nil, sort_by: nil, include: nil, onboarded: nil, onboarded_active: nil, terminated: nil, terminated_today: nil, uuids: nil, page: nil, per: nil, x_gusto_api_version: Models::Operations::GetV1CompaniesCompanyIdEmployeesHeaderXGustoAPIVersion::TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15)
