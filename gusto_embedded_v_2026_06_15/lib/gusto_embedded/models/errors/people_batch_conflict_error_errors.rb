...
module GustoEmbedded
  module Models
    module Errors
      ...
      class PeopleBatchConflictErrorErrors
        extend T::Sig
        ...
        field :metadata, Crystalline::Nilable.new(Models::Errors::PeopleBatchConflictErrorMetadata), { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('metadata') } }

        sig { params(error_key: T.nilable(::String), category: T.nilable(::String), message: T.nilable(::String), metadata: T.nilable(Models::Errors::PeopleBatchConflictErrorMetadata)).void }
