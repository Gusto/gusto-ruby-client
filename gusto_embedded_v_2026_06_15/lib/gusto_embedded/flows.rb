...
module GustoEmbedded
  ...
  class Flows
    ...
    sig { params(create_flow_request: Models::Shared::CreateFlowRequest, company_uuid: ::String, x_gusto_api_version: T.nilable(Models::Operations::PostV1CompanyFlowsHeaderXGustoAPIVersion), timeout_ms: T.nilable(Integer), http_headers: T.nilable(T::Hash[T.any(String, Symbol), String])).returns(Models::Operations::PostV1CompanyFlowsResponse) }
    def create(create_flow_request:, company_uuid:, x_gusto_api_version: nil, timeout_ms: nil, http_headers: nil)
      ...
      req_content_type, data, form = Utils.serialize_request_body(request, false, false, :create_flow_request, :json)
