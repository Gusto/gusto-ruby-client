...
module GustoEmbedded
  ...
  class PaymentConfigs
    ...
    sig { params(company_uuid: ::String, x_gusto_api_version: T.nilable(Models::Operations::GetV1CompanyPaymentConfigsHeaderXGustoAPIVersion), timeout_ms: T.nilable(Integer), http_headers: T.nilable(T::Hash[T.any(String, Symbol), String])).returns(Models::Operations::GetV1CompanyPaymentConfigsResponse) }
    def get(company_uuid:, x_gusto_api_version: nil, timeout_ms: nil, http_headers: nil)
      ...
      request = Models::Operations::GetV1CompanyPaymentConfigsRequest.new(
      ...
      url = Utils.generate_url(
        Models::Operations::GetV1CompanyPaymentConfigsRequest,
        base_url,
      ...
      if Utils.match_status_code(http_response.status, ['200'])
        if Utils.match_content_type(content_type, 'application/json')
          ...
          obj = Crystalline.unmarshal_json(JSON.parse(response_data), Models::Shared::PaymentConfigs)
          response = Models::Operations::GetV1CompanyPaymentConfigsResponse.new(
            status_code: http_response.status,
            content_type: content_type,
            raw_response: http_response,
            payment_configs: T.unsafe(obj)
          )
    ...
    sig { params(payment_configs_update_request: Models::Shared::PaymentConfigsUpdateRequest, company_uuid: ::String, x_gusto_api_version: T.nilable(Models::Operations::PutV1CompanyPaymentConfigsHeaderXGustoAPIVersion), timeout_ms: T.nilable(Integer), http_headers: T.nilable(T::Hash[T.any(String, Symbol), String])).returns(Models::Operations::PutV1CompanyPaymentConfigsResponse) }
    def update(payment_configs_update_request:, company_uuid:, x_gusto_api_version: nil, timeout_ms: nil, http_headers: nil)
      ...
      #
      # If set, this operation will use `company_access_auth` from the global security.
      request = Models::Operations::PutV1CompanyPaymentConfigsRequest.new(
        company_uuid: company_uuid,
        payment_configs_update_request: payment_configs_update_request,
        x_gusto_api_version: x_gusto_api_version
      )
      url, params = @sdk_configuration.get_server_details
      base_url = Utils.template_url(url, params)
      url = Utils.generate_url(
        Models::Operations::PutV1CompanyPaymentConfigsRequest,
        base_url,
        '/v1/companies/{company_uuid}/payment_configs',
        request
      )
      headers = Utils.get_headers(request)
      headers = T.cast(headers, T::Hash[String, String])
      req_content_type, data, form = Utils.serialize_request_body(request, false, false, :payment_configs_update_request, :json)
      ...
      if Utils.match_status_code(http_response.status, ['200'])
        if Utils.match_content_type(content_type, 'application/json')
          ...
          response_data = http_response.env.response_body
          obj = Crystalline.unmarshal_json(JSON.parse(response_data), Models::Shared::PaymentConfigs)
          response = Models::Operations::PutV1CompanyPaymentConfigsResponse.new(
            status_code: http_response.status,
            content_type: content_type,
            raw_response: http_response,
            payment_configs: T.unsafe(obj)
