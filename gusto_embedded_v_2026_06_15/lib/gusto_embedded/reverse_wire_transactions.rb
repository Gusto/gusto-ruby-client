...
module GustoEmbedded
  ...
  class ReverseWireTransactions
    ...
    sig { params(request: Models::Operations::GetReverseWireTransactionsRequest, timeout_ms: T.nilable(Integer), http_headers: T.nilable(T::Hash[T.any(String, Symbol), String])).returns(Models::Operations::GetReverseWireTransactionsResponse) }
    def get_reverse_wire_transactions(request:, timeout_ms: nil, http_headers: nil)
      # get_reverse_wire_transactions - Get all reverse wire transactions for a company
      ...
      url = Utils.generate_url(
        Models::Operations::GetReverseWireTransactionsRequest,
        base_url,
      ...
      query_params = Utils.get_query_params(Models::Operations::GetReverseWireTransactionsRequest, request, nil)
      ...
      hook_ctx = SDKHooks::HookContext.new(
        ...
        base_url: base_url,
        oauth2_scopes: nil,
        operation_id: 'get-reverse-wire-transactions',
      ...
      if Utils.match_status_code(http_response.status, ['200'])
        if Utils.match_content_type(content_type, 'application/json')
          ...
          obj = Crystalline.unmarshal_json(JSON.parse(response_data), Crystalline::Array.new(Models::Shared::ReverseWireTransaction))
          response = Models::Operations::GetReverseWireTransactionsResponse.new(
            status_code: http_response.status,
            content_type: content_type,
            raw_response: http_response,
            reverse_wire_transaction_list: T.unsafe(obj)
          )
