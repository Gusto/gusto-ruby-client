...
res = s.company_attachments.get_list(company_id: '<id>', x_gusto_api_version: Models::Operations::GetV1CompaniesAttachmentsHeaderXGustoAPIVersion::TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15)
...
), x_gusto_api_version: Models::Operations::PostV1CompaniesAttachmentHeaderXGustoAPIVersion::TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15)
...
res = s.company_attachments.get_details(company_id: '<id>', company_attachment_uuid: '<id>', x_gusto_api_version: Models::Operations::GetV1CompaniesAttachmentHeaderXGustoAPIVersion::TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15)
