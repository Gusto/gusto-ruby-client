...
res = s.wire_in_requests.get(wire_in_request_uuid: '<id>', x_gusto_api_version: Models::Operations::GetWireInRequestsWireInRequestUuidHeaderXGustoAPIVersion::TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15)
...
), x_gusto_api_version: Models::Operations::PutWireInRequestsWireInRequestUuidHeaderXGustoAPIVersion::TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15)
...
res = s.wire_in_requests.list(company_uuid: '<id>', x_gusto_api_version: Models::Operations::GetCompaniesCompanyUuidWireInRequestUuidHeaderXGustoAPIVersion::TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15)
