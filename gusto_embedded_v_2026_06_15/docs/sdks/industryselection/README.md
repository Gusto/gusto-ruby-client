...
res = s.industry_selection.get(company_id: '<id>', x_gusto_api_version: Models::Operations::GetV1CompanyIndustryHeaderXGustoAPIVersion::TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15)
...
), x_gusto_api_version: Models::Operations::PutV1CompanyIndustryHeaderXGustoAPIVersion::TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15)
