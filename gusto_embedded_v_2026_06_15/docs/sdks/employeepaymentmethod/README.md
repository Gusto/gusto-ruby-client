...
), x_gusto_api_version: Models::Operations::PostV1EmployeesEmployeeIdBankAccountsHeaderXGustoAPIVersion::TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15)
...
res = s.employee_payment_method.update_bank_account(employee_id: '<id>', bank_account_uuid: '<id>', employee_bank_account_request: Models::Shared::EmployeeBankAccountRequest.new(
  ...
  account_type: Models::Shared::EmployeeBankAccountRequestAccountType::CHECKING,
  name: 'BoA Checking Account'
), x_gusto_api_version: Models::Operations::PutV1EmployeesEmployeeIdBankAccountsHeaderXGustoAPIVersion::TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15)
...
res = s.employee_payment_method.delete_bank_account(employee_id: '<id>', bank_account_uuid: '<id>', x_gusto_api_version: Models::Operations::DeleteV1EmployeesEmployeeIdBankAccountsBankAccountIdHeaderXGustoAPIVersion::TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15)
...
res = s.employee_payment_method.get(employee_id: '<id>', x_gusto_api_version: Models::Operations::GetV1EmployeesEmployeeIdPaymentMethodHeaderXGustoAPIVersion::TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15)
...
), x_gusto_api_version: Models::Operations::PutV1EmployeesEmployeeIdPaymentMethodHeaderXGustoAPIVersion::TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15)
