...
res = s.employee_tax_setup.get_federal_taxes(employee_uuid: '<id>', x_gusto_api_version: Models::Operations::GetV1EmployeesEmployeeIdFederalTaxesHeaderXGustoAPIVersion::TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15)
...
), x_gusto_api_version: Models::Operations::PutV1EmployeesEmployeeIdFederalTaxesHeaderXGustoAPIVersion::TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15)
...
res = s.employee_tax_setup.get_state_taxes(employee_uuid: '<id>', x_gusto_api_version: Models::Operations::GetV1EmployeesEmployeeIdStateTaxesHeaderXGustoAPIVersion::TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15)
...
res = s.employee_tax_setup.update_state_taxes(employee_uuid: '<id>', employee_state_taxes_request: Models::Shared::EmployeeStateTaxesRequest.new(
  states: []
), x_gusto_api_version: Models::Operations::PutV1EmployeesEmployeeIdStateTaxesHeaderXGustoAPIVersion::TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15)
