...
module OpenApiSDK
  module Shared
    ...
    class Termination < ::OpenApiSDK::Utils::FieldAugmented
      extend T::Sig
      ...
      field :cancelable, T.nilable(T::Boolean), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('cancelable') } }
      ...
      field :employee_uuid, T.nilable(::Integer), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('employee_uuid') } }
      ...
      sig { params(uuid: ::String, active: T.nilable(T::Boolean), cancelable: T.nilable(T::Boolean), effective_date: T.nilable(::String), employee_uuid: T.nilable(::Integer), run_termination_payroll: T.nilable(T::Boolean), version: T.nilable(::String)).void }
