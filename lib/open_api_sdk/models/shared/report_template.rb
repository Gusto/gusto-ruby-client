...
module OpenApiSDK
  module Shared
    ...
    # Example response
    class ReportTemplate < ::OpenApiSDK::Utils::FieldAugmented
      extend T::Sig

      # List of columns recommended
      field :columns, T.nilable(T::Array[::String]), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('columns') } }
      # Company UUID
      ...
      field :groupings, T.nilable(T::Array[::String]), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('groupings') } }
      # Type of report template
      field :report_type, T.nilable(::String), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('report_type') } }
