...
module OpenApiSDK
  module Shared
    ...
    class PayrollTotalsType < ::OpenApiSDK::Utils::FieldAugmented
      extend T::Sig

      # The total additional earnings amount for the payroll.
      field :additional_earnings, T.nilable(::String), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('additional_earnings') } }
      # The total amount of company contributed benefits for the payroll.
      field :benefits, T.nilable(::String), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('benefits') } }
      # The total check amount for the payroll.
      field :check_amount, T.nilable(::String), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('check_amount') } }
      # The total child support debit for the payroll.
      field :child_support_debit, T.nilable(::String), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('child_support_debit') } }
      ...
      field :deferred_payroll_taxes, T.nilable(::String), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('deferred_payroll_taxes') } }
      # The total amount of employee deducted benefits for the payroll.
      field :employee_benefits_deductions, T.nilable(::String), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('employee_benefits_deductions') } }
      # The total employee bonuses amount for the payroll.
      field :employee_bonuses, T.nilable(::String), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('employee_bonuses') } }
      # The total employee cash tips amount for the payroll.
      field :employee_cash_tips, T.nilable(::String), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('employee_cash_tips') } }
      # The total employee commissions amount for the payroll.
      field :employee_commissions, T.nilable(::String), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('employee_commissions') } }
      # The total employee paycheck tips amount for the payroll.
      field :employee_paycheck_tips, T.nilable(::String), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('employee_paycheck_tips') } }
      # The total amount of employee paid taxes for the payroll.
      field :employee_taxes, T.nilable(::String), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('employee_taxes') } }
      # The total amount of employer paid taxes for the payroll.
      field :employer_taxes, T.nilable(::String), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('employer_taxes') } }
      ...
      field :net_pay_debit, T.nilable(::String), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('net_pay_debit') } }
      # The total amount of deductions for the payroll.
      field :other_deductions, T.nilable(::String), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('other_deductions') } }
      # The total owner's draw for the payroll.
      field :owners_draw, T.nilable(::String), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('owners_draw') } }
      # The total reimbursement debit for the payroll.
      field :reimbursement_debit, T.nilable(::String), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('reimbursement_debit') } }
      # The total reimbursements for the payroll.
      field :reimbursements, T.nilable(::String), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('reimbursements') } }
      # The total tax debit for the payroll.
      field :tax_debit, T.nilable(::String), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('tax_debit') } }
