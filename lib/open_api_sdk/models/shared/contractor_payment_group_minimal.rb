...
module OpenApiSDK
  module Shared
    ...
    class ContractorPaymentGroupMinimal < ::OpenApiSDK::Utils::FieldAugmented
      extend T::Sig
      ...
      field :status, T.nilable(::OpenApiSDK::Shared::ContractorPaymentGroupMinimalStatus), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('status'), 'decoder': Utils.enum_from_string(::OpenApiSDK::Shared::ContractorPaymentGroupMinimalStatus, true) } }

      field :totals, T.nilable(::OpenApiSDK::Shared::ContractorPaymentGroupMinimalTotals), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('totals') } }
      ...
      sig { params(check_date: T.nilable(::String), company_uuid: T.nilable(::String), creation_token: T.nilable(::String), debit_date: T.nilable(::String), status: T.nilable(::OpenApiSDK::Shared::ContractorPaymentGroupMinimalStatus), totals: T.nilable(::OpenApiSDK::Shared::ContractorPaymentGroupMinimalTotals), uuid: T.nilable(::String)).void }
