...
module OpenApiSDK
  module Shared
    ...
    # Example response
    class PayrollReceipt < ::OpenApiSDK::Utils::FieldAugmented
      extend T::Sig
      ...
      field :employee_compensations, T.nilable(T::Array[::OpenApiSDK::Shared::EmployeeCompensations]), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('employee_compensations') } }
      ...
      field :licensee, T.nilable(::OpenApiSDK::Shared::Licensee), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('licensee') } }
      ...
      field :recipient_notice, T.nilable(::String), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('recipient_notice') } }
      ...
      field :taxes, T.nilable(T::Array[::OpenApiSDK::Shared::PayrollReceiptTaxes]), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('taxes') } }
      # The subtotals for the payroll.
      field :totals, T.nilable(::OpenApiSDK::Shared::Totals), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('totals') } }


      sig { params(company_uuid: T.nilable(::String), debit_date: T.nilable(::String), employee_compensations: T.nilable(T::Array[::OpenApiSDK::Shared::EmployeeCompensations]), liability_of_licensee: T.nilable(::String), license: T.nilable(::String), license_uri: T.nilable(::String), licensee: T.nilable(::OpenApiSDK::Shared::Licensee), name_of_recipient: T.nilable(::String), name_of_sender: T.nilable(::String), payroll_uuid: T.nilable(::String), recipient_notice: T.nilable(::String), right_to_refund: T.nilable(::String), taxes: T.nilable(T::Array[::OpenApiSDK::Shared::PayrollReceiptTaxes]), totals: T.nilable(::OpenApiSDK::Shared::Totals)).void }
