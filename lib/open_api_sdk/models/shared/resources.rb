...
module OpenApiSDK
  module Shared
    ...
    class Resources < ::OpenApiSDK::Utils::FieldAugmented
      extend T::Sig
      ...
      field :entity_type, ::String, { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('entity_type') } }
      # Unique identifier of the entity
      field :entity_uuid, ::String, { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('entity_uuid') } }
      ...
      field :reference_type, T.nilable(::String), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('reference_type') } }
      # Optional. Unique identifier of the reference.
      field :reference_uuid, T.nilable(::String), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('reference_uuid') } }
