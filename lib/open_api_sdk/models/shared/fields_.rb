...
module OpenApiSDK
  module Shared
    ...
    class Fields < ::OpenApiSDK::Utils::FieldAugmented
      ...
      field :data_type, T.nilable(::String), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('data_type') } }
      # Height of the field
      ...
      field :page_number, T.nilable(::Integer), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('page_number') } }
      ...
      field :x, T.nilable(::Integer), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('x') } }
      # Y-coordinate location of the field on the page
      field :y, T.nilable(::Integer), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('y') } }
