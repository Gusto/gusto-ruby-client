...
module OpenApiSDK
  module Shared
    ...
    class TaxRequirement < ::OpenApiSDK::Utils::FieldAugmented
      extend T::Sig
      ...
      field :applicable_if, T.nilable(T::Array[::OpenApiSDK::Shared::ApplicableIf]), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('applicable_if') } }
      ...
      field :metadata, T.nilable(::OpenApiSDK::Shared::TaxRequirementMetadata), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('metadata') } }
      # The "answer"
      field :value, T.nilable(::String), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('value') } }


      sig { params(applicable_if: T.nilable(T::Array[::OpenApiSDK::Shared::ApplicableIf]), description: T.nilable(::String), key: T.nilable(::String), label: T.nilable(::String), metadata: T.nilable(::OpenApiSDK::Shared::TaxRequirementMetadata), value: T.nilable(::String)).void }
