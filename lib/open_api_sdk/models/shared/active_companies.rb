...
module OpenApiSDK
  module Shared
    ...
    class ActiveCompanies < ::OpenApiSDK::Utils::FieldAugmented
      extend T::Sig
      ...
      field :active_contractors, T.nilable(::Integer), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('active_contractors') } }
      ...
      field :active_employees, T.nilable(::Integer), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('active_employees') } }
      ...
      field :initial_invoice_period, T.nilable(::String), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('initial_invoice_period') } }
