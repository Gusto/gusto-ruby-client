...
module OpenApiSDK
  module Operations
    ...
    class PostV1PayrollsPayrollIdCalculateAccruingTimeOffHoursRequestBody < ::OpenApiSDK::Utils::FieldAugmented
      extend T::Sig

      # double overtime hours worked in this pay period
      field :double_overtime_hours_worked, T.nilable(::Float), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('double_overtime_hours_worked') } }
      # overtime hours worked in this pay period
      field :overtime_hours_worked, T.nilable(::Float), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('overtime_hours_worked') } }
      # paid time off hours used in this pay period
      field :pto_hours_used, T.nilable(::Float), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('pto_hours_used') } }
      # regular hours worked in this pay period
      field :regular_hours_worked, T.nilable(::Float), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('regular_hours_worked') } }
      # sick hours used in this pay period
      field :sick_hours_used, T.nilable(::Float), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('sick_hours_used') } }
