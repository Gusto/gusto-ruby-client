...
module OpenApiSDK
  module Operations
    ...
    class PostV1CompensationsCompensationIdRequest < ::OpenApiSDK::Utils::FieldAugmented
      ...
      field :request_body, T.nilable(::OpenApiSDK::Operations::PostV1CompensationsCompensationIdRequestBody), { 'request': { 'media_type': 'application/json' } }
      ...
      sig { params(job_id: ::String, request_body: T.nilable(::OpenApiSDK::Operations::PostV1CompensationsCompensationIdRequestBody), x_gusto_api_version: T.nilable(::OpenApiSDK::Shared::VersionHeader)).void }
