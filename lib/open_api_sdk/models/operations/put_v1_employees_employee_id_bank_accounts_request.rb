...
module OpenApiSDK
  module Operations
    ...
    class PutV1EmployeesEmployeeIdBankAccountsRequest < ::OpenApiSDK::Utils::FieldAugmented
      extend T::Sig
      ...
      field :request_body, T.nilable(::OpenApiSDK::Operations::PutV1EmployeesEmployeeIdBankAccountsRequestBody), { 'request': { 'media_type': 'application/json' } }
      ...
      sig { params(bank_account_uuid: ::String, employee_id: ::String, request_body: T.nilable(::OpenApiSDK::Operations::PutV1EmployeesEmployeeIdBankAccountsRequestBody), x_gusto_api_version: T.nilable(::OpenApiSDK::Shared::VersionHeader)).void }
