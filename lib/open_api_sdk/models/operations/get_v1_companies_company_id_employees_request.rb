...
module OpenApiSDK
  module Operations
    ...
    class GetV1CompaniesCompanyIdEmployeesRequest < ::OpenApiSDK::Utils::FieldAugmented
      extend T::Sig
      ...
      field :include, T.nilable(T::Array[::OpenApiSDK::Operations::Include]), { 'query_param': { 'field_name': 'include', 'style': 'form', 'explode': false } }
      ...
      sig { params(company_id: ::String, include: T.nilable(T::Array[::OpenApiSDK::Operations::Include]), page: T.nilable(::Float), per: T.nilable(::Float), search_term: T.nilable(::String), terminated: T.nilable(T::Boolean), x_gusto_api_version: T.nilable(::OpenApiSDK::Shared::VersionHeader)).void }
