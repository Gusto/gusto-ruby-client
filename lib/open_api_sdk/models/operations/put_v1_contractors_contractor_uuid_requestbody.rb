...
module OpenApiSDK
  module Operations
    ...
    class PutV1ContractorsContractorUuidRequestBody < ::OpenApiSDK::Utils::FieldAugmented
      extend T::Sig
      ...
      # The contractor type.
      field :type, T.nilable(::OpenApiSDK::Operations::PutV1ContractorsContractorUuidType), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('type'), 'decoder': Utils.enum_from_string(::OpenApiSDK::Operations::PutV1ContractorsContractorUuidType, true) } }
      # The contractor’s wage type.
      # 
      field :wage_type, T.nilable(::OpenApiSDK::Operations::PutV1ContractorsContractorUuidWageType), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('wage_type'), 'decoder': Utils.enum_from_string(::OpenApiSDK::Operations::PutV1ContractorsContractorUuidWageType, true) } }
      ...
      sig { params(version: ::String, business_name: T.nilable(::String), ein: T.nilable(::String), email: T.nilable(::String), file_new_hire_report: T.nilable(T::Boolean), first_name: T.nilable(::String), hourly_rate: T.nilable(::String), is_active: T.nilable(T::Boolean), last_name: T.nilable(::String), middle_initial: T.nilable(::String), self_onboarding: T.nilable(T::Boolean), ssn: T.nilable(::String), start_date: T.nilable(::String), type: T.nilable(::OpenApiSDK::Operations::PutV1ContractorsContractorUuidType), wage_type: T.nilable(::OpenApiSDK::Operations::PutV1ContractorsContractorUuidWageType), work_state: T.nilable(::String)).void }
