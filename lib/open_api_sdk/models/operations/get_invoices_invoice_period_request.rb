...
module OpenApiSDK
  module Operations
    ...
    class GetInvoicesInvoicePeriodRequest < ::OpenApiSDK::Utils::FieldAugmented
      extend T::Sig
      ...
      sig { params(invoice_period: ::String, company_uuids: T.nilable(::String), page: T.nilable(::Float), per: T.nilable(::Float), x_gusto_api_version: T.nilable(::OpenApiSDK::Shared::VersionHeader)).void }
