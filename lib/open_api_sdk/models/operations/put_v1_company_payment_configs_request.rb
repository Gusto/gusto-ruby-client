...
module OpenApiSDK
  module Operations
    ...
    class PutV1CompanyPaymentConfigsRequest < ::OpenApiSDK::Utils::FieldAugmented
      extend T::Sig
      ...
      sig { params(company_uuid: ::String, request_body: T.nilable(::Object), x_gusto_api_version: T.nilable(::OpenApiSDK::Shared::VersionHeader)).void }
