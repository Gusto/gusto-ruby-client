...
module OpenApiSDK
  module Operations
    ...
    class PayPeriods < ::OpenApiSDK::Utils::FieldAugmented
      extend T::Sig
      ...
      field :run_payroll_by, T.nilable(::String), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('run_payroll_by') } }
