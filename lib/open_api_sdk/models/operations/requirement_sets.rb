...
module OpenApiSDK
  module Operations
    ...
    class RequirementSets < ::OpenApiSDK::Utils::FieldAugmented
      extend T::Sig
      ...
      field :requirements, T.nilable(T::Array[::OpenApiSDK::Operations::Requirements]), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('requirements') } }
      ...
      sig { params(effective_from: T.nilable(::String), key: T.nilable(::String), requirements: T.nilable(T::Array[::OpenApiSDK::Operations::Requirements]), state: T.nilable(::String)).void }
