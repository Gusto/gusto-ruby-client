...
module OpenApiSDK
  module Operations
    ...
    class GetV1CompaniesCompanyIdContractorPaymentGroupsRequest < ::OpenApiSDK::Utils::FieldAugmented
      extend T::Sig
      ...
      sig { params(company_id: ::String, end_date: T.nilable(::String), page: T.nilable(::Float), per: T.nilable(::Float), start_date: T.nilable(::String), x_gusto_api_version: T.nilable(::OpenApiSDK::Shared::VersionHeader)).void }
