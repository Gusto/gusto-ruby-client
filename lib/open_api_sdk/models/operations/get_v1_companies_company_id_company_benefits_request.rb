...
module OpenApiSDK
  module Operations
    ...
    class GetV1CompaniesCompanyIdCompanyBenefitsRequest < ::OpenApiSDK::Utils::FieldAugmented
      extend T::Sig
      ...
      sig { params(company_id: ::String, enrollment_count: T.nilable(T::Boolean), x_gusto_api_version: T.nilable(::OpenApiSDK::Shared::VersionHeader)).void }
      def initialize(company_id: nil, enrollment_count: nil, x_gusto_api_version: nil)
