...
module OpenApiSDK
  module Operations
    ...
    class PutV1EmployeesEmployeeIdI9AuthorizationRequestBody < ::OpenApiSDK::Utils::FieldAugmented
      extend T::Sig
      ...
      # 
      field :authorization_status, ::OpenApiSDK::Operations::AuthorizationStatus, { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('authorization_status'), 'decoder': Utils.enum_from_string(::OpenApiSDK::Operations::AuthorizationStatus, false) } }
      ...
      # 
      field :document_type, T.nilable(::OpenApiSDK::Operations::DocumentType), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('document_type'), 'decoder': Utils.enum_from_string(::OpenApiSDK::Operations::DocumentType, true) } }
      ...
      sig { params(authorization_status: ::OpenApiSDK::Operations::AuthorizationStatus, country: T.nilable(::String), document_number: T.nilable(::String), document_type: T.nilable(::OpenApiSDK::Operations::DocumentType), expiration_date: T.nilable(::String), version: T.nilable(::String)).void }
