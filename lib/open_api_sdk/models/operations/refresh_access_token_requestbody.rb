...
module OpenApiSDK
  module Operations
    ...
    class RefreshAccessTokenRequestBody < ::OpenApiSDK::Utils::FieldAugmented
      extend T::Sig
      ...
      field :grant_type, ::String, { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('grant_type') } }
      ...
      field :redirect_uri, T.nilable(::String), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('redirect_uri') } }
