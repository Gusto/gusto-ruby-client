...
module OpenApiSDK
  ...
  class FederalTaxDetails
    ...
    sig { params(company_id: ::String, x_gusto_api_version: T.nilable(::OpenApiSDK::Shared::VersionHeader)).returns(::OpenApiSDK::Operations::GetV1CompaniesCompanyIdFederalTaxDetailsResponse) }
    def get(company_id, x_gusto_api_version = nil)
      # get - Get Federal Tax Details
      # Fetches attributes relevant for a company's federal taxes.
      # 
      # scope: `company_federal_taxes:read`
      request = ::OpenApiSDK::Operations::GetV1CompaniesCompanyIdFederalTaxDetailsRequest.new(
      ...
      url = Utils.generate_url(
        ::OpenApiSDK::Operations::GetV1CompaniesCompanyIdFederalTaxDetailsRequest,
        base_url,
      ...
      res = ::OpenApiSDK::Operations::GetV1CompaniesCompanyIdFederalTaxDetailsResponse.new(
        status_code: r.status, content_type: content_type, raw_response: r
      )
      if r.status == 200
        if Utils.match_content_type(content_type, 'application/json')
          out = Utils.unmarshal_complex(r.env.response_body, ::OpenApiSDK::Shared::FederalTaxDetails)
    ...
    def update(company_id, x_gusto_api_version = nil, request_body = nil)
      ...
      base_url = Utils.template_url(url, params)
      url = Utils.generate_url(
        ::OpenApiSDK::Operations::PutV1CompaniesCompanyIdFederalTaxDetailsRequest,
        base_url,
        '/v1/companies/{company_id}/federal_tax_details',
        request
      )
      ...
      res = ::OpenApiSDK::Operations::PutV1CompaniesCompanyIdFederalTaxDetailsResponse.new(
        status_code: r.status, content_type: content_type, raw_response: r
      )
      if r.status == 200
        if Utils.match_content_type(content_type, 'application/json')
