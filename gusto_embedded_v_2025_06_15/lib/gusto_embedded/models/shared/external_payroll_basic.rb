...
module GustoEmbedded
  module Shared
    ...
    class ExternalPayrollBasic < ::Crystalline::FieldAugmented
      extend T::Sig
      ...
      field :status, T.nilable(::GustoEmbedded::Shared::ExternalPayrollBasicStatus), { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('status'), 'decoder': Utils.enum_from_string(::GustoEmbedded::Shared::ExternalPayrollBasicStatus, true) } }


      sig { params(uuid: ::String, check_date: T.nilable(::String), company_uuid: T.nilable(::String), payment_period_end_date: T.nilable(::String), payment_period_start_date: T.nilable(::String), status: T.nilable(::GustoEmbedded::Shared::ExternalPayrollBasicStatus)).void }
