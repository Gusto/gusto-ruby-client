...
module GustoEmbedded
  module Shared
    ...
    class EmployeeBenefitForCompanyBenefit < ::Crystalline::FieldAugmented
      extend T::Sig
      ...
      field :contribution, T.nilable(::GustoEmbedded::Shared::EmployeeBenefitForCompanyBenefitContribution), { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('contribution') } }
      ...
      field :deduction_reduces_taxable_income, T.nilable(::GustoEmbedded::Shared::EmployeeBenefitForCompanyBenefitDeductionReducesTaxableIncome), { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('deduction_reduces_taxable_income'), 'decoder': Utils.enum_from_string(::GustoEmbedded::Shared::EmployeeBenefitForCompanyBenefitDeductionReducesTaxableIncome, true) } }
      ...
      sig { params(employee_uuid: ::String, active: T.nilable(T::Boolean), catch_up: T.nilable(T::Boolean), company_contribution: T.nilable(::String), company_contribution_annual_maximum: T.nilable(::String), contribute_as_percentage: T.nilable(T::Boolean), contribution: T.nilable(::GustoEmbedded::Shared::EmployeeBenefitForCompanyBenefitContribution), coverage_amount: T.nilable(::String), coverage_salary_multiplier: T.nilable(::String), deduct_as_percentage: T.nilable(T::Boolean), deduction_reduces_taxable_income: T.nilable(::GustoEmbedded::Shared::EmployeeBenefitForCompanyBenefitDeductionReducesTaxableIncome), elective: T.nilable(T::Boolean), employee_deduction: T.nilable(::String), employee_deduction_annual_maximum: T.nilable(::String), limit_option: T.nilable(::String), retirement_loan_identifier: T.nilable(::String), version: T.nilable(::String)).void }
