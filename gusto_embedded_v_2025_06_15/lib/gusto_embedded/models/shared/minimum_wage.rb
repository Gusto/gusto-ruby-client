...
module GustoEmbedded
  module Shared
    ...
    class MinimumWage < ::Crystalline::FieldAugmented
      extend T::Sig

      # The governing authority that created the minimum wage, e.g. "City", "State", or "Federal".
      field :authority, ::String, { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('authority') } }
      # The date the minimum wage rule is effective on.
      field :effective_date, ::Date, { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('effective_date'), 'decoder': Utils.date_from_iso_format(false) } }
      ...
      field :wage, ::String, { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('wage') } }
      # The type of wage the minimum wage applies to, e.g. "Regular", "Regular-Industry-Specific".
      field :wage_type, ::String, { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('wage_type') } }
      # Description of parties the minimum wage applies to.
      field :notes, T.nilable(::String), { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('notes') } }
