...
module GustoEmbedded
  module Shared
    ...
    class PayScheduleCreateUpdate < ::Crystalline::FieldAugmented
      extend T::Sig
      ...
      field :frequency, T.nilable(::GustoEmbedded::Shared::PayScheduleFrequencyCreateUpdate), { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('frequency'), 'decoder': Utils.enum_from_string(::GustoEmbedded::Shared::PayScheduleFrequencyCreateUpdate, true) } }
