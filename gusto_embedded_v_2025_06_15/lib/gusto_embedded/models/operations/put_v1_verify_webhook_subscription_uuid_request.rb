...
module GustoEmbedded
  module Operations
    ...
    class PutV1VerifyWebhookSubscriptionUuidRequest < ::Crystalline::FieldAugmented
      extend T::Sig


      field :request_body, ::GustoEmbedded::Operations::PutV1VerifyWebhookSubscriptionUuidRequestBody, { 'request': { 'media_type': 'application/json' } }
      ...
      sig { params(request_body: ::GustoEmbedded::Operations::PutV1VerifyWebhookSubscriptionUuidRequestBody, webhook_subscription_uuid: ::String, x_gusto_api_version: T.nilable(::GustoEmbedded::Shared::VersionHeader)).void }
