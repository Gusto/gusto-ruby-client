...
module GustoEmbedded
  module Operations
    ...
    class PutV1CompaniesCompanyUuidSignatoriesSignatoryUuidRequest < ::Crystalline::FieldAugmented
      extend T::Sig

      # The UUID of the company
      field :company_uuid, ::String, { 'path_param': { 'field_name': 'company_uuid', 'style': 'simple', 'explode': false } }

      field :request_body, ::GustoEmbedded::Operations::PutV1CompaniesCompanyUuidSignatoriesSignatoryUuidRequestBody, { 'request': { 'media_type': 'application/json' } }
      ...
      sig { params(company_uuid: ::String, request_body: ::GustoEmbedded::Operations::PutV1CompaniesCompanyUuidSignatoriesSignatoryUuidRequestBody, signatory_uuid: ::String, x_gusto_api_version: T.nilable(::GustoEmbedded::Shared::VersionHeader)).void }
