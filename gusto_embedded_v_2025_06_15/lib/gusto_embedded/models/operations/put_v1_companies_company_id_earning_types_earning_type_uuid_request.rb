...
module GustoEmbedded
  module Operations
    ...
    class PutV1CompaniesCompanyIdEarningTypesEarningTypeUuidRequest < ::Crystalline::FieldAugmented
      extend T::Sig
      ...
      field :request_body, ::GustoEmbedded::Operations::PutV1CompaniesCompanyIdEarningTypesEarningTypeUuidRequestBody, { 'request': { 'media_type': 'application/json' } }
      ...
      sig { params(company_id: ::String, earning_type_uuid: ::String, request_body: ::GustoEmbedded::Operations::PutV1CompaniesCompanyIdEarningTypesEarningTypeUuidRequestBody, x_gusto_api_version: T.nilable(::GustoEmbedded::Shared::VersionHeader)).void }
