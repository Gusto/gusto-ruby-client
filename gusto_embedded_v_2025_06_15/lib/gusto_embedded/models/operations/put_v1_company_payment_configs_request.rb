...
module GustoEmbedded
  module Operations
    ...
    class PutV1CompanyPaymentConfigsRequest < ::Crystalline::FieldAugmented
      extend T::Sig
      ...
      sig { params(company_uuid: ::String, request_body: ::Object, x_gusto_api_version: T.nilable(::GustoEmbedded::Shared::VersionHeader)).void }
