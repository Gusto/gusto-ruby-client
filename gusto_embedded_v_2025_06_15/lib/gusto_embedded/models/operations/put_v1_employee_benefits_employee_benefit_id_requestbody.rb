...
module GustoEmbedded
  module Operations
    ...
    class PutV1EmployeeBenefitsEmployeeBenefitIdRequestBody < ::Crystalline::FieldAugmented
      extend T::Sig
      ...
      field :contribution, T.nilable(::GustoEmbedded::Operations::PutV1EmployeeBenefitsEmployeeBenefitIdContribution), { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('contribution') } }
      ...
      field :deduction_reduces_taxable_income, T.nilable(::GustoEmbedded::Operations::PutV1EmployeeBenefitsEmployeeBenefitIdDeductionReducesTaxableIncome), { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('deduction_reduces_taxable_income'), 'decoder': Utils.enum_from_string(::GustoEmbedded::Operations::PutV1EmployeeBenefitsEmployeeBenefitIdDeductionReducesTaxableIncome, true) } }
      ...
      field :limit_option, T.nilable(::GustoEmbedded::Operations::PutV1EmployeeBenefitsEmployeeBenefitIdLimitOption), { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('limit_option'), 'decoder': Utils.enum_from_string(::GustoEmbedded::Operations::PutV1EmployeeBenefitsEmployeeBenefitIdLimitOption, true) } }


      sig { params(version: ::String, active: T.nilable(T::Boolean), catch_up: T.nilable(T::Boolean), company_contribution: T.nilable(::String), company_contribution_annual_maximum: T.nilable(::String), contribute_as_percentage: T.nilable(T::Boolean), contribution: T.nilable(::GustoEmbedded::Operations::PutV1EmployeeBenefitsEmployeeBenefitIdContribution), coverage_amount: T.nilable(::String), coverage_salary_multiplier: T.nilable(::String), deduct_as_percentage: T.nilable(T::Boolean), deduction_reduces_taxable_income: T.nilable(::GustoEmbedded::Operations::PutV1EmployeeBenefitsEmployeeBenefitIdDeductionReducesTaxableIncome), elective: T.nilable(T::Boolean), employee_deduction: T.nilable(::String), employee_deduction_annual_maximum: T.nilable(::String), limit_option: T.nilable(::GustoEmbedded::Operations::PutV1EmployeeBenefitsEmployeeBenefitIdLimitOption)).void }
