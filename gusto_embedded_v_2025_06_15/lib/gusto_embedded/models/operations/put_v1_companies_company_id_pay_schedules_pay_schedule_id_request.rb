...
module GustoEmbedded
  module Operations
    ...
    class PutV1CompaniesCompanyIdPaySchedulesPayScheduleIdRequest < ::Crystalline::FieldAugmented
      extend T::Sig
      ...
      field :request_body, ::GustoEmbedded::Operations::PutV1CompaniesCompanyIdPaySchedulesPayScheduleIdRequestBody, { 'request': { 'media_type': 'application/json' } }
      ...
      sig { params(company_id: ::String, pay_schedule_id: ::String, request_body: ::GustoEmbedded::Operations::PutV1CompaniesCompanyIdPaySchedulesPayScheduleIdRequestBody, x_gusto_api_version: T.nilable(::GustoEmbedded::Shared::VersionHeader)).void }
