...
module GustoEmbedded
  module Operations
    ...
    class EmployeeCompensations < ::Crystalline::FieldAugmented
      ...
      field :fixed_compensations, T.nilable(T::Array[::GustoEmbedded::Operations::FixedCompensations]), { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('fixed_compensations') } }

      field :hourly_compensations, T.nilable(T::Array[::GustoEmbedded::Operations::HourlyCompensations]), { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('hourly_compensations') } }
      ...
      field :paid_time_off, T.nilable(T::Array[::GustoEmbedded::Operations::PaidTimeOff]), { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('paid_time_off') } }
      ...
      sig { params(employee_uuid: T.nilable(::String), excluded: T.nilable(T::Boolean), fixed_compensations: T.nilable(T::Array[::GustoEmbedded::Operations::FixedCompensations]), hourly_compensations: T.nilable(T::Array[::GustoEmbedded::Operations::HourlyCompensations]), memo: T.nilable(::String), paid_time_off: T.nilable(T::Array[::GustoEmbedded::Operations::PaidTimeOff]), payment_method: T.nilable(::GustoEmbedded::Operations::PaymentMethod), version: T.nilable(::String)).void }
