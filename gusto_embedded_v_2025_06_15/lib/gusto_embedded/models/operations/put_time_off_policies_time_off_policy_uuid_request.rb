...
module GustoEmbedded
  module Operations
    ...
    class PutTimeOffPoliciesTimeOffPolicyUuidRequest < ::Crystalline::FieldAugmented
      extend T::Sig

      # Can update any attributes of the time off policy except policy_type, is_active, complete & employees
      field :request_body, ::GustoEmbedded::Operations::PutTimeOffPoliciesTimeOffPolicyUuidRequestBody, { 'request': { 'media_type': 'application/json' } }
      ...
      sig { params(request_body: ::GustoEmbedded::Operations::PutTimeOffPoliciesTimeOffPolicyUuidRequestBody, time_off_policy_uuid: ::String, x_gusto_api_version: T.nilable(::GustoEmbedded::Shared::VersionHeader)).void }
