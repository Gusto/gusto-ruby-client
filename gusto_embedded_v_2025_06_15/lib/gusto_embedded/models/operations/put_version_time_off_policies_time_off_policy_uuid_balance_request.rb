...
module GustoEmbedded
  module Operations
    ...
    class PutVersionTimeOffPoliciesTimeOffPolicyUuidBalanceRequest < ::Crystalline::FieldAugmented
      extend T::Sig

      # A list of employee objects containing the employee uuid and time off hours balance
      field :request_body, ::GustoEmbedded::Operations::PutVersionTimeOffPoliciesTimeOffPolicyUuidBalanceRequestBody, { 'request': { 'media_type': 'application/json' } }
      ...
      sig { params(request_body: ::GustoEmbedded::Operations::PutVersionTimeOffPoliciesTimeOffPolicyUuidBalanceRequestBody, time_off_policy_uuid: ::String, x_gusto_api_version: T.nilable(::GustoEmbedded::Shared::VersionHeader)).void }
