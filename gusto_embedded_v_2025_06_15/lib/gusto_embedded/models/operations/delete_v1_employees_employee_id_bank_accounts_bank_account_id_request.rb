...
module GustoEmbedded
  module Operations
    ...
    class DeleteV1EmployeesEmployeeIdBankAccountsBankAccountIdRequest < ::Crystalline::FieldAugmented
      extend T::Sig
      ...
      sig { params(bank_account_uuid: ::String, employee_id: ::String, x_gusto_api_version: T.nilable(::GustoEmbedded::Shared::VersionHeader)).void }
