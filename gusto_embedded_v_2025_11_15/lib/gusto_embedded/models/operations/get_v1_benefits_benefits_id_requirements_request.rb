  ...
  module Models
    module Operations
      ...
      class GetV1BenefitsBenefitsIdRequirementsRequest
        ...
        field(
          :x_gusto_api_version,
          Crystalline::Nilable.new(Models::Operations::GetV1BenefitsBenefitsIdRequirementsHeaderXGustoAPIVersion),
        ...
        sig {
          params(
            ...
            x_gusto_api_version: T.nilable(
              Models::Operations::GetV1BenefitsBenefitsIdRequirementsHeaderXGustoAPIVersion
            )
          )
            .void
        }
        def initialize(
          benefit_id:,
          x_gusto_api_version: Models::Operations::GetV1BenefitsBenefitsIdRequirementsHeaderXGustoAPIVersion::TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15
        )
