  ...
  module Models
    module Operations
      ...
      class PostV1PayrollsPayrollIdCalculateAccruingTimeOffHoursRequest
        ...
        field(
          :body,
          Crystalline::Nilable.new(Models::Shared::PayrollCalculateAccruingTimeOffHoursRequest),
        ...
        def initialize(
          ...
          employee_id:,
          body: nil,
          x_gusto_api_version: Models::Operations::PostV1PayrollsPayrollIdCalculateAccruingTimeOffHoursHeaderXGustoAPIVersion::TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15
        )
