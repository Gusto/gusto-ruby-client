  ...
  module Models
    module Operations
      ...
      class PostV1CompaniesCompanyIdAdminsRequest
        ...
        field :body, Models::Shared::AdminCreateRequest, {'request': {'media_type': "application/json"}}
        # Determines the date-based API version associated with your API call. If none is provided, your application's [minimum API version](https://docs.gusto.com/embedded-payroll/docs/api-versioning#minimum-api-version) is used.
        field(
          :x_gusto_api_version,
          Crystalline::Nilable.new(Models::Operations::PostV1CompaniesCompanyIdAdminsHeaderXGustoAPIVersion),
