  ...
  module Models
    module Operations
      ...
      class PostV1CompaniesCompanyIdContractorPaymentGroupsContractorPayments
        ...
        field(
          :payment_method,
          Crystalline::Nilable.new(Models::Operations::PostV1CompaniesCompanyIdContractorPaymentGroupsPaymentMethod),
          {
            'format_json': {
              'letter_case': ::GustoEmbedded::Utils.field_name("payment_method"),
              'decoder': ::GustoEmbedded::Utils.enum_from_string(
                Models::Operations::PostV1CompaniesCompanyIdContractorPaymentGroupsPaymentMethod,
                true
              )
            }
          }
        ...
        sig {
          params(
            ...
            payment_method: T.nilable(Models::Operations::PostV1CompaniesCompanyIdContractorPaymentGroupsPaymentMethod)
          )
            .void
        }
        def initialize(
          ...
          bonus: nil,
          reimbursement: nil,
          payment_method: Models::Operations::PostV1CompaniesCompanyIdContractorPaymentGroupsPaymentMethod::DIRECT_DEPOSIT
        )
