...
module GustoEmbedded
  module Models
    module Operations
      ...
      class GetV1CompanyBenefitsCompanyBenefitIdEmployeeBenefitsRequest
        extend T::Sig
        ...
        field(
          :include,
          Crystalline::Nilable.new(Models::Operations::QueryParamInclude),
        ...
        sig {
          params(
            ...
            include: T.nilable(Models::Operations::QueryParamInclude),
        ...
        def initialize(
          ...
          per: nil,
          include: nil,
          x_gusto_api_version: Models::Operations::GetV1CompanyBenefitsCompanyBenefitIdEmployeeBenefitsHeaderXGustoAPIVersion::TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15
        )
