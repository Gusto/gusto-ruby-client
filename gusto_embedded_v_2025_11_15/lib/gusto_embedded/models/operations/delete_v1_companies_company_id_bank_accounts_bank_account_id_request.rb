    ...
    module Operations
      ...
      class DeleteV1CompaniesCompanyIdBankAccountsBankAccountIdRequest
        ...
        field(
          :bank_account_id,
          ::String,
          {'path_param': {'field_name': "bank_account_id", 'style': "simple", 'explode': false}}
        )
        ...
        def initialize(
          company_id:,
          bank_account_id:,
          x_gusto_api_version: Models::Operations::DeleteV1CompaniesCompanyIdBankAccountsBankAccountIdHeaderXGustoAPIVersion::TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15
        )
