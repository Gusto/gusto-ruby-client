    ...
    module Operations
      ...
      class GetV1CompaniesCompanyIdPaySchedulesPayScheduleIdRequest
        ...
        field(
          :pay_schedule_id,
          ::String,
          {'path_param': {'field_name': "pay_schedule_id", 'style': "simple", 'explode': false}}
        )
        ...
        def initialize(
          company_id:,
          pay_schedule_id:,
          x_gusto_api_version: Models::Operations::GetV1CompaniesCompanyIdPaySchedulesPayScheduleIdHeaderXGustoAPIVersion::TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15
        )
