    ...
    module Operations
      ...
      class GetV1CompaniesCompanyIdCompanyBenefitsRequest
        ...
        field(
          :enrollment_count,
          Crystalline::Nilable.new(Crystalline::Boolean.new),
          {'query_param': {'field_name': "enrollment_count", 'style': "form", 'explode': true}}
        )
        # Filter by benefit type. Comma-separated list of benefit type IDs, i.e. `?benefit_type=5,105`
        field(
          :benefit_type,
          Crystalline::Nilable.new(::String),
          {'query_param': {'field_name': "benefit_type", 'style': "form", 'explode': true}}
        )
        # Determines the date-based API version associated with your API call. If none is provided, your application's [minimum API version](https://docs.gusto.com/embedded-payroll/docs/api-versioning#minimum-api-version) is used.
        field(
          :x_gusto_api_version,
          Crystalline::Nilable.new(Models::Operations::GetV1CompaniesCompanyIdCompanyBenefitsHeaderXGustoAPIVersion),
        ...
        sig {
          params(
            ...
            enrollment_count: T.nilable(T::Boolean),
            benefit_type: T.nilable(::String),
            x_gusto_api_version: T.nilable(
              Models::Operations::GetV1CompaniesCompanyIdCompanyBenefitsHeaderXGustoAPIVersion
            )
          )
            .void
        }
        def initialize(
          ...
          benefit_type: nil,
          x_gusto_api_version: Models::Operations::GetV1CompaniesCompanyIdCompanyBenefitsHeaderXGustoAPIVersion::TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15
        )
