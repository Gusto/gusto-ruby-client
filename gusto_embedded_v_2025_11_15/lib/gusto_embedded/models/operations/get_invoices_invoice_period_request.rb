    ...
    module Operations
      ...
      class GetInvoicesInvoicePeriodRequest
        ...
        field(
          :invoice_period,
          ::String,
          {'path_param': {'field_name': "invoice_period", 'style': "simple", 'explode': false}}
        )
        ...
        field(
          ...
          {'query_param': {'field_name': "company_uuids", 'style': "form", 'explode': true}}
        )
        # Determines the date-based API version associated with your API call. If none is provided, your application's [minimum API version](https://docs.gusto.com/embedded-payroll/docs/api-versioning#minimum-api-version) is used.
        field(
          :x_gusto_api_version,
          Crystalline::Nilable.new(Models::Operations::GetInvoicesInvoicePeriodHeaderXGustoAPIVersion),
        ...
        sig {
          params(
            ...
            company_uuids: T.nilable(::String),
            x_gusto_api_version: T.nilable(Models::Operations::GetInvoicesInvoicePeriodHeaderXGustoAPIVersion)
          )
            .void
        }
        def initialize(
          ...
          per: nil,
          company_uuids: nil,
          x_gusto_api_version: Models::Operations::GetInvoicesInvoicePeriodHeaderXGustoAPIVersion::TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15
        )
