    ...
    module Operations
      ...
      class GetV1CompaniesAttachmentUrlRequest
        ...
        field(
          ...
          ::String,
          {'path_param': {'field_name': "company_attachment_uuid", 'style': "simple", 'explode': false}}
        )
        # Determines the date-based API version associated with your API call. If none is provided, your application's [minimum API version](https://docs.gusto.com/embedded-payroll/docs/api-versioning#minimum-api-version) is used.
        field(
          :x_gusto_api_version,
          Crystalline::Nilable.new(Models::Operations::GetV1CompaniesAttachmentUrlHeaderXGustoAPIVersion),
        ...
        def initialize(
          company_id:,
          company_attachment_uuid:,
          x_gusto_api_version: Models::Operations::GetV1CompaniesAttachmentUrlHeaderXGustoAPIVersion::TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15
        )
