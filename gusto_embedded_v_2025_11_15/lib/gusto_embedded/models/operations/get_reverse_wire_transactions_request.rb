  ...
  module Models
    module Operations
      ...
      class GetReverseWireTransactionsRequest
        ...
        field(
          :x_gusto_api_version,
          Crystalline::Nilable.new(Models::Operations::GetReverseWireTransactionsHeaderXGustoAPIVersion),
        ...
        def initialize(
          ...
          page: nil,
          per: nil,
          x_gusto_api_version: Models::Operations::GetReverseWireTransactionsHeaderXGustoAPIVersion::TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15
        )
