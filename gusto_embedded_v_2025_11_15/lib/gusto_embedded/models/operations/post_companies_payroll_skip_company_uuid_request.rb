  ...
  module Models
    module Operations
      ...
      class PostCompaniesPayrollSkipCompanyUuidRequest
        ...
        field(
          :x_gusto_api_version,
          Crystalline::Nilable.new(Models::Operations::PostCompaniesPayrollSkipCompanyUuidHeaderXGustoAPIVersion),
        ...
        sig {
          params(
            ...
            x_gusto_api_version: T.nilable(
              Models::Operations::PostCompaniesPayrollSkipCompanyUuidHeaderXGustoAPIVersion
            )
          )
            .void
        }
