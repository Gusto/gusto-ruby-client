  ...
  module Models
    module Operations
      ...
      class GetV1CompaniesCompanyUuidHolidayPayPolicyRequest
        ...
        field(
          :x_gusto_api_version,
          Crystalline::Nilable.new(Models::Operations::GetV1CompaniesCompanyUuidHolidayPayPolicyHeaderXGustoAPIVersion),
        ...
        def initialize(
          company_uuid:,
          x_gusto_api_version: Models::Operations::GetV1CompaniesCompanyUuidHolidayPayPolicyHeaderXGustoAPIVersion::TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15
        )
