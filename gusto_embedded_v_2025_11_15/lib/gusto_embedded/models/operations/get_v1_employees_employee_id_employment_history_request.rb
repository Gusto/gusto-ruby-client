  ...
  module Models
    module Operations
      ...
      class GetV1EmployeesEmployeeIdEmploymentHistoryRequest
        ...
        field(
          :x_gusto_api_version,
          Crystalline::Nilable.new(Models::Operations::GetV1EmployeesEmployeeIdEmploymentHistoryHeaderXGustoAPIVersion),
        ...
        def initialize(
          employee_id:,
          x_gusto_api_version: Models::Operations::GetV1EmployeesEmployeeIdEmploymentHistoryHeaderXGustoAPIVersion::TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15
        )
