    ...
    module Operations
      ...
      class DeleteV1CompaniesCompanyIdPayrollsRequest
        ...
        field(
          ...
          {'query_param': {'field_name': "async", 'style': "form", 'explode': true}}
        )
        # Determines the date-based API version associated with your API call. If none is provided, your application's [minimum API version](https://docs.gusto.com/embedded-payroll/docs/api-versioning#minimum-api-version) is used.
        field(
          :x_gusto_api_version,
          Crystalline::Nilable.new(Models::Operations::DeleteV1CompaniesCompanyIdPayrollsHeaderXGustoAPIVersion),
        ...
        def initialize(
          ...
          payroll_id:,
          async: nil,
          x_gusto_api_version: Models::Operations::DeleteV1CompaniesCompanyIdPayrollsHeaderXGustoAPIVersion::TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15
        )
