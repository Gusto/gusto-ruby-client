  ...
  module Models
    module Operations
      ...
      class GetV1EmployeesEmployeeIdGarnishmentsRequest
        ...
        field(
          :x_gusto_api_version,
          Crystalline::Nilable.new(Models::Operations::GetV1EmployeesEmployeeIdGarnishmentsHeaderXGustoAPIVersion),
        ...
        sig {
          params(
            ...
            x_gusto_api_version: T.nilable(
              Models::Operations::GetV1EmployeesEmployeeIdGarnishmentsHeaderXGustoAPIVersion
            )
          )
            .void
        }
        def initialize(
          ...
          page: nil,
          per: nil,
          x_gusto_api_version: Models::Operations::GetV1EmployeesEmployeeIdGarnishmentsHeaderXGustoAPIVersion::TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15
        )
