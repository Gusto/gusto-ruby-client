    ...
    module Operations
      ...
      class GetV1CompanyBenefitsCompanyBenefitIdRequest
        ...
        field(
          ...
          {'query_param': {'field_name': "with_employee_benefits", 'style': "form", 'explode': true}}
        )
        # Available options:
        ...
        field(
          :x_gusto_api_version,
          Crystalline::Nilable.new(Models::Operations::GetV1CompanyBenefitsCompanyBenefitIdHeaderXGustoAPIVersion),
        ...
        def initialize(
          ...
          include: nil,
          x_gusto_api_version: Models::Operations::GetV1CompanyBenefitsCompanyBenefitIdHeaderXGustoAPIVersion::TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15
        )
