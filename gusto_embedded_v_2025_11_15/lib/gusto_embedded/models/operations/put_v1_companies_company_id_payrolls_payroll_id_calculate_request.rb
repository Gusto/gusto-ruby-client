    ...
    module Operations
      ...
      class PutV1CompaniesCompanyIdPayrollsPayrollIdCalculateRequest
        ...
        def initialize(
          company_id:,
          payroll_id:,
          x_gusto_api_version: Models::Operations::PutV1CompaniesCompanyIdPayrollsPayrollIdCalculateHeaderXGustoAPIVersion::TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15
        )
