      ...
      class PostV1CompaniesCompanyIdContractorPaymentGroupsPreviewContractorPayments
        ...
        field(
          ...
          Crystalline::Nilable.new(
            Models::Operations::PostV1CompaniesCompanyIdContractorPaymentGroupsPreviewPaymentMethod
          ),
          {
            'format_json': {
        ...
        def initialize(
          ...
          bonus: nil,
          reimbursement: nil,
          payment_method: Models::Operations::PostV1CompaniesCompanyIdContractorPaymentGroupsPreviewPaymentMethod::DIRECT_DEPOSIT
        )
