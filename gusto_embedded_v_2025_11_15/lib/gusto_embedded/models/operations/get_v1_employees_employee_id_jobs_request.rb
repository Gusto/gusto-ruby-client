  ...
  module Models
    module Operations
      ...
      class GetV1EmployeesEmployeeIdJobsRequest
        ...
        field(
          :include,
          Crystalline::Nilable.new(Models::Operations::GetV1EmployeesEmployeeIdJobsQueryParamInclude),
          {'query_param': {'field_name': "include", 'style': "form", 'explode': true}}
        )
        # Determines the date-based API version associated with your API call. If none is provided, your application's [minimum API version](https://docs.gusto.com/embedded-payroll/docs/api-versioning#minimum-api-version) is used.
        field(
          :x_gusto_api_version,
          Crystalline::Nilable.new(Models::Operations::GetV1EmployeesEmployeeIdJobsHeaderXGustoAPIVersion),
        ...
        sig {
          params(
            ...
            include: T.nilable(Models::Operations::GetV1EmployeesEmployeeIdJobsQueryParamInclude),
            x_gusto_api_version: T.nilable(Models::Operations::GetV1EmployeesEmployeeIdJobsHeaderXGustoAPIVersion)
          )
            .void
        }
        def initialize(
          ...
          per: nil,
          include: nil,
          x_gusto_api_version: Models::Operations::GetV1EmployeesEmployeeIdJobsHeaderXGustoAPIVersion::TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15
        )
