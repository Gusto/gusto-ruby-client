  ...
  module Models
    module Operations
      ...
      class GetV1CompaniesCompanyIdPaySchedulesPreviewRequest
        ...
        field(
          :frequency,
          Models::Operations::Frequency,
          {'query_param': {'field_name': "frequency", 'style': "form", 'explode': true}}
        )
        # The first date that employees on this pay schedule are paid with Gusto.
        field(
          :anchor_pay_date,
          ::Date,
          {'query_param': {'field_name': "anchor_pay_date", 'style': "form", 'explode': true}}
        )
        # The last date of the first pay period. This can be the same date as the anchor pay date.
        field(
          :anchor_end_of_pay_period,
          ::Date,
          {'query_param': {'field_name': "anchor_end_of_pay_period", 'style': "form", 'explode': true}}
        )
        ...
        field(
          ...
          {'query_param': {'field_name': "day_1", 'style': "form", 'explode': true}}
        )
        ...
        field(
          :day_2,
          Crystalline::Nilable.new(::Integer),
          {'query_param': {'field_name': "day_2", 'style': "form", 'explode': true}}
        )
        ...
        field(
          :x_gusto_api_version,
          Crystalline::Nilable.new(Models::Operations::GetV1CompaniesCompanyIdPaySchedulesPreviewHeaderXGustoAPIVersion),
        ...
        sig {
          params(
            company_id: ::String,
            frequency: Models::Operations::Frequency,
