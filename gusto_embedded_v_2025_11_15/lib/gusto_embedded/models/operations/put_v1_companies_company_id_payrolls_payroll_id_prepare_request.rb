  ...
  module Models
    module Operations
      ...
      class PutV1CompaniesCompanyIdPayrollsPayrollIdPrepareRequest
        ...
        field(
          :body,
          Crystalline::Nilable.new(Models::Operations::PutV1CompaniesCompanyIdPayrollsPayrollIdPrepareRequestBody),
        ...
        def initialize(
          ...
          sort_by: nil,
          body: nil,
          x_gusto_api_version: Models::Operations::PutV1CompaniesCompanyIdPayrollsPayrollIdPrepareHeaderXGustoAPIVersion::TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15
        )
