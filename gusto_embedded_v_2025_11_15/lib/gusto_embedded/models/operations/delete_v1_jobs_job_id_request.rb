  ...
  module Models
    module Operations
      ...
      class DeleteV1JobsJobIdRequest
        ...
        field(
          :x_gusto_api_version,
          Crystalline::Nilable.new(Models::Operations::DeleteV1JobsJobIdHeaderXGustoAPIVersion),
        ...
        def initialize(
          job_id:,
          x_gusto_api_version: Models::Operations::DeleteV1JobsJobIdHeaderXGustoAPIVersion::TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15
        )
          @job_id = job_id
