    ...
    module Operations
      ...
      class Occupations
        ...
        field(
          :code,
          ::String,
          {'format_json': {'letter_case': ::GustoEmbedded::Utils.field_name("code"), required: true}}
        )
        # Experience level for this occupation
        field(
          :experience_level,
          Models::Operations::ExperienceLevel,
          {
            'format_json': {
              'letter_case': ::GustoEmbedded::Utils.field_name("experience_level"),
              required: true,
              'decoder': ::GustoEmbedded::Utils.enum_from_string(Models::Operations::ExperienceLevel, false)
            }
          }
        )
        ...
        field(
          :time_percentage,
          ::String,
          {'format_json': {'letter_case': ::GustoEmbedded::Utils.field_name("time_percentage"), required: true}}
        )
        ...
        sig {
          params(
            code: ::String,
            experience_level: Models::Operations::ExperienceLevel,
