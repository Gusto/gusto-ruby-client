  ...
  module Models
    module Operations
      ...
      class GetCompaniesDepartmentsRequest
        ...
        field(
          :x_gusto_api_version,
          Crystalline::Nilable.new(Models::Operations::GetCompaniesDepartmentsHeaderXGustoAPIVersion),
        ...
        def initialize(
          company_uuid:,
          x_gusto_api_version: Models::Operations::GetCompaniesDepartmentsHeaderXGustoAPIVersion::TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15
        )
