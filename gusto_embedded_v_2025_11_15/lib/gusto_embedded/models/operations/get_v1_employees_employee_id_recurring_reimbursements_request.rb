    ...
    module Operations
      ...
      class GetV1EmployeesEmployeeIdRecurringReimbursementsRequest
        ...
        def initialize(
          ...
          page: nil,
          per: nil,
          x_gusto_api_version: Models::Operations::GetV1EmployeesEmployeeIdRecurringReimbursementsHeaderXGustoAPIVersion::TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15
        )
