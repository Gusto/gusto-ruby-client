    ...
    module Operations
      ...
      class PostCompaniesCompanyUuidSuspensionsRequestBody
        ...
        field(
          ...
          {'format_json': {'letter_case': ::GustoEmbedded::Utils.field_name("file_quarterly_forms"), required: true}}
        )
        ...
        field(
          :file_yearly_forms,
          Crystalline::Boolean.new,
          {'format_json': {'letter_case': ::GustoEmbedded::Utils.field_name("file_yearly_forms"), required: true}}
        )
        # How Gusto will handle taxes already collected.
        field(
          :reconcile_tax_method,
          Models::Operations::ReconcileTaxMethod,
          {
            'format_json': {
              'letter_case': ::GustoEmbedded::Utils.field_name("reconcile_tax_method"),
              required: true,
              'decoder': ::GustoEmbedded::Utils.enum_from_string(Models::Operations::ReconcileTaxMethod, false)
            }
          }
        )
        ...
        field(
          :reason,
          Models::Operations::Reason,
          {
            'format_json': {
              'letter_case': ::GustoEmbedded::Utils.field_name("reason"),
              required: true,
              'decoder': ::GustoEmbedded::Utils.enum_from_string(Models::Operations::Reason, false)
            }
          }
        )
        ...
        field(
          :leaving_for,
          Crystalline::Nilable.new(Models::Operations::LeavingFor),
          {
            'format_json': {
              'letter_case': ::GustoEmbedded::Utils.field_name("leaving_for"),
              'decoder': ::GustoEmbedded::Utils.enum_from_string(Models::Operations::LeavingFor, true)
            }
          }
        )
        ...
        sig {
          params(
            file_quarterly_forms: T::Boolean,
            file_yearly_forms: T::Boolean,
            reconcile_tax_method: Models::Operations::ReconcileTaxMethod,
            reason: Models::Operations::Reason,
            comments: T.nilable(::String),
            leaving_for: T.nilable(Models::Operations::LeavingFor)
          )
            .void
        }
        def initialize(
