  ...
  module Models
    module Operations
      ...
      class GetV1CompaniesCompanyIdAdminsRequest
        ...
        field(
          :x_gusto_api_version,
          Crystalline::Nilable.new(Models::Operations::GetV1CompaniesCompanyIdAdminsHeaderXGustoAPIVersion),
        ...
        def initialize(
          ...
          page: nil,
          per: nil,
          x_gusto_api_version: Models::Operations::GetV1CompaniesCompanyIdAdminsHeaderXGustoAPIVersion::TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15
        )
