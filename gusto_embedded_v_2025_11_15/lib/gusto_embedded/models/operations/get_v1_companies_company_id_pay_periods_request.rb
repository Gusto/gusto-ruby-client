  ...
  module Models
    module Operations
      ...
      class GetV1CompaniesCompanyIdPayPeriodsRequest
        ...
        field(
          :payroll_types,
          Crystalline::Nilable.new(Models::Operations::PayrollTypes),
          {'query_param': {'field_name': "payroll_types", 'style': "form", 'explode': true}}
        )
        # Determines the date-based API version associated with your API call. If none is provided, your application's [minimum API version](https://docs.gusto.com/embedded-payroll/docs/api-versioning#minimum-api-version) is used.
        field(
          :x_gusto_api_version,
          Crystalline::Nilable.new(Models::Operations::GetV1CompaniesCompanyIdPayPeriodsHeaderXGustoAPIVersion),
        ...
        sig {
          params(
            ...
            payroll_types: T.nilable(Models::Operations::PayrollTypes),
        ...
        def initialize(
          ...
          end_date: nil,
          payroll_types: nil,
          x_gusto_api_version: Models::Operations::GetV1CompaniesCompanyIdPayPeriodsHeaderXGustoAPIVersion::TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15
        )
