    ...
    module Operations
      ...
      class GetV1CompaniesCompanyUuidTimeOffBalancesRequest
        ...
        field(
          ...
          {'query_param': {'field_name': "employee_uuids", 'style': "form", 'explode': true}}
        )
        # Filter by time off policy UUIDs (comma-separated)
        field(
          :policy_uuids,
          Crystalline::Nilable.new(::String),
          {'query_param': {'field_name': "policy_uuids", 'style': "form", 'explode': true}}
        )
        ...
        field(
          :x_gusto_api_version,
          Crystalline::Nilable.new(Models::Operations::GetV1CompaniesCompanyUuidTimeOffBalancesHeaderXGustoAPIVersion),
        ...
        sig {
          params(
            company_uuid: ::String,
            employee_uuids: T.nilable(::String),
            policy_uuids: T.nilable(::String),
            page: T.nilable(::Integer),
            per: T.nilable(::Integer),
            x_gusto_api_version: T.nilable(
              Models::Operations::GetV1CompaniesCompanyUuidTimeOffBalancesHeaderXGustoAPIVersion
            )
          )
            .void
        }
        def initialize(
          ...
          page: nil,
          per: nil,
          x_gusto_api_version: Models::Operations::GetV1CompaniesCompanyUuidTimeOffBalancesHeaderXGustoAPIVersion::TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15
        )
