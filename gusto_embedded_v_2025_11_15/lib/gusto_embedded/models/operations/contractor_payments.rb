  ...
  module Models
    module Operations
      ...
      class ContractorPayments
        ...
        field(
          :payment_method,
          Crystalline::Nilable.new(Models::Operations::PaymentMethod),
          {
            'format_json': {
              'letter_case': ::GustoEmbedded::Utils.field_name("payment_method"),
              'decoder': ::GustoEmbedded::Utils.enum_from_string(Models::Operations::PaymentMethod, true)
            }
          }
        )
        ...
        sig {
          params(
            ...
            payment_method: T.nilable(Models::Operations::PaymentMethod)
          )
            .void
        }
        def initialize(
          ...
          bonus: nil,
          reimbursement: nil,
          payment_method: Models::Operations::PaymentMethod::DIRECT_DEPOSIT
        )
