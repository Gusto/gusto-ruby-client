    ...
    module Operations
      ...
      class GetV1BenefitsCompanyBenefitIdSummaryRequest
        ...
        field(
          ...
          {'query_param': {'field_name': "detailed", 'style': "form", 'explode': true}}
        )
        # Determines the date-based API version associated with your API call. If none is provided, your application's [minimum API version](https://docs.gusto.com/embedded-payroll/docs/api-versioning#minimum-api-version) is used.
        field(
          :x_gusto_api_version,
          Crystalline::Nilable.new(Models::Operations::GetV1BenefitsCompanyBenefitIdSummaryHeaderXGustoAPIVersion),
        ...
        sig {
          params(
            ...
            x_gusto_api_version: T.nilable(
              Models::Operations::GetV1BenefitsCompanyBenefitIdSummaryHeaderXGustoAPIVersion
            )
          )
            .void
        }
        def initialize(
          ...
          end_date: nil,
          detailed: nil,
          x_gusto_api_version: Models::Operations::GetV1BenefitsCompanyBenefitIdSummaryHeaderXGustoAPIVersion::TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15
        )
