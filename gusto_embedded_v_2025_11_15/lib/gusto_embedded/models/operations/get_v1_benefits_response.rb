  ...
  module Models
    module Operations
      ...
      class GetV1BenefitsResponse
        ...
        # Successful
        field(
          :supported_benefit_list,
          Crystalline::Nilable.new(Crystalline::Array.new(Models::Shared::SupportedBenefit))
        )
        ...
        sig {
          params(
            ...
            supported_benefit_list: T.nilable(T::Array[Models::Shared::SupportedBenefit])
          )
            .void
        }
