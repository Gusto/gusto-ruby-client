    ...
    module Operations
      ...
      class PostV1CompaniesCompanyIdContractorPaymentGroupsRequestBody
        ...
        field(
          :creation_token,
          ::String,
          {'format_json': {'letter_case': ::GustoEmbedded::Utils.field_name("creation_token"), required: true}}
        )
        ...
        field(
          :submission_blockers,
          Crystalline::Nilable.new(Crystalline::Array.new(Models::Operations::SubmissionBlockers)),
