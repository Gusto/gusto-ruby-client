      ...
      class GetV1CompaniesCompanyUuidContractorsRequest
        ...
        field(
          ...
          Crystalline::Nilable.new(
            Crystalline::Array.new(Models::Operations::GetV1CompaniesCompanyUuidContractorsQueryParamInclude)
          ),
        ...
        field(
          :x_gusto_api_version,
          Crystalline::Nilable.new(Models::Operations::GetV1CompaniesCompanyUuidContractorsHeaderXGustoAPIVersion),
        ...
        sig {
          params(
            ...
            include: T.nilable(T::Array[Models::Operations::GetV1CompaniesCompanyUuidContractorsQueryParamInclude]),
            page: T.nilable(::Integer),
            per: T.nilable(::Integer),
            x_gusto_api_version: T.nilable(
              Models::Operations::GetV1CompaniesCompanyUuidContractorsHeaderXGustoAPIVersion
            )
          )
            .void
        }
        def initialize(
          ...
          page: nil,
          per: nil,
          x_gusto_api_version: Models::Operations::GetV1CompaniesCompanyUuidContractorsHeaderXGustoAPIVersion::TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15
        )
