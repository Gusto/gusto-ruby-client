  ...
  module Models
    module Operations
      ...
      class GetV1CompaniesCompanyIdPaySchedulesAssignmentsRequest
        ...
        def initialize(
          company_id:,
          x_gusto_api_version: Models::Operations::GetV1CompaniesCompanyIdPaySchedulesAssignmentsHeaderXGustoAPIVersion::TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15
        )
