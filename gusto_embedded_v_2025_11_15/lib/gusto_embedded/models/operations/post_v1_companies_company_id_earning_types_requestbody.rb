  ...
  module Models
    module Operations
      ...
      class PostV1CompaniesCompanyIdEarningTypesRequestBody
        ...
        field(
          :category,
          Crystalline::Nilable.new(Models::Operations::Category),
          {
            'format_json': {
              'letter_case': ::GustoEmbedded::Utils.field_name("category"),
              'decoder': ::GustoEmbedded::Utils.enum_from_string(Models::Operations::Category, true)
            }
          }
        )
        ...
        sig {
          params(
            category: T.nilable(Models::Operations::Category),
