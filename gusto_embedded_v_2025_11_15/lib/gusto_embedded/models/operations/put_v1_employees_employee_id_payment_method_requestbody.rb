  ...
  module Models
    module Operations
      ...
      class PutV1EmployeesEmployeeIdPaymentMethodRequestBody
        ...
        field(
          :split_by,
          Crystalline::Nilable.new(Models::Operations::SplitBy),
          {
            'format_json': {
              'letter_case': ::GustoEmbedded::Utils.field_name("split_by"),
              'decoder': ::GustoEmbedded::Utils.enum_from_string(Models::Operations::SplitBy, true)
            }
          }
        )
        ...
        field(
          :splits,
          Crystalline::Nilable.new(Crystalline::Array.new(Models::Operations::Splits)),
