  ...
  module Models
    module Operations
      ...
      class DeleteV1WebhookSubscriptionUuidRequest
        ...
        field(
          :x_gusto_api_version,
          Crystalline::Nilable.new(Models::Operations::DeleteV1WebhookSubscriptionUuidHeaderXGustoAPIVersion),
        ...
        def initialize(
          webhook_subscription_uuid:,
          x_gusto_api_version: Models::Operations::DeleteV1WebhookSubscriptionUuidHeaderXGustoAPIVersion::TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15
        )
