  ...
  module Models
    module Operations
      ...
      class GetV1CompaniesAttachmentRequest
        ...
        field(
          :x_gusto_api_version,
          Crystalline::Nilable.new(Models::Operations::GetV1CompaniesAttachmentHeaderXGustoAPIVersion),
        ...
        def initialize(
          company_id:,
          company_attachment_uuid:,
          x_gusto_api_version: Models::Operations::GetV1CompaniesAttachmentHeaderXGustoAPIVersion::TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15
        )
