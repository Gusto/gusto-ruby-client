  ...
  module Models
    module Operations
      ...
      class GetV1CompaniesCompanyIdFederalTaxDetailsRequest
        ...
        field(
          :x_gusto_api_version,
          Crystalline::Nilable.new(Models::Operations::GetV1CompaniesCompanyIdFederalTaxDetailsHeaderXGustoAPIVersion),
        ...
        def initialize(
          company_id:,
          x_gusto_api_version: Models::Operations::GetV1CompaniesCompanyIdFederalTaxDetailsHeaderXGustoAPIVersion::TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15
        )
