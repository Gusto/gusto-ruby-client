  ...
  module Models
    module Shared
      ...
      class Garnishment
        ...
        field(
          :garnishment_type,
          Crystalline::Nilable.new(Models::Shared::GarnishmentType),
          {
            'format_json': {
              'letter_case': ::GustoEmbedded::Utils.field_name("garnishment_type"),
              'decoder': ::GustoEmbedded::Utils.open_enum_from_string(Models::Shared::GarnishmentType, true)
            }
          }
        )
        ...
        sig {
          params(
            ...
            garnishment_type: T.nilable(Models::Shared::GarnishmentType),
