  ...
  module Models
    module Shared
      ...
      class PaymentConfigs
        ...
        field(
          :payment_speed,
          Crystalline::Nilable.new(Models::Shared::PaymentSpeed),
          {
            'format_json': {
              'letter_case': ::GustoEmbedded::Utils.field_name("payment_speed"),
              'decoder': ::GustoEmbedded::Utils.open_enum_from_string(Models::Shared::PaymentSpeed, true)
            }
          }
        )
        ...
        field(
          ...
          Crystalline::Nilable.new(Crystalline::Array.new(Models::Shared::EarnedFastAchBlockers)),
          {'format_json': {'letter_case': ::GustoEmbedded::Utils.field_name("earned_fast_ach_blockers")}}
        )
        ...
        sig {
          params(
            ...
            payment_speed: T.nilable(Models::Shared::PaymentSpeed),
            partner_owned_disbursement: T.nilable(T::Boolean),
            earned_fast_ach_blockers: T.nilable(T::Array[Models::Shared::EarnedFastAchBlockers]),
            fast_payment_limit: T.nilable(::String)
          )
            .void
        }
        def initialize(
          ...
          earned_fast_ach_blockers: nil,
          fast_payment_limit: nil
        )
