    ...
    module Shared
      ...
      class Location
        ...
        field(
          :phone_number,
          Crystalline::Nilable.new(::String),
          {'format_json': {'letter_case': ::GustoEmbedded::Utils.field_name("phone_number")}}
        )
        ...
        field(
          :created_at,
          Crystalline::Nilable.new(::String),
          {'format_json': {'letter_case': ::GustoEmbedded::Utils.field_name("created_at")}}
        )
        # Datetime for when location is updated
        field(
          :updated_at,
          Crystalline::Nilable.new(::String),
          {'format_json': {'letter_case': ::GustoEmbedded::Utils.field_name("updated_at")}}
        )
