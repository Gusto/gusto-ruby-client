  ...
  module Models
    module Shared
      ...
      class PaySchedulePreview
        ...
        field(
          :pay_periods,
          Crystalline::Nilable.new(Crystalline::Array.new(Models::Shared::PaySchedulePreviewPayPeriod)),
          {'format_json': {'letter_case': ::GustoEmbedded::Utils.field_name("pay_periods")}}
        )
        # A list of dates for bank closures (ISO date strings); may affect payroll processing.
        field(
          :holidays,
          Crystalline::Nilable.new(Crystalline::Array.new(::Date)),
          {'format_json': {'letter_case': ::GustoEmbedded::Utils.field_name("holidays")}}
        )

        sig {
          params(
            pay_periods: T.nilable(T::Array[Models::Shared::PaySchedulePreviewPayPeriod]),
            holidays: T.nilable(T::Array[::Date])
          )
            .void
        }
