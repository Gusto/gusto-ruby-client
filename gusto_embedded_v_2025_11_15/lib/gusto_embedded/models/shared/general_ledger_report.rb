  ...
  module Models
    module Shared
      ...
      class GeneralLedgerReport
        ...
        field(
          :aggregation,
          Crystalline::Nilable.new(Models::Shared::GeneralLedgerReportAggregation),
          {
            'format_json': {
              'letter_case': ::GustoEmbedded::Utils.field_name("aggregation"),
              'decoder': ::GustoEmbedded::Utils.open_enum_from_string(
                Models::Shared::GeneralLedgerReportAggregation,
                true
              )
            }
          }
        ...
        sig {
          params(
            ...
            aggregation: T.nilable(Models::Shared::GeneralLedgerReportAggregation),
