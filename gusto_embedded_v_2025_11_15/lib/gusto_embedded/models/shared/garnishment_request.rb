    ...
    module Shared
      ...
      class GarnishmentRequest
        ...
        field(
          ...
          {'format_json': {'letter_case': ::GustoEmbedded::Utils.field_name("court_ordered"), required: true}}
        )
        ...
        field(
          :garnishment_type,
          Crystalline::Nilable.new(Models::Shared::GarnishmentRequestGarnishmentType),
          {
            'format_json': {
              'letter_case': ::GustoEmbedded::Utils.field_name("garnishment_type"),
              'decoder': ::GustoEmbedded::Utils.enum_from_string(
                Models::Shared::GarnishmentRequestGarnishmentType,
                true
              )
            }
          }
        ...
        sig {
          params(
            amount: ::String,
            court_ordered: T::Boolean,
            description: T.nilable(::String),
            active: T.nilable(T::Boolean),
            garnishment_type: T.nilable(Models::Shared::GarnishmentRequestGarnishmentType),
