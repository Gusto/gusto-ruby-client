    ...
    module Shared
      ...
      class I9AuthorizationRequestBody
        ...
        field(
          ...
          Models::Shared::I9AuthorizationRequestBodyAuthorizationStatus,
          {
            'format_json': {
        ...
        field(
          :document_type,
          Crystalline::Nilable.new(Models::Shared::I9AuthorizationRequestBodyDocumentType),
          {
            'format_json': {
              'letter_case': ::GustoEmbedded::Utils.field_name("document_type"),
              'decoder': ::GustoEmbedded::Utils.enum_from_string(
                Models::Shared::I9AuthorizationRequestBodyDocumentType,
                true
              )
            }
          }
        ...
        field(
          :document_number,
          Crystalline::Nilable.new(::String),
          {'format_json': {'letter_case': ::GustoEmbedded::Utils.field_name("document_number")}}
        )
        ...
        sig {
          params(
            authorization_status: Models::Shared::I9AuthorizationRequestBodyAuthorizationStatus,
            version: T.nilable(::String),
            document_type: T.nilable(Models::Shared::I9AuthorizationRequestBodyDocumentType),
