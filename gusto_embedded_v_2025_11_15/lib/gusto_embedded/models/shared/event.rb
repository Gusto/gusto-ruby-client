  ...
  module Models
    module Shared
      ...
      class Event
        ...
        field(
          :resource_type,
          Crystalline::Nilable.new(Models::Shared::ResourceType),
          {
            'format_json': {
              'letter_case': ::GustoEmbedded::Utils.field_name("resource_type"),
              'decoder': ::GustoEmbedded::Utils.enum_from_string(Models::Shared::ResourceType, true)
            }
          }
        )
        ...
        field(
          :resource_uuid,
          Crystalline::Nilable.new(::String),
          {'format_json': {'letter_case': ::GustoEmbedded::Utils.field_name("resource_uuid")}}
        )
        # Name of the entity that the event corresponds to.
        field(
          :entity_type,
          Crystalline::Nilable.new(::String),
          {'format_json': {'letter_case': ::GustoEmbedded::Utils.field_name("entity_type")}}
        )
        # Unique identifier for the entity.
        field(
          :entity_uuid,
          Crystalline::Nilable.new(::String),
          {'format_json': {'letter_case': ::GustoEmbedded::Utils.field_name("entity_uuid")}}
        )
        # Time at which this event was created. Measured in seconds since the Unix epoch.
        field(
          :timestamp,
          Crystalline::Nilable.new(::Integer),
          {'format_json': {'letter_case': ::GustoEmbedded::Utils.field_name("timestamp")}}
        )
        ...
        sig {
          params(
            ...
            resource_type: T.nilable(Models::Shared::ResourceType),
            resource_uuid: T.nilable(::String),
            entity_type: T.nilable(::String),
            entity_uuid: T.nilable(::String),
