  ...
  module Models
    module Shared
      ...
      class ExternalPayrollUpdateRequestEarnings
        ...
        field(
          :earning_type,
          Crystalline::Nilable.new(Models::Shared::ExternalPayrollUpdateRequestEarningType),
          {
            'format_json': {
              'letter_case': ::GustoEmbedded::Utils.field_name("earning_type"),
              'decoder': ::GustoEmbedded::Utils.enum_from_string(
                Models::Shared::ExternalPayrollUpdateRequestEarningType,
                true
              )
            }
          }
        ...
        sig {
          params(
            earning_type: T.nilable(Models::Shared::ExternalPayrollUpdateRequestEarningType),
