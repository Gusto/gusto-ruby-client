    ...
    module Shared
      ...
      class PaidTimeOff
        ...
        field(
          ...
          {'format_json': {'letter_case': ::GustoEmbedded::Utils.field_name("paid_at_termination")}}
        )
        # The name of the paid time off type.
        field(
          :name,
          Crystalline::Nilable.new(Models::Shared::Name),
          {
            'format_json': {
              'letter_case': ::GustoEmbedded::Utils.field_name("name"),
              'decoder': ::GustoEmbedded::Utils.open_enum_from_string(Models::Shared::Name, true)
            }
          }
        )
        ...
        field(
          ...
          {'format_json': {'letter_case': ::GustoEmbedded::Utils.field_name("policy_name")}}
        )
        # The UUID of the time off policy.
        field(
          :policy_uuid,
          Crystalline::Nilable.new(::String),
          {'format_json': {'letter_case': ::GustoEmbedded::Utils.field_name("policy_uuid")}}
        )
        # The unit the PTO type is accrued in.
        field(
          :accrual_unit,
          Crystalline::Nilable.new(::String),
          {'format_json': {'letter_case': ::GustoEmbedded::Utils.field_name("accrual_unit")}}
        )
        ...
        field(
          :accrual_method,
          Crystalline::Nilable.new(::String),
          {'format_json': {'letter_case': ::GustoEmbedded::Utils.field_name("accrual_method")}}
        )
        # The frequency at which the PTO type is accrued.
        field(
          :accrual_period,
          Crystalline::Nilable.new(::String),
          {'format_json': {'letter_case': ::GustoEmbedded::Utils.field_name("accrual_period")}}
        )
        # The number of accrual units accrued.
        field(
          :accrual_balance,
          Crystalline::Nilable.new(::String),
          {'format_json': {'letter_case': ::GustoEmbedded::Utils.field_name("accrual_balance")}}
        )
        # The maximum number of accrual units allowed. A null value signifies no maximum.
        field(
          :maximum_accrual_balance,
          Crystalline::Nilable.new(::String),
          {'format_json': {'letter_case': ::GustoEmbedded::Utils.field_name("maximum_accrual_balance")}}
        )

        sig {
          params(
            paid_at_termination: T.nilable(T::Boolean),
            name: T.nilable(Models::Shared::Name),
            policy_name: T.nilable(::String),
            policy_uuid: T.nilable(::String),
            accrual_unit: T.nilable(::String),
            accrual_rate: T.nilable(::String),
            accrual_method: T.nilable(::String),
            accrual_period: T.nilable(::String),
            accrual_balance: T.nilable(::String),
            maximum_accrual_balance: T.nilable(::String)
          )
            .void
        }
        def initialize(
          paid_at_termination: nil,
          name: nil,
          policy_name: nil,
          policy_uuid: nil,
          accrual_unit: nil,
