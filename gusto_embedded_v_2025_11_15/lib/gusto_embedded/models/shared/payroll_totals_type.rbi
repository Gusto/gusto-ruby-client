...
class GustoEmbedded::Models::Shared::PayrollTotalsType
  ...
  def employee_bonuses=(str_)
  end

  def employee_commissions
  end

  def employee_commissions=(str_)
  end

  def employee_cash_tips
  end

  def employee_cash_tips=(str_)
  end

  def employee_paycheck_tips
  end

  def employee_paycheck_tips=(str_)
  end

  def additional_earnings
  end

  def additional_earnings=(str_)
  end

  def owners_draw
  end

  def owners_draw=(str_)
  end
  ...
  def employer_taxes=(str_)
  end

  def employee_taxes
  end

  def employee_taxes=(str_)
  end
  ...
  def employee_benefits_deductions=(str_)
  end
  ...
  def deferred_payroll_taxes=(str_)
  end

  def other_deductions
  end

  def other_deductions=(str_)
  end
end
