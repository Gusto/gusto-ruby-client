  ...
  module Models
    module Shared
      ...
      class ContractorPaymentSummaryByDates
        ...
        field(
          :total,
          Crystalline::Nilable.new(Models::Shared::ContractorPaymentSummaryByDatesTotal),
          {'format_json': {'letter_case': ::GustoEmbedded::Utils.field_name("total")}}
        )
        # The individual contractor payments, within a given time period, grouped by check date.
        field(
          :contractor_payments,
          Crystalline::Nilable.new(
            Crystalline::Array.new(Models::Shared::ContractorPaymentSummaryByDatesContractorPayments)
          ),
        ...
        sig {
          params(
            total: T.nilable(Models::Shared::ContractorPaymentSummaryByDatesTotal),
            contractor_payments: T.nilable(T::Array[Models::Shared::ContractorPaymentSummaryByDatesContractorPayments])
          )
            .void
        }
