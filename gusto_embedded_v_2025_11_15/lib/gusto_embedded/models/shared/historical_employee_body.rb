  ...
  module Models
    module Shared
      ...
      class HistoricalEmployeeBody
        ...
        field(
          :termination,
          Models::Shared::HistoricalEmployeeBodyTermination,
        ...
        field(
          :job,
          Models::Shared::HistoricalEmployeeBodyJob,
        ...
        field(
          ...
          Crystalline::Nilable.new(Models::Shared::EmployeeStateTaxes),
        ...
        sig {
          params(
            ...
            employee_state_taxes: T.nilable(Models::Shared::EmployeeStateTaxes)
          )
            .void
        }
        def initialize(
