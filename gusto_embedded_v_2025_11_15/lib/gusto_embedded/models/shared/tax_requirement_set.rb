  ...
  module Models
    module Shared
      ...
      class TaxRequirementSet
        ...
        field(
          :requirements,
          Crystalline::Nilable.new(Crystalline::Array.new(Models::Shared::TaxRequirement)),
        ...
        field(
          :effective_from,
          Crystalline::Nilable.new(::String),
          {'format_json': {'letter_case': ::GustoEmbedded::Utils.field_name("effective_from")}}
        )
        ...
        sig {
          params(
            ...
            requirements: T.nilable(T::Array[Models::Shared::TaxRequirement]),
            effective_from: T.nilable(::String)
          )
            .void
        }
