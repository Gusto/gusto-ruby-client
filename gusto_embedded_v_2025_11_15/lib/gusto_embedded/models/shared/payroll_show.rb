    ...
    module Shared
      ...
      class PayrollShow
        ...
        field(
          ...
          {
            'format_json': {
              'letter_case': ::GustoEmbedded::Utils.field_name("payroll_deadline"),
        ...
        field(
          ...
          {'format_json': {'letter_case': ::GustoEmbedded::Utils.field_name("processed")}}
        )
        ...
        field(
          :off_cycle,
          Crystalline::Nilable.new(Crystalline::Boolean.new),
          {'format_json': {'letter_case': ::GustoEmbedded::Utils.field_name("off_cycle")}}
        )
        ...
        field(
          :external,
          Crystalline::Nilable.new(Crystalline::Boolean.new),
          {'format_json': {'letter_case': ::GustoEmbedded::Utils.field_name("external")}}
        )
        ...
        field(
          ...
          Crystalline::Nilable.new(Crystalline::Boolean.new),
          {'format_json': {'letter_case': ::GustoEmbedded::Utils.field_name("final_termination_payroll")}}
        )

        field(
          :pay_period,
          Crystalline::Nilable.new(Models::Shared::PayrollPayPeriodType),
        ...
        field(
          :payroll_status_meta,
          Crystalline::Nilable.new(Models::Shared::PayrollPayrollStatusMetaType),
          {'format_json': {'letter_case': ::GustoEmbedded::Utils.field_name("payroll_status_meta")}}
        )
        # The subtotals for the payroll.
        field(
          :totals,
          Crystalline::Nilable.new(Models::Shared::PayrollTotalsType),
        ...
        field(
          :company_taxes,
          Crystalline::Nilable.new(Crystalline::Array.new(Models::Shared::PayrollCompanyTaxesType)),
          {'format_json': {'letter_case': ::GustoEmbedded::Utils.field_name("company_taxes")}}
        )
        ...
        field(
          :payroll_taxes,
          Crystalline::Nilable.new(Crystalline::Array.new(Models::Shared::PayrollTaxesType)),
          {'format_json': {'letter_case': ::GustoEmbedded::Utils.field_name("payroll_taxes")}}
        )
        # Only applicable when a payroll is moved to four day processing instead of fast ach.
        field(
          :payment_speed_changed,
          Crystalline::Nilable.new(Models::Shared::PayrollPaymentSpeedChangedType),
          {'format_json': {'letter_case': ::GustoEmbedded::Utils.field_name("payment_speed_changed")}}
        )
        ...
        field(
          ...
          {
            'format_json': {
              'letter_case': ::GustoEmbedded::Utils.field_name("created_at"),
              'decoder': ::GustoEmbedded::Utils.datetime_from_iso_format(true)
            }
          }
        )
        ...
        field(
          ...
          Crystalline::Nilable.new(Crystalline::Array.new(Models::Shared::EmployeeCompensations)),
        ...
        field(
          :processed_date,
          Crystalline::Nilable.new(::String),
          {'format_json': {'letter_case': ::GustoEmbedded::Utils.field_name("processed_date")}}
        )
        ...
        field(
          ...
          {
            'format_json': {
              'letter_case': ::GustoEmbedded::Utils.field_name("calculated_at"),
              'decoder': ::GustoEmbedded::Utils.datetime_from_iso_format(true)
            }
          }
        )
        ...
        field(
          :off_cycle_reason,
          Crystalline::Nilable.new(Models::Shared::OffCycleReasonType),
          {
            'format_json': {
              'letter_case': ::GustoEmbedded::Utils.field_name("off_cycle_reason"),
              'decoder': ::GustoEmbedded::Utils.open_enum_from_string(Models::Shared::OffCycleReasonType, true)
            }
          }
        )
        ...
        field(
          ...
          Crystalline::Nilable.new(Models::Shared::PayrollWithholdingPayPeriodType),
          {
            'format_json': {
              'letter_case': ::GustoEmbedded::Utils.field_name("withholding_pay_period"),
              'decoder': ::GustoEmbedded::Utils.open_enum_from_string(
                Models::Shared::PayrollWithholdingPayPeriodType,
                true
              )
            }
          }
        ...
        field(
          :processing_request,
          Crystalline::Nilable.new(Models::Shared::PayrollProcessingRequest),
          {'format_json': {'letter_case': ::GustoEmbedded::Utils.field_name("processing_request")}}
        )
        ...
        sig {
          params(
            payroll_deadline: T.nilable(::DateTime),
            ...
            off_cycle: T.nilable(T::Boolean),
            auto_payroll: T.nilable(T::Boolean),
            external: T.nilable(T::Boolean),
            final_termination_payroll: T.nilable(T::Boolean),
            pay_period: T.nilable(Models::Shared::PayrollPayPeriodType),
            payroll_status_meta: T.nilable(Models::Shared::PayrollPayrollStatusMetaType),
            totals: T.nilable(Models::Shared::PayrollTotalsType),
            company_taxes: T.nilable(T::Array[Models::Shared::PayrollCompanyTaxesType]),
            payroll_taxes: T.nilable(T::Array[Models::Shared::PayrollTaxesType]),
            payment_speed_changed: T.nilable(Models::Shared::PayrollPaymentSpeedChangedType),
            ...
            employee_compensations: T.nilable(T::Array[Models::Shared::EmployeeCompensations]),
            processed_date: T.nilable(::String),
            calculated_at: T.nilable(::DateTime),
            off_cycle_reason: T.nilable(Models::Shared::OffCycleReasonType),
