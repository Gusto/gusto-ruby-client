    ...
    module Shared
      ...
      class SalaryEstimate
        ...
        field(
          ...
          {
            'format_json': {
              'letter_case': ::GustoEmbedded::Utils.field_name("updated_at"),
              required: true,
              'decoder': ::GustoEmbedded::Utils.datetime_from_iso_format(false)
            }
          }
        ...
        field(
          :occupations,
          Crystalline::Array.new(Models::Shared::Occupations),
          {'format_json': {'letter_case': ::GustoEmbedded::Utils.field_name("occupations"), required: true}}
        )
        ...
        field(
          :annual_net_revenue,
          Crystalline::Nilable.new(::String),
          {'format_json': {'letter_case': ::GustoEmbedded::Utils.field_name("annual_net_revenue"), required: true}}
        )
        # The ZIP code used for location-based salary calculations.
        field(
          :zip_code,
          Crystalline::Nilable.new(::String),
          {'format_json': {'letter_case': ::GustoEmbedded::Utils.field_name("zip_code"), required: true}}
        )
        # The UUID of the employee job this salary estimate is associated with (once accepted).
        field(
          :employee_job_uuid,
          Crystalline::Nilable.new(::String),
          {'format_json': {'letter_case': ::GustoEmbedded::Utils.field_name("employee_job_uuid")}}
        )
        # The calculated reasonable salary estimate in cents. Null if not yet calculated.
        field(
          :result,
          Crystalline::Nilable.new(::Integer),
          {'format_json': {'letter_case': ::GustoEmbedded::Utils.field_name("result")}}
        )
        ...
        field(
          ...
          {
            'format_json': {
              'letter_case': ::GustoEmbedded::Utils.field_name("accepted_at"),
        ...
        sig {
          params(
            ...
            created_at: ::DateTime,
            updated_at: ::DateTime,
            occupations: T::Array[Models::Shared::Occupations],
            employee_uuid: T.nilable(::String),
            annual_net_revenue: T.nilable(::String),
            zip_code: T.nilable(::String),
            employee_job_uuid: T.nilable(::String),
            result: T.nilable(::Integer),
            accepted_at: T.nilable(::DateTime)
          )
            .void
        }
        def initialize(
          ...
          occupations:,
          employee_uuid: nil,
          annual_net_revenue: nil,
          zip_code: nil,
          employee_job_uuid: nil,
          result: nil,
          accepted_at: nil
        )
          @uuid = uuid
