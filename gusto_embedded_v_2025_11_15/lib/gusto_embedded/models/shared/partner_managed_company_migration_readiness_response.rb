    ...
    module Shared
      ...
      class PartnerManagedCompanyMigrationReadinessResponse
        ...
        field(
          ...
          {'format_json': {'letter_case': ::GustoEmbedded::Utils.field_name("ready_to_migrate")}}
        )
        # The company UUID
        field(
          :company_uuid,
        ...
        field(
          :errors,
          Crystalline::Nilable.new(Crystalline::Array.new(Models::Shared::Errors)),
          {'format_json': {'letter_case': ::GustoEmbedded::Utils.field_name("errors")}}
        )

        field(
          :warnings,
          Crystalline::Nilable.new(Crystalline::Array.new(Models::Shared::Warnings)),
          {'format_json': {'letter_case': ::GustoEmbedded::Utils.field_name("warnings")}}
        )

        sig {
          params(
            ready_to_migrate: T.nilable(T::Boolean),
            company_uuid: T.nilable(::String),
            errors: T.nilable(T::Array[Models::Shared::Errors]),
            warnings: T.nilable(T::Array[Models::Shared::Warnings])
          )
            .void
        }
