  ...
  module Models
    module Shared
      ...
      class ContractorPaymentForGroupPreview
        ...
        field(
          :payment_method,
          Crystalline::Nilable.new(Models::Shared::ContractorPaymentForGroupPreviewPaymentMethod),
          {
            'format_json': {
              'letter_case': ::GustoEmbedded::Utils.field_name("payment_method"),
              'decoder': ::GustoEmbedded::Utils.open_enum_from_string(
                Models::Shared::ContractorPaymentForGroupPreviewPaymentMethod,
                true
              )
            }
          }
        ...
        field(
          :status,
          Crystalline::Nilable.new(Models::Shared::ContractorPaymentForGroupPreviewStatus),
          {
            'format_json': {
              'letter_case': ::GustoEmbedded::Utils.field_name("status"),
              'decoder': ::GustoEmbedded::Utils.open_enum_from_string(
                Models::Shared::ContractorPaymentForGroupPreviewStatus,
                true
              )
            }
          }
        ...
        sig {
          params(
            ...
            payment_method: T.nilable(Models::Shared::ContractorPaymentForGroupPreviewPaymentMethod),
            reimbursement: T.nilable(::String),
            status: T.nilable(Models::Shared::ContractorPaymentForGroupPreviewStatus),
