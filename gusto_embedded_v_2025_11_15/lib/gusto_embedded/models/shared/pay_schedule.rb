    ...
    module Shared
      ...
      class PaySchedule
        ...
        field(
          :frequency,
          Crystalline::Nilable.new(::String),
          {'format_json': {'letter_case': ::GustoEmbedded::Utils.field_name("frequency")}}
        )
        ...
        sig {
          params(uuid: T.nilable(::String), frequency: T.nilable(::String), custom_name: T.nilable(::String)).void
        }
