...
class GustoEmbedded::Models::Shared::CompanyBenefitWithEmployeeBenefits
  ...
  def supports_percentage_amounts=(str_)
  end

  def responsible_for_employer_taxes
  end

  def responsible_for_employer_taxes=(str_)
  end

  def responsible_for_employee_w2
  end

  def responsible_for_employee_w2=(str_)
  end

  def employee_benefits
  end

  def employee_benefits=(str_)
  end
  ...
  def partner_name=(str_)
  end

  def catch_up_type
  end

  def catch_up_type=(str_)
  end
end
