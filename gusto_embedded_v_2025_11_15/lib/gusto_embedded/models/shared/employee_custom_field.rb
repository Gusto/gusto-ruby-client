    ...
    module Shared
      ...
      class EmployeeCustomField
        ...
        field(
          ...
          ::String,
          {'format_json': {'letter_case': ::GustoEmbedded::Utils.field_name("company_custom_field_id"), required: true}}
        )
        ...
        field(
          :type,
          Models::Shared::CustomFieldType,
          {
            'format_json': {
              'letter_case': ::GustoEmbedded::Utils.field_name("type"),
              required: true,
              'decoder': ::GustoEmbedded::Utils.open_enum_from_string(Models::Shared::CustomFieldType, false)
            }
          }
        )
        ...
        field(
          ...
          {'format_json': {'letter_case': ::GustoEmbedded::Utils.field_name("selection_options")}}
        )
        ...
        sig {
          params(
            ...
            name: ::String,
            type: Models::Shared::CustomFieldType,
            value: ::String,
            description: T.nilable(::String),
            selection_options: T.nilable(T::Array[::String])
          )
            .void
        }
