      ...
      class CompanyBenefitWithEmployeeBenefitsContribution
        ...
        field(
          ...
          Crystalline::Nilable.new(
            Crystalline::Union.new(::String, Models::Shared::CompanyBenefitWithEmployeeBenefitsValue2)
          ),
        ...
        sig {
          params(
            ...
            value: T.nilable(T.any(::String, Models::Shared::CompanyBenefitWithEmployeeBenefitsValue2))
          )
            .void
        }
