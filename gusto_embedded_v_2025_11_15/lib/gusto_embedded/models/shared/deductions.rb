  ...
  module Models
    module Shared
      ...
      class Deductions
        ...
        field(
          :amount_type,
          Crystalline::Nilable.new(Models::Shared::AmountType),
          {
            'format_json': {
              'letter_case': ::GustoEmbedded::Utils.field_name("amount_type"),
              'decoder': ::GustoEmbedded::Utils.open_enum_from_string(Models::Shared::AmountType, true)
            }
          }
        )
        ...
        sig {
          params(
            ...
            amount_type: T.nilable(Models::Shared::AmountType),
