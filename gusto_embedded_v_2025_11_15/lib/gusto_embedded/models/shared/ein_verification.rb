  ...
  module Models
    module Shared
      ...
      class EinVerification
        ...
        field(
          :status,
          Crystalline::Nilable.new(Models::Shared::FederalTaxDetailsStatus),
          {
            'format_json': {
              'letter_case': ::GustoEmbedded::Utils.field_name("status"),
              'decoder': ::GustoEmbedded::Utils.open_enum_from_string(Models::Shared::FederalTaxDetailsStatus, true)
            }
          }
        )
