  ...
  module Models
    module Shared
      ...
      class OnboardingStep
        ...
        field(
          :id,
          Crystalline::Nilable.new(Models::Shared::Id),
          {
            'format_json': {
              'letter_case': ::GustoEmbedded::Utils.field_name("id"),
              'decoder': ::GustoEmbedded::Utils.open_enum_from_string(Models::Shared::Id, true)
            }
          }
        )
        ...
        field(
          :skippable,
          Crystalline::Nilable.new(Crystalline::Boolean.new),
          {'format_json': {'letter_case': ::GustoEmbedded::Utils.field_name("skippable")}}
        )
        # A list of onboarding steps that are required to be completed in order to proceed with the current onboarding step.
        field(
          :requirements,
          Crystalline::Nilable.new(Crystalline::Array.new(Models::Shared::CompanyOnboardingStatusRequirements)),
        ...
        field(
          :completed_at,
          Crystalline::Nilable.new(::String),
          {'format_json': {'letter_case': ::GustoEmbedded::Utils.field_name("completed_at")}}
        )

        sig {
          params(
            title: T.nilable(::String),
            id: T.nilable(Models::Shared::Id),
            required: T.nilable(T::Boolean),
            completed: T.nilable(T::Boolean),
            skippable: T.nilable(T::Boolean),
            requirements: T.nilable(T::Array[Models::Shared::CompanyOnboardingStatusRequirements]),
