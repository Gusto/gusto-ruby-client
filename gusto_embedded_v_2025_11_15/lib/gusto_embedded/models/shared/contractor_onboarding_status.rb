  ...
  module Models
    module Shared
      ...
      class ContractorOnboardingStatus
        ...
        field(
          :onboarding_status,
          Crystalline::Nilable.new(Models::Shared::ContractorOnboardingStatusOnboardingStatus),
          {
            'format_json': {
              'letter_case': ::GustoEmbedded::Utils.field_name("onboarding_status"),
              'decoder': ::GustoEmbedded::Utils.open_enum_from_string(
                Models::Shared::ContractorOnboardingStatusOnboardingStatus,
                true
              )
            }
          }
        ...
        field(
          :onboarding_steps,
          Crystalline::Nilable.new(Crystalline::Array.new(Models::Shared::ContractorOnboardingStatusOnboardingStep)),
        ...
        sig {
          params(
            uuid: ::String,
            onboarding_status: T.nilable(Models::Shared::ContractorOnboardingStatusOnboardingStatus),
            onboarding_steps: T.nilable(T::Array[Models::Shared::ContractorOnboardingStatusOnboardingStep])
          )
            .void
        }
