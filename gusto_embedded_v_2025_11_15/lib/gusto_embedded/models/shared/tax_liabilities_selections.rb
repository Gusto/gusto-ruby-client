    ...
    module Shared
      ...
      class TaxLiabilitiesSelections
        ...
        field(
          ...
          {'format_json': {'letter_case': ::GustoEmbedded::Utils.field_name("tax_name")}}
        )
        # Possible tax liabilities selections.
        field(
          :possible_liabilities,
          Crystalline::Nilable.new(Crystalline::Array.new(Models::Shared::PossibleLiabilities)),
          {'format_json': {'letter_case': ::GustoEmbedded::Utils.field_name("possible_liabilities")}}
        )
        ...
        field(
          ...
          Crystalline::Nilable.new(::String),
          {'format_json': {'letter_case': ::GustoEmbedded::Utils.field_name("last_unpaid_external_payroll_uuid")}}
        )

        sig {
          params(
            tax_id: T.nilable(::Integer),
            tax_name: T.nilable(::String),
            possible_liabilities: T.nilable(T::Array[Models::Shared::PossibleLiabilities]),
            description: T.nilable(::String),
            last_unpaid_external_payroll_uuid: T.nilable(::String)
          )
            .void
        }
        def initialize(
