  ...
  module Models
    module Shared
      ...
      class AchTransaction
        ...
        field(
          :payment_event_type,
          Crystalline::Nilable.new(Models::Shared::PaymentEventType),
          {
            'format_json': {
              'letter_case': ::GustoEmbedded::Utils.field_name("payment_event_type"),
              'decoder': ::GustoEmbedded::Utils.open_enum_from_string(Models::Shared::PaymentEventType, true)
            }
          }
        )
        ...
        field(
          :recipient_uuid,
          Crystalline::Nilable.new(::String),
          {'format_json': {'letter_case': ::GustoEmbedded::Utils.field_name("recipient_uuid")}}
        )
        # The type of transaction associated with the ACH transaction
        field(
          :transaction_type,
          Crystalline::Nilable.new(::String),
          {'format_json': {'letter_case': ::GustoEmbedded::Utils.field_name("transaction_type")}}
        )
        # The status of the ACH transaction
        field(
          :payment_status,
          Crystalline::Nilable.new(Models::Shared::PaymentStatus),
          {
            'format_json': {
              'letter_case': ::GustoEmbedded::Utils.field_name("payment_status"),
              'decoder': ::GustoEmbedded::Utils.open_enum_from_string(Models::Shared::PaymentStatus, true)
            }
          }
        )
        ...
        field(
          :payment_direction,
          Crystalline::Nilable.new(Models::Shared::PaymentDirection),
          {
            'format_json': {
              'letter_case': ::GustoEmbedded::Utils.field_name("payment_direction"),
              'decoder': ::GustoEmbedded::Utils.open_enum_from_string(Models::Shared::PaymentDirection, true)
            }
          }
        )
        ...
        field(
          :payment_date,
          Crystalline::Nilable.new(::String),
          {'format_json': {'letter_case': ::GustoEmbedded::Utils.field_name("payment_date")}}
        )
        ...
        field(
          :error_code,
          Crystalline::Nilable.new(::String),
          {'format_json': {'letter_case': ::GustoEmbedded::Utils.field_name("error_code")}}
        )
        ...
        sig {
          params(
            ...
            payment_event_type: T.nilable(Models::Shared::PaymentEventType),
            payment_event_uuid: T.nilable(::String),
            recipient_uuid: T.nilable(::String),
            transaction_type: T.nilable(::String),
            payment_status: T.nilable(Models::Shared::PaymentStatus),
            payment_direction: T.nilable(Models::Shared::PaymentDirection),
