    ...
    module Shared
      ...
      class CreateFlowRequest
        ...
        field(
          :flow_type,
          ::String,
          {'format_json': {'letter_case': ::GustoEmbedded::Utils.field_name("flow_type"), required: true}}
        )
        ...
        field(
          :entity_type,
          Crystalline::Nilable.new(Models::Shared::CreateFlowRequestEntityType),
          {
            'format_json': {
              'letter_case': ::GustoEmbedded::Utils.field_name("entity_type"),
              'decoder': ::GustoEmbedded::Utils.enum_from_string(Models::Shared::CreateFlowRequestEntityType, true)
            }
          }
        )
        ...
        sig {
          params(
            ...
            entity_type: T.nilable(Models::Shared::CreateFlowRequestEntityType),
