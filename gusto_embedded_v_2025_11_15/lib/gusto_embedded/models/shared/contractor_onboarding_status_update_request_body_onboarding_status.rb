...
module GustoEmbedded
  module Models
    module Shared
      # ContractorOnboardingStatusUpdateRequestBodyOnboardingStatus - The updated onboarding status for the contractor.
      class ContractorOnboardingStatusUpdateRequestBodyOnboardingStatus < T::Enum
        enums do
