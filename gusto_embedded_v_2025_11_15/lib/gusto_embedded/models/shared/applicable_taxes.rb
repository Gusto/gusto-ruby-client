    ...
    module Shared
      ...
      class ApplicableTaxes
        ...
        field(
          ...
          {'format_json': {'letter_case': ::GustoEmbedded::Utils.field_name("employer_tax")}}
        )
        ...
        field(
          :resident_tax,
          Crystalline::Nilable.new(Crystalline::Boolean.new),
          {'format_json': {'letter_case': ::GustoEmbedded::Utils.field_name("resident_tax")}}
        )
        ...
        sig {
          params(
            ...
            employer_tax: T.nilable(T::Boolean),
            resident_tax: T.nilable(T::Boolean)
          )
            .void
        }
