  ...
  module Models
    module Shared
      ...
      class DocumentSigned
        ...
        field(
          :recipient_type,
          Crystalline::Nilable.new(Models::Shared::DocumentSignedRecipientType),
          {
            'format_json': {
              'letter_case': ::GustoEmbedded::Utils.field_name("recipient_type"),
              'decoder': ::GustoEmbedded::Utils.open_enum_from_string(Models::Shared::DocumentSignedRecipientType, true)
            }
          }
        )
        ...
        field(
          :pages,
          Crystalline::Nilable.new(Crystalline::Array.new(Models::Shared::DocumentSignedPages)),
          {'format_json': {'letter_case': ::GustoEmbedded::Utils.field_name("pages")}}
        )
        # List of the document's fields and associated data. Values reflect the data provided at signing.
        field(
          :fields_,
          Crystalline::Nilable.new(Crystalline::Array.new(Models::Shared::DocumentSignedFields)),
          {'format_json': {'letter_case': ::GustoEmbedded::Utils.field_name("fields")}}
        )
        ...
        field(
          ...
          {'format_json': {'letter_case': ::GustoEmbedded::Utils.field_name("requires_signing")}}
        )
        # If the document is in a draft state
        field(
          :draft,
          Crystalline::Nilable.new(Crystalline::Boolean.new),
          {'format_json': {'letter_case': ::GustoEmbedded::Utils.field_name("draft")}}
        )
        # When the document was signed (will be `null` if unsigned)
        field(
          :signed_at,
          Crystalline::Nilable.new(::String),
          {'format_json': {'letter_case': ::GustoEmbedded::Utils.field_name("signed_at")}}
        )
        # The year of this document. This value is nullable and will not be present on all documents.
        field(
          :year,
          Crystalline::Nilable.new(::Integer),
          {'format_json': {'letter_case': ::GustoEmbedded::Utils.field_name("year")}}
        )
        # The quarter of this document. This value is nullable and will not be present on all documents.
        field(
          :quarter,
          Crystalline::Nilable.new(::Integer),
          {'format_json': {'letter_case': ::GustoEmbedded::Utils.field_name("quarter")}}
        )
        ...
        sig {
          params(
            ...
            recipient_type: T.nilable(Models::Shared::DocumentSignedRecipientType),
            recipient_uuid: T.nilable(::String),
            pages: T.nilable(T::Array[Models::Shared::DocumentSignedPages]),
            fields_: T.nilable(T::Array[Models::Shared::DocumentSignedFields]),
            description: T.nilable(::String),
            requires_signing: T.nilable(T::Boolean),
            draft: T.nilable(T::Boolean),
            signed_at: T.nilable(::String),
            year: T.nilable(::Integer),
            quarter: T.nilable(::Integer)
          )
            .void
        }
        def initialize(
