    ...
    module Shared
      ...
      class ExternalPayrollUpdateRequest
        ...
        field(
          ...
          Crystalline::Array.new(Models::Shared::ExternalPayrollUpdateRequestExternalPayrollItems),
          {'format_json': {'letter_case': ::GustoEmbedded::Utils.field_name("external_payroll_items"), required: true}}
        )
        ...
        field(
          ...
          {'format_json': {'letter_case': ::GustoEmbedded::Utils.field_name("replace_fields")}}
        )

        sig {
          params(
            external_payroll_items: T::Array[Models::Shared::ExternalPayrollUpdateRequestExternalPayrollItems],
            replace_fields: T.nilable(T::Boolean)
          )
            .void
        }
