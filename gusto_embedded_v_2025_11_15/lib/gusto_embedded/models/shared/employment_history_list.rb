  ...
  module Models
    module Shared
      ...
      class EmploymentHistoryList
        ...
        field(
          :employment_status,
          Crystalline::Nilable.new(Models::Shared::EmploymentHistoryListEmploymentStatus),
          {
            'format_json': {
              'letter_case': ::GustoEmbedded::Utils.field_name("employment_status"),
              'decoder': ::GustoEmbedded::Utils.open_enum_from_string(
                Models::Shared::EmploymentHistoryListEmploymentStatus,
                true
              )
            }
          }
        ...
        field(
          :termination_date,
          Crystalline::Nilable.new(::String),
          {'format_json': {'letter_case': ::GustoEmbedded::Utils.field_name("termination_date")}}
        )
        ...
        sig {
          params(
            ...
            employment_status: T.nilable(Models::Shared::EmploymentHistoryListEmploymentStatus),
            termination_date: T.nilable(::String)
          )
            .void
        }
        def initialize(
