  ...
  module Models
    module Shared
      ...
      class FederalTaxDetails
        ...
        field(
          :filing_form,
          Crystalline::Nilable.new(Models::Shared::FilingForm),
          {
            'format_json': {
              'letter_case': ::GustoEmbedded::Utils.field_name("filing_form"),
              'decoder': ::GustoEmbedded::Utils.open_enum_from_string(Models::Shared::FilingForm, true)
            }
          }
        )
        ...
        field(
          :ein_verified,
          Crystalline::Nilable.new(Crystalline::Boolean.new),
          {'format_json': {'letter_case': ::GustoEmbedded::Utils.field_name("ein_verified")}}
        )
        # Information about the status of verifying the company's Employer Identification Number (EIN)
        field(
          :ein_verification,
          Crystalline::Nilable.new(Models::Shared::EinVerification),
          {'format_json': {'letter_case': ::GustoEmbedded::Utils.field_name("ein_verification")}}
        )
        ...
        field(
          :deposit_schedule,
          Crystalline::Nilable.new(::String),
          {'format_json': {'letter_case': ::GustoEmbedded::Utils.field_name("deposit_schedule")}}
        )
        ...
        field(
          :tax_payer_type,
          Crystalline::Nilable.new(Models::Shared::TaxPayerType),
          {
            'format_json': {
              'letter_case': ::GustoEmbedded::Utils.field_name("tax_payer_type"),
              'decoder': ::GustoEmbedded::Utils.open_enum_from_string(Models::Shared::TaxPayerType, true)
            }
          }
        )
        ...
        sig {
          params(
            ...
            filing_form: T.nilable(Models::Shared::FilingForm),
            has_ein: T.nilable(T::Boolean),
            ein_verified: T.nilable(T::Boolean),
            ein_verification: T.nilable(Models::Shared::EinVerification),
            legal_name: T.nilable(::String),
            effective_date: T.nilable(::String),
            deposit_schedule: T.nilable(::String),
            tax_payer_type: T.nilable(Models::Shared::TaxPayerType)
          )
            .void
        }
        def initialize(
          ...
          has_ein: nil,
          ein_verified: nil,
          ein_verification: nil,
          legal_name: nil,
          effective_date: nil,
          deposit_schedule: nil,
          tax_payer_type: nil
        )
          @version = version
