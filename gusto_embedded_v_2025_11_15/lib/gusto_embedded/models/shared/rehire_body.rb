  ...
  module Models
    module Shared
      ...
      class RehireBody
        ...
        field(
          :employment_status,
          Crystalline::Nilable.new(Models::Shared::RehireBodyEmploymentStatus),
          {
            'format_json': {
              'letter_case': ::GustoEmbedded::Utils.field_name("employment_status"),
              'decoder': ::GustoEmbedded::Utils.enum_from_string(Models::Shared::RehireBodyEmploymentStatus, true)
            }
          }
        )
        ...
        sig {
          params(
            ...
            employment_status: T.nilable(Models::Shared::RehireBodyEmploymentStatus),
