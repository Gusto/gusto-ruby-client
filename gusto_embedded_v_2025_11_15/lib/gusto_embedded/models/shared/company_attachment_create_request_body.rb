  ...
  module Models
    module Shared
      ...
      class CompanyAttachmentCreateRequestBody
        ...
        field(
          :document,
          Models::Shared::CompanyAttachmentCreateRequestBodyDocument,
          {'multipart_form': {'file': true, 'field_name': "document"}}
        )
        ...
        field(
          :category,
          Models::Shared::CompanyAttachmentCreateRequestBodyCategory,
          {'multipart_form': {'field_name': "category"}}
        )

        sig {
          params(
            document: Models::Shared::CompanyAttachmentCreateRequestBodyDocument,
            category: Models::Shared::CompanyAttachmentCreateRequestBodyCategory
          )
            .void
        }
