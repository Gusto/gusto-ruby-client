    ...
    module Shared
      ...
      class EmployeeBenefitCreateRequest
        ...
        field(
          ...
          ::String,
          {'format_json': {'letter_case': ::GustoEmbedded::Utils.field_name("company_benefit_uuid"), required: true}}
        )
        # An object representing the company contribution type and value.
        field(
          :contribution,
          Crystalline::Nilable.new(Models::Shared::EmployeeBenefitCreateRequestContribution),
        ...
        field(
          :limit_option,
          Crystalline::Nilable.new(Models::Shared::EmployeeBenefitCreateRequestLimitOption),
          {
            'format_json': {
              'letter_case': ::GustoEmbedded::Utils.field_name("limit_option"),
              'decoder': ::GustoEmbedded::Utils.enum_from_string(
                Models::Shared::EmployeeBenefitCreateRequestLimitOption,
                true
              )
            }
          }
        ...
        field(
          ...
          Crystalline::Nilable.new(Models::Shared::EmployeeBenefitCreateRequestDeductionReducesTaxableIncome),
          {
            'format_json': {
              'letter_case': ::GustoEmbedded::Utils.field_name("deduction_reduces_taxable_income"),
              'decoder': ::GustoEmbedded::Utils.enum_from_string(
                Models::Shared::EmployeeBenefitCreateRequestDeductionReducesTaxableIncome,
                true
              )
            }
          }
        ...
        sig {
          params(
            ...
            contribution: T.nilable(Models::Shared::EmployeeBenefitCreateRequestContribution),
            ...
            limit_option: T.nilable(Models::Shared::EmployeeBenefitCreateRequestLimitOption),
        ...
        def initialize(
          ...
          effective_date: Date.parse("1970-01-01"),
          expiration_date: nil
        )
