  ...
  module Models
    module Shared
      ...
      class PeopleBatch
        ...
        field(
          :status,
          Models::Shared::PeopleBatchStatus,
          {
            'format_json': {
              'letter_case': ::GustoEmbedded::Utils.field_name("status"),
              required: true,
              'decoder': ::GustoEmbedded::Utils.open_enum_from_string(Models::Shared::PeopleBatchStatus, false)
            }
          }
        )
        ...
        field(
          :batch_action,
          ::String,
          {'format_json': {'letter_case': ::GustoEmbedded::Utils.field_name("batch_action"), required: true}}
        )
        ...
        sig {
          params(
            ...
            status: Models::Shared::PeopleBatchStatus,
            batch_action: ::String
          )
            .void
        }
