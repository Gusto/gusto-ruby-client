    ...
    module Shared
      ...
      class Validation
        ...
        field(
          ...
          {'format_json': {'letter_case': ::GustoEmbedded::Utils.field_name("min")}}
        )
        # [for `min_max`] The inclusive upper bound of the tax rate
        field(
          :max,
          Crystalline::Nilable.new(::String),
          {'format_json': {'letter_case': ::GustoEmbedded::Utils.field_name("max")}}
        )
        ...
        field(
          ...
          {'format_json': {'letter_case': ::GustoEmbedded::Utils.field_name("rates")}}
        )
