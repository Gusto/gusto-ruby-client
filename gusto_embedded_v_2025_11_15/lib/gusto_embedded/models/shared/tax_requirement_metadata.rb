    ...
    module Shared
      ...
      class TaxRequirementMetadata
        ...
        field(
          ...
          {'format_json': {'letter_case': ::GustoEmbedded::Utils.field_name("risk_class_code")}}
        )
        ...
        field(
          ...
          Crystalline::Nilable.new(::String),
          {'format_json': {'letter_case': ::GustoEmbedded::Utils.field_name("risk_class_description")}}
        )
        ...
        field(
          :rate_type,
          Crystalline::Nilable.new(Models::Shared::RateType),
          {
            'format_json': {
              'letter_case': ::GustoEmbedded::Utils.field_name("rate_type"),
              'decoder': ::GustoEmbedded::Utils.open_enum_from_string(Models::Shared::RateType, true)
            }
          }
        )
        ...
        field(
          :validation,
          Crystalline::Nilable.new(Models::Shared::Validation),
          {'format_json': {'letter_case': ::GustoEmbedded::Utils.field_name("validation")}}
        )
        ...
        field(
          :mask,
          Crystalline::Nilable.new(::String),
          {'format_json': {'letter_case': ::GustoEmbedded::Utils.field_name("mask")}}
        )
        ...
        field(
          :prefix,
          Crystalline::Nilable.new(::String),
          {'format_json': {'letter_case': ::GustoEmbedded::Utils.field_name("prefix")}}
        )
        ...
        sig {
          params(
            ...
            validation: T.nilable(Models::Shared::Validation),
