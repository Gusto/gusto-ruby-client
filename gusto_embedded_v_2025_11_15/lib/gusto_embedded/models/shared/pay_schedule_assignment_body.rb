  ...
  module Models
    module Shared
      ...
      class PayScheduleAssignmentBody
        ...
        field(
          :type,
          Crystalline::Nilable.new(Models::Shared::PayScheduleAssignmentBodyType),
          {
            'format_json': {
              'letter_case': ::GustoEmbedded::Utils.field_name("type"),
              required: true,
              'decoder': ::GustoEmbedded::Utils.enum_from_string(Models::Shared::PayScheduleAssignmentBodyType, false)
            }
          }
        )
        ...
        field(
          ...
          {'format_json': {'letter_case': ::GustoEmbedded::Utils.field_name("hourly_pay_schedule_uuid")}}
        )
        # Pay schedule for salaried employees.
        field(
          :salaried_pay_schedule_uuid,
          Crystalline::Nilable.new(::String),
          {'format_json': {'letter_case': ::GustoEmbedded::Utils.field_name("salaried_pay_schedule_uuid")}}
        )
        # Default pay schedule for employees.
        field(
          :default_pay_schedule_uuid,
          Crystalline::Nilable.new(::String),
          {'format_json': {'letter_case': ::GustoEmbedded::Utils.field_name("default_pay_schedule_uuid")}}
        )
        ...
        field(
          ...
          {'format_json': {'letter_case': ::GustoEmbedded::Utils.field_name("partial_assignment")}}
        )
        ...
        field(
          :departments,
          Crystalline::Nilable.new(Crystalline::Array.new(Models::Shared::Departments)),
          {'format_json': {'letter_case': ::GustoEmbedded::Utils.field_name("departments")}}
        )

        sig {
          params(
            type: T.nilable(Models::Shared::PayScheduleAssignmentBodyType),
        ...
        def initialize(
          type: nil,
          hourly_pay_schedule_uuid: nil,
          salaried_pay_schedule_uuid: nil,
          default_pay_schedule_uuid: nil,
          partial_assignment: nil,
          employees: nil,
          departments: nil
        )
          @type = type
