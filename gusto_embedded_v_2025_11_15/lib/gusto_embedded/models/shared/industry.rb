    ...
    module Shared
      ...
      class Industry
        ...
        field(
          ...
          {'format_json': {'letter_case': ::GustoEmbedded::Utils.field_name("sic_codes")}}
        )
        # Industry title
        field(
          :title,
        ...
        field(
          :naics_code,
          Crystalline::Nilable.new(::String),
          {'format_json': {'letter_case': ::GustoEmbedded::Utils.field_name("naics_code")}}
        )

        sig {
          params(
            company_uuid: T.nilable(::String),
            sic_codes: T.nilable(T::Array[::String]),
