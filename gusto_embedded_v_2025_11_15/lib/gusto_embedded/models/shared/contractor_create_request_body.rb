  ...
  module Models
    module Shared
      ...
      class ContractorCreateRequestBody
        ...
        field(
          :wage_type,
          Models::Shared::ContractorCreateRequestBodyWageType,
          {
            'format_json': {
        ...
        field(
          :type,
          Crystalline::Nilable.new(Models::Shared::ContractorCreateRequestBodyType),
          {
            'format_json': {
              'letter_case': ::GustoEmbedded::Utils.field_name("type"),
              'decoder': ::GustoEmbedded::Utils.enum_from_string(Models::Shared::ContractorCreateRequestBodyType, true)
            }
          }
        )
        ...
        sig {
          params(
            wage_type: Models::Shared::ContractorCreateRequestBodyWageType,
            start_date: ::String,
            ...
            type: T.nilable(Models::Shared::ContractorCreateRequestBodyType),
        ...
        def initialize(
          ...
          ein: nil,
          is_active: nil,
          type: Models::Shared::ContractorCreateRequestBodyType::INDIVIDUAL,
