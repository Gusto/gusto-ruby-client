    ...
    module Shared
      ...
      class CompanyOnboardingStatus
        ...
        field(
          ...
          {'format_json': {'letter_case': ::GustoEmbedded::Utils.field_name("onboarding_completed")}}
        )
        # a list of company onboarding steps
        field(
          :onboarding_steps,
          Crystalline::Nilable.new(Crystalline::Array.new(Models::Shared::OnboardingStep)),
        ...
        sig {
          params(
            uuid: ::String,
            onboarding_completed: T.nilable(T::Boolean),
            onboarding_steps: T.nilable(T::Array[Models::Shared::OnboardingStep])
          )
            .void
        }
