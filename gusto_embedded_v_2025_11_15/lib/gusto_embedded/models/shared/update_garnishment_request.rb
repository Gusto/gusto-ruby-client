...
module GustoEmbedded
  module Models
    module Shared
      ...
      class UpdateGarnishmentRequest
        extend T::Sig
        ...
        field(
          ...
          {'format_json': {'letter_case': ::GustoEmbedded::Utils.field_name("court_ordered")}}
        )
        ...
        field(
          :garnishment_type,
          Crystalline::Nilable.new(Models::Shared::UpdateGarnishmentRequestGarnishmentType),
          {
            'format_json': {
              'letter_case': ::GustoEmbedded::Utils.field_name("garnishment_type"),
              'decoder': ::GustoEmbedded::Utils.enum_from_string(
                Models::Shared::UpdateGarnishmentRequestGarnishmentType,
                true
              )
            }
          }
        ...
        field(
          :recurring,
          Crystalline::Nilable.new(Crystalline::Boolean.new),
          {'format_json': {'letter_case': ::GustoEmbedded::Utils.field_name("recurring")}}
        )
        ...
        field(
          :total_amount,
          Crystalline::Nilable.new(::String),
          {'format_json': {'letter_case': ::GustoEmbedded::Utils.field_name("total_amount")}}
        )
        # Additional child support order details
        field(
          :child_support,
          Crystalline::Nilable.new(Models::Shared::GarnishmentChildSupport),
          {'format_json': {'letter_case': ::GustoEmbedded::Utils.field_name("child_support")}}
        )
        # The number of times to apply the garnishment. Ignored if recurring is true.
        field(
          :times,
          Crystalline::Nilable.new(::Integer),
          {'format_json': {'letter_case': ::GustoEmbedded::Utils.field_name("times")}}
        )
        # The maximum deduction per annum. A null value indicates no maximum. Represented as a float, e.g. "200.00".
        field(
          :annual_maximum,
          Crystalline::Nilable.new(::String),
          {'format_json': {'letter_case': ::GustoEmbedded::Utils.field_name("annual_maximum")}}
        )
        # The maximum deduction per pay period. A null value indicates no maximum. Represented as a float, e.g. "16.00".
        field(
          :pay_period_maximum,
          Crystalline::Nilable.new(::String),
          {'format_json': {'letter_case': ::GustoEmbedded::Utils.field_name("pay_period_maximum")}}
        )
        ...
        sig {
          params(
            ...
            court_ordered: T.nilable(T::Boolean),
            active: T.nilable(T::Boolean),
            garnishment_type: T.nilable(Models::Shared::UpdateGarnishmentRequestGarnishmentType),
            recurring: T.nilable(T::Boolean),
            deduct_as_percentage: T.nilable(T::Boolean),
            total_amount: T.nilable(::String),
            child_support: T.nilable(Models::Shared::GarnishmentChildSupport),
            times: T.nilable(::Integer),
            annual_maximum: T.nilable(::String),
            pay_period_maximum: T.nilable(::String)
          )
            .void
        }
        def initialize(
