  ...
  module Models
    module Shared
      ...
      class Compensation
        ...
        field(
          :payment_unit,
          Crystalline::Nilable.new(Models::Shared::PaymentUnit),
          {
            'format_json': {
              'letter_case': ::GustoEmbedded::Utils.field_name("payment_unit"),
              'decoder': ::GustoEmbedded::Utils.open_enum_from_string(Models::Shared::PaymentUnit, true)
            }
          }
        )
        ...
        field(
          :minimum_wages,
          Crystalline::Nilable.new(Crystalline::Array.new(Models::Shared::MinimumWages)),
        ...
        sig {
          params(
            ...
            payment_unit: T.nilable(Models::Shared::PaymentUnit),
            ...
            minimum_wages: T.nilable(T::Array[Models::Shared::MinimumWages])
          )
            .void
        }
        def initialize(
