    ...
    module Shared
      ...
      class RehireUpdateRequestBody
        ...
        field(
          :effective_date,
          ::String,
          {'format_json': {'letter_case': ::GustoEmbedded::Utils.field_name("effective_date"), required: true}}
        )
        ...
        field(
          ...
          {'format_json': {'letter_case': ::GustoEmbedded::Utils.field_name("file_new_hire_report"), required: true}}
        )
        # The uuid of the employee's work location.
        field(
          :work_location_uuid,
          ::String,
          {'format_json': {'letter_case': ::GustoEmbedded::Utils.field_name("work_location_uuid"), required: true}}
        )
        # The employee's employment status. Supplying an invalid option will set the employment_status to *not_set*.
        field(
          :employment_status,
          Crystalline::Nilable.new(Models::Shared::RehireUpdateRequestBodyEmploymentStatus),
          {
            'format_json': {
              'letter_case': ::GustoEmbedded::Utils.field_name("employment_status"),
              'decoder': ::GustoEmbedded::Utils.enum_from_string(
                Models::Shared::RehireUpdateRequestBodyEmploymentStatus,
                true
              )
            }
          }
        ...
        sig {
          params(
            ...
            file_new_hire_report: T::Boolean,
            work_location_uuid: ::String,
            employment_status: T.nilable(Models::Shared::RehireUpdateRequestBodyEmploymentStatus),
