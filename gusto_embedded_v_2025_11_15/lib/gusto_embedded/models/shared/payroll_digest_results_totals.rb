    ...
    module Shared
      ...
      class PayrollDigestResultsTotals
        ...
        field(
          ...
          {'format_json': {'letter_case': ::GustoEmbedded::Utils.field_name("total_debit_amount")}}
        )
        ...
        field(
          :total_employer_cost,
          Crystalline::Nilable.new(::String),
          {'format_json': {'letter_case': ::GustoEmbedded::Utils.field_name("total_employer_cost")}}
        )

        sig {
          params(
            total_debit_amount: T.nilable(::String),
            net_pay: T.nilable(::String),
            total_employer_cost: T.nilable(::String)
          )
            .void
        }
