  ...
  module Models
    module Shared
      ...
      class PayrollBatch
        ...
        field(
          :status,
          Models::Shared::PayrollBatchStatus,
          {
            'format_json': {
              'letter_case': ::GustoEmbedded::Utils.field_name("status"),
              required: true,
              'decoder': ::GustoEmbedded::Utils.open_enum_from_string(Models::Shared::PayrollBatchStatus, false)
            }
          }
        )
        ...
        sig {
          params(
            ...
            status: Models::Shared::PayrollBatchStatus
          )
            .void
        }
