    ...
    module Shared
      ...
      class ActiveCompanies
        ...
        field(
          ...
          {'format_json': {'letter_case': ::GustoEmbedded::Utils.field_name("active_employees")}}
        )
        ...
        field(
          :active_contractors,
          Crystalline::Nilable.new(::Integer),
          {'format_json': {'letter_case': ::GustoEmbedded::Utils.field_name("active_contractors")}}
        )
        ...
        field(
          ...
          Crystalline::Nilable.new(::String),
          {'format_json': {'letter_case': ::GustoEmbedded::Utils.field_name("initial_invoice_period")}}
        )

        sig {
          params(
            company_uuid: T.nilable(::String),
            active_employees: T.nilable(::Integer),
            active_contractors: T.nilable(::Integer),
            initial_invoice_period: T.nilable(::String)
          )
            .void
        }
