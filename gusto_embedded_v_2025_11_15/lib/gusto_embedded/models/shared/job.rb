    ...
    module Shared
      ...
      class Job
        ...
        field(
          ...
          {'format_json': {'letter_case': ::GustoEmbedded::Utils.field_name("primary")}}
        )
        ...
        field(
          :compensations,
          Crystalline::Nilable.new(Crystalline::Array.new(Models::Shared::Compensation)),
        ...
        field(
          :location_uuid,
          Crystalline::Nilable.new(::String),
          {'format_json': {'letter_case': ::GustoEmbedded::Utils.field_name("location_uuid")}}
        )
        # The representation of an address in Gusto.
        field(
          :location,
          Crystalline::Nilable.new(Models::Shared::Location),
          {'format_json': {'letter_case': ::GustoEmbedded::Utils.field_name("location")}}
        )
