    ...
    module Shared
      ...
      class CompanyBenefitWithEmployeeBenefitsValueTiers
        ...
        field(
          :threshold_delta,
          Crystalline::Nilable.new(::String),
          {'format_json': {'letter_case': ::GustoEmbedded::Utils.field_name("threshold_delta")}}
        )

        sig {
          params(rate: T.nilable(::String), threshold: T.nilable(::String), threshold_delta: T.nilable(::String)).void
        }
