  ...
  module Models
    module Shared
      ...
      class PayrollUpdateDeductions
        ...
        field(
          :amount_type,
          Crystalline::Nilable.new(Models::Shared::PayrollUpdateAmountType),
          {
            'format_json': {
              'letter_case': ::GustoEmbedded::Utils.field_name("amount_type"),
              'decoder': ::GustoEmbedded::Utils.enum_from_string(Models::Shared::PayrollUpdateAmountType, true)
            }
          }
        )
        ...
        sig {
          params(
            ...
            amount_type: T.nilable(Models::Shared::PayrollUpdateAmountType),
