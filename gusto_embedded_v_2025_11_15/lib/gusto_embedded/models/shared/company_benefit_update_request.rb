  ...
  module Models
    module Shared
      ...
      class CompanyBenefitUpdateRequest
        ...
        field(
          :catch_up_type,
          Crystalline::Nilable.new(Models::Shared::CompanyBenefitUpdateRequestCatchUpType),
          {
            'format_json': {
              'letter_case': ::GustoEmbedded::Utils.field_name("catch_up_type"),
              'decoder': ::GustoEmbedded::Utils.enum_from_string(
                Models::Shared::CompanyBenefitUpdateRequestCatchUpType,
                true
              )
            }
          }
        ...
        sig {
          params(
            ...
            catch_up_type: T.nilable(Models::Shared::CompanyBenefitUpdateRequestCatchUpType)
          )
            .void
        }
        def initialize(
