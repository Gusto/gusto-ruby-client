    ...
    module Shared
      ...
      class Signatory
        ...
        field(
          ...
          {'format_json': {'letter_case': ::GustoEmbedded::Utils.field_name("is_admin")}}
        )
        ...
        field(
          :birthday,
          Crystalline::Nilable.new(::String),
          {'format_json': {'letter_case': ::GustoEmbedded::Utils.field_name("birthday")}}
        )
        # |   |   |
        # |---|---|
        ...
        field(
          ...
          Crystalline::Nilable.new(Models::Shared::IdentityVerificationStatus),
          {
            'format_json': {
              'letter_case': ::GustoEmbedded::Utils.field_name("identity_verification_status"),
              'decoder': ::GustoEmbedded::Utils.open_enum_from_string(Models::Shared::IdentityVerificationStatus, true)
            }
          }
        )
        ...
        def initialize(
          ...
          phone: nil,
          birthday: nil,
          identity_verification_status: nil,
          home_address: nil
        )
          @uuid = uuid
          @email = email
