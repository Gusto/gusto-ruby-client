    ...
    module Shared
      ...
      class EmployeeStateTaxQuestion
        ...
        field(
          ...
          {
            'format_json': {
              'letter_case': ::GustoEmbedded::Utils.field_name("is_question_for_admin_only"),
              required: true
            }
          }
        )
        ...
        field(
          ...
          Models::Shared::EmployeeStateTaxInputQuestionFormat,
          {'format_json': {'letter_case': ::GustoEmbedded::Utils.field_name("input_question_format"), required: true}}
        )

        field(
          :answers,
          Crystalline::Array.new(Models::Shared::EmployeeStateTaxAnswer),
          {'format_json': {'letter_case': ::GustoEmbedded::Utils.field_name("answers"), required: true}}
        )
        ...
        sig {
          params(
            label: ::String,
            key: ::String,
            is_question_for_admin_only: T::Boolean,
            input_question_format: Models::Shared::EmployeeStateTaxInputQuestionFormat,
            answers: T::Array[Models::Shared::EmployeeStateTaxAnswer],
