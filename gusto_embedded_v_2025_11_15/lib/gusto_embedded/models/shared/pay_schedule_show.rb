  ...
  module Models
    module Shared
      ...
      class PayScheduleShow
        ...
        field(
          :frequency,
          Crystalline::Nilable.new(Models::Shared::PayScheduleFrequency),
          {
            'format_json': {
              'letter_case': ::GustoEmbedded::Utils.field_name("frequency"),
              'decoder': ::GustoEmbedded::Utils.open_enum_from_string(Models::Shared::PayScheduleFrequency, true)
            }
          }
        )
        ...
        sig {
          params(
            uuid: ::String,
            version: ::String,
            frequency: T.nilable(Models::Shared::PayScheduleFrequency),
            anchor_pay_date: T.nilable(::Date),
            anchor_end_of_pay_period: T.nilable(::Date),
