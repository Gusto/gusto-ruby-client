  ...
  module Models
    module Shared
      ...
      class TimeOffPolicy
        ...
        field(
          :policy_type,
          Models::Shared::PolicyType,
          {
            'format_json': {
              'letter_case': ::GustoEmbedded::Utils.field_name("policy_type"),
              required: true,
              'decoder': ::GustoEmbedded::Utils.open_enum_from_string(Models::Shared::PolicyType, false)
            }
          }
        )
        ...
        field(
          :accrual_method,
          ::String,
          {'format_json': {'letter_case': ::GustoEmbedded::Utils.field_name("accrual_method"), required: true}}
        )
        # boolean representing if a policy is active or not
        field(
          :is_active,
          Crystalline::Boolean.new,
          {'format_json': {'letter_case': ::GustoEmbedded::Utils.field_name("is_active"), required: true}}
        )
        # List of employee UUIDs under a time off policy
        field(
          :employees,
          Crystalline::Array.new(Models::Shared::TimeOffPolicyEmployees),
        ...
        sig {
          params(
            ...
            company_uuid: ::String,
            name: ::String,
            policy_type: Models::Shared::PolicyType,
            accrual_method: ::String,
            is_active: T::Boolean,
            employees: T::Array[Models::Shared::TimeOffPolicyEmployees],
