  ...
  module Models
    module Shared
      ...
      class TimeOffActivity
        ...
        field(
          :time_off_type,
          Crystalline::Nilable.new(Models::Shared::TimeOffType),
          {
            'format_json': {
              'letter_case': ::GustoEmbedded::Utils.field_name("time_off_type"),
              'decoder': ::GustoEmbedded::Utils.open_enum_from_string(Models::Shared::TimeOffType, true)
            }
          }
        )
        ...
        field(
          ...
          {'format_json': {'letter_case': ::GustoEmbedded::Utils.field_name("event_type")}}
        )
        ...
        field(
          :event_description,
          Crystalline::Nilable.new(::String),
          {'format_json': {'letter_case': ::GustoEmbedded::Utils.field_name("event_description")}}
        )
        # The datetime of the time off activity
        field(
          :effective_time,
          Crystalline::Nilable.new(::String),
          {'format_json': {'letter_case': ::GustoEmbedded::Utils.field_name("effective_time")}}
        )
        ...
        field(
          :balance_change,
          Crystalline::Nilable.new(::String),
          {'format_json': {'letter_case': ::GustoEmbedded::Utils.field_name("balance_change")}}
        )

        sig {
          params(
            time_off_type: T.nilable(Models::Shared::TimeOffType),
            event_type: T.nilable(::String),
            policy_uuid: T.nilable(::String),
            policy_name: T.nilable(::String),
            event_description: T.nilable(::String),
            effective_time: T.nilable(::String),
            balance: T.nilable(::String),
            balance_change: T.nilable(::String)
          )
            .void
        }
        def initialize(
