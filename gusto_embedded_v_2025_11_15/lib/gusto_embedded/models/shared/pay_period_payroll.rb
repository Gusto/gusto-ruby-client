  ...
  module Models
    module Shared
      ...
      class PayPeriodPayroll
        ...
        field(
          :payroll_type,
          Crystalline::Nilable.new(Models::Shared::PayrollType),
          {
            'format_json': {
              'letter_case': ::GustoEmbedded::Utils.field_name("payroll_type"),
              'decoder': ::GustoEmbedded::Utils.open_enum_from_string(Models::Shared::PayrollType, true)
            }
          }
        )
        ...
        sig {
          params(
            ...
            payroll_type: T.nilable(Models::Shared::PayrollType)
          )
            .void
        }
