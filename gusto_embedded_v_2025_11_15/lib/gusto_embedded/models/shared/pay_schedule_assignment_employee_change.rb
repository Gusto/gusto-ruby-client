    ...
    module Shared
      ...
      class PayScheduleAssignmentEmployeeChange
        ...
        field(
          :pay_frequency,
          Crystalline::Nilable.new(::String),
          {'format_json': {'letter_case': ::GustoEmbedded::Utils.field_name("pay_frequency")}}
        )
        # Pay schedule assignment first pay period information.
        field(
          :first_pay_period,
          Crystalline::Nilable.new(Models::Shared::PayScheduleAssignmentPayPeriod),
          {'format_json': {'letter_case': ::GustoEmbedded::Utils.field_name("first_pay_period")}}
        )
        # Pay schedule assignment transition pay period information.
        field(
          :transition_pay_period,
          Crystalline::Nilable.new(Models::Shared::PayScheduleAssignmentTransitionPayPeriod),
          {'format_json': {'letter_case': ::GustoEmbedded::Utils.field_name("transition_pay_period")}}
        )
        ...
        sig {
          params(
            ...
            pay_frequency: T.nilable(::String),
            first_pay_period: T.nilable(Models::Shared::PayScheduleAssignmentPayPeriod),
            transition_pay_period: T.nilable(Models::Shared::PayScheduleAssignmentTransitionPayPeriod)
          )
            .void
        }
        def initialize(
