  ...
  module Models
    module Shared
      ...
      class ContractorPaymentGroup
        ...
        field(
          :status,
          Crystalline::Nilable.new(Models::Shared::ContractorPaymentGroupStatus),
          {
            'format_json': {
              'letter_case': ::GustoEmbedded::Utils.field_name("status"),
              'decoder': ::GustoEmbedded::Utils.open_enum_from_string(
                Models::Shared::ContractorPaymentGroupStatus,
                true
              )
            }
          }
        ...
        field(
          :totals,
          Crystalline::Nilable.new(Models::Shared::ContractorPaymentGroupTotals),
          {'format_json': {'letter_case': ::GustoEmbedded::Utils.field_name("totals")}}
        )

        field(
          :contractor_payments,
          Crystalline::Nilable.new(Crystalline::Array.new(Models::Shared::ContractorPaymentForGroup)),
        ...
        sig {
          params(
            ...
            status: T.nilable(Models::Shared::ContractorPaymentGroupStatus),
            ...
            totals: T.nilable(Models::Shared::ContractorPaymentGroupTotals),
            contractor_payments: T.nilable(T::Array[Models::Shared::ContractorPaymentForGroup]),
