    ...
    module Shared
      ...
      class I9Authorization
        ...
        field(
          ...
          Models::Shared::AuthorizationStatus,
          {
            'format_json': {
              'letter_case': ::GustoEmbedded::Utils.field_name("authorization_status"),
              required: true,
              'decoder': ::GustoEmbedded::Utils.open_enum_from_string(Models::Shared::AuthorizationStatus, false)
            }
          }
        )
        ...
        field(
          ...
          {'format_json': {'letter_case': ::GustoEmbedded::Utils.field_name("employer_signed"), required: true}}
        )
        # Whether the employee has signed the Form I-9
        field(
          :employee_signed,
          Crystalline::Boolean.new,
          {'format_json': {'letter_case': ::GustoEmbedded::Utils.field_name("employee_signed"), required: true}}
        )
        ...
        field(
          ...
          {'format_json': {'letter_case': ::GustoEmbedded::Utils.field_name("form_uuid")}}
        )
        # The document's document type
        field(
          :document_type,
          Crystalline::Nilable.new(Models::Shared::DocumentType),
          {
            'format_json': {
              'letter_case': ::GustoEmbedded::Utils.field_name("document_type"),
              'decoder': ::GustoEmbedded::Utils.open_enum_from_string(Models::Shared::DocumentType, true)
            }
          }
        )
        ...
        field(
          ...
          {'format_json': {'letter_case': ::GustoEmbedded::Utils.field_name("has_document_number")}}
        )
        ...
        sig {
          params(
            uuid: ::String,
            version: ::String,
            authorization_status: Models::Shared::AuthorizationStatus,
            employer_signed: T::Boolean,
            employee_signed: T::Boolean,
            form_uuid: T.nilable(::String),
            document_type: T.nilable(Models::Shared::DocumentType),
            has_document_number: T.nilable(T::Boolean),
