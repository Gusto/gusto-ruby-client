  ...
  module Models
    module Shared
      ...
      class PayrollDigestResults
        ...
        field(
          :status,
          Models::Shared::PayrollDigestResultsStatus,
          {
            'format_json': {
              'letter_case': ::GustoEmbedded::Utils.field_name("status"),
              required: true,
              'decoder': ::GustoEmbedded::Utils.open_enum_from_string(Models::Shared::PayrollDigestResultsStatus, false)
            }
          }
        )
        ...
        field(
          :results,
          Crystalline::Nilable.new(Crystalline::Array.new(Models::Shared::PayrollDigestResultsResults)),
        ...
        field(
          :exclusions,
          Crystalline::Nilable.new(Crystalline::Array.new(Models::Shared::PayrollDigestResultsExclusions)),
        ...
        sig {
          params(
            ...
            status: Models::Shared::PayrollDigestResultsStatus,
            submitted_at: ::DateTime,
            processed_items: T.nilable(::Integer),
            excluded_items: T.nilable(::Integer),
            results: T.nilable(T::Array[Models::Shared::PayrollDigestResultsResults]),
            exclusions: T.nilable(T::Array[Models::Shared::PayrollDigestResultsExclusions]),
