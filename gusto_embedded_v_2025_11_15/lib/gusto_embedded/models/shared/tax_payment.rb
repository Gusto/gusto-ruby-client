    ...
    module Shared
      ...
      class TaxPayment
        ...
        field(
          :agency_name,
          ::String,
          {'format_json': {'letter_case': ::GustoEmbedded::Utils.field_name("agency_name"), required: true}}
        )
        # The tax jurisdiction this payment is for. A two-letter state code, or US for federal.
        field(
          :jurisdiction,
          ::String,
          {'format_json': {'letter_case': ::GustoEmbedded::Utils.field_name("jurisdiction"), required: true}}
        )
        ...
        field(
          ...
          {
            'format_json': {
              'letter_case': ::GustoEmbedded::Utils.field_name("period_end"),
              required: true,
        ...
        field(
          :amount_paid,
          ::String,
          {'format_json': {'letter_case': ::GustoEmbedded::Utils.field_name("amount_paid"), required: true}}
        )
        ...
        field(
          ...
          {
            'format_json': {
              'letter_case': ::GustoEmbedded::Utils.field_name("period_start"),
              required: true,
              'decoder': ::GustoEmbedded::Utils.date_from_iso_format(false)
            }
          }
        ...
        field(
          ...
          {
            'format_json': {
              'letter_case': ::GustoEmbedded::Utils.field_name("due_date"),
              required: true,
              'decoder': ::GustoEmbedded::Utils.date_from_iso_format(false)
            }
          }
        ...
        field(
          :line_items,
          Crystalline::Nilable.new(Crystalline::Array.new(Models::Shared::TaxPaymentLineItem)),
          {'format_json': {'letter_case': ::GustoEmbedded::Utils.field_name("line_items")}}
        )
        ...
        field(
          ...
          {
            'format_json': {
              'letter_case': ::GustoEmbedded::Utils.field_name("payment_sent_on"),
        ...
        sig {
          params(
            ...
            amount: ::String,
            amount_paid: ::String,
            period_start: T.nilable(::Date),
            due_date: T.nilable(::Date),
            line_items: T.nilable(T::Array[Models::Shared::TaxPaymentLineItem]),
            payment_sent_on: T.nilable(::Date)
          )
            .void
        }
        def initialize(
