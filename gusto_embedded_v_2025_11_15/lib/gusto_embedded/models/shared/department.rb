  ...
  module Models
    module Shared
      ...
      class Department
        ...
        field(
          :employees,
          Crystalline::Nilable.new(Crystalline::Array.new(Models::Shared::DepartmentEmployees)),
          {'format_json': {'letter_case': ::GustoEmbedded::Utils.field_name("employees")}}
        )
        # Array of contractors assigned to the department.
        field(
          :contractors,
          Crystalline::Nilable.new(Crystalline::Array.new(Models::Shared::Contractors)),
        ...
        sig {
          params(
            ...
            employees: T.nilable(T::Array[Models::Shared::DepartmentEmployees]),
            contractors: T.nilable(T::Array[Models::Shared::Contractors])
          )
            .void
        }
