  ...
  module Models
    module Shared
      ...
      class Notification
        ...
        field(
          :status,
          Models::Shared::NotificationStatus,
          {
            'format_json': {
              'letter_case': ::GustoEmbedded::Utils.field_name("status"),
              required: true,
              'decoder': ::GustoEmbedded::Utils.open_enum_from_string(Models::Shared::NotificationStatus, false)
            }
          }
        )
        ...
        field(
          ...
          {'format_json': {'letter_case': ::GustoEmbedded::Utils.field_name("actionable"), required: true}}
        )
        ...
        field(
          :can_block_payroll,
          Crystalline::Boolean.new,
          {'format_json': {'letter_case': ::GustoEmbedded::Utils.field_name("can_block_payroll"), required: true}}
        )
        # Timestamp of when the notification was published.
        field(
          :published_at,
          ::String,
          {'format_json': {'letter_case': ::GustoEmbedded::Utils.field_name("published_at"), required: true}}
        )
        # An array of entities relevant to the notification
        field(
          :resources,
          Crystalline::Array.new(Models::Shared::Resources),
          {'format_json': {'letter_case': ::GustoEmbedded::Utils.field_name("resources"), required: true}}
        )
        ...
        field(
          ...
          {'format_json': {'letter_case': ::GustoEmbedded::Utils.field_name("due_at"), required: true}}
        )
        ...
        field(
          ...
          {'format_json': {'letter_case': ::GustoEmbedded::Utils.field_name("template_variables")}}
        )
        ...
        sig {
          params(
            ...
            title: ::String,
            message: ::String,
            status: Models::Shared::NotificationStatus,
            category: ::String,
            actionable: T::Boolean,
            can_block_payroll: T::Boolean,
            published_at: ::String,
            resources: T::Array[Models::Shared::Resources],
            due_at: T.nilable(::String),
