    ...
    module Shared
      ...
      class SupportedBenefit
        ...
        field(
          ...
          {'format_json': {'letter_case': ::GustoEmbedded::Utils.field_name("pretax")}}
        )
        # Whether the benefit is deducted after tax calculations.
        field(
          :posttax,
          Crystalline::Nilable.new(Crystalline::Boolean.new),
          {'format_json': {'letter_case': ::GustoEmbedded::Utils.field_name("posttax")}}
        )
        # Whether the benefit is considered imputed income.
        field(
          :imputed,
          Crystalline::Nilable.new(Crystalline::Boolean.new),
          {'format_json': {'letter_case': ::GustoEmbedded::Utils.field_name("imputed")}}
        )
        # Whether the benefit is healthcare related.
        field(
          :healthcare,
          Crystalline::Nilable.new(Crystalline::Boolean.new),
          {'format_json': {'letter_case': ::GustoEmbedded::Utils.field_name("healthcare")}}
        )
        # Whether the benefit is associated with retirement planning.
        field(
          :retirement,
          Crystalline::Nilable.new(Crystalline::Boolean.new),
          {'format_json': {'letter_case': ::GustoEmbedded::Utils.field_name("retirement")}}
        )
        ...
        field(
          :yearly_limit,
          Crystalline::Nilable.new(Crystalline::Boolean.new),
          {'format_json': {'letter_case': ::GustoEmbedded::Utils.field_name("yearly_limit")}}
        )
        ...
        field(
          ...
          Crystalline::Nilable.new(Crystalline::Boolean.new),
          {'format_json': {'letter_case': ::GustoEmbedded::Utils.field_name("writable_by_application")}}
        )
        ...
        sig {
          params(
            ...
            pretax: T.nilable(T::Boolean),
            posttax: T.nilable(T::Boolean),
            imputed: T.nilable(T::Boolean),
            healthcare: T.nilable(T::Boolean),
            retirement: T.nilable(T::Boolean),
            yearly_limit: T.nilable(T::Boolean),
            category: T.nilable(::String),
            writable_by_application: T.nilable(T::Boolean)
          )
            .void
        }
        def initialize(
