  ...
  module Models
    module Shared
      ...
      class EmployeeMemberPortalInvitationStatus
        ...
        field(
          :status,
          Crystalline::Nilable.new(Models::Shared::EmployeeStatus),
          {
            'format_json': {
              'letter_case': ::GustoEmbedded::Utils.field_name("status"),
              'decoder': ::GustoEmbedded::Utils.open_enum_from_string(Models::Shared::EmployeeStatus, true)
            }
          }
        )
        ...
        sig {
          params(
            status: T.nilable(Models::Shared::EmployeeStatus),
