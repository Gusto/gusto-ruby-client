  ...
  module Models
    module Shared
      ...
      class BulkReportGeneralLedgerItem
        ...
        field(
          :report_type,
          Models::Shared::BulkReportGeneralLedgerItemReportType,
          {
            'format_json': {
        ...
        field(
          ...
          {'format_json': {'letter_case': ::GustoEmbedded::Utils.field_name("integration_type")}}
        )

        sig {
          params(
            company_uuid: ::String,
            report_type: Models::Shared::BulkReportGeneralLedgerItemReportType,
            payroll_uuid: ::String,
            aggregation: Models::Shared::Aggregation,
            integration_type: T.nilable(::String)
          )
            .void
        }
