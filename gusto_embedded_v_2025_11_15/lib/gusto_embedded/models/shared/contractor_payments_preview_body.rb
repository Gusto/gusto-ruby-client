  ...
  module Models
    module Shared
      ...
      class ContractorPaymentsPreviewBody
        ...
        field(
          :contractor_payments,
          Crystalline::Array.new(Models::Shared::ContractorPaymentsPreviewBodyContractorPayments),
          {'format_json': {'letter_case': ::GustoEmbedded::Utils.field_name("contractor_payments"), required: true}}
        )

        sig {
          params(contractor_payments: T::Array[Models::Shared::ContractorPaymentsPreviewBodyContractorPayments]).void
        }
