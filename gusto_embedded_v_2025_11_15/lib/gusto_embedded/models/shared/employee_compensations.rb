    ...
    module Shared
      ...
      class EmployeeCompensations
        ...
        field(
          ...
          Crystalline::Nilable.new(Crystalline::Array.new(Models::Shared::PayrollShowHourlyCompensations)),
        ...
        field(
          :paid_time_off,
          Crystalline::Nilable.new(Crystalline::Array.new(Models::Shared::PayrollShowPaidTimeOff)),
        ...
        field(
          :deductions,
          Crystalline::Nilable.new(Crystalline::Array.new(Models::Shared::PayrollShowDeductions)),
        ...
        field(
          :taxes,
          Crystalline::Nilable.new(Crystalline::Array.new(Models::Shared::PayrollShowTaxes)),
        ...
        field(
          :payment_method,
          Crystalline::Nilable.new(Models::Shared::PayrollShowPaymentMethod),
          {
            'format_json': {
              'letter_case': ::GustoEmbedded::Utils.field_name("payment_method"),
              'decoder': ::GustoEmbedded::Utils.open_enum_from_string(Models::Shared::PayrollShowPaymentMethod, true)
            }
          }
        )
        ...
        sig {
          params(
            ...
            fixed_compensations: T.nilable(T::Array[Models::Shared::PayrollShowFixedCompensations]),
            ...
            payment_method: T.nilable(Models::Shared::PayrollShowPaymentMethod),
