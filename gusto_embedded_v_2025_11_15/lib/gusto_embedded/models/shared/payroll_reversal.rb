    ...
    module Shared
      ...
      class PayrollReversal
        ...
        field(
          ...
          {'format_json': {'letter_case': ::GustoEmbedded::Utils.field_name("reversed_payroll_uuid")}}
        )
        ...
        field(
          ...
          {'format_json': {'letter_case': ::GustoEmbedded::Utils.field_name("reversed_employee_uuids")}}
        )
        # The UUID of the payroll where the reversal was applied.
        field(
          :reversal_payroll_uuid,
          Crystalline::Nilable.new(::String),
          {'format_json': {'letter_case': ::GustoEmbedded::Utils.field_name("reversal_payroll_uuid")}}
        )
        # Timestamp of when the reversal was approved.
        field(
          :approved_at,
          Crystalline::Nilable.new(::String),
          {'format_json': {'letter_case': ::GustoEmbedded::Utils.field_name("approved_at")}}
        )
        ...
        sig {
          params(
            reversed_payroll_uuid: T.nilable(::String),
            reason: T.nilable(::String),
            reversed_employee_uuids: T.nilable(T::Array[::String]),
            reversal_payroll_uuid: T.nilable(::String),
        ...
        def initialize(
          reversed_payroll_uuid: nil,
          reason: nil,
          reversed_employee_uuids: nil,
          reversal_payroll_uuid: nil,
          approved_at: nil,
          category: nil
        )
