    ...
    module Shared
      ...
      class ContractorPaymentReceipt
        ...
        field(
          ...
          {'format_json': {'letter_case': ::GustoEmbedded::Utils.field_name("contractor_payment_uuid")}}
        )
        ...
        field(
          ...
          {
            'format_json': {
              'letter_case': ::GustoEmbedded::Utils.field_name("debit_date"),
        ...
        field(
          :totals,
          Crystalline::Nilable.new(Models::Shared::ContractorPaymentReceiptTotals),
