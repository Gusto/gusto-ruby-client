  ...
  module Models
    module Shared
      ...
      class TaxRequirementsState
        ...
        field(
          :requirement_sets,
          Crystalline::Nilable.new(Crystalline::Array.new(Models::Shared::TaxRequirementSet)),
          {'format_json': {'letter_case': ::GustoEmbedded::Utils.field_name("requirement_sets")}}
        )
        ...
        sig {
          params(
            ...
            requirement_sets: T.nilable(T::Array[Models::Shared::TaxRequirementSet])
          )
            .void
        }
