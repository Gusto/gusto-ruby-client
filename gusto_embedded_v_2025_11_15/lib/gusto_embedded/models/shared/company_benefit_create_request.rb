  ...
  module Models
    module Shared
      ...
      class CompanyBenefitCreateRequest
        ...
        field(
          :catch_up_type,
          Crystalline::Nilable.new(Models::Shared::CompanyBenefitCreateRequestCatchUpType),
          {
            'format_json': {
              'letter_case': ::GustoEmbedded::Utils.field_name("catch_up_type"),
              'decoder': ::GustoEmbedded::Utils.enum_from_string(
                Models::Shared::CompanyBenefitCreateRequestCatchUpType,
                true
              )
            }
          }
        ...
        sig {
          params(
            ...
            catch_up_type: T.nilable(Models::Shared::CompanyBenefitCreateRequestCatchUpType)
          )
            .void
        }
        def initialize(
