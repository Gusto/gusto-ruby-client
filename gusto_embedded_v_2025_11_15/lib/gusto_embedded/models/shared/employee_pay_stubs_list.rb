  ...
  module Models
    module Shared
      ...
      class EmployeePayStubsList
        ...
        field(
          :payment_method,
          Crystalline::Nilable.new(Models::Shared::EmployeePayStubsListPaymentMethod),
          {
            'format_json': {
              'letter_case': ::GustoEmbedded::Utils.field_name("payment_method"),
              'decoder': ::GustoEmbedded::Utils.open_enum_from_string(
                Models::Shared::EmployeePayStubsListPaymentMethod,
                true
              )
            }
          }
        ...
        sig {
          params(
            ...
            payment_method: T.nilable(Models::Shared::EmployeePayStubsListPaymentMethod)
          )
            .void
        }
        def initialize(
