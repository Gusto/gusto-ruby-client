      ...
      class PayrollEmployeeCompensationsType
        ...
        field(
          ...
          Crystalline::Nilable.new(
            Crystalline::Array.new(Models::Shared::PayrollEmployeeCompensationsTypeFixedCompensations)
          ),
        ...
        field(
          ...
          Crystalline::Nilable.new(
            Crystalline::Array.new(Models::Shared::PayrollEmployeeCompensationsTypeHourlyCompensations)
          ),
        ...
        field(
          :paid_time_off,
          Crystalline::Nilable.new(Crystalline::Array.new(Models::Shared::PayrollEmployeeCompensationsTypePaidTimeOff)),
        ...
        field(
          :reimbursements,
          Crystalline::Nilable.new(
            Crystalline::Array.new(Models::Shared::PayrollEmployeeCompensationsTypeReimbursements)
          ),
        ...
        field(
          :deductions,
          Crystalline::Nilable.new(Crystalline::Array.new(Models::Shared::Deductions)),
        ...
        field(
          :payment_method,
          Crystalline::Nilable.new(Models::Shared::PayrollEmployeeCompensationsTypePaymentMethod),
          {
            'format_json': {
              'letter_case': ::GustoEmbedded::Utils.field_name("payment_method"),
              'decoder': ::GustoEmbedded::Utils.open_enum_from_string(
                Models::Shared::PayrollEmployeeCompensationsTypePaymentMethod,
                true
              )
            }
          }
        ...
        sig {
          params(
            ...
            fixed_compensations: T.nilable(T::Array[Models::Shared::PayrollEmployeeCompensationsTypeFixedCompensations]),
            hourly_compensations: T.nilable(
              T::Array[Models::Shared::PayrollEmployeeCompensationsTypeHourlyCompensations]
            ),
            paid_time_off: T.nilable(T::Array[Models::Shared::PayrollEmployeeCompensationsTypePaidTimeOff]),
            reimbursements: T.nilable(T::Array[Models::Shared::PayrollEmployeeCompensationsTypeReimbursements]),
            version: T.nilable(::Object),
            deductions: T.nilable(T::Array[Models::Shared::Deductions]),
            ...
            payment_method: T.nilable(Models::Shared::PayrollEmployeeCompensationsTypePaymentMethod),
