  ...
  module Models
    module Shared
      ...
      class Employee
        ...
        field(
          :onboarding_status,
          Crystalline::Nilable.new(Models::Shared::EmployeeOnboardingStatus1),
          {
            'format_json': {
              'letter_case': ::GustoEmbedded::Utils.field_name("onboarding_status"),
              'decoder': ::GustoEmbedded::Utils.open_enum_from_string(Models::Shared::EmployeeOnboardingStatus1, true)
            }
          }
        )
        ...
        field(
          :payment_method,
          Crystalline::Nilable.new(Models::Shared::EmployeePaymentMethod1),
          {
            'format_json': {
              'letter_case': ::GustoEmbedded::Utils.field_name("payment_method"),
              'decoder': ::GustoEmbedded::Utils.open_enum_from_string(Models::Shared::EmployeePaymentMethod1, true)
            }
          }
        )
        ...
        field(
          ...
          Crystalline::Nilable.new(Models::Shared::EmployeeMemberPortalInvitationStatus),
        ...
        sig {
          params(
            ...
            onboarding_status: T.nilable(Models::Shared::EmployeeOnboardingStatus1),
        ...
        def initialize(
          ...
          payment_method: Models::Shared::EmployeePaymentMethod1::CHECK,
