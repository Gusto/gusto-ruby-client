  ...
  module Models
    module Shared
      ...
      class TimeOffPolicyRequest
        ...
        field(
          :policy_type,
          Models::Shared::TimeOffPolicyRequestPolicyType,
          {
            'format_json': {
              'letter_case': ::GustoEmbedded::Utils.field_name("policy_type"),
              required: true,
              'decoder': ::GustoEmbedded::Utils.enum_from_string(Models::Shared::TimeOffPolicyRequestPolicyType, false)
            }
          }
        )
        ...
        field(
          :accrual_method,
          Models::Shared::AccrualMethod,
          {
            'format_json': {
              'letter_case': ::GustoEmbedded::Utils.field_name("accrual_method"),
              required: true,
              'decoder': ::GustoEmbedded::Utils.enum_from_string(Models::Shared::AccrualMethod, false)
            }
          }
        )
        ...
        sig {
          params(
            name: ::String,
            policy_type: Models::Shared::TimeOffPolicyRequestPolicyType,
            accrual_method: Models::Shared::AccrualMethod,
