  ...
  module Models
    module Shared
      ...
      class ContractorPayment
        ...
        field(
          :payment_method,
          Crystalline::Nilable.new(Models::Shared::ContractorPaymentPaymentMethod),
          {
            'format_json': {
              'letter_case': ::GustoEmbedded::Utils.field_name("payment_method"),
              'decoder': ::GustoEmbedded::Utils.open_enum_from_string(
                Models::Shared::ContractorPaymentPaymentMethod,
                true
              )
            }
          }
        ...
        field(
          :status,
          Crystalline::Nilable.new(Models::Shared::ContractorPaymentStatus),
          {
            'format_json': {
              'letter_case': ::GustoEmbedded::Utils.field_name("status"),
              'decoder': ::GustoEmbedded::Utils.open_enum_from_string(Models::Shared::ContractorPaymentStatus, true)
            }
          }
        )
        ...
        field(
          :wage_type,
          Crystalline::Nilable.new(Models::Shared::ContractorPaymentWageType),
          {
            'format_json': {
              'letter_case': ::GustoEmbedded::Utils.field_name("wage_type"),
              'decoder': ::GustoEmbedded::Utils.open_enum_from_string(Models::Shared::ContractorPaymentWageType, true)
            }
          }
        )
        ...
        sig {
          params(
            ...
            payment_method: T.nilable(Models::Shared::ContractorPaymentPaymentMethod),
            reimbursement: T.nilable(::String),
            status: T.nilable(Models::Shared::ContractorPaymentStatus),
            hourly_rate: T.nilable(::String),
            may_cancel: T.nilable(T::Boolean),
            wage: T.nilable(::String),
            wage_type: T.nilable(Models::Shared::ContractorPaymentWageType),
