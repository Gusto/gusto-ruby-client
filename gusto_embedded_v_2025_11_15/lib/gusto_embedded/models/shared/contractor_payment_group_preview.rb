...
module GustoEmbedded
  module Models
    module Shared
      ...
      class ContractorPaymentGroupPreview
        extend T::Sig
        ...
        field(
          :status,
          Crystalline::Nilable.new(Models::Shared::ContractorPaymentGroupPreviewStatus),
          {
            'format_json': {
              'letter_case': ::GustoEmbedded::Utils.field_name("status"),
              'decoder': ::GustoEmbedded::Utils.open_enum_from_string(
                Models::Shared::ContractorPaymentGroupPreviewStatus,
                true
              )
            }
          }
        ...
        field(
          :contractor_payments,
          Crystalline::Nilable.new(Crystalline::Array.new(Models::Shared::ContractorPaymentForGroupPreview)),
