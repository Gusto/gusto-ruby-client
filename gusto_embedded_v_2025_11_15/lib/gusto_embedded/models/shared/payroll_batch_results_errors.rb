  ...
  module Models
    module Shared
      ...
      class PayrollBatchResultsErrors
        ...
        field(
          :category,
          Crystalline::Nilable.new(Models::Shared::PayrollBatchResultsResultsCategory),
          {
            'format_json': {
              'letter_case': ::GustoEmbedded::Utils.field_name("category"),
              'decoder': ::GustoEmbedded::Utils.open_enum_from_string(
                Models::Shared::PayrollBatchResultsResultsCategory,
                true
              )
            }
          }
        ...
        sig {
          params(
            ...
            category: T.nilable(Models::Shared::PayrollBatchResultsResultsCategory),
