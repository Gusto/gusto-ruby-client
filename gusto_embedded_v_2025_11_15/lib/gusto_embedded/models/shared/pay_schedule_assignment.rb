  ...
  module Models
    module Shared
      ...
      class PayScheduleAssignment
        ...
        field(
          :employees,
          Crystalline::Nilable.new(Crystalline::Array.new(Models::Shared::PayScheduleAssignmentEmployee)),
          {'format_json': {'letter_case': ::GustoEmbedded::Utils.field_name("employees")}}
        )
        # List of departments and their pay schedules.
        field(
          :departments,
          Crystalline::Nilable.new(Crystalline::Array.new(Models::Shared::PayScheduleAssignmentDepartment)),
        ...
        sig {
          params(
            ...
            employees: T.nilable(T::Array[Models::Shared::PayScheduleAssignmentEmployee]),
            departments: T.nilable(T::Array[Models::Shared::PayScheduleAssignmentDepartment])
          )
            .void
        }
        def initialize(
