  ...
  module Models
    module Shared
      ...
      class GarnishmentChildSupport
        ...
        field(
          :payment_period,
          Crystalline::Nilable.new(Models::Shared::PaymentPeriod),
          {
            'format_json': {
              'letter_case': ::GustoEmbedded::Utils.field_name("payment_period"),
              'decoder': ::GustoEmbedded::Utils.open_enum_from_string(Models::Shared::PaymentPeriod, true)
            }
          }
        )
        ...
        field(
          :fips_code,
          Crystalline::Nilable.new(::String),
          {'format_json': {'letter_case': ::GustoEmbedded::Utils.field_name("fips_code")}}
        )
        ...
        field(
          :case_number,
          Crystalline::Nilable.new(::String),
          {'format_json': {'letter_case': ::GustoEmbedded::Utils.field_name("case_number")}}
        )
        ...
        field(
          :order_number,
          Crystalline::Nilable.new(::String),
          {'format_json': {'letter_case': ::GustoEmbedded::Utils.field_name("order_number")}}
        )
        ...
        field(
          :remittance_number,
          Crystalline::Nilable.new(::String),
          {'format_json': {'letter_case': ::GustoEmbedded::Utils.field_name("remittance_number")}}
        )

        sig {
          params(
            state: T.nilable(::String),
            payment_period: T.nilable(Models::Shared::PaymentPeriod),
            fips_code: T.nilable(::String),
            case_number: T.nilable(::String),
            order_number: T.nilable(::String),
            remittance_number: T.nilable(::String)
          )
            .void
        }
        def initialize(
