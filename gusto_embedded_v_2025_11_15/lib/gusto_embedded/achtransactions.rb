...
module GustoEmbedded
  ...
  class AchTransactions
    ...
    sig {
      params(
        request: Models::Operations::GetAchTransactionsRequest,
        timeout_ms: T.nilable(Integer),
        http_headers: T.nilable(T::Hash[T.any(String, Symbol), String])
      )
        .returns(Models::Operations::GetAchTransactionsResponse)
    }
      ...
      if Utils.match_status_code(http_response.status, ["200"])
        if Utils.match_content_type(content_type, "application/json")
          ...
          obj = Crystalline.unmarshal_json(
            ...
            Crystalline::Array.new(Models::Shared::AchTransaction)
          )
