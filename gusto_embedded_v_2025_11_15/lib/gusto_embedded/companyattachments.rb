  ...
  class CompanyAttachments
    ...
    sig {
      params(
        ...
        .returns(Models::Operations::GetV1CompaniesAttachmentResponse)
    }
    ...
    sig {
      params(
        company_id: ::String,
        x_gusto_api_version: T.nilable(Models::Operations::GetV1CompaniesAttachmentsHeaderXGustoAPIVersion),
        timeout_ms: T.nilable(Integer),
        http_headers: T.nilable(T::Hash[T.any(String, Symbol), String])
      )
        .returns(Models::Operations::GetV1CompaniesAttachmentsResponse)
    }
      ...
      if Utils.match_status_code(http_response.status, ["200"])
        if Utils.match_content_type(content_type, "application/json")
          ...
          obj = Crystalline.unmarshal_json(
            ...
            Crystalline::Array.new(Models::Shared::CompanyAttachment)
          )
    ...
    sig {
      params(
        body: Models::Shared::CompanyAttachmentCreateRequestBody,
        company_id: ::String,
        x_gusto_api_version: T.nilable(Models::Operations::PostV1CompaniesAttachmentHeaderXGustoAPIVersion),
        timeout_ms: T.nilable(Integer),
        http_headers: T.nilable(T::Hash[T.any(String, Symbol), String])
      )
        .returns(Models::Operations::PostV1CompaniesAttachmentResponse)
    }
