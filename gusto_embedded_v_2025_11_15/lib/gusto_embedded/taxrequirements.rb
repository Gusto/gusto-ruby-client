...
module GustoEmbedded
  ...
  class TaxRequirements
    ...
    sig {
      params(
        ...
        x_gusto_api_version: T.nilable(
          Models::Operations::GetV1CompaniesCompanyUuidTaxRequirementsStateHeaderXGustoAPIVersion
        ),
        scheduling: T.nilable(T::Boolean),
        timeout_ms: T.nilable(Integer),
        http_headers: T.nilable(T::Hash[T.any(String, Symbol), String])
      )
        .returns(Models::Operations::GetV1CompaniesCompanyUuidTaxRequirementsStateResponse)
    }
    ...
    sig {
      params(
        body: Models::Operations::PutV1CompaniesCompanyUuidTaxRequirementsStateRequestBody,
        company_uuid: ::String,
        state: ::String,
        x_gusto_api_version: T.nilable(
          Models::Operations::PutV1CompaniesCompanyUuidTaxRequirementsStateHeaderXGustoAPIVersion
        ),
        timeout_ms: T.nilable(Integer),
        http_headers: T.nilable(T::Hash[T.any(String, Symbol), String])
      )
        .returns(Models::Operations::PutV1CompaniesCompanyUuidTaxRequirementsStateResponse)
    }
    def update_state(body:, company_uuid:, state:, x_gusto_api_version: nil, timeout_ms: nil, http_headers: nil)
    ...
    sig {
      params(
        company_uuid: ::String,
        x_gusto_api_version: T.nilable(
          Models::Operations::GetV1CompaniesCompanyUuidTaxRequirementsHeaderXGustoAPIVersion
        ),
        timeout_ms: T.nilable(Integer),
        http_headers: T.nilable(T::Hash[T.any(String, Symbol), String])
      )
        .returns(Models::Operations::GetV1CompaniesCompanyUuidTaxRequirementsResponse)
    }
      ...
      if Utils.match_status_code(http_response.status, ["200"])
        if Utils.match_content_type(content_type, "application/json")
          ...
          obj = Crystalline.unmarshal_json(
            ...
            Crystalline::Array.new(Models::Shared::TaxRequirementStatesList)
          )
