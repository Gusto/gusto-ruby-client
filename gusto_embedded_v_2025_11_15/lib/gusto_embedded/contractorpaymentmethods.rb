...
module GustoEmbedded
  ...
  class ContractorPaymentMethods
    ...
    sig {
      params(
        body: Models::Shared::ContractorBankAccountCreateRequestBody,
        contractor_uuid: ::String,
        x_gusto_api_version: T.nilable(
          Models::Operations::PostV1ContractorsContractorUuidBankAccountsHeaderXGustoAPIVersion
        ),
        timeout_ms: T.nilable(Integer),
        http_headers: T.nilable(T::Hash[T.any(String, Symbol), String])
      )
        .returns(Models::Operations::PostV1ContractorsContractorUuidBankAccountsResponse)
    }
    def create_bank_account(body:, contractor_uuid:, x_gusto_api_version: nil, timeout_ms: nil, http_headers: nil)
