...
module GustoEmbedded
  ...
  class Suspensions
    ...
    sig {
      params(
        company_uuid: ::String,
        x_gusto_api_version: T.nilable(Models::Operations::GetCompaniesCompanyUuidSuspensionsHeaderXGustoAPIVersion),
        timeout_ms: T.nilable(Integer),
        http_headers: T.nilable(T::Hash[T.any(String, Symbol), String])
      )
        .returns(Models::Operations::GetCompaniesCompanyUuidSuspensionsResponse)
    }
      ...
      if Utils.match_status_code(http_response.status, ["200"])
        if Utils.match_content_type(content_type, "application/json")
          ...
          obj = Crystalline.unmarshal_json(
            ...
            Crystalline::Array.new(Models::Shared::CompanySuspension)
          )
    ...
    sig {
      params(
        body: Models::Operations::PostCompaniesCompanyUuidSuspensionsRequestBody,
        company_uuid: ::String,
        x_gusto_api_version: T.nilable(Models::Operations::PostCompaniesCompanyUuidSuspensionsHeaderXGustoAPIVersion),
        timeout_ms: T.nilable(Integer),
        http_headers: T.nilable(T::Hash[T.any(String, Symbol), String])
      )
        .returns(Models::Operations::PostCompaniesCompanyUuidSuspensionsResponse)
    }
    def suspend(body:, company_uuid:, x_gusto_api_version: nil, timeout_ms: nil, http_headers: nil)
