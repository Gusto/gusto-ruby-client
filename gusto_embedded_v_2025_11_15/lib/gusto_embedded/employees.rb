...
module GustoEmbedded
  ...
  class Employees
    ...
    sig {
      params(
        request: Models::Operations::GetV1CompaniesCompanyIdEmployeesRequest,
        timeout_ms: T.nilable(Integer),
        http_headers: T.nilable(T::Hash[T.any(String, Symbol), String])
      )
        .returns(Models::Operations::GetV1CompaniesCompanyIdEmployeesResponse)
    }
      ...
      if Utils.match_status_code(http_response.status, ["200"])
        if Utils.match_content_type(content_type, "application/json")
          ...
          obj = Crystalline.unmarshal_json(
            ...
            Crystalline::Array.new(Models::Shared::ShowEmployees)
          )
    ...
    sig {
      params(
        company_id: ::String,
        body: T.nilable(Models::Operations::PostV1EmployeesRequestBody),
        x_gusto_api_version: T.nilable(Models::Operations::PostV1EmployeesHeaderXGustoAPIVersion),
        timeout_ms: T.nilable(Integer),
        http_headers: T.nilable(T::Hash[T.any(String, Symbol), String])
      )
        .returns(Models::Operations::PostV1EmployeesResponse)
    }
    def create(company_id:, body: nil, x_gusto_api_version: nil, timeout_ms: nil, http_headers: nil)
    ...
    sig {
      params(
        request: Models::Operations::GetV1CompaniesCompanyIdEmployeesPaymentDetailsRequest,
        timeout_ms: T.nilable(Integer),
        http_headers: T.nilable(T::Hash[T.any(String, Symbol), String])
      )
        .returns(Models::Operations::GetV1CompaniesCompanyIdEmployeesPaymentDetailsResponse)
    }
    def get_v1_companies_company_id_employees_payment_details(request:, timeout_ms: nil, http_headers: nil)
      ...
      if Utils.match_status_code(http_response.status, ["200"])
        if Utils.match_content_type(content_type, "application/json")
          ...
          obj = Crystalline.unmarshal_json(
            JSON.parse(response_data),
            Crystalline::Array.new(Models::Shared::EmployeePaymentDetailsList)
          )
    ...
    sig {
      params(
        body: Models::Shared::HistoricalEmployeeBody,
        company_uuid: ::String,
        x_gusto_api_version: T.nilable(Models::Operations::PostV1HistoricalEmployeesHeaderXGustoAPIVersion),
        timeout_ms: T.nilable(Integer),
        http_headers: T.nilable(T::Hash[T.any(String, Symbol), String])
      )
        .returns(Models::Operations::PostV1HistoricalEmployeesResponse)
    }
    def create_historical(body:, company_uuid:, x_gusto_api_version: nil, timeout_ms: nil, http_headers: nil)
    ...
    sig {
      params(
        ...
        .returns(Models::Operations::GetV1EmployeesResponse)
    }
    ...
    sig {
      params(
        body: Models::Operations::PutV1EmployeesRequestBody,
        employee_id: ::String,
        x_gusto_api_version: T.nilable(Models::Operations::PutV1EmployeesHeaderXGustoAPIVersion),
        timeout_ms: T.nilable(Integer),
        http_headers: T.nilable(T::Hash[T.any(String, Symbol), String])
      )
        .returns(Models::Operations::PutV1EmployeesResponse)
    }
    def update(body:, employee_id:, x_gusto_api_version: nil, timeout_ms: nil, http_headers: nil)
    ...
    sig {
      params(
        employee_id: ::String,
        x_gusto_api_version: T.nilable(Models::Operations::DeleteV1EmployeeHeaderXGustoAPIVersion),
        timeout_ms: T.nilable(Integer),
        http_headers: T.nilable(T::Hash[T.any(String, Symbol), String])
      )
        .returns(Models::Operations::DeleteV1EmployeeResponse)
    }
    def delete(employee_id:, x_gusto_api_version: nil, timeout_ms: nil, http_headers: nil)
    ...
    sig {
      params(
        ...
        .returns(Models::Operations::GetV1EmployeesEmployeeIdCustomFieldsResponse)
    }
    ...
    sig {
      params(
        employee_id: ::String,
        body: T.nilable(Models::Shared::EmployeeOnboardingDocumentsConfigRequest),
        x_gusto_api_version: T.nilable(
          Models::Operations::PutV1EmployeesEmployeeIdOnboardingDocumentsConfigHeaderXGustoAPIVersion
        ),
        timeout_ms: T.nilable(Integer),
        http_headers: T.nilable(T::Hash[T.any(String, Symbol), String])
      )
        .returns(Models::Operations::PutV1EmployeesEmployeeIdOnboardingDocumentsConfigResponse)
    }
    ...
    sig {
      params(
        ...
        .returns(Models::Operations::GetV1EmployeesEmployeeIdOnboardingStatusResponse)
    }
    def get_onboarding_status(employee_id:, x_gusto_api_version: nil, timeout_ms: nil, http_headers: nil)
    ...
    sig {
      params(
        body: Models::Operations::PutV1EmployeesEmployeeIdOnboardingStatusRequestBody,
        employee_id: ::String,
        x_gusto_api_version: T.nilable(
          Models::Operations::PutV1EmployeesEmployeeIdOnboardingStatusHeaderXGustoAPIVersion
        ),
        timeout_ms: T.nilable(Integer),
        http_headers: T.nilable(T::Hash[T.any(String, Symbol), String])
      )
        .returns(Models::Operations::PutV1EmployeesEmployeeIdOnboardingStatusResponse)
    }
    def update_onboarding_status(body:, employee_id:, x_gusto_api_version: nil, timeout_ms: nil, http_headers: nil)
    ...
    sig {
      params(
        ...
        .returns(Models::Operations::GetVersionEmployeesTimeOffActivitiesResponse)
    }
    def get_time_off_activities(
      ...
      if Utils.match_status_code(http_response.status, ["200"])
        if Utils.match_content_type(content_type, "application/json")
          ...
          obj = Crystalline.unmarshal_json(
            JSON.parse(response_data),
            Crystalline::Array.new(Models::Shared::TimeOffActivity)
          )
