...
module GustoEmbedded
  ...
  class Reports
    ...
    sig {
      params(
        security: Models::Operations::PostV1BulkReportsSecurity,
        body: Models::Shared::BulkReportBody,
        ...
        .returns(Models::Operations::PostV1BulkReportsResponse)
    }
    def post_v1_bulk_reports(security:, body:, x_gusto_api_version: nil, timeout_ms: nil, http_headers: nil)
    ...
    sig {
      params(
        security: Models::Operations::GetV1BulkReportsRequestUuidSecurity,
        request_uuid: ::String,
        x_gusto_api_version: T.nilable(Models::Operations::GetV1BulkReportsRequestUuidHeaderXGustoAPIVersion),
        timeout_ms: T.nilable(Integer),
        http_headers: T.nilable(T::Hash[T.any(String, Symbol), String])
      )
        .returns(Models::Operations::GetV1BulkReportsRequestUuidResponse)
    }
    ...
    sig {
      params(
        body: Models::Operations::PostV1CompaniesCompanyIdReportsEmployeesAnnualFicaWageRequestBody,
        company_id: ::String,
        x_gusto_api_version: T.nilable(
          Models::Operations::PostV1CompaniesCompanyIdReportsEmployeesAnnualFicaWageHeaderXGustoAPIVersion
        ),
        timeout_ms: T.nilable(Integer),
        http_headers: T.nilable(T::Hash[T.any(String, Symbol), String])
      )
        .returns(Models::Operations::PostV1CompaniesCompanyIdReportsEmployeesAnnualFicaWageResponse)
    }
    ...
    sig {
      params(
        body: Models::Shared::CreateReportBody,
        company_uuid: ::String,
        x_gusto_api_version: T.nilable(Models::Operations::PostCompaniesCompanyUuidReportsHeaderXGustoAPIVersion),
        timeout_ms: T.nilable(Integer),
        http_headers: T.nilable(T::Hash[T.any(String, Symbol), String])
      )
        .returns(Models::Operations::PostCompaniesCompanyUuidReportsResponse)
    }
    def create_custom(body:, company_uuid:, x_gusto_api_version: nil, timeout_ms: nil, http_headers: nil)
    ...
    sig {
      params(
        body: Models::Shared::GeneralLedgerReportBody,
        payroll_uuid: ::String,
        x_gusto_api_version: T.nilable(
          Models::Operations::PostPayrollsPayrollUuidReportsGeneralLedgerHeaderXGustoAPIVersion
        ),
        timeout_ms: T.nilable(Integer),
        http_headers: T.nilable(T::Hash[T.any(String, Symbol), String])
      )
        .returns(Models::Operations::PostPayrollsPayrollUuidReportsGeneralLedgerResponse)
    }
    ...
    sig {
      params(
        request_uuid: ::String,
        x_gusto_api_version: T.nilable(Models::Operations::GetReportsRequestUuidHeaderXGustoAPIVersion),
        timeout_ms: T.nilable(Integer),
        http_headers: T.nilable(T::Hash[T.any(String, Symbol), String])
      )
        .returns(Models::Operations::GetReportsRequestUuidResponse)
    }
    ...
    sig {
      params(
        ...
        .returns(Models::Operations::GetCompaniesCompanyUuidReportTemplatesReportTypeResponse)
    }
