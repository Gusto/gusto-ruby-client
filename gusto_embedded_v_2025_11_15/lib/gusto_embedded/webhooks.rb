...
module GustoEmbedded
  ...
  class Webhooks
    ...
    sig {
      params(
        security: Models::Operations::GetV1WebhookSubscriptionsSecurity,
        x_gusto_api_version: T.nilable(Models::Operations::GetV1WebhookSubscriptionsHeaderXGustoAPIVersion),
        timeout_ms: T.nilable(Integer),
        http_headers: T.nilable(T::Hash[T.any(String, Symbol), String])
      )
        .returns(Models::Operations::GetV1WebhookSubscriptionsResponse)
    }
      ...
      if Utils.match_status_code(http_response.status, ["200"])
        if Utils.match_content_type(content_type, "application/json")
          ...
          obj = Crystalline.unmarshal_json(
            ...
            Crystalline::Array.new(Models::Shared::WebhookSubscription)
          )
    ...
    sig {
      params(
        security: Models::Operations::PostV1WebhookSubscriptionSecurity,
        body: Models::Operations::PostV1WebhookSubscriptionRequestBody,
        x_gusto_api_version: T.nilable(Models::Operations::PostV1WebhookSubscriptionHeaderXGustoAPIVersion),
        timeout_ms: T.nilable(Integer),
        http_headers: T.nilable(T::Hash[T.any(String, Symbol), String])
      )
        .returns(Models::Operations::PostV1WebhookSubscriptionResponse)
    }
    def create_subscription(security:, body:, x_gusto_api_version: nil, timeout_ms: nil, http_headers: nil)
    ...
    sig {
      params(
        security: Models::Operations::GetV1WebhookSubscriptionUuidSecurity,
        webhook_subscription_uuid: ::String,
        x_gusto_api_version: T.nilable(Models::Operations::GetV1WebhookSubscriptionUuidHeaderXGustoAPIVersion),
        timeout_ms: T.nilable(Integer),
        http_headers: T.nilable(T::Hash[T.any(String, Symbol), String])
      )
        .returns(Models::Operations::GetV1WebhookSubscriptionUuidResponse)
    }
    ...
    sig {
      params(
        security: Models::Operations::PutV1WebhookSubscriptionUuidSecurity,
        body: Models::Operations::PutV1WebhookSubscriptionUuidRequestBody,
        webhook_subscription_uuid: ::String,
        x_gusto_api_version: T.nilable(Models::Operations::PutV1WebhookSubscriptionUuidHeaderXGustoAPIVersion),
        timeout_ms: T.nilable(Integer),
        http_headers: T.nilable(T::Hash[T.any(String, Symbol), String])
      )
        .returns(Models::Operations::PutV1WebhookSubscriptionUuidResponse)
    }
    ...
    sig {
      params(
        security: Models::Operations::DeleteV1WebhookSubscriptionUuidSecurity,
        webhook_subscription_uuid: ::String,
        x_gusto_api_version: T.nilable(Models::Operations::DeleteV1WebhookSubscriptionUuidHeaderXGustoAPIVersion),
        timeout_ms: T.nilable(Integer),
        http_headers: T.nilable(T::Hash[T.any(String, Symbol), String])
      )
        .returns(Models::Operations::DeleteV1WebhookSubscriptionUuidResponse)
    }
    ...
    sig {
      params(
        security: Models::Operations::PutV1VerifyWebhookSubscriptionUuidSecurity,
        body: Models::Operations::PutV1VerifyWebhookSubscriptionUuidRequestBody,
        webhook_subscription_uuid: ::String,
        x_gusto_api_version: T.nilable(Models::Operations::PutV1VerifyWebhookSubscriptionUuidHeaderXGustoAPIVersion),
        timeout_ms: T.nilable(Integer),
        http_headers: T.nilable(T::Hash[T.any(String, Symbol), String])
      )
        .returns(Models::Operations::PutV1VerifyWebhookSubscriptionUuidResponse)
    }
    def verify(
      security:,
      body:,
    ...
    sig {
      params(
        security: Models::Operations::GetV1WebhookSubscriptionVerificationTokenUuidSecurity,
        webhook_subscription_uuid: ::String,
        ...
        .returns(Models::Operations::GetV1WebhookSubscriptionVerificationTokenUuidResponse)
    }
    ...
    sig {
      params(
        security: Models::Operations::GetV1WebhooksHealthCheckSecurity,
        x_gusto_api_version: T.nilable(Models::Operations::GetV1WebhooksHealthCheckHeaderXGustoAPIVersion),
        timeout_ms: T.nilable(Integer),
        http_headers: T.nilable(T::Hash[T.any(String, Symbol), String])
      )
        .returns(Models::Operations::GetV1WebhooksHealthCheckResponse)
    }
