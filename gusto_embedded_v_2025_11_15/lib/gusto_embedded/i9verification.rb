  ...
  class I9Verification
    ...
    sig {
      params(
        ...
        .returns(Models::Operations::GetV1EmployeesEmployeeIdI9AuthorizationResponse)
    }
    ...
    sig {
      params(
        body: Models::Shared::I9AuthorizationRequestBody,
        employee_id: ::String,
        x_gusto_api_version: T.nilable(
        ...
        .returns(Models::Operations::PutV1EmployeesEmployeeIdI9AuthorizationResponse)
    }
    ...
    sig {
      params(
        ...
        .returns(Models::Operations::GetV1EmployeesEmployeeIdI9AuthorizationDocumentOptionsResponse)
    }
      ...
      if Utils.match_status_code(http_response.status, ["200"])
        if Utils.match_content_type(content_type, "application/json")
          ...
          obj = Crystalline.unmarshal_json(
            ...
            Crystalline::Array.new(Models::Shared::I9AuthorizationDocumentOption)
          )
    ...
    sig {
      params(
        ...
        .returns(Models::Operations::GetV1EmployeesEmployeeIdI9AuthorizationDocumentsResponse)
    }
    def get_documents(employee_id:, x_gusto_api_version: nil, timeout_ms: nil, http_headers: nil)
      ...
      if Utils.match_status_code(http_response.status, ["200"])
        if Utils.match_content_type(content_type, "application/json")
          ...
          obj = Crystalline.unmarshal_json(
            JSON.parse(response_data),
            Crystalline::Array.new(Models::Shared::I9AuthorizationDocument)
          )
    ...
    sig {
      params(
        body: Models::Shared::I9AuthorizationDocumentsRequestBody,
        employee_id: ::String,
        x_gusto_api_version: T.nilable(
          Models::Operations::PutV1EmployeesEmployeeIdI9AuthorizationDocumentsHeaderXGustoAPIVersion
        ),
        timeout_ms: T.nilable(Integer),
        http_headers: T.nilable(T::Hash[T.any(String, Symbol), String])
      )
        .returns(Models::Operations::PutV1EmployeesEmployeeIdI9AuthorizationDocumentsResponse)
    }
    def create_documents(body:, employee_id:, x_gusto_api_version: nil, timeout_ms: nil, http_headers: nil)
    ...
    sig {
      params(
        ...
        .returns(Models::Operations::DeleteV1EmployeesEmployeeIdI9AuthorizationDocumentsDocumentIdResponse)
    }
    ...
    sig {
      params(
        body: Models::Shared::I9AuthorizationEmployerSignRequestBody,
        employee_id: ::String,
        x_gusto_api_version: T.nilable(
          Models::Operations::PutV1EmployeesEmployeeIdI9AuthorizationEmployerSignHeaderXGustoAPIVersion
        ),
        x_gusto_client_ip: T.nilable(::String),
        timeout_ms: T.nilable(Integer),
        http_headers: T.nilable(T::Hash[T.any(String, Symbol), String])
      )
        .returns(Models::Operations::PutV1EmployeesEmployeeIdI9AuthorizationEmployerSignResponse)
    }
    def employer_sign(
      body:,
      employee_id:,
