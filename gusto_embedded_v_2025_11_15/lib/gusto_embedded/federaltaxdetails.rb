  ...
  class FederalTaxDetails
    ...
    sig {
      params(
        ...
        .returns(Models::Operations::GetV1CompaniesCompanyIdFederalTaxDetailsResponse)
    }
    ...
    sig {
      params(
        body: Models::Shared::FederalTaxDetailsUpdate,
        company_id: ::String,
        x_gusto_api_version: T.nilable(
        ...
        .returns(Models::Operations::PutV1CompaniesCompanyIdFederalTaxDetailsResponse)
    }
