...
module GustoEmbedded
  ...
  class InformationRequests
      ...
      if Utils.match_status_code(http_response.status, ["200"])
        if Utils.match_content_type(content_type, "application/json")
          ...
          obj = Crystalline.unmarshal_json(
            ...
            Crystalline::Array.new(Models::Shared::InformationRequest)
          )
    ...
    sig {
      params(
        body: Models::Operations::SubmitInformationRequestRequestBody,
        information_request_uuid: ::String,
        timeout_ms: T.nilable(Integer),
        http_headers: T.nilable(T::Hash[T.any(String, Symbol), String])
      )
        .returns(Models::Operations::SubmitInformationRequestResponse)
    }
    def submit(body:, information_request_uuid:, timeout_ms: nil, http_headers: nil)
