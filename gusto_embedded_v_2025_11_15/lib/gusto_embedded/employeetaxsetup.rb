  ...
  class EmployeeTaxSetup
    ...
    sig {
      params(
        ...
        .returns(Models::Operations::GetV1EmployeesEmployeeIdFederalTaxesResponse)
    }
        ...
        if Utils.match_content_type(content_type, "application/json")
          ...
          obj = Crystalline.unmarshal_json(
            ...
            Crystalline::DiscriminatedUnion.new(
              "w4_data_type",
              {
                "pre_2020_w4" => Models::Shared::EmployeeFederalTaxPre2020,
                "rev_2020_w4" => Models::Shared::EmployeeFederalTaxRev2020
              }
            )
          )
    ...
    sig {
      params(
        body: Models::Operations::PutV1EmployeesEmployeeIdFederalTaxesRequestBody,
        employee_uuid: ::String,
        x_gusto_api_version: T.nilable(Models::Operations::PutV1EmployeesEmployeeIdFederalTaxesHeaderXGustoAPIVersion),
        timeout_ms: T.nilable(Integer),
        http_headers: T.nilable(T::Hash[T.any(String, Symbol), String])
      )
        .returns(Models::Operations::PutV1EmployeesEmployeeIdFederalTaxesResponse)
    }
    def update_federal_taxes(body:, employee_uuid:, x_gusto_api_version: nil, timeout_ms: nil, http_headers: nil)
    ...
    sig {
      params(
        employee_uuid: ::String,
        x_gusto_api_version: T.nilable(Models::Operations::GetV1EmployeesEmployeeIdStateTaxesHeaderXGustoAPIVersion),
        timeout_ms: T.nilable(Integer),
        http_headers: T.nilable(T::Hash[T.any(String, Symbol), String])
      )
        .returns(Models::Operations::GetV1EmployeesEmployeeIdStateTaxesResponse)
    }
    def get_state_taxes(employee_uuid:, x_gusto_api_version: nil, timeout_ms: nil, http_headers: nil)
      ...
      if Utils.match_status_code(http_response.status, ["200"])
        if Utils.match_content_type(content_type, "application/json")
          ...
          obj = Crystalline.unmarshal_json(
            JSON.parse(response_data),
            Crystalline::Array.new(Models::Shared::EmployeeStateTaxesList)
          )
    ...
    sig {
      params(
        body: Models::Shared::EmployeeStateTaxesRequest,
        employee_uuid: ::String,
        x_gusto_api_version: T.nilable(Models::Operations::PutV1EmployeesEmployeeIdStateTaxesHeaderXGustoAPIVersion),
        timeout_ms: T.nilable(Integer),
        http_headers: T.nilable(T::Hash[T.any(String, Symbol), String])
      )
        .returns(Models::Operations::PutV1EmployeesEmployeeIdStateTaxesResponse)
    }
    def update_state_taxes(body:, employee_uuid:, x_gusto_api_version: nil, timeout_ms: nil, http_headers: nil)
