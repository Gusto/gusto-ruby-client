...
res = s.departments.get_all(company_uuid: '<id>', x_gusto_api_version: Models::Operations::GetCompaniesDepartmentsHeaderXGustoAPIVersion::TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15)
...
res = s.departments.create(company_uuid: '<id>', body: Models::Shared::DepartmentCreateRequestBody.new(
  title: 'Stage Hand'
), x_gusto_api_version: Models::Operations::PostDepartmentsHeaderXGustoAPIVersion::TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15)
...
| ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `company_uuid`                                                                                                                                                                                                               | *::String*                                                                                                                                                                                                                   | :heavy_check_mark:                                                                                                                                                                                                           | The UUID of the company                                                                                                                                                                                                      |
| `body`                                                                                                                                                                                                                       | [Models::Shared::DepartmentCreateRequestBody](../../models/shared/departmentcreaterequestbody.md)                                                                                                                            | :heavy_check_mark:                                                                                                                                                                                                           | N/A                                                                                                                                                                                                                          |
...
res = s.departments.get(department_uuid: '<id>', x_gusto_api_version: Models::Operations::GetDepartmentHeaderXGustoAPIVersion::TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15)
...
res = s.departments.update(department_uuid: '<id>', body: Models::Shared::DepartmentUpdateRequestBody.new(
  version: '56d00c178bc7393b2a206ed6a86afcb4',
  title: 'Stage Hand'
), x_gusto_api_version: Models::Operations::PutDepartmentsHeaderXGustoAPIVersion::TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15)
...
| ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `department_uuid`                                                                                                                                                                                                            | *::String*                                                                                                                                                                                                                   | :heavy_check_mark:                                                                                                                                                                                                           | The UUID of the department                                                                                                                                                                                                   |
| `body`                                                                                                                                                                                                                       | [Models::Shared::DepartmentUpdateRequestBody](../../models/shared/departmentupdaterequestbody.md)                                                                                                                            | :heavy_check_mark:                                                                                                                                                                                                           | N/A                                                                                                                                                                                                                          |
...
res = s.departments.delete(department_uuid: '<id>', x_gusto_api_version: Models::Operations::DeleteDepartmentHeaderXGustoAPIVersion::TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15)
...
res = s.departments.add_people(department_uuid: '<id>', body: Models::Shared::DepartmentPeopleRequestBody.new(
  version: '56d00c178bc7393b2a206ed6a86afcb4'
...
| ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `department_uuid`                                                                                                                                                                                                            | *::String*                                                                                                                                                                                                                   | :heavy_check_mark:                                                                                                                                                                                                           | The UUID of the department                                                                                                                                                                                                   |
| `body`                                                                                                                                                                                                                       | [Models::Shared::DepartmentPeopleRequestBody](../../models/shared/departmentpeoplerequestbody.md)                                                                                                                            | :heavy_check_mark:                                                                                                                                                                                                           | N/A                                                                                                                                                                                                                          |
...
res = s.departments.remove_people(department_uuid: '<id>', body: Models::Shared::DepartmentPeopleRequestBody.new(
  version: '56d00c178bc7393b2a206ed6a86afcb4'
), x_gusto_api_version: Models::Operations::PutRemovePeopleFromDepartmentHeaderXGustoAPIVersion::TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15)
