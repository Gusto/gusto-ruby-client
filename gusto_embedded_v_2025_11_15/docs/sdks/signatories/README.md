...
res = s.signatories.list(company_uuid: '<id>', x_gusto_api_version: Models::Operations::GetV1CompaniesCompanyUuidSignatoriesHeaderXGustoAPIVersion::TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15)
...
res = s.signatories.create(company_uuid: '<id>', body: Models::Shared::SignatoryCreateRequest.new(
  first_name: 'Ed',
  last_name: 'Reichert',
  title: '<value>',
...
), x_gusto_api_version: Models::Operations::PostV1CompanySignatoriesHeaderXGustoAPIVersion::TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15)
...
| ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `company_uuid`                                                                                                                                                                                                               | *::String*                                                                                                                                                                                                                   | :heavy_check_mark:                                                                                                                                                                                                           | The UUID of the company                                                                                                                                                                                                      |
| `body`                                                                                                                                                                                                                       | [Models::Shared::SignatoryCreateRequest](../../models/shared/signatorycreaterequest.md)                                                                                                                                      | :heavy_check_mark:                                                                                                                                                                                                           | N/A                                                                                                                                                                                                                          |
...
res = s.signatories.invite(company_uuid: '<id>', body: Models::Shared::SignatoryInviteRequest.new(
  first_name: 'Madelyn',
  last_name: 'Littel',
  email: 'Harmon_Heidenreich@yahoo.com'
), x_gusto_api_version: Models::Operations::PostV1CompaniesCompanyUuidSignatoriesInviteHeaderXGustoAPIVersion::TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15)
...
res = s.signatories.update(company_uuid: '<id>', signatory_uuid: '<id>', body: Models::Shared::SignatoryUpdateRequest.new(
  version: '<value>'
), x_gusto_api_version: Models::Operations::PutV1CompaniesCompanyUuidSignatoriesSignatoryUuidHeaderXGustoAPIVersion::TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15)
...
| `body`                                                                                                                                                                                                                       | [Models::Shared::SignatoryUpdateRequest](../../models/shared/signatoryupdaterequest.md)                                                                                                                                      | :heavy_check_mark:                                                                                                                                                                                                           | N/A                                                                                                                                                                                                                          |
...
res = s.signatories.delete(company_uuid: '<id>', signatory_uuid: '<id>', x_gusto_api_version: Models::Operations::DeleteV1CompaniesCompanyUuidSignatoriesSignatoryUuidHeaderXGustoAPIVersion::TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15)
