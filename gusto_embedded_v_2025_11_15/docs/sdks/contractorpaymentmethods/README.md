...
res = s.contractor_payment_methods.create_bank_account(contractor_uuid: '<id>', body: Models::Shared::ContractorBankAccountCreateRequestBody.new(
  name: '<value>',
  routing_number: '<value>',
  account_number: '<value>',
  account_type: Models::Shared::ContractorBankAccountCreateRequestBodyAccountType::SAVINGS
), x_gusto_api_version: Models::Operations::PostV1ContractorsContractorUuidBankAccountsHeaderXGustoAPIVersion::TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15)
...
| `body`                                                                                                                                                                                                                       | [Models::Shared::ContractorBankAccountCreateRequestBody](../../models/shared/contractorbankaccountcreaterequestbody.md)                                                                                                      | :heavy_check_mark:                                                                                                                                                                                                           | N/A                                                                                                                                                                                                                          |
