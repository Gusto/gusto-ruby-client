...
res = s.tax_requirements.get(company_uuid: '<id>', state: 'CA', x_gusto_api_version: Models::Operations::GetV1CompaniesCompanyUuidTaxRequirementsStateHeaderXGustoAPIVersion::TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15)
...
res = s.tax_requirements.update_state(company_uuid: '<id>', state: 'CA', body: Models::Operations::PutV1CompaniesCompanyUuidTaxRequirementsStateRequestBody.new(
  requirement_sets: [
...
), x_gusto_api_version: Models::Operations::PutV1CompaniesCompanyUuidTaxRequirementsStateHeaderXGustoAPIVersion::TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15)
...
| `company_uuid`                                                                                                                                                                                                               | *::String*                                                                                                                                                                                                                   | :heavy_check_mark:                                                                                                                                                                                                           | The UUID of the company                                                                                                                                                                                                      |                                                                                                                                                                                                                              |
| `state`                                                                                                                                                                                                                      | *::String*                                                                                                                                                                                                                   | :heavy_check_mark:                                                                                                                                                                                                           | The two-letter state abbreviation                                                                                                                                                                                            | CA                                                                                                                                                                                                                           |
| `body`                                                                                                                                                                                                                       | [Models::Operations::PutV1CompaniesCompanyUuidTaxRequirementsStateRequestBody](../../models/operations/putv1companiescompanyuuidtaxrequirementsstaterequestbody.md)                                                          | :heavy_check_mark:                                                                                                                                                                                                           | N/A                                                                                                                                                                                                                          |                                                                                                                                                                                                                              |
