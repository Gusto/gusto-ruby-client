...
res = s.wire_in_requests.get(wire_in_request_uuid: '<id>', x_gusto_api_version: Models::Operations::GetWireInRequestsWireInRequestUuidHeaderXGustoAPIVersion::TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15)
...
res = s.wire_in_requests.submit(wire_in_request_uuid: '<id>', body: Models::Shared::WireInRequestUpdateRequestBody.new(
  date_sent: '2024-06-10',
  bank_name: 'Chase',
  amount_sent: '314500.00',
  additional_notes: 'Wire for 2024-06-15 payroll.'
), x_gusto_api_version: Models::Operations::PutWireInRequestsWireInRequestUuidHeaderXGustoAPIVersion::TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15)
...
res = s.wire_in_requests.list(company_uuid: '<id>', x_gusto_api_version: Models::Operations::GetCompaniesCompanyUuidWireInRequestUuidHeaderXGustoAPIVersion::TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15)
