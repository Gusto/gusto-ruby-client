...
res = s.payrolls.get_approved_reversals(company_id: '<id>', x_gusto_api_version: Models::Operations::GetV1CompaniesCompanyIdPayrollReversalsHeaderXGustoAPIVersion::TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15)
