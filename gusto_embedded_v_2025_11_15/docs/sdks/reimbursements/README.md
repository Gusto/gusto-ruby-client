...
res = s.reimbursements.get_v1_employees_employee_id_recurring_reimbursements(employee_id: '<id>', x_gusto_api_version: Models::Operations::GetV1EmployeesEmployeeIdRecurringReimbursementsHeaderXGustoAPIVersion::TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15)

unless res.recurring_reimbursement_list.nil?
  # handle response
end
...
res = s.reimbursements.post_v1_employees_employee_id_recurring_reimbursements(employee_id: '<id>', body: Models::Operations::PostV1EmployeesEmployeeIdRecurringReimbursementsRequestBody.new(
  description: 'as procrastinate produce provided gracefully huzzah likewise when',
  amount: 2610.77
), x_gusto_api_version: Models::Operations::PostV1EmployeesEmployeeIdRecurringReimbursementsHeaderXGustoAPIVersion::TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15)

unless res.recurring_reimbursement.nil?
  # handle response
end
...
res = s.reimbursements.get_v1_recurring_reimbursements(id: '<id>', x_gusto_api_version: Models::Operations::GetV1RecurringReimbursementsHeaderXGustoAPIVersion::TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15)
...
res = s.reimbursements.put_v1_recurring_reimbursements(id: '<id>', body: Models::Operations::PutV1RecurringReimbursementsRequestBody.new(
  version: '56d00c178bc7393b2a206ed6a86afcb4'
), x_gusto_api_version: Models::Operations::PutV1RecurringReimbursementsHeaderXGustoAPIVersion::TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15)
...
| ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `id`                                                                                                                                                                                                                         | *::String*                                                                                                                                                                                                                   | :heavy_check_mark:                                                                                                                                                                                                           | The UUID of the reimbursement                                                                                                                                                                                                |
| `body`                                                                                                                                                                                                                       | [Models::Operations::PutV1RecurringReimbursementsRequestBody](../../models/operations/putv1recurringreimbursementsrequestbody.md)                                                                                            | :heavy_check_mark:                                                                                                                                                                                                           | N/A                                                                                                                                                                                                                          |
...
res = s.reimbursements.delete_v1_recurring_reimbursements(id: '<id>', x_gusto_api_version: Models::Operations::DeleteV1RecurringReimbursementsHeaderXGustoAPIVersion::TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15)
