...
module OpenApiSDK
  module Operations
    ...
    class GetCompaniesCompanyUuidContractorPaymentsPreviewContractorPayments < ::OpenApiSDK::Utils::FieldAugmented
      extend T::Sig


      field :bonus, T.nilable(::Integer), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('bonus') } }
      ...
      field :hourly_rate, T.nilable(::Integer), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('hourly_rate') } }

      field :hours, T.nilable(::Integer), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('hours') } }

      field :payment_method, T.nilable(::String), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('payment_method') } }

      field :reimbursement, T.nilable(::Integer), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('reimbursement') } }

      field :wage, T.nilable(::Integer), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('wage') } }
