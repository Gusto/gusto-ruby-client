...
module OpenApiSDK
  module Operations
    ...
    class GetV1BenefitsCompanyBenefitIdSummaryRequest < ::OpenApiSDK::Utils::FieldAugmented
      extend T::Sig
      ...
      sig { params(company_benefit_id: ::String, detailed: T.nilable(T::Boolean), end_date: T.nilable(::String), start_date: T.nilable(::String), x_gusto_api_version: T.nilable(::OpenApiSDK::Shared::VersionHeader)).void }
