...
module OpenApiSDK
  module Operations
    ...
    class PutV1PartnerManagedCompaniesCompanyUuidMigrateRequest < ::OpenApiSDK::Utils::FieldAugmented
      ...
      field :request_body, ::OpenApiSDK::Operations::PutV1PartnerManagedCompaniesCompanyUuidMigrateRequestBody, { 'request': { 'media_type': 'application/json' } }
      ...
      sig { params(company_uuid: ::String, request_body: ::OpenApiSDK::Operations::PutV1PartnerManagedCompaniesCompanyUuidMigrateRequestBody, x_gusto_api_version: T.nilable(::OpenApiSDK::Shared::VersionHeader)).void }
