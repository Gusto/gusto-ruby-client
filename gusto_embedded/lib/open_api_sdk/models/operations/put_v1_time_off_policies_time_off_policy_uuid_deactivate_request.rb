...
module OpenApiSDK
  module Operations
    ...
    class PutV1TimeOffPoliciesTimeOffPolicyUuidDeactivateRequest < ::OpenApiSDK::Utils::FieldAugmented
      extend T::Sig
      ...
      sig { params(time_off_policy_uuid: ::String, x_gusto_api_version: T.nilable(::OpenApiSDK::Shared::VersionHeader)).void }
      def initialize(time_off_policy_uuid: nil, x_gusto_api_version: nil)
