...
module OpenApiSDK
  module Operations
    ...
    class RefreshAccessTokenRequest < ::OpenApiSDK::Utils::FieldAugmented
      ...
      field :request_body, ::OpenApiSDK::Operations::RefreshAccessTokenRequestBody, { 'request': { 'media_type': 'application/json' } }
      ...
      sig { params(request_body: ::OpenApiSDK::Operations::RefreshAccessTokenRequestBody, x_gusto_api_version: T.nilable(::OpenApiSDK::Shared::VersionHeader)).void }
