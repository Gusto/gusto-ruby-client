...
module OpenApiSDK
  module Operations
    ...
    class GetV1PaymentReceiptsPayrollsPayrollUuidRequest < ::OpenApiSDK::Utils::FieldAugmented
      extend T::Sig
      ...
      sig { params(payroll_uuid: ::String, x_gusto_api_version: T.nilable(::OpenApiSDK::Shared::VersionHeader)).void }
