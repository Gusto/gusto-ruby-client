...
module OpenApiSDK
  module Operations
    ...
    class PutV1CompaniesCompanyIdPaySchedulesPayScheduleIdRequest < ::OpenApiSDK::Utils::FieldAugmented
      ...
      field :request_body, ::OpenApiSDK::Operations::PutV1CompaniesCompanyIdPaySchedulesPayScheduleIdRequestBody, { 'request': { 'media_type': 'application/json' } }
      ...
      sig { params(company_id: ::String, pay_schedule_id: ::String, request_body: ::OpenApiSDK::Operations::PutV1CompaniesCompanyIdPaySchedulesPayScheduleIdRequestBody, x_gusto_api_version: T.nilable(::OpenApiSDK::Shared::VersionHeader)).void }
