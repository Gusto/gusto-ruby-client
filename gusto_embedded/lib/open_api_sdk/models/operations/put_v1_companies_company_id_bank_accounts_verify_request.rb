...
module OpenApiSDK
  module Operations
    ...
    class PutV1CompaniesCompanyIdBankAccountsVerifyRequest < ::OpenApiSDK::Utils::FieldAugmented
      ...
      field :request_body, ::OpenApiSDK::Operations::PutV1CompaniesCompanyIdBankAccountsVerifyRequestBody, { 'request': { 'media_type': 'application/json' } }
      ...
      sig { params(bank_account_uuid: ::String, company_id: ::String, request_body: ::OpenApiSDK::Operations::PutV1CompaniesCompanyIdBankAccountsVerifyRequestBody, x_gusto_api_version: T.nilable(::OpenApiSDK::Shared::VersionHeader)).void }
