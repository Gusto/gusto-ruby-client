...
module OpenApiSDK
  module Operations
    ...
    class GetV1CompanyBenefitsCompanyBenefitIdEmployeeBenefitsRequest < ::OpenApiSDK::Utils::FieldAugmented
      extend T::Sig
      ...
      sig { params(company_benefit_id: ::String, page: T.nilable(::Float), per: T.nilable(::Float), x_gusto_api_version: T.nilable(::OpenApiSDK::Shared::VersionHeader)).void }
