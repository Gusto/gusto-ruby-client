...
module OpenApiSDK
  module Operations
    ...
    class GetV1EmployeesEmployeeIdI9AuthorizationDocumentOptionsRequest < ::OpenApiSDK::Utils::FieldAugmented
      extend T::Sig
      ...
      sig { params(employee_id: ::String, x_gusto_api_version: T.nilable(::OpenApiSDK::Shared::VersionHeader)).void }
