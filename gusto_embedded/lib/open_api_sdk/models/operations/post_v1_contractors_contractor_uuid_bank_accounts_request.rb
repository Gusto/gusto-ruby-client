...
module OpenApiSDK
  module Operations
    ...
    class PostV1ContractorsContractorUuidBankAccountsRequest < ::OpenApiSDK::Utils::FieldAugmented
      ...
      field :request_body, ::OpenApiSDK::Operations::PostV1ContractorsContractorUuidBankAccountsRequestBody, { 'request': { 'media_type': 'application/json' } }
      ...
      sig { params(contractor_uuid: ::String, request_body: ::OpenApiSDK::Operations::PostV1ContractorsContractorUuidBankAccountsRequestBody, x_gusto_api_version: T.nilable(::OpenApiSDK::Shared::VersionHeader)).void }
