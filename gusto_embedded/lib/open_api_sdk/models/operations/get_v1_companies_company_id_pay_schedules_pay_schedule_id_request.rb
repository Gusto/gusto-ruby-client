...
module OpenApiSDK
  module Operations
    ...
    class GetV1CompaniesCompanyIdPaySchedulesPayScheduleIdRequest < ::OpenApiSDK::Utils::FieldAugmented
      extend T::Sig
      ...
      sig { params(company_id: ::String, pay_schedule_id: ::String, x_gusto_api_version: T.nilable(::OpenApiSDK::Shared::VersionHeader)).void }
      def initialize(company_id: nil, pay_schedule_id: nil, x_gusto_api_version: nil)
