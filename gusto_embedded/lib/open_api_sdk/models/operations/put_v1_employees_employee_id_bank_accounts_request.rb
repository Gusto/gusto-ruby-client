...
module OpenApiSDK
  module Operations
    ...
    class PutV1EmployeesEmployeeIdBankAccountsRequest < ::OpenApiSDK::Utils::FieldAugmented
      ...
      field :request_body, ::OpenApiSDK::Operations::PutV1EmployeesEmployeeIdBankAccountsRequestBody, { 'request': { 'media_type': 'application/json' } }
      ...
      sig { params(bank_account_uuid: ::String, employee_id: ::String, request_body: ::OpenApiSDK::Operations::PutV1EmployeesEmployeeIdBankAccountsRequestBody, x_gusto_api_version: T.nilable(::OpenApiSDK::Shared::VersionHeader)).void }
