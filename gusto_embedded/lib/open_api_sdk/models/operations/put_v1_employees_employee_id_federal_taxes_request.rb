...
module OpenApiSDK
  module Operations
    ...
    class PutV1EmployeesEmployeeIdFederalTaxesRequest < ::OpenApiSDK::Utils::FieldAugmented
      ...
      field :request_body, ::OpenApiSDK::Operations::PutV1EmployeesEmployeeIdFederalTaxesRequestBody, { 'request': { 'media_type': 'application/json' } }
      ...
      sig { params(employee_uuid: ::String, request_body: ::OpenApiSDK::Operations::PutV1EmployeesEmployeeIdFederalTaxesRequestBody, x_gusto_api_version: T.nilable(::OpenApiSDK::Shared::VersionHeader)).void }
