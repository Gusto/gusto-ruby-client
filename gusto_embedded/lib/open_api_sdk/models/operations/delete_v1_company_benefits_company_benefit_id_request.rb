...
module OpenApiSDK
  module Operations
    ...
    class DeleteV1CompanyBenefitsCompanyBenefitIdRequest < ::OpenApiSDK::Utils::FieldAugmented
      extend T::Sig
      ...
      sig { params(company_benefit_id: ::String, x_gusto_api_version: T.nilable(::OpenApiSDK::Shared::VersionHeader)).void }
