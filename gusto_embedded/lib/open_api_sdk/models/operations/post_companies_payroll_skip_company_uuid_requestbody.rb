...
module OpenApiSDK
  module Operations
    ...
    class PostCompaniesPayrollSkipCompanyUuidRequestBody < ::OpenApiSDK::Utils::FieldAugmented
      extend T::Sig

      # Payroll type
      field :payroll_type, ::OpenApiSDK::Operations::PayrollType, { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('payroll_type'), 'decoder': Utils.enum_from_string(::OpenApiSDK::Operations::PayrollType, false) } }
      ...
      sig { params(payroll_type: ::OpenApiSDK::Operations::PayrollType, employee_uuids: T.nilable(T::Array[::String]), end_date: T.nilable(::String), pay_schedule_uuid: T.nilable(::String), start_date: T.nilable(::String)).void }
