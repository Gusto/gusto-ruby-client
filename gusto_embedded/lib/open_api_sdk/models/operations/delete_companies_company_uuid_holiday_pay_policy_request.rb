...
module OpenApiSDK
  module Operations
    ...
    class DeleteCompaniesCompanyUuidHolidayPayPolicyRequest < ::OpenApiSDK::Utils::FieldAugmented
      extend T::Sig
      ...
      sig { params(company_uuid: ::String, x_gusto_api_version: T.nilable(::OpenApiSDK::Shared::VersionHeader)).void }
