...
module OpenApiSDK
  module Operations
    ...
    class PostV1ExternalPayrollRequestBody < ::OpenApiSDK::Utils::FieldAugmented
      extend T::Sig

      # External payroll's check date.
      field :check_date, ::String, { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('check_date') } }
      # External payroll's pay period end date.
      field :payment_period_end_date, ::String, { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('payment_period_end_date') } }
      # External payroll's pay period start date.
      field :payment_period_start_date, ::String, { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('payment_period_start_date') } }
