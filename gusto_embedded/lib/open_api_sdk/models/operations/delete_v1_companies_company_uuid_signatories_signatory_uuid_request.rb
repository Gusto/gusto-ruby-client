...
module OpenApiSDK
  module Operations
    ...
    class DeleteV1CompaniesCompanyUuidSignatoriesSignatoryUuidRequest < ::OpenApiSDK::Utils::FieldAugmented
      extend T::Sig
      ...
      sig { params(company_uuid: ::String, signatory_uuid: ::String, x_gusto_api_version: T.nilable(::OpenApiSDK::Shared::VersionHeader)).void }
      def initialize(company_uuid: nil, signatory_uuid: nil, x_gusto_api_version: nil)
