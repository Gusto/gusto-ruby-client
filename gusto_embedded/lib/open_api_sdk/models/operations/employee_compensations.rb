...
module OpenApiSDK
  module Operations
    ...
    class EmployeeCompensations < ::OpenApiSDK::Utils::FieldAugmented
      ...
      field :fixed_compensations, T.nilable(T::Array[::OpenApiSDK::Operations::FixedCompensations]), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('fixed_compensations') } }

      field :hourly_compensations, T.nilable(T::Array[::OpenApiSDK::Operations::HourlyCompensations]), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('hourly_compensations') } }
      ...
      field :paid_time_off, T.nilable(T::Array[::OpenApiSDK::Operations::PaidTimeOff]), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('paid_time_off') } }
      # The employee's compensation payment method. Invalid values will be ignored.
      field :payment_method, T.nilable(::OpenApiSDK::Operations::PaymentMethod), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('payment_method'), 'decoder': Utils.enum_from_string(::OpenApiSDK::Operations::PaymentMethod, true) } }
      ...
      sig { params(employee_uuid: T.nilable(::String), excluded: T.nilable(T::Boolean), fixed_compensations: T.nilable(T::Array[::OpenApiSDK::Operations::FixedCompensations]), hourly_compensations: T.nilable(T::Array[::OpenApiSDK::Operations::HourlyCompensations]), memo: T.nilable(::String), paid_time_off: T.nilable(T::Array[::OpenApiSDK::Operations::PaidTimeOff]), payment_method: T.nilable(::OpenApiSDK::Operations::PaymentMethod), version: T.nilable(::String)).void }
