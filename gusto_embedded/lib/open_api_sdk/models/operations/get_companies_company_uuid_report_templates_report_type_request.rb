...
module OpenApiSDK
  module Operations
    ...
    class GetCompaniesCompanyUuidReportTemplatesReportTypeRequest < ::OpenApiSDK::Utils::FieldAugmented
      extend T::Sig
      ...
      sig { params(company_uuid: ::String, report_type: ::String, x_gusto_api_version: T.nilable(::OpenApiSDK::Shared::VersionHeader)).void }
