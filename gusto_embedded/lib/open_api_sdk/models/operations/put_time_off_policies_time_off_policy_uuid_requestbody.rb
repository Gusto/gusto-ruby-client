...
module OpenApiSDK
  module Operations
    ...
    class PutTimeOffPoliciesTimeOffPolicyUuidRequestBody < ::OpenApiSDK::Utils::FieldAugmented
      extend T::Sig

      # Accrual method of the time off policy
      field :accrual_method, T.nilable(::OpenApiSDK::Operations::AccrualMethod), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('accrual_method'), 'decoder': Utils.enum_from_string(::OpenApiSDK::Operations::AccrualMethod, true) } }
