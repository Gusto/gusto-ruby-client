...
module OpenApiSDK
  module Operations
    ...
    class PutV1TimeOffPoliciesTimeOffPolicyUuidRemoveEmployeesRequest < ::OpenApiSDK::Utils::FieldAugmented
      ...
      field :request_body, ::OpenApiSDK::Operations::PutV1TimeOffPoliciesTimeOffPolicyUuidRemoveEmployeesRequestBody, { 'request': { 'media_type': 'application/json' } }
      ...
      sig { params(request_body: ::OpenApiSDK::Operations::PutV1TimeOffPoliciesTimeOffPolicyUuidRemoveEmployeesRequestBody, time_off_policy_uuid: ::String, x_gusto_api_version: T.nilable(::OpenApiSDK::Shared::VersionHeader)).void }
