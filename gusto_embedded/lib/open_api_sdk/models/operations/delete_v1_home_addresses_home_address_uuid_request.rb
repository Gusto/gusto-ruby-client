...
module OpenApiSDK
  module Operations
    ...
    class DeleteV1HomeAddressesHomeAddressUuidRequest < ::OpenApiSDK::Utils::FieldAugmented
      extend T::Sig
      ...
      sig { params(home_address_uuid: ::String, x_gusto_api_version: T.nilable(::OpenApiSDK::Shared::VersionHeader)).void }
