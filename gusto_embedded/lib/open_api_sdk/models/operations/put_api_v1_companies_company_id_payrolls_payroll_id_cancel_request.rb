...
module OpenApiSDK
  module Operations
    ...
    class PutApiV1CompaniesCompanyIdPayrollsPayrollIdCancelRequest < ::OpenApiSDK::Utils::FieldAugmented
      extend T::Sig
      ...
      sig { params(company_id: ::String, payroll_id: ::String, x_gusto_api_version: T.nilable(::OpenApiSDK::Shared::VersionHeader)).void }
