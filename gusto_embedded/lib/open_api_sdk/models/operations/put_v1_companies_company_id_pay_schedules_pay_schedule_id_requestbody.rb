...
module OpenApiSDK
  module Operations
    ...
    class PutV1CompaniesCompanyIdPaySchedulesPayScheduleIdRequestBody < ::OpenApiSDK::Utils::FieldAugmented
      extend T::Sig
      ...
      field :anchor_end_of_pay_period, T.nilable(::String), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('anchor_end_of_pay_period') } }
      # The first date that employees on this pay schedule are paid with Gusto.
      field :anchor_pay_date, T.nilable(::String), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('anchor_pay_date') } }
      ...
      field :frequency, T.nilable(::OpenApiSDK::Operations::PutV1CompaniesCompanyIdPaySchedulesPayScheduleIdFrequency), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('frequency'), 'decoder': Utils.enum_from_string(::OpenApiSDK::Operations::PutV1CompaniesCompanyIdPaySchedulesPayScheduleIdFrequency, true) } }


      sig { params(version: ::String, anchor_end_of_pay_period: T.nilable(::String), anchor_pay_date: T.nilable(::String), auto_pilot: T.nilable(T::Boolean), custom_name: T.nilable(::String), day_1: T.nilable(::Integer), day_2: T.nilable(::Integer), frequency: T.nilable(::OpenApiSDK::Operations::PutV1CompaniesCompanyIdPaySchedulesPayScheduleIdFrequency)).void }
