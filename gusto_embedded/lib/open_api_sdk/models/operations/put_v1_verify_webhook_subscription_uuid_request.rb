...
module OpenApiSDK
  module Operations
    ...
    class PutV1VerifyWebhookSubscriptionUuidRequest < ::OpenApiSDK::Utils::FieldAugmented
      ...
      field :request_body, ::OpenApiSDK::Operations::PutV1VerifyWebhookSubscriptionUuidRequestBody, { 'request': { 'media_type': 'application/json' } }
      ...
      sig { params(request_body: ::OpenApiSDK::Operations::PutV1VerifyWebhookSubscriptionUuidRequestBody, webhook_subscription_uuid: ::String, x_gusto_api_version: T.nilable(::OpenApiSDK::Shared::VersionHeader)).void }
