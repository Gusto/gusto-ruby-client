...
module OpenApiSDK
  module Operations
    ...
    class PostPayrollsGrossUpPayrollUuidRequestBody < ::OpenApiSDK::Utils::FieldAugmented
      extend T::Sig

      # Employee UUID
      field :employee_uuid, ::String, { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('employee_uuid') } }
      # Employee net earnings
      field :net_pay, ::String, { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('net_pay') } }
