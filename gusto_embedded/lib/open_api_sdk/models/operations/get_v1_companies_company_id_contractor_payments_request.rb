...
module OpenApiSDK
  module Operations
    ...
    class GetV1CompaniesCompanyIdContractorPaymentsRequest < ::OpenApiSDK::Utils::FieldAugmented
      extend T::Sig
      ...
      sig { params(company_id: ::String, end_date: ::String, start_date: ::String, contractor_uuid: T.nilable(::String), group_by_date: T.nilable(T::Boolean), page: T.nilable(::Float), per: T.nilable(::Float), x_gusto_api_version: T.nilable(::OpenApiSDK::Shared::VersionHeader)).void }
