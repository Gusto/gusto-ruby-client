...
module OpenApiSDK
  module Operations
    ...
    class GetV1WebhookSubscriptionVerificationTokenUuidRequest < ::OpenApiSDK::Utils::FieldAugmented
      extend T::Sig
      ...
      sig { params(webhook_subscription_uuid: ::String, x_gusto_api_version: T.nilable(::OpenApiSDK::Shared::VersionHeader)).void }
