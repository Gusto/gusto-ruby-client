...
module OpenApiSDK
  module Operations
    ...
    class GetCompaniesCompanyUuidContractorPaymentsPreviewBase < ::OpenApiSDK::Utils::FieldAugmented
      extend T::Sig


      field :full_message, T.nilable(::String), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('full_message') } }
