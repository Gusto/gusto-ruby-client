...
module OpenApiSDK
  module Operations
    ...
    class PostV1EmployeesEmployeeIdEmployeeBenefitsRequestBody < ::OpenApiSDK::Utils::FieldAugmented
      extend T::Sig

      # The UUID of the company benefit.
      field :company_benefit_uuid, ::String, { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('company_benefit_uuid') } }
      ...
      field :contribution, T.nilable(::OpenApiSDK::Operations::Contribution), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('contribution') } }
      ...
      field :deduction_reduces_taxable_income, T.nilable(::OpenApiSDK::Operations::DeductionReducesTaxableIncome), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('deduction_reduces_taxable_income'), 'decoder': Utils.enum_from_string(::OpenApiSDK::Operations::DeductionReducesTaxableIncome, true) } }
      ...
      field :limit_option, T.nilable(::OpenApiSDK::Operations::LimitOption), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('limit_option'), 'decoder': Utils.enum_from_string(::OpenApiSDK::Operations::LimitOption, true) } }


      sig { params(company_benefit_uuid: ::String, active: T.nilable(T::Boolean), catch_up: T.nilable(T::Boolean), company_contribution: T.nilable(::String), company_contribution_annual_maximum: T.nilable(::String), contribute_as_percentage: T.nilable(T::Boolean), contribution: T.nilable(::OpenApiSDK::Operations::Contribution), coverage_amount: T.nilable(::String), coverage_salary_multiplier: T.nilable(::String), deduct_as_percentage: T.nilable(T::Boolean), deduction_reduces_taxable_income: T.nilable(::OpenApiSDK::Operations::DeductionReducesTaxableIncome), elective: T.nilable(T::Boolean), employee_deduction: T.nilable(::String), employee_deduction_annual_maximum: T.nilable(::String), limit_option: T.nilable(::OpenApiSDK::Operations::LimitOption)).void }
