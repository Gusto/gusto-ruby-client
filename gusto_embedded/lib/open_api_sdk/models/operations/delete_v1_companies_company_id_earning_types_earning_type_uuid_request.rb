...
module OpenApiSDK
  module Operations
    ...
    class DeleteV1CompaniesCompanyIdEarningTypesEarningTypeUuidRequest < ::OpenApiSDK::Utils::FieldAugmented
      extend T::Sig
      ...
      sig { params(company_id: ::String, earning_type_uuid: ::String, x_gusto_api_version: T.nilable(::OpenApiSDK::Shared::VersionHeader)).void }
      def initialize(company_id: nil, earning_type_uuid: nil, x_gusto_api_version: nil)
