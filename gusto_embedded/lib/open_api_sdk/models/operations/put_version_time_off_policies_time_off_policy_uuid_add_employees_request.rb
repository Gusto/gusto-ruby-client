...
module OpenApiSDK
  module Operations
    ...
    class PutVersionTimeOffPoliciesTimeOffPolicyUuidAddEmployeesRequest < ::OpenApiSDK::Utils::FieldAugmented
      ...
      field :request_body, ::OpenApiSDK::Operations::PutVersionTimeOffPoliciesTimeOffPolicyUuidAddEmployeesRequestBody, { 'request': { 'media_type': 'application/json' } }
      ...
      sig { params(request_body: ::OpenApiSDK::Operations::PutVersionTimeOffPoliciesTimeOffPolicyUuidAddEmployeesRequestBody, time_off_policy_uuid: ::String, x_gusto_api_version: T.nilable(::OpenApiSDK::Shared::VersionHeader)).void }
