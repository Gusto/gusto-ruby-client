...
module OpenApiSDK
  module Shared
    ...
    class PayrollBenefits < ::OpenApiSDK::Utils::FieldAugmented
      extend T::Sig
      ...
      field :pay_period, T.nilable(::OpenApiSDK::Shared::BenefitSummaryPayPeriod), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('pay_period') } }
      # Whether it is regular or bonus payroll
      field :payroll_type, T.nilable(::String), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('payroll_type') } }

      field :payroll_uuid, T.nilable(::String), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('payroll_uuid') } }


      sig { params(check_date: T.nilable(::String), company_benefit_contribution: T.nilable(::String), company_benefit_deduction: T.nilable(::String), gross_pay: T.nilable(::String), imputed_pay: T.nilable(::String), pay_period: T.nilable(::OpenApiSDK::Shared::BenefitSummaryPayPeriod), payroll_type: T.nilable(::String), payroll_uuid: T.nilable(::String)).void }
