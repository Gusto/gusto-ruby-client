...
module OpenApiSDK
  module Shared
    ...
    class TaxRequirementMetadata < ::OpenApiSDK::Utils::FieldAugmented
      extend T::Sig
      ...
      # 
      field :type, ::OpenApiSDK::Shared::TaxRequirementMetadataType, { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('type'), 'decoder': Utils.enum_from_string(::OpenApiSDK::Shared::TaxRequirementMetadataType, false) } }
      ...
      # 
      field :mask, T.nilable(::String), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('mask') } }
      # [for `select` or `radio`] An array of objects describing the possible values.
      field :options, T.nilable(T::Array[::OpenApiSDK::Shared::TaxRequirementMetadataOptions]), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('options') } }
      ...
      # 
      field :rate_type, T.nilable(::OpenApiSDK::Shared::RateType), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('rate_type'), 'decoder': Utils.enum_from_string(::OpenApiSDK::Shared::RateType, true) } }
      # [for `workers_compensation_rate`] The industry risk class code for the rate being requested
      field :risk_class_code, T.nilable(::String), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('risk_class_code') } }
      # [for `workers_compensation_rate`] A description of the industry risk class for the rate being requested
      field :risk_class_description, T.nilable(::String), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('risk_class_description') } }
      # [for `tax_rate`] Describes the validation required for the tax rate
      field :validation, T.nilable(::OpenApiSDK::Shared::Validation), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('validation') } }


      sig { params(type: ::OpenApiSDK::Shared::TaxRequirementMetadataType, mask: T.nilable(::String), options: T.nilable(T::Array[::OpenApiSDK::Shared::TaxRequirementMetadataOptions]), prefix: T.nilable(::String), rate_type: T.nilable(::OpenApiSDK::Shared::RateType), risk_class_code: T.nilable(::String), risk_class_description: T.nilable(::String), validation: T.nilable(::OpenApiSDK::Shared::Validation)).void }
