...
module OpenApiSDK
  module Shared
    ...
    # Example response
    class Rehire < ::OpenApiSDK::Utils::FieldAugmented
      extend T::Sig
      ...
      field :employment_status, T.nilable(::OpenApiSDK::Shared::RehireEmploymentStatus), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('employment_status'), 'decoder': Utils.enum_from_string(::OpenApiSDK::Shared::RehireEmploymentStatus, true) } }
      ...
      field :work_location_uuid, T.nilable(::String), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('work_location_uuid') } }


      sig { params(active: T.nilable(T::Boolean), effective_date: T.nilable(::String), employee_uuid: T.nilable(::String), employment_status: T.nilable(::OpenApiSDK::Shared::RehireEmploymentStatus), file_new_hire_report: T.nilable(T::Boolean), two_percent_shareholder: T.nilable(T::Boolean), version: T.nilable(::String), work_location_uuid: T.nilable(::String)).void }
