...
module OpenApiSDK
  module Shared
    ...
    class CompanyBenefitWithEmployeeBenefits < ::OpenApiSDK::Utils::FieldAugmented
      extend T::Sig
      ...
      field :employee_benefits, T.nilable(T::Array[::OpenApiSDK::Shared::EmployeeBenefits]), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('employee_benefits') } }
      ...
      field :responsible_for_employee_w2, T.nilable(T::Boolean), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('responsible_for_employee_w2') } }
      ...
      field :responsible_for_employer_taxes, T.nilable(T::Boolean), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('responsible_for_employer_taxes') } }
      ...
      field :supports_percentage_amounts, T.nilable(T::Boolean), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('supports_percentage_amounts') } }
      # The current version of the object. See the [versioning guide](https://docs.gusto.com/embedded-payroll/docs/idempotency) for information on how to use this field.
      field :version, T.nilable(::String), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('version') } }


      sig { params(uuid: ::String, active: T.nilable(T::Boolean), benefit_type: T.nilable(::Float), deletable: T.nilable(T::Boolean), description: T.nilable(::String), employee_benefits: T.nilable(T::Array[::OpenApiSDK::Shared::EmployeeBenefits]), responsible_for_employee_w2: T.nilable(T::Boolean), responsible_for_employer_taxes: T.nilable(T::Boolean), supports_percentage_amounts: T.nilable(T::Boolean), version: T.nilable(::String)).void }
      def initialize(uuid: nil, active: nil, benefit_type: nil, deletable: nil, description: nil, employee_benefits: nil, responsible_for_employee_w2: nil, responsible_for_employer_taxes: nil, supports_percentage_amounts: nil, version: nil)
        @uuid = uuid
        @active = active
