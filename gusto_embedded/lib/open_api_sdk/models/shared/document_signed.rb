...
module OpenApiSDK
  module Shared
    ...
    class DocumentSigned < ::OpenApiSDK::Utils::FieldAugmented
      extend T::Sig
      ...
      field :recipient_type, T.nilable(::OpenApiSDK::Shared::DocumentSignedRecipientType), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('recipient_type'), 'decoder': Utils.enum_from_string(::OpenApiSDK::Shared::DocumentSignedRecipientType, true) } }
      ...
      sig { params(description: T.nilable(::String), draft: T.nilable(T::Boolean), name: T.nilable(::String), quarter: T.nilable(::Integer), recipient_type: T.nilable(::OpenApiSDK::Shared::DocumentSignedRecipientType), recipient_uuid: T.nilable(::String), requires_signing: T.nilable(T::Boolean), signed_at: T.nilable(::String), title: T.nilable(::String), uuid: T.nilable(::String), year: T.nilable(::Integer)).void }
