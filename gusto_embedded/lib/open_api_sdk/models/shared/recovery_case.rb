...
module OpenApiSDK
  module Shared
    ...
    class RecoveryCase < ::OpenApiSDK::Utils::FieldAugmented
      extend T::Sig
      ...
      field :amount_outstanding, T.nilable(::String), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('amount_outstanding') } }
      ...
      field :contractor_payment_uuids, T.nilable(T::Array[::String]), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('contractor_payment_uuids') } }
      # Total amount to be debited from the payroll or contractor payments
      field :event_total_amount, T.nilable(::String), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('event_total_amount') } }
      ...
      field :latest_error_code, T.nilable(::String), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('latest_error_code') } }
      ...
      field :status, T.nilable(::OpenApiSDK::Shared::RecoveryCaseStatus), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('status'), 'decoder': Utils.enum_from_string(::OpenApiSDK::Shared::RecoveryCaseStatus, true) } }


      sig { params(uuid: ::String, amount_outstanding: T.nilable(::String), check_date: T.nilable(::String), company_uuid: T.nilable(::String), contractor_payment_uuids: T.nilable(T::Array[::String]), event_total_amount: T.nilable(::String), latest_error_code: T.nilable(::String), original_debit_date: T.nilable(::String), payroll_uuid: T.nilable(::String), status: T.nilable(::OpenApiSDK::Shared::RecoveryCaseStatus)).void }
