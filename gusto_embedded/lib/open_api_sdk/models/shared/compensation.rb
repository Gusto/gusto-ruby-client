...
module OpenApiSDK
  module Shared
    ...
    class Compensation < ::OpenApiSDK::Utils::FieldAugmented
      extend T::Sig
      ...
      field :minimum_wages, T.nilable(T::Array[::OpenApiSDK::Shared::MinimumWages]), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('minimum_wages') } }
      # The unit accompanying the compensation rate. If the employee is an owner, rate should be 'Paycheck'.
      field :payment_unit, T.nilable(::OpenApiSDK::Shared::PaymentUnit), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('payment_unit'), 'decoder': Utils.enum_from_string(::OpenApiSDK::Shared::PaymentUnit, true) } }
      ...
      sig { params(uuid: ::String, adjust_for_minimum_wage: T.nilable(T::Boolean), effective_date: T.nilable(::String), employee_uuid: T.nilable(::String), flsa_status: T.nilable(::OpenApiSDK::Shared::FlsaStatusType), job_uuid: T.nilable(::String), minimum_wages: T.nilable(T::Array[::OpenApiSDK::Shared::MinimumWages]), payment_unit: T.nilable(::OpenApiSDK::Shared::PaymentUnit), rate: T.nilable(::String), version: T.nilable(::String)).void }
