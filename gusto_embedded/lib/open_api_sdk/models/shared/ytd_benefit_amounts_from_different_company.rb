...
module OpenApiSDK
  module Shared
    ...
    class YtdBenefitAmountsFromDifferentCompany < ::OpenApiSDK::Utils::FieldAugmented
      extend T::Sig
      ...
      field :benefit_type, ::Float, { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('benefit_type') } }
