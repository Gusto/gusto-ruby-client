...
module OpenApiSDK
  module Shared
    ...
    class PayrollEmployeeCompensationsType < ::OpenApiSDK::Utils::FieldAugmented
      extend T::Sig
      ...
      field :benefits, T.nilable(T::Array[::OpenApiSDK::Shared::Benefits]), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('benefits') } }
      # The employee's check amount, equal to net_pay + reimbursements. This value is only available for processed payrolls.
      field :check_amount, T.nilable(::Float), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('check_amount') } }
      ...
      field :deductions, T.nilable(T::Array[::OpenApiSDK::Shared::Deductions]), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('deductions') } }
      ...
      field :excluded, T.nilable(T::Boolean), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('excluded') } }
      ...
      field :fixed_compensations, T.nilable(T::Array[::OpenApiSDK::Shared::FixedCompensations]), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('fixed_compensations') } }
      ...
      field :hourly_compensations, T.nilable(T::Array[::OpenApiSDK::Shared::HourlyCompensations]), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('hourly_compensations') } }
      ...
      field :paid_time_off, T.nilable(T::Array[::OpenApiSDK::Shared::PayrollEmployeeCompensationsTypePaidTimeOff]), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('paid_time_off') } }
      # The employee's compensation payment method.
      field :payment_method, T.nilable(::OpenApiSDK::Shared::PayrollEmployeeCompensationsTypePaymentMethod), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('payment_method'), 'decoder': Utils.enum_from_string(::OpenApiSDK::Shared::PayrollEmployeeCompensationsTypePaymentMethod, true) } }
      ...
      field :taxes, T.nilable(T::Array[::OpenApiSDK::Shared::Taxes]), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('taxes') } }
      ...
      sig { params(benefits: T.nilable(T::Array[::OpenApiSDK::Shared::Benefits]), check_amount: T.nilable(::Float), deductions: T.nilable(T::Array[::OpenApiSDK::Shared::Deductions]), employee_uuid: T.nilable(::String), excluded: T.nilable(T::Boolean), fixed_compensations: T.nilable(T::Array[::OpenApiSDK::Shared::FixedCompensations]), gross_pay: T.nilable(::Float), hourly_compensations: T.nilable(T::Array[::OpenApiSDK::Shared::HourlyCompensations]), memo: T.nilable(::String), net_pay: T.nilable(::Float), paid_time_off: T.nilable(T::Array[::OpenApiSDK::Shared::PayrollEmployeeCompensationsTypePaidTimeOff]), payment_method: T.nilable(::OpenApiSDK::Shared::PayrollEmployeeCompensationsTypePaymentMethod), taxes: T.nilable(T::Array[::OpenApiSDK::Shared::Taxes]), version: T.nilable(::String)).void }
