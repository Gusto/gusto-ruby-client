...
module OpenApiSDK
  module Shared
    ...
    class PaidTimeOff < ::OpenApiSDK::Utils::FieldAugmented
      extend T::Sig

      # The number of accrual units accrued.
      field :accrual_balance, T.nilable(::String), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('accrual_balance') } }
      # The accrual method of the time off policy
      field :accrual_method, T.nilable(::String), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('accrual_method') } }
      # The frequency at which the PTO type is accrued.
      field :accrual_period, T.nilable(::String), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('accrual_period') } }
      ...
      field :accrual_unit, T.nilable(::String), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('accrual_unit') } }
      # The maximum number of accrual units allowed. A null value signifies no maximum.
      field :maximum_accrual_balance, T.nilable(::String), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('maximum_accrual_balance') } }
      # The name of the paid time off type.
      field :name, T.nilable(::OpenApiSDK::Shared::Name), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('name'), 'decoder': Utils.enum_from_string(::OpenApiSDK::Shared::Name, true) } }
      # Whether the accrual balance is paid to the employee upon termination.
      field :paid_at_termination, T.nilable(T::Boolean), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('paid_at_termination') } }
