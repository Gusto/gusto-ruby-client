...
module OpenApiSDK
  module Shared
    ...
    class PaymentMethodBankAccount < ::OpenApiSDK::Utils::FieldAugmented
      extend T::Sig
      ...
      field :priority, T.nilable(::Integer), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('priority') } }
      # The cents amount allocated for each payment split
      field :split_amount, T.nilable(::Integer), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('split_amount') } }
