...
module OpenApiSDK
  module Shared
    ...
    class Notification < ::OpenApiSDK::Utils::FieldAugmented
      extend T::Sig
      ...
      field :actionable, T.nilable(T::Boolean), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('actionable') } }
      ...
      field :due_at, T.nilable(::String), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('due_at') } }
      ...
      field :published_at, T.nilable(::String), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('published_at') } }
      # An array of entities relevant to the notification
      field :resources, T.nilable(T::Array[::OpenApiSDK::Shared::Resources]), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('resources') } }
      # The title of the notification. This highlights the actionable component of the notification.
      field :title, T.nilable(::String), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('title') } }


      sig { params(uuid: ::String, actionable: T.nilable(T::Boolean), category: T.nilable(::String), company_uuid: T.nilable(::String), due_at: T.nilable(::String), message: T.nilable(::String), published_at: T.nilable(::String), resources: T.nilable(T::Array[::OpenApiSDK::Shared::Resources]), title: T.nilable(::String)).void }
