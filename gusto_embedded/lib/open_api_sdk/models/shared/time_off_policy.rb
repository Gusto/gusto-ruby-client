...
module OpenApiSDK
  module Shared
    ...
    class TimeOffPolicy < ::OpenApiSDK::Utils::FieldAugmented
      extend T::Sig

      # Policy time off accrual method
      field :accrual_method, ::String, { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('accrual_method') } }
      ...
      field :employees, T::Array[::OpenApiSDK::Shared::TimeOffPolicyEmployees], { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('employees') } }
      # boolean representing if a policy is active or not
      field :is_active, T::Boolean, { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('is_active') } }
      # Name of the time off policy
      field :name, ::String, { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('name') } }
      # Type of the time off policy
      field :policy_type, ::OpenApiSDK::Shared::PolicyType, { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('policy_type'), 'decoder': Utils.enum_from_string(::OpenApiSDK::Shared::PolicyType, false) } }
