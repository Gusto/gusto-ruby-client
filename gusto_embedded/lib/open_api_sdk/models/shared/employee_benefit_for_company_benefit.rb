...
module OpenApiSDK
  module Shared
    ...
    class EmployeeBenefitForCompanyBenefit < ::OpenApiSDK::Utils::FieldAugmented
      extend T::Sig
      ...
      field :contribution, T.nilable(::OpenApiSDK::Shared::EmployeeBenefitForCompanyBenefitContribution), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('contribution') } }
      ...
      field :deduction_reduces_taxable_income, T.nilable(::OpenApiSDK::Shared::EmployeeBenefitForCompanyBenefitDeductionReducesTaxableIncome), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('deduction_reduces_taxable_income'), 'decoder': Utils.enum_from_string(::OpenApiSDK::Shared::EmployeeBenefitForCompanyBenefitDeductionReducesTaxableIncome, true) } }
      ...
      field :limit_option, T.nilable(::String), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('limit_option') } }
      # Identifier for a 401(k) loan assigned by the 401(k) provider
      field :retirement_loan_identifier, T.nilable(::String), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('retirement_loan_identifier') } }
      # The current version of the object. See the [versioning guide](https://docs.gusto.com/embedded-payroll/docs/idempotency) for information on how to use this field.
      field :version, T.nilable(::String), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('version') } }


      sig { params(employee_uuid: ::String, active: T.nilable(T::Boolean), catch_up: T.nilable(T::Boolean), company_contribution: T.nilable(::String), company_contribution_annual_maximum: T.nilable(::String), contribute_as_percentage: T.nilable(T::Boolean), contribution: T.nilable(::OpenApiSDK::Shared::EmployeeBenefitForCompanyBenefitContribution), coverage_amount: T.nilable(::String), coverage_salary_multiplier: T.nilable(::String), deduct_as_percentage: T.nilable(T::Boolean), deduction_reduces_taxable_income: T.nilable(::OpenApiSDK::Shared::EmployeeBenefitForCompanyBenefitDeductionReducesTaxableIncome), elective: T.nilable(T::Boolean), employee_deduction: T.nilable(::String), employee_deduction_annual_maximum: T.nilable(::String), limit_option: T.nilable(::String), retirement_loan_identifier: T.nilable(::String), version: T.nilable(::String)).void }
      def initialize(employee_uuid: nil, active: nil, catch_up: nil, company_contribution: nil, company_contribution_annual_maximum: nil, contribute_as_percentage: nil, contribution: nil, coverage_amount: nil, coverage_salary_multiplier: nil, deduct_as_percentage: nil, deduction_reduces_taxable_income: nil, elective: nil, employee_deduction: nil, employee_deduction_annual_maximum: nil, limit_option: nil, retirement_loan_identifier: nil, version: nil)
