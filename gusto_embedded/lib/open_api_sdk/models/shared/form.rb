...
module OpenApiSDK
  module Shared
    ...
    class Form < ::OpenApiSDK::Utils::FieldAugmented
      ...
      sig { params(uuid: ::String, description: T.nilable(::String), draft: T.nilable(T::Boolean), name: T.nilable(::String), quarter: T.nilable(::Integer), requires_signing: T.nilable(T::Boolean), title: T.nilable(::String), year: T.nilable(::Integer)).void }
      def initialize(uuid: nil, description: nil, draft: nil, name: nil, quarter: nil, requires_signing: nil, title: nil, year: nil)
        @uuid = uuid
