...
module OpenApiSDK
  module Shared
    ...
    class Payroll < ::OpenApiSDK::Utils::FieldAugmented
      ...
      sig { params(auto_pilot: T.nilable(T::Boolean), calculated_at: T.nilable(::String), check_date: T.nilable(::String), company_taxes: T.nilable(T::Array[::OpenApiSDK::Shared::PayrollCompanyTaxesType]), company_uuid: T.nilable(::String), created_at: T.nilable(::DateTime), credit_blockers: T.nilable(T::Array[::OpenApiSDK::Shared::PayrollCreditBlockersType]), employee_compensations: T.nilable(T::Array[::OpenApiSDK::Shared::PayrollEmployeeCompensationsType]), external: T.nilable(T::Boolean), final_termination_payroll: T.nilable(T::Boolean), fixed_withholding_rate: T.nilable(T::Boolean), off_cycle: T.nilable(T::Boolean), off_cycle_reason: T.nilable(::OpenApiSDK::Shared::OffCycleReasonType), pay_period: T.nilable(::OpenApiSDK::Shared::PayrollPayPeriodType), payment_speed_changed: T.nilable(::OpenApiSDK::Shared::PayrollPaymentSpeedChangedType), payroll_deadline: T.nilable(::DateTime), payroll_status_meta: T.nilable(::OpenApiSDK::Shared::PayrollPayrollStatusMetaType), payroll_uuid: T.nilable(::String), processed: T.nilable(T::Boolean), processed_date: T.nilable(::String), processing_request: T.nilable(::OpenApiSDK::Shared::PayrollProcessingRequest), skip_regular_deductions: T.nilable(T::Boolean), submission_blockers: T.nilable(T::Array[::OpenApiSDK::Shared::PayrollSubmissionBlockersType]), totals: T.nilable(::OpenApiSDK::Shared::PayrollTotalsType), uuid: T.nilable(::String), withholding_pay_period: T.nilable(::OpenApiSDK::Shared::PayrollWithholdingPayPeriodType)).void }
