...
module OpenApiSDK
  module Shared
    ...
    # Example response
    class PaymentConfigs < ::OpenApiSDK::Utils::FieldAugmented
      extend T::Sig
      ...
      field :fast_payment_limit, T.nilable(::String), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('fast_payment_limit') } }
      # Partner uuid
      field :partner_uuid, T.nilable(::String), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('partner_uuid') } }
      # Payment speed for 1-day, 2-day, 4-day
      field :payment_speed, T.nilable(::String), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('payment_speed') } }
