...
module OpenApiSDK
  module Shared
    ...
    class RehireBody < ::OpenApiSDK::Utils::FieldAugmented
      extend T::Sig
      ...
      field :employment_status, T.nilable(::OpenApiSDK::Shared::EmploymentStatus), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('employment_status'), 'decoder': Utils.enum_from_string(::OpenApiSDK::Shared::EmploymentStatus, true) } }
      ...
      sig { params(effective_date: ::String, file_new_hire_report: T::Boolean, work_location_uuid: ::String, employment_status: T.nilable(::OpenApiSDK::Shared::EmploymentStatus), two_percent_shareholder: T.nilable(T::Boolean)).void }
