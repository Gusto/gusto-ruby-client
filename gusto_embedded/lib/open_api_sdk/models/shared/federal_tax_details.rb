...
module OpenApiSDK
  module Shared
    ...
    # Example response
    class FederalTaxDetails < ::OpenApiSDK::Utils::FieldAugmented
      extend T::Sig

      # How often the company sends money to the IRS. One of:
      #   - Semiweekly
      #   - Monthly
      field :deposit_schedule, T.nilable(::String), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('deposit_schedule') } }
      ...
      field :ein_verified, T.nilable(T::Boolean), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('ein_verified') } }
      ...
      field :filing_form, T.nilable(::String), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('filing_form') } }
      ...
      # - Joint venture
      # - Non-Profit
      field :tax_payer_type, T.nilable(::String), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('tax_payer_type') } }
