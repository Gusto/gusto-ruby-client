...
module OpenApiSDK
  module Shared
    ...
    class ContractorPaymentForGroup < ::OpenApiSDK::Utils::FieldAugmented
      extend T::Sig
      ...
      # The payment method.
      field :payment_method, T.nilable(::OpenApiSDK::Shared::ContractorPaymentForGroupPaymentMethod), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('payment_method'), 'decoder': Utils.enum_from_string(::OpenApiSDK::Shared::ContractorPaymentForGroupPaymentMethod, true) } }
      ...
      field :status, T.nilable(::OpenApiSDK::Shared::ContractorPaymentForGroupStatus), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('status'), 'decoder': Utils.enum_from_string(::OpenApiSDK::Shared::ContractorPaymentForGroupStatus, true) } }
      ...
      field :wage_type, T.nilable(::OpenApiSDK::Shared::ContractorPaymentForGroupWageType), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('wage_type'), 'decoder': Utils.enum_from_string(::OpenApiSDK::Shared::ContractorPaymentForGroupWageType, true) } }


      sig { params(bonus: T.nilable(::String), contractor_uuid: T.nilable(::String), hourly_rate: T.nilable(::String), hours: T.nilable(::String), may_cancel: T.nilable(T::Boolean), payment_method: T.nilable(::OpenApiSDK::Shared::ContractorPaymentForGroupPaymentMethod), reimbursement: T.nilable(::String), status: T.nilable(::OpenApiSDK::Shared::ContractorPaymentForGroupStatus), uuid: T.nilable(::String), wage: T.nilable(::String), wage_total: T.nilable(::String), wage_type: T.nilable(::OpenApiSDK::Shared::ContractorPaymentForGroupWageType)).void }
