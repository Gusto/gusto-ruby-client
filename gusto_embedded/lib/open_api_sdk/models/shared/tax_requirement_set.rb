...
module OpenApiSDK
  module Shared
    ...
    class TaxRequirementSet < ::OpenApiSDK::Utils::FieldAugmented
      extend T::Sig
      ...
      field :effective_from, T.nilable(::String), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('effective_from') } }
      ...
      field :requirements, T.nilable(T::Array[::OpenApiSDK::Shared::TaxRequirement]), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('requirements') } }
      ...
      sig { params(effective_from: T.nilable(::String), key: T.nilable(::String), label: T.nilable(::String), requirements: T.nilable(T::Array[::OpenApiSDK::Shared::TaxRequirement]), state: T.nilable(::String)).void }
