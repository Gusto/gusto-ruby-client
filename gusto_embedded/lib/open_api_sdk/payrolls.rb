...
module OpenApiSDK
  ...
  class Payrolls
    ...
    def create(company_id, x_gusto_api_version = nil, request_body = nil)
      # create - Create an off-cycle payroll
    ...
    def list_reversals(company_id, page = nil, per = nil, x_gusto_api_version = nil)
      # list_reversals - Get approved payroll reversals
    ...
    def prepare_for_update(company_id, payroll_id, x_gusto_api_version = nil)
      # prepare_for_update - Prepare a payroll for update
    ...
    def calculate_gross_up(payroll_uuid, x_gusto_api_version = nil, request_body = nil)
    ...
    def get_employee_pay_stubs(employee_id, x_gusto_api_version = nil)
      # get_employee_pay_stubs - Get an employee's pay stubs
    ...
    def generate_printable_checks(payroll_uuid, x_gusto_api_version = nil, request_body = nil)
