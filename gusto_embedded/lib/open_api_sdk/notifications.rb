...
module OpenApiSDK
  ...
  class Notifications
    ...
    def get(notification_uuid, x_gusto_api_version = nil)
      ...
      request = ::OpenApiSDK::Operations::GetNotificationsNotificationUuidRequest.new(
      ...
      url = Utils.generate_url(
        ::OpenApiSDK::Operations::GetNotificationsNotificationUuidRequest,
        base_url,
      ...
      res = ::OpenApiSDK::Operations::GetNotificationsNotificationUuidResponse.new(
        status_code: r.status, content_type: content_type, raw_response: r
      )
      if r.status == 200
        if Utils.match_content_type(content_type, 'application/json')
          out = Utils.unmarshal_complex(r.env.response_body, ::OpenApiSDK::Shared::Notification)
