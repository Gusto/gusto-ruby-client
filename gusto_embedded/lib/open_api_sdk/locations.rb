  ...
  class Locations
    ...
    def create(company_id, x_gusto_api_version = nil, request_body = nil)
      ...
      url = Utils.generate_url(
        ::OpenApiSDK::Operations::PostV1CompaniesCompanyIdLocationsRequest,
        base_url,
      ...
      res = ::OpenApiSDK::Operations::PostV1CompaniesCompanyIdLocationsResponse.new(
        status_code: r.status, content_type: content_type, raw_response: r
      )
      if r.status == 201
        if Utils.match_content_type(content_type, 'application/json')
          out = Utils.unmarshal_complex(r.env.response_body, ::OpenApiSDK::Shared::Location)
          res.location = out
        end
      elsif r.status == 404
      elsif r.status == 422
    ...
    def list(company_id, page = nil, per = nil, x_gusto_api_version = nil)
      ...
      request = ::OpenApiSDK::Operations::GetV1CompaniesCompanyIdLocationsRequest.new(
      ...
      base_url = Utils.template_url(url, params)
      url = Utils.generate_url(
        ::OpenApiSDK::Operations::GetV1CompaniesCompanyIdLocationsRequest,
        base_url,
        '/v1/companies/{company_id}/locations',
        request
      )
      headers = Utils.get_headers(request)
      query_params = Utils.get_query_params(::OpenApiSDK::Operations::GetV1CompaniesCompanyIdLocationsRequest, request)
      headers['Accept'] = 'application/json'
      headers['user-agent'] = @sdk_configuration.user_agent
      ...
      res = ::OpenApiSDK::Operations::GetV1CompaniesCompanyIdLocationsResponse.new(
        status_code: r.status, content_type: content_type, raw_response: r
      )
      if r.status == 200
        if Utils.match_content_type(content_type, 'application/json')
          out = Utils.unmarshal_complex(r.env.response_body, T::Array[::OpenApiSDK::Shared::Location])
    ...
    def get(location_id, x_gusto_api_version = nil)
      ...
      # 
      # scope: `companies:read`
      request = ::OpenApiSDK::Operations::GetV1LocationsLocationIdRequest.new(
      ...
      base_url = Utils.template_url(url, params)
      url = Utils.generate_url(
        ::OpenApiSDK::Operations::GetV1LocationsLocationIdRequest,
        base_url,
      ...
      res = ::OpenApiSDK::Operations::GetV1LocationsLocationIdResponse.new(
        status_code: r.status, content_type: content_type, raw_response: r
      )
      if r.status == 200
        if Utils.match_content_type(content_type, 'application/json')
    ...
    def update(location_id, x_gusto_api_version = nil, request_body = nil)
      ...
      base_url = Utils.template_url(url, params)
      url = Utils.generate_url(
        ::OpenApiSDK::Operations::PutV1LocationsLocationIdRequest,
        base_url,
        '/v1/locations/{location_id}',
        request
      )
      ...
      res = ::OpenApiSDK::Operations::PutV1LocationsLocationIdResponse.new(
        status_code: r.status, content_type: content_type, raw_response: r
      )
      if r.status == 200
        if Utils.match_content_type(content_type, 'application/json')
    ...
    sig { params(location_uuid: ::String, effective_date: T.nilable(::String), x_gusto_api_version: T.nilable(::OpenApiSDK::Shared::VersionHeader)).returns(::OpenApiSDK::Operations::GetV1LocationsLocationUuidMinimumWagesResponse) }
    def get_minimum_wages(location_uuid, effective_date = nil, x_gusto_api_version = nil)
      ...
      # 
      # scope: `companies:read`
      request = ::OpenApiSDK::Operations::GetV1LocationsLocationUuidMinimumWagesRequest.new(
      ...
      base_url = Utils.template_url(url, params)
      url = Utils.generate_url(
        ::OpenApiSDK::Operations::GetV1LocationsLocationUuidMinimumWagesRequest,
        base_url,
        '/v1/locations/{location_uuid}/minimum_wages',
        request
      )
      headers = Utils.get_headers(request)
      query_params = Utils.get_query_params(::OpenApiSDK::Operations::GetV1LocationsLocationUuidMinimumWagesRequest, request)
      headers['Accept'] = 'application/json'
      headers['user-agent'] = @sdk_configuration.user_agent
      ...
      res = ::OpenApiSDK::Operations::GetV1LocationsLocationUuidMinimumWagesResponse.new(
        status_code: r.status, content_type: content_type, raw_response: r
      )
      if r.status == 200
        if Utils.match_content_type(content_type, 'application/json')
          out = Utils.unmarshal_complex(r.env.response_body, T::Array[::OpenApiSDK::Shared::MinimumWage])
