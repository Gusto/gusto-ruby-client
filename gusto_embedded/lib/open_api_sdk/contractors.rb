  ...
  class Contractors
    ...
    def create(company_uuid, request_body, x_gusto_api_version = nil)
      ...
      url = Utils.generate_url(
        ::OpenApiSDK::Operations::PostV1CompaniesCompanyUuidContractorsRequest,
        base_url,
      ...
      res = ::OpenApiSDK::Operations::PostV1CompaniesCompanyUuidContractorsResponse.new(
        status_code: r.status, content_type: content_type, raw_response: r
      )
      if r.status == 201
        if Utils.match_content_type(content_type, 'application/json')
          out = Utils.unmarshal_complex(r.env.response_body, ::OpenApiSDK::Shared::Contractor)
          res.contractor = out
        end
      elsif r.status == 404
      elsif r.status == 422
    ...
    def get(contractor_uuid, x_gusto_api_version = nil)
      ...
      # 
      # scope: `contractors:read`
      request = ::OpenApiSDK::Operations::GetV1ContractorsContractorUuidRequest.new(
      ...
      base_url = Utils.template_url(url, params)
      url = Utils.generate_url(
        ::OpenApiSDK::Operations::GetV1ContractorsContractorUuidRequest,
        base_url,
      ...
      res = ::OpenApiSDK::Operations::GetV1ContractorsContractorUuidResponse.new(
        status_code: r.status, content_type: content_type, raw_response: r
      )
      if r.status == 200
        if Utils.match_content_type(content_type, 'application/json')
    ...
    def update(contractor_uuid, request_body, x_gusto_api_version = nil)
      ...
      base_url = Utils.template_url(url, params)
      url = Utils.generate_url(
        ::OpenApiSDK::Operations::PutV1ContractorsContractorUuidRequest,
        base_url,
        '/v1/contractors/{contractor_uuid}',
        request
      )
      ...
      res = ::OpenApiSDK::Operations::PutV1ContractorsContractorUuidResponse.new(
        status_code: r.status, content_type: content_type, raw_response: r
      )
      if r.status == 200
        if Utils.match_content_type(content_type, 'application/json')
    ...
    sig { params(contractor_uuid: ::String, x_gusto_api_version: T.nilable(::OpenApiSDK::Shared::VersionHeader)).returns(::OpenApiSDK::Operations::DeleteV1ContractorsContractorUuidResponse) }
    def delete(contractor_uuid, x_gusto_api_version = nil)
      # delete - Delete a contractor
      # A contractor can only be deleted when there are no contractor payments.
      # 
      # scope: `contractors:manage`
      request = ::OpenApiSDK::Operations::DeleteV1ContractorsContractorUuidRequest.new(
      ...
      base_url = Utils.template_url(url, params)
      url = Utils.generate_url(
        ::OpenApiSDK::Operations::DeleteV1ContractorsContractorUuidRequest,
        base_url,
        '/v1/contractors/{contractor_uuid}',
        request
      )
      ...
      res = ::OpenApiSDK::Operations::DeleteV1ContractorsContractorUuidResponse.new(
        status_code: r.status, content_type: content_type, raw_response: r
      )
      if r.status == 204
      elsif r.status == 404
    ...
    sig { params(contractor_uuid: ::String, x_gusto_api_version: T.nilable(::OpenApiSDK::Shared::VersionHeader)).returns(::OpenApiSDK::Operations::GetV1ContractorsContractorUuidOnboardingStatusResponse) }
    def get_onboarding_status(contractor_uuid, x_gusto_api_version = nil)
      ...
      request = ::OpenApiSDK::Operations::GetV1ContractorsContractorUuidOnboardingStatusRequest.new(
      ...
      base_url = Utils.template_url(url, params)
      url = Utils.generate_url(
        ::OpenApiSDK::Operations::GetV1ContractorsContractorUuidOnboardingStatusRequest,
        base_url,
      ...
      res = ::OpenApiSDK::Operations::GetV1ContractorsContractorUuidOnboardingStatusResponse.new(
        status_code: r.status, content_type: content_type, raw_response: r
      )
      if r.status == 200
        if Utils.match_content_type(content_type, 'application/json')
          out = Utils.unmarshal_complex(r.env.response_body, ::OpenApiSDK::Shared::ContractorOnboardingStatus)
    ...
    def update_onboarding_status(contractor_uuid, request_body, x_gusto_api_version = nil)
      ...
      base_url = Utils.template_url(url, params)
      url = Utils.generate_url(
        ::OpenApiSDK::Operations::PutV1ContractorsContractorUuidOnboardingStatusRequest,
        base_url,
        '/v1/contractors/{contractor_uuid}/onboarding_status',
        request
      )
      ...
      res = ::OpenApiSDK::Operations::PutV1ContractorsContractorUuidOnboardingStatusResponse.new(
        status_code: r.status, content_type: content_type, raw_response: r
      )
      if r.status == 200
        if Utils.match_content_type(content_type, 'application/json')
    ...
    sig { params(contractor_uuid: ::String, x_gusto_api_version: T.nilable(::OpenApiSDK::Shared::VersionHeader)).returns(::OpenApiSDK::Operations::GetV1ContractorsContractorUuidAddressResponse) }
    def get_address(contractor_uuid, x_gusto_api_version = nil)
      # get_address - Get a contractor address
      # The address of a contractor is used to determine certain tax information about them. Addresses are geocoded on create and update to ensure validity.
      # 
      # scope: `contractors:read`
      request = ::OpenApiSDK::Operations::GetV1ContractorsContractorUuidAddressRequest.new(
      ...
      base_url = Utils.template_url(url, params)
      url = Utils.generate_url(
        ::OpenApiSDK::Operations::GetV1ContractorsContractorUuidAddressRequest,
        base_url,
      ...
      res = ::OpenApiSDK::Operations::GetV1ContractorsContractorUuidAddressResponse.new(
        status_code: r.status, content_type: content_type, raw_response: r
      )
      if r.status == 200
        if Utils.match_content_type(content_type, 'application/json')
          out = Utils.unmarshal_complex(r.env.response_body, ::OpenApiSDK::Shared::ContractorAddress)
    ...
    def update_address(contractor_uuid, request_body, x_gusto_api_version = nil)
      ...
      base_url = Utils.template_url(url, params)
      url = Utils.generate_url(
        ::OpenApiSDK::Operations::PutV1ContractorsContractorUuidAddressRequest,
        base_url,
        '/v1/contractors/{contractor_uuid}/address',
        request
      )
      ...
      res = ::OpenApiSDK::Operations::PutV1ContractorsContractorUuidAddressResponse.new(
        status_code: r.status, content_type: content_type, raw_response: r
      )
      if r.status == 200
        if Utils.match_content_type(content_type, 'application/json')
