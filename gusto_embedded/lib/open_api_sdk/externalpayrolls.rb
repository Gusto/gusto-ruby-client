...
module OpenApiSDK
  ...
  class ExternalPayrolls
    ...
    def list(company_uuid, x_gusto_api_version = nil)
      # list - Get external payrolls for a company
    ...
    def finish_tax_liabilities(company_uuid, x_gusto_api_version = nil)
      # finish_tax_liabilities - Finalize tax liabilities options and convert into processed payrolls
