...
module OpenApiSDK
  ...
  class EmployeeAddresses
    ...
    def get(employee_id, x_gusto_api_version = nil)
      ...
      request = ::OpenApiSDK::Operations::GetV1EmployeesEmployeeIdHomeAddressesRequest.new(
      ...
      url = Utils.generate_url(
        ::OpenApiSDK::Operations::GetV1EmployeesEmployeeIdHomeAddressesRequest,
        base_url,
      ...
      res = ::OpenApiSDK::Operations::GetV1EmployeesEmployeeIdHomeAddressesResponse.new(
        status_code: r.status, content_type: content_type, raw_response: r
      )
      if r.status == 200
        if Utils.match_content_type(content_type, 'application/json')
          out = Utils.unmarshal_complex(r.env.response_body, T::Array[::OpenApiSDK::Shared::EmployeeAddress])
    ...
    def create_home_address(employee_id, x_gusto_api_version = nil, request_body = nil)
      # create_home_address - Create an employee's home address
      # The home address of an employee is used to determine certain tax information about them. Addresses are geocoded on create and update to ensure validity.
      # 
      # Supports home address effective dating and courtesy withholding.
      # 
      ...
      base_url = Utils.template_url(url, params)
      url = Utils.generate_url(
        ::OpenApiSDK::Operations::PostV1EmployeesEmployeeIdHomeAddressesRequest,
        base_url,
        '/v1/employees/{employee_id}/home_addresses',
        request
      )
    ...
    def get_home_by_id(home_address_uuid, x_gusto_api_version = nil)
      # get_home_by_id - Get an employee's home address
      # The home address of an employee is used to determine certain tax information about them. Addresses are geocoded on create and update to ensure validity.
      # 
      # Supports home address effective dating and courtesy withholding.
      # 
      # scope: `employees:read`
      request = ::OpenApiSDK::Operations::GetV1HomeAddressesHomeAddressUuidRequest.new(
      ...
      base_url = Utils.template_url(url, params)
      url = Utils.generate_url(
        ::OpenApiSDK::Operations::GetV1HomeAddressesHomeAddressUuidRequest,
        base_url,
      ...
      res = ::OpenApiSDK::Operations::GetV1HomeAddressesHomeAddressUuidResponse.new(
        status_code: r.status, content_type: content_type, raw_response: r
      )
      if r.status == 200
        if Utils.match_content_type(content_type, 'application/json')
    ...
    def update(home_address_uuid, x_gusto_api_version = nil, request_body = nil)
      ...
      base_url = Utils.template_url(url, params)
      url = Utils.generate_url(
        ::OpenApiSDK::Operations::PutV1HomeAddressesHomeAddressUuidRequest,
        base_url,
        '/v1/home_addresses/{home_address_uuid}',
        request
      )
      ...
      res = ::OpenApiSDK::Operations::PutV1HomeAddressesHomeAddressUuidResponse.new(
        status_code: r.status, content_type: content_type, raw_response: r
      )
      if r.status == 200
        if Utils.match_content_type(content_type, 'application/json')
    ...
    def delete(home_address_uuid, x_gusto_api_version = nil)
      ...
      # 
      # scope: `employees:write`
      request = ::OpenApiSDK::Operations::DeleteV1HomeAddressesHomeAddressUuidRequest.new(
      ...
      base_url = Utils.template_url(url, params)
      url = Utils.generate_url(
        ::OpenApiSDK::Operations::DeleteV1HomeAddressesHomeAddressUuidRequest,
        base_url,
        '/v1/home_addresses/{home_address_uuid}',
        request
      )
      ...
      res = ::OpenApiSDK::Operations::DeleteV1HomeAddressesHomeAddressUuidResponse.new(
        status_code: r.status, content_type: content_type, raw_response: r
      )
    ...
    def get_work_addresses(employee_id, x_gusto_api_version = nil)
      ...
      # 
      # scope: `employees:read`
      request = ::OpenApiSDK::Operations::GetV1EmployeesEmployeeIdWorkAddressesRequest.new(
      ...
      base_url = Utils.template_url(url, params)
      url = Utils.generate_url(
        ::OpenApiSDK::Operations::GetV1EmployeesEmployeeIdWorkAddressesRequest,
        base_url,
      ...
      res = ::OpenApiSDK::Operations::GetV1EmployeesEmployeeIdWorkAddressesResponse.new(
        status_code: r.status, content_type: content_type, raw_response: r
      )
      if r.status == 200
        if Utils.match_content_type(content_type, 'application/json')
          out = Utils.unmarshal_complex(r.env.response_body, T::Array[::OpenApiSDK::Shared::EmployeeWorkAddress])
    ...
    def create_work_address(employee_id, x_gusto_api_version = nil, request_body = nil)
      ...
      base_url = Utils.template_url(url, params)
      url = Utils.generate_url(
        ::OpenApiSDK::Operations::PostV1EmployeesEmployeeIdWorkAddressesRequest,
        base_url,
        '/v1/employees/{employee_id}/work_addresses',
        request
      )
      ...
      res = ::OpenApiSDK::Operations::PostV1EmployeesEmployeeIdWorkAddressesResponse.new(
        status_code: r.status, content_type: content_type, raw_response: r
      )
      if r.status == 201
        if Utils.match_content_type(content_type, 'application/json')
          out = Utils.unmarshal_complex(r.env.response_body, ::OpenApiSDK::Shared::EmployeeWorkAddress)
    ...
    def get_work_address(work_address_uuid, x_gusto_api_version = nil)
      ...
      # 
      # scope: `employees:read`
      request = ::OpenApiSDK::Operations::GetV1WorkAddressesWorkAddressUuidRequest.new(
      ...
      base_url = Utils.template_url(url, params)
      url = Utils.generate_url(
        ::OpenApiSDK::Operations::GetV1WorkAddressesWorkAddressUuidRequest,
        base_url,
      ...
      res = ::OpenApiSDK::Operations::GetV1WorkAddressesWorkAddressUuidResponse.new(
        status_code: r.status, content_type: content_type, raw_response: r
      )
      if r.status == 200
        if Utils.match_content_type(content_type, 'application/json')
    ...
    def update_work_address(work_address_uuid, x_gusto_api_version = nil, request_body = nil)
      ...
      base_url = Utils.template_url(url, params)
      url = Utils.generate_url(
        ::OpenApiSDK::Operations::PutV1WorkAddressesWorkAddressUuidRequest,
        base_url,
        '/v1/work_addresses/{work_address_uuid}',
        request
      )
      ...
      res = ::OpenApiSDK::Operations::PutV1WorkAddressesWorkAddressUuidResponse.new(
        status_code: r.status, content_type: content_type, raw_response: r
      )
      if r.status == 200
        if Utils.match_content_type(content_type, 'application/json')
    ...
    def remove(work_address_uuid, x_gusto_api_version = nil)
      # remove - Delete an employee's work address
      # Used for deleting an employee's work address.  Cannot delete the employee's active work address.
      # 
      # scope: `employees:manage`
      request = ::OpenApiSDK::Operations::DeleteV1WorkAddressesWorkAddressUuidRequest.new(
      ...
      base_url = Utils.template_url(url, params)
      url = Utils.generate_url(
        ::OpenApiSDK::Operations::DeleteV1WorkAddressesWorkAddressUuidRequest,
        base_url,
        '/v1/work_addresses/{work_address_uuid}',
        request
      )
      ...
      res = ::OpenApiSDK::Operations::DeleteV1WorkAddressesWorkAddressUuidResponse.new(
        status_code: r.status, content_type: content_type, raw_response: r
      )
      if [204, 404].include?(r.status)
      elsif r.status == 422
