...
module OpenApiSDK
  ...
  class CompanyBenefits
    ...
    def get_by_id(company_benefit_id, with_employee_benefits = nil, x_gusto_api_version = nil)
    ...
    def get_all_supported(x_gusto_api_version = nil)
      # get_all_supported - Get all benefits supported by Gusto
    ...
    def get(benefit_id, x_gusto_api_version = nil)
    ...
    def bulk_update(company_benefit_id, x_gusto_api_version = nil, request_body = nil)
      # bulk_update - Bulk update employee benefits for a company benefit
      # Employee benefits represent an employee enrolled in a particular company benefit. It includes information specific to that employee’s enrollment.
      # 
