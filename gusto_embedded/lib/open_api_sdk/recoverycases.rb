...
module OpenApiSDK
  ...
  class RecoveryCases
    ...
    def get_all(company_uuid, x_gusto_api_version = nil)
      # get_all - Get all recovery cases for a company
    ...
    def initiate_redeit(recovery_case_uuid, x_gusto_api_version = nil)
      # initiate_redeit - Initiate a redebit for a recovery case
