...
module OpenApiSDK
  ...
  class ContractorPaymentGroups
    ...
    def list(request)
      # list - Get contractor payment groups for a company
    ...
    def fetch(contractor_payment_group_uuid, x_gusto_api_version = nil)
    ...
    def cancel(contractor_payment_group_uuid, x_gusto_api_version = nil)
      # cancel - Cancel a contractor payment group
