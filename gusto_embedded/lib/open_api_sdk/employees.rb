...
module OpenApiSDK
  ...
  class Employees
    ...
    def update_onboarding_documents_config(employee_id, request_body, x_gusto_api_version = nil)
      ...
      base_url = Utils.template_url(url, params)
      url = Utils.generate_url(
        ::OpenApiSDK::Operations::PutV1EmployeesEmployeeIdOnboardingDocumentsConfigRequest,
        base_url,
      ...
      res = ::OpenApiSDK::Operations::PutV1EmployeesEmployeeIdOnboardingDocumentsConfigResponse.new(
        status_code: r.status, content_type: content_type, raw_response: r
      )
      if r.status == 200
        if Utils.match_content_type(content_type, 'application/json')
          out = Utils.unmarshal_complex(r.env.response_body, ::OpenApiSDK::Shared::EmployeeOnboardingDocument)
