...
module GustoEmbedded
  ...
  class AchTransactions
    ...
    sig { params(request: Models::Operations::GetAchTransactionsRequest, timeout_ms: T.nilable(Integer)).returns(Models::Operations::GetAchTransactionsResponse) }
    def get_all(request:, timeout_ms: nil)
