...
module GustoEmbedded
  ...
  class Suspensions
    ...
    sig { params(company_uuid: ::String, x_gusto_api_version: T.nilable(Models::Operations::GetCompaniesCompanyUuidSuspensionsHeaderXGustoAPIVersion), timeout_ms: T.nilable(Integer)).returns(Models::Operations::GetCompaniesCompanyUuidSuspensionsResponse) }
    ...
    sig { params(request_body: Models::Operations::PostCompaniesCompanyUuidSuspensionsRequestBody, company_uuid: ::String, x_gusto_api_version: T.nilable(Models::Operations::PostCompaniesCompanyUuidSuspensionsHeaderXGustoAPIVersion), timeout_ms: T.nilable(Integer)).returns(Models::Operations::PostCompaniesCompanyUuidSuspensionsResponse) }
    def suspend(request_body:, company_uuid:, x_gusto_api_version: nil, timeout_ms: nil)
      ...
      if Utils.match_status_code(http_response.status, ['200'])
        ...
        if Utils.match_content_type(content_type, 'application/json')
          ...
          response_data = http_response.env.response_body
          obj = Crystalline.unmarshal_json(JSON.parse(response_data), Models::Errors::CompanySuspensionCreationErrors)
          raise obj
        else
          raise ::GustoEmbedded::Models::Errors::APIError.new(status_code: http_response.status, body: http_response.env.response_body, raw_response: http_response), 'Unknown content type received'
        end
