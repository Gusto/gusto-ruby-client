  ...
  module Models
    module Operations
      ...
      class GetCompaniesCompanyUuidReportTemplatesReportTypeRequest
        ...
        sig { params(company_uuid: ::String, report_type: ::String, x_gusto_api_version: T.nilable(Models::Shared::VersionHeader)).void }
        def initialize(company_uuid:, report_type:, x_gusto_api_version: Models::Shared::VersionHeader::TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15)
