...
module GustoEmbedded
  module Operations
    ...
    class PutV1TimeOffPoliciesTimeOffPolicyUuidDeactivateRequest < ::Crystalline::FieldAugmented
      extend T::Sig
      ...
      sig { params(time_off_policy_uuid: ::String, x_gusto_api_version: T.nilable(::GustoEmbedded::Shared::VersionHeader)).void }
