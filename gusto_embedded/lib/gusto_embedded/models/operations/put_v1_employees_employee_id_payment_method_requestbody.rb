  ...
  module Models
    module Operations
      ...
      class PutV1EmployeesEmployeeIdPaymentMethodRequestBody
        ...
        field :type, Models::Operations::Type, { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('type'), required: true, 'decoder': Utils.enum_from_string(Models::Operations::Type, false) } }
        ...
        field :split_by, Crystalline::Nilable.new(Models::Operations::SplitBy), { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('split_by'), 'decoder': Utils.enum_from_string(Models::Operations::SplitBy, true) } }
