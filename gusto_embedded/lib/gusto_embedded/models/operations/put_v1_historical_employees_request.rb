  ...
  module Models
    module Operations
      ...
      class PutV1HistoricalEmployeesRequest
        ...
        sig { params(company_uuid: ::String, historical_employee_uuid: ::String, request_body: Models::Operations::PutV1HistoricalEmployeesRequestBody, x_gusto_api_version: T.nilable(Models::Shared::VersionHeader)).void }
        def initialize(company_uuid:, historical_employee_uuid:, request_body:, x_gusto_api_version: Models::Shared::VersionHeader::TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15)
