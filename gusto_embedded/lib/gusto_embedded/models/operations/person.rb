  ...
  module Models
    module Operations
      ...
      class Person
        ...
        field :external_id, ::String, { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('external_id'), required: true } }
        # Legal first name
        ...
        sig { params(external_id: ::String, first_name: ::String, last_name: ::String, middle_initial: T.nilable(::String), preferred_first_name: T.nilable(::String), email: T.nilable(::String), work_email: T.nilable(::String), ssn: T.nilable(::String), date_of_birth: T.nilable(::Date), self_onboarding: T.nilable(T::Boolean)).void }
