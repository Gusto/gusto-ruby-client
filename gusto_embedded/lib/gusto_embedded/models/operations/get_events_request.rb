  ...
  module Models
    module Operations
      ...
      class GetEventsRequest
        ...
        field :sort_order, Crystalline::Nilable.new(Models::Shared::SortOrder), { 'query_param': { 'field_name': 'sort_order', 'style': 'form', 'explode': true } }
        ...
        sig { params(starting_after_uuid: T.nilable(::String), resource_uuid: T.nilable(::String), limit: T.nilable(::String), event_type: T.nilable(::String), sort_order: T.nilable(Models::Shared::SortOrder), x_gusto_api_version: T.nilable(Models::Shared::VersionHeader)).void }
        def initialize(starting_after_uuid: nil, resource_uuid: nil, limit: nil, event_type: nil, sort_order: nil, x_gusto_api_version: Models::Shared::VersionHeader::TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15)
