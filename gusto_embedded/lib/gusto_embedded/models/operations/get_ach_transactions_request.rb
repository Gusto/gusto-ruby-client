  ...
  module Models
    module Operations
      ...
      class GetAchTransactionsRequest
        ...
        field :contractor_payment_uuid, Crystalline::Nilable.new(::String), { 'query_param': { 'field_name': 'contractor_payment_uuid', 'style': 'form', 'explode': true } }
        ...
        field :payment_direction, Crystalline::Nilable.new(::String), { 'query_param': { 'field_name': 'payment_direction', 'style': 'form', 'explode': true } }
        ...
        sig { params(company_uuid: ::String, contractor_payment_uuid: T.nilable(::String), payroll_uuid: T.nilable(::String), transaction_type: T.nilable(::String), payment_direction: T.nilable(::String), page: T.nilable(::Integer), per: T.nilable(::Integer), x_gusto_api_version: T.nilable(Models::Shared::VersionHeader)).void }
        def initialize(company_uuid:, contractor_payment_uuid: nil, payroll_uuid: nil, transaction_type: nil, payment_direction: nil, page: nil, per: nil, x_gusto_api_version: Models::Shared::VersionHeader::TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15)
