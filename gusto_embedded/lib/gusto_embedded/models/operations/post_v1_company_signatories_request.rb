  ...
  module Models
    module Operations
      ...
      class PostV1CompanySignatoriesRequest
        ...
        field :request_body, Models::Operations::PostV1CompanySignatoriesRequestBody, { 'request': { 'media_type': 'application/json' } }
        ...
        sig { params(company_uuid: ::String, request_body: Models::Operations::PostV1CompanySignatoriesRequestBody, x_gusto_api_version: T.nilable(Models::Shared::VersionHeader)).void }
