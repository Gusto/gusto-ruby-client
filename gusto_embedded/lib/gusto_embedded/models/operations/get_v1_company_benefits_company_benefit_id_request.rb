  ...
  module Models
    module Operations
      ...
      class GetV1CompanyBenefitsCompanyBenefitIdRequest
        ...
        sig { params(company_benefit_id: ::String, with_employee_benefits: T.nilable(T::Boolean), x_gusto_api_version: T.nilable(Models::Shared::VersionHeader)).void }
        def initialize(company_benefit_id:, with_employee_benefits: nil, x_gusto_api_version: Models::Shared::VersionHeader::TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15)
