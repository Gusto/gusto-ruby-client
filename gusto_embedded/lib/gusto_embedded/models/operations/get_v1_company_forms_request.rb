  ...
  module Models
    module Operations
      ...
      class GetV1CompanyFormsRequest
        ...
        field :sort_by, Crystalline::Nilable.new(Models::Shared::CompanyFormsSortBy), { 'query_param': { 'field_name': 'sort_by', 'style': 'form', 'explode': true } }
        ...
        sig { params(company_id: ::String, sort_by: T.nilable(Models::Shared::CompanyFormsSortBy), x_gusto_api_version: T.nilable(Models::Shared::VersionHeader)).void }
        def initialize(company_id:, sort_by: nil, x_gusto_api_version: Models::Shared::VersionHeader::TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15)
