  ...
  module Models
    module Operations
      ...
      class GetInvoicesInvoicePeriodRequest
        ...
        sig { params(invoice_period: ::String, page: T.nilable(::Integer), per: T.nilable(::Integer), company_uuids: T.nilable(::String), x_gusto_api_version: T.nilable(Models::Shared::VersionHeader)).void }
        def initialize(invoice_period:, page: nil, per: nil, company_uuids: nil, x_gusto_api_version: Models::Shared::VersionHeader::TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15)
