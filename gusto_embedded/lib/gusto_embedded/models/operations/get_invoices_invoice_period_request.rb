...
module GustoEmbedded
  module Operations
    ...
    class GetInvoicesInvoicePeriodRequest < ::Crystalline::FieldAugmented
      ...
      sig { params(invoice_period: ::String, company_uuids: T.nilable(::String), page: T.nilable(::Float), per: T.nilable(::Float), x_gusto_api_version: T.nilable(::GustoEmbedded::Shared::VersionHeader)).void }
