...
module GustoEmbedded
  module Models
    module Operations
      ...
      class PutVersionTimeOffPoliciesTimeOffPolicyUuidAddEmployeesRequest
        extend T::Sig
        ...
        field :request_body, Models::Operations::PutVersionTimeOffPoliciesTimeOffPolicyUuidAddEmployeesRequestBody, { 'request': { 'media_type': 'application/json' } }
        ...
        sig { params(time_off_policy_uuid: ::String, request_body: Models::Operations::PutVersionTimeOffPoliciesTimeOffPolicyUuidAddEmployeesRequestBody, x_gusto_api_version: T.nilable(Models::Shared::VersionHeader)).void }
        def initialize(time_off_policy_uuid:, request_body:, x_gusto_api_version: Models::Shared::VersionHeader::TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15)
