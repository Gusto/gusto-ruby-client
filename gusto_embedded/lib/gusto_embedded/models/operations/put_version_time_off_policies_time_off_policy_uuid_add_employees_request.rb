...
module GustoEmbedded
  module Operations
    ...
    class PutVersionTimeOffPoliciesTimeOffPolicyUuidAddEmployeesRequest < ::Crystalline::FieldAugmented
      extend T::Sig

      # A list of employee objects containing the employee uuid
      field :request_body, ::GustoEmbedded::Operations::PutVersionTimeOffPoliciesTimeOffPolicyUuidAddEmployeesRequestBody, { 'request': { 'media_type': 'application/json' } }
      ...
      sig { params(request_body: ::GustoEmbedded::Operations::PutVersionTimeOffPoliciesTimeOffPolicyUuidAddEmployeesRequestBody, time_off_policy_uuid: ::String, x_gusto_api_version: T.nilable(::GustoEmbedded::Shared::VersionHeader)).void }
