  ...
  module Models
    module Operations
      ...
      class PostV1CompaniesCompanyIdContractorPaymentGroupsContractorPayments
        ...
        sig { params(contractor_uuid: T.nilable(::String), wage: T.nilable(::String), hours: T.nilable(::String), bonus: T.nilable(::String), reimbursement: T.nilable(::String), payment_method: T.nilable(Models::Operations::PostV1CompaniesCompanyIdContractorPaymentGroupsPaymentMethod)).void }
        def initialize(contractor_uuid: nil, wage: nil, hours: nil, bonus: nil, reimbursement: nil, payment_method: Models::Operations::PostV1CompaniesCompanyIdContractorPaymentGroupsPaymentMethod::DIRECT_DEPOSIT)
