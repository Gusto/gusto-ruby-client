...
module GustoEmbedded
  module Models
    module Operations
      ...
      class PostV1CompaniesCompanyUuidContractorsRequestBody
        extend T::Sig
        include Crystalline::MetadataFields

        # The contractor’s wage type.
        # 
        field :wage_type, Models::Operations::WageType, { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('wage_type'), required: true, 'decoder': Utils.enum_from_string(Models::Operations::WageType, false) } }
        ...
        # The contractor type.
        field :type, Crystalline::Nilable.new(Models::Operations::PostV1CompaniesCompanyUuidContractorsType), { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('type'), 'decoder': Utils.enum_from_string(Models::Operations::PostV1CompaniesCompanyUuidContractorsType, true) } }
        ...
        sig { params(wage_type: Models::Operations::WageType, start_date: ::String, hourly_rate: T.nilable(::String), email: T.nilable(::String), first_name: T.nilable(::String), last_name: T.nilable(::String), middle_initial: T.nilable(::String), ssn: T.nilable(::String), business_name: T.nilable(::String), ein: T.nilable(::String), is_active: T.nilable(T::Boolean), type: T.nilable(Models::Operations::PostV1CompaniesCompanyUuidContractorsType), self_onboarding: T.nilable(T::Boolean), file_new_hire_report: T.nilable(T::Boolean), work_state: T.nilable(::String)).void }
        def initialize(wage_type:, start_date:, hourly_rate: nil, email: nil, first_name: nil, last_name: nil, middle_initial: nil, ssn: nil, business_name: nil, ein: nil, is_active: nil, type: Models::Operations::PostV1CompaniesCompanyUuidContractorsType::INDIVIDUAL, self_onboarding: false, file_new_hire_report: false, work_state: nil)
          @wage_type = wage_type
