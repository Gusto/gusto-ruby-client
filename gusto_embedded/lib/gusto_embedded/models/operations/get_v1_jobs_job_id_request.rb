  ...
  module Models
    module Operations
      ...
      class GetV1JobsJobIdRequest
        ...
        sig { params(job_id: ::String, include: T.nilable(Models::Operations::GetV1JobsJobIdQueryParamInclude), x_gusto_api_version: T.nilable(Models::Shared::VersionHeader)).void }
        def initialize(job_id:, include: nil, x_gusto_api_version: Models::Shared::VersionHeader::TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15)
          @job_id = job_id
          @include = include
