  ...
  module Models
    module Operations
      ...
      class GetV1JobsJobIdCompensationsRequest
        ...
        sig { params(job_id: ::String, page: T.nilable(::Integer), per: T.nilable(::Integer), include: T.nilable(Models::Operations::GetV1JobsJobIdCompensationsQueryParamInclude), x_gusto_api_version: T.nilable(Models::Shared::VersionHeader)).void }
        def initialize(job_id:, page: nil, per: nil, include: nil, x_gusto_api_version: Models::Shared::VersionHeader::TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15)
          @job_id = job_id
          @page = page
          @per = per
          @include = include
