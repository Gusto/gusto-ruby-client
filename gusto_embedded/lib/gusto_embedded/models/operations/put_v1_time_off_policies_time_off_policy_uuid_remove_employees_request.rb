  ...
  module Models
    module Operations
      ...
      class PutV1TimeOffPoliciesTimeOffPolicyUuidRemoveEmployeesRequest
        ...
        sig { params(time_off_policy_uuid: ::String, request_body: Models::Operations::PutV1TimeOffPoliciesTimeOffPolicyUuidRemoveEmployeesRequestBody, x_gusto_api_version: T.nilable(Models::Shared::VersionHeader)).void }
