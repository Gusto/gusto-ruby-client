  ...
  module Models
    module Operations
      ...
      class PutV1CompaniesCompanyIdPayrollsPayrollIdPrepareRequest
        ...
        field :sort_by, Crystalline::Nilable.new(Models::Shared::PayrollPrepareSortBy), { 'query_param': { 'field_name': 'sort_by', 'style': 'form', 'explode': true } }
        ...
        sig { params(company_id: ::String, payroll_id: ::String, page: T.nilable(::Integer), per: T.nilable(::Integer), sort_by: T.nilable(Models::Shared::PayrollPrepareSortBy), request_body: T.nilable(Models::Operations::PutV1CompaniesCompanyIdPayrollsPayrollIdPrepareRequestBody), x_gusto_api_version: T.nilable(Models::Shared::VersionHeader)).void }
        def initialize(company_id:, payroll_id:, page: nil, per: nil, sort_by: nil, request_body: nil, x_gusto_api_version: Models::Shared::VersionHeader::TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15)
