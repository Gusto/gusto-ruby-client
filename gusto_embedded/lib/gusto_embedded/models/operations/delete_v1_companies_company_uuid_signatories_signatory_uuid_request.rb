...
module GustoEmbedded
  module Operations
    ...
    class DeleteV1CompaniesCompanyUuidSignatoriesSignatoryUuidRequest < ::Crystalline::FieldAugmented
      extend T::Sig
      ...
      sig { params(company_uuid: ::String, signatory_uuid: ::String, x_gusto_api_version: T.nilable(::GustoEmbedded::Shared::VersionHeader)).void }
