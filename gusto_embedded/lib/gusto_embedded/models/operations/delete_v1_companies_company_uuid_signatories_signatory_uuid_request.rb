  ...
  module Models
    module Operations
      ...
      class DeleteV1CompaniesCompanyUuidSignatoriesSignatoryUuidRequest
        ...
        sig { params(company_uuid: ::String, signatory_uuid: ::String, x_gusto_api_version: T.nilable(Models::Shared::VersionHeader)).void }
        def initialize(company_uuid:, signatory_uuid:, x_gusto_api_version: Models::Shared::VersionHeader::TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15)
