  ...
  module Models
    module Operations
      ...
      class DeleteV1EmployeesEmployeeIdBankAccountsBankAccountIdRequest
        ...
        sig { params(employee_id: ::String, bank_account_uuid: ::String, x_gusto_api_version: T.nilable(Models::Shared::VersionHeader)).void }
        def initialize(employee_id:, bank_account_uuid:, x_gusto_api_version: Models::Shared::VersionHeader::TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15)
