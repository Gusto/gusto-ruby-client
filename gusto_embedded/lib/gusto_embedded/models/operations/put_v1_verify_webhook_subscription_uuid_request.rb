  ...
  module Models
    module Operations
      ...
      class PutV1VerifyWebhookSubscriptionUuidRequest
        ...
        sig { params(webhook_subscription_uuid: ::String, request_body: Models::Operations::PutV1VerifyWebhookSubscriptionUuidRequestBody, x_gusto_api_version: T.nilable(Models::Shared::VersionHeader)).void }
        def initialize(webhook_subscription_uuid:, request_body:, x_gusto_api_version: Models::Shared::VersionHeader::TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15)
