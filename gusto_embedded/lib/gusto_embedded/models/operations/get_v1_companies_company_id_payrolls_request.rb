...
module GustoEmbedded
  module Operations
    ...
    class GetV1CompaniesCompanyIdPayrollsRequest < ::Crystalline::FieldAugmented
      ...
      sig { params(company_id: ::String, end_date: T.nilable(::String), include: T.nilable(T::Array[::GustoEmbedded::Operations::GetV1CompaniesCompanyIdPayrollsQueryParamInclude]), include_off_cycle: T.nilable(T::Boolean), page: T.nilable(::Integer), payroll_types: T.nilable(T::Array[::GustoEmbedded::Operations::PayrollTypes]), per: T.nilable(::Integer), processed: T.nilable(T::Boolean), processing_statuses: T.nilable(T::Array[::GustoEmbedded::Operations::ProcessingStatuses]), sort_order: T.nilable(::GustoEmbedded::Operations::SortOrder), start_date: T.nilable(::String), x_gusto_api_version: T.nilable(::GustoEmbedded::Operations::GetV1CompaniesCompanyIdPayrollsHeaderXGustoAPIVersion)).void }
      def initialize(company_id: nil, end_date: nil, include: nil, include_off_cycle: nil, page: nil, payroll_types: nil, per: nil, processed: nil, processing_statuses: nil, sort_order: nil, start_date: nil, x_gusto_api_version: nil)
