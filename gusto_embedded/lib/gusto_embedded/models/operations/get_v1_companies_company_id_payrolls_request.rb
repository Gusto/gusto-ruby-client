...
module GustoEmbedded
  module Operations
    ...
    class GetV1CompaniesCompanyIdPayrollsRequest < ::Crystalline::FieldAugmented
      ...
      sig { params(company_id: ::String, end_date: T.nilable(::String), include: T.nilable(T::Array[::GustoEmbedded::Operations::GetV1CompaniesCompanyIdPayrollsQueryParamInclude]), payroll_types: T.nilable(T::Array[::GustoEmbedded::Operations::PayrollTypes]), processing_statuses: T.nilable(T::Array[::GustoEmbedded::Operations::ProcessingStatuses]), sort_order: T.nilable(::GustoEmbedded::Shared::SortOrder), start_date: T.nilable(::String), x_gusto_api_version: T.nilable(::GustoEmbedded::Shared::VersionHeader)).void }
