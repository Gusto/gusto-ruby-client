  ...
  module Models
    module Operations
      ...
      class GetV1CompaniesCompanyIdContractorPaymentsRequest
        ...
        sig { params(company_id: ::String, start_date: ::String, end_date: ::String, contractor_uuid: T.nilable(::String), group_by_date: T.nilable(T::Boolean), page: T.nilable(::Integer), per: T.nilable(::Integer), x_gusto_api_version: T.nilable(Models::Shared::VersionHeader)).void }
        def initialize(company_id:, start_date:, end_date:, contractor_uuid: nil, group_by_date: nil, page: nil, per: nil, x_gusto_api_version: Models::Shared::VersionHeader::TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15)
