...
module GustoEmbedded
  module Operations
    ...
    class PutV1SalaryEstimatesIdOccupations < ::Crystalline::FieldAugmented
      extend T::Sig
      ...
      field :experience_level, ::GustoEmbedded::Operations::PutV1SalaryEstimatesIdExperienceLevel, { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('experience_level'), 'decoder': Utils.enum_from_string(::GustoEmbedded::Operations::PutV1SalaryEstimatesIdExperienceLevel, false) } }
      ...
      sig { params(code: ::String, experience_level: ::GustoEmbedded::Operations::PutV1SalaryEstimatesIdExperienceLevel, time_percentage: ::String, primary: T.nilable(T::Boolean)).void }
