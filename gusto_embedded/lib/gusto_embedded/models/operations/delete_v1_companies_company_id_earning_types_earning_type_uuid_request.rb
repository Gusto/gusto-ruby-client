  ...
  module Models
    module Operations
      ...
      class DeleteV1CompaniesCompanyIdEarningTypesEarningTypeUuidRequest
        ...
        sig { params(company_id: ::String, earning_type_uuid: ::String, x_gusto_api_version: T.nilable(Models::Shared::VersionHeader)).void }
        def initialize(company_id:, earning_type_uuid:, x_gusto_api_version: Models::Shared::VersionHeader::TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15)
