...
module GustoEmbedded
  module Operations
    ...
    class DeleteV1CompaniesCompanyIdEarningTypesEarningTypeUuidRequest < ::Crystalline::FieldAugmented
      extend T::Sig
      ...
      sig { params(company_id: ::String, earning_type_uuid: ::String, x_gusto_api_version: T.nilable(::GustoEmbedded::Shared::VersionHeader)).void }
