  ...
  module Models
    module Operations
      ...
      class PutV1EmployeesEmployeeIdFederalTaxesRequestBody
        ...
        field :w4_data_type, Models::Operations::W4DataType, { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('w4_data_type'), required: true, 'decoder': ::GustoEmbedded::Utils.enum_from_string(Models::Operations::W4DataType, false) } }
        # Determines which tax return form an individual will use. One of: Single, Married, Head of Household, Exempt from withholding.
        field :filing_status, Models::Operations::FilingStatus, { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('filing_status'), required: true, 'decoder': ::GustoEmbedded::Utils.enum_from_string(Models::Operations::FilingStatus, false) } }
        ...
        field :dependents_amount, Crystalline::Nilable.new(::Float), { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('dependents_amount') } }
        # Other income amount.
        field :other_income, Crystalline::Nilable.new(::Float), { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('other_income') } }
        # Deductions other than the standard deduction to reduce withholding.
        field :deductions, Crystalline::Nilable.new(::Float), { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('deductions') } }
        # Additional amount to be withheld from each paycheck.
        field :extra_withholding, Crystalline::Nilable.new(::Float), { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('extra_withholding') } }
        # Only applicable when w4_data_type is 'pre_2020_w4' (pre-2020 W4 forms are deprecated for updates).
        field :federal_withholding_allowance, Crystalline::Nilable.new(::Integer), { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('federal_withholding_allowance') } }
        # Only applicable when w4_data_type is 'pre_2020_w4' (pre-2020 W4 forms are deprecated for updates).
        field :additional_withholding, Crystalline::Nilable.new(::Float), { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('additional_withholding') } }

        sig { params(version: ::String, w4_data_type: Models::Operations::W4DataType, filing_status: Models::Operations::FilingStatus, two_jobs: T.nilable(T::Boolean), dependents_amount: T.nilable(::Float), other_income: T.nilable(::Float), deductions: T.nilable(::Float), extra_withholding: T.nilable(::Float), federal_withholding_allowance: T.nilable(::Integer), additional_withholding: T.nilable(::Float)).void }
