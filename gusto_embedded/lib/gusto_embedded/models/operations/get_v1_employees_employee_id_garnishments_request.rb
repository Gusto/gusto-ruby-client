...
module GustoEmbedded
  module Operations
    ...
    class GetV1EmployeesEmployeeIdGarnishmentsRequest < ::Crystalline::FieldAugmented
      extend T::Sig
      ...
      sig { params(employee_id: ::String, page: T.nilable(::Float), per: T.nilable(::Float), x_gusto_api_version: T.nilable(::GustoEmbedded::Shared::VersionHeader)).void }
