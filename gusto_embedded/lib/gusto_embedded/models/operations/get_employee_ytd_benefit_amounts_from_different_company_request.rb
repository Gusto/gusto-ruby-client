  ...
  module Models
    module Operations
      ...
      class GetEmployeeYtdBenefitAmountsFromDifferentCompanyRequest
        ...
        sig { params(employee_id: ::String, tax_year: T.nilable(::Integer), x_gusto_api_version: T.nilable(Models::Shared::VersionHeader)).void }
        def initialize(employee_id:, tax_year: nil, x_gusto_api_version: Models::Shared::VersionHeader::TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15)
