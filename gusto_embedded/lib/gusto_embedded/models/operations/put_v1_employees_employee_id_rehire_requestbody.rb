...
module GustoEmbedded
  module Models
    module Operations
      ...
      class PutV1EmployeesEmployeeIdRehireRequestBody
        extend T::Sig
        ...
        field :employment_status, Crystalline::Nilable.new(Models::Operations::EmploymentStatus), { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('employment_status'), 'decoder': Utils.enum_from_string(Models::Operations::EmploymentStatus, true) } }
        ...
        sig { params(version: ::String, effective_date: ::String, file_new_hire_report: T::Boolean, work_location_uuid: ::String, employment_status: T.nilable(Models::Operations::EmploymentStatus), two_percent_shareholder: T.nilable(T::Boolean)).void }
