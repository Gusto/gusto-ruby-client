...
module GustoEmbedded
  module Operations
    ...
    class PutV1LocationsLocationIdRequest < ::Crystalline::FieldAugmented
      ...
      sig { params(location_id: ::String, request_body: ::GustoEmbedded::Operations::PutV1LocationsLocationIdRequestBody, x_gusto_api_version: T.nilable(::GustoEmbedded::Shared::VersionHeader)).void }
