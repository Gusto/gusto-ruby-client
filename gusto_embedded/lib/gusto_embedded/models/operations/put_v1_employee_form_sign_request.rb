  ...
  module Models
    module Operations
      ...
      class PutV1EmployeeFormSignRequest
        ...
        sig { params(employee_id: ::String, form_id: ::String, request_body: Models::Operations::PutV1EmployeeFormSignRequestBody, x_gusto_client_ip: T.nilable(::String), x_gusto_api_version: T.nilable(Models::Shared::VersionHeader)).void }
        def initialize(employee_id:, form_id:, request_body:, x_gusto_client_ip: nil, x_gusto_api_version: Models::Shared::VersionHeader::TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15)
