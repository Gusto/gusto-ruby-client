  ...
  module Models
    module Operations
      ...
      class PutV1EmployeesEmployeeIdI9AuthorizationEmployerSignRequest
        ...
        field :request_body, Models::Operations::PutV1EmployeesEmployeeIdI9AuthorizationEmployerSignRequestBody, { 'request': { 'media_type': 'application/json' } }
        ...
        sig { params(employee_id: ::String, request_body: Models::Operations::PutV1EmployeesEmployeeIdI9AuthorizationEmployerSignRequestBody, x_gusto_client_ip: T.nilable(::String), x_gusto_api_version: T.nilable(Models::Shared::VersionHeader)).void }
        def initialize(employee_id:, request_body:, x_gusto_client_ip: nil, x_gusto_api_version: Models::Shared::VersionHeader::TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15)
