...
module GustoEmbedded
  module Operations
    ...
    class PutV1SalaryEstimatesIdRequestBody < ::Crystalline::FieldAugmented
      extend T::Sig

      # Array of occupations. Time percentages must sum to 100%.
      field :occupations, T::Array[::GustoEmbedded::Operations::PutV1SalaryEstimatesIdOccupations], { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('occupations') } }
      ...
      sig { params(occupations: T::Array[::GustoEmbedded::Operations::PutV1SalaryEstimatesIdOccupations], zip_code: ::String, annual_net_revenue: T.nilable(::Float)).void }
