  ...
  module Models
    module Operations
      ...
      class PostV1CompanyFlowsRequest
        ...
        field :request_body, Models::Operations::PostV1CompanyFlowsRequestBody, { 'request': { 'media_type': 'application/json' } }
        ...
        sig { params(company_uuid: ::String, request_body: Models::Operations::PostV1CompanyFlowsRequestBody, x_gusto_api_version: T.nilable(Models::Shared::VersionHeader)).void }
