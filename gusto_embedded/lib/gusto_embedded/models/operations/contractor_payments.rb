  ...
  module Models
    module Operations
      ...
      class ContractorPayments
        ...
        sig { params(contractor_uuid: T.nilable(::String), wage: T.nilable(::String), hours: T.nilable(::String), bonus: T.nilable(::String), reimbursement: T.nilable(::String), payment_method: T.nilable(Models::Operations::PaymentMethod)).void }
