...
module GustoEmbedded
  module Operations
    ...
    class GetV1CompaniesCompanyIdPaySchedulesPayScheduleIdRequest < ::Crystalline::FieldAugmented
      extend T::Sig
      ...
      sig { params(company_id: ::String, pay_schedule_id: ::String, x_gusto_api_version: T.nilable(::GustoEmbedded::Shared::VersionHeader)).void }
