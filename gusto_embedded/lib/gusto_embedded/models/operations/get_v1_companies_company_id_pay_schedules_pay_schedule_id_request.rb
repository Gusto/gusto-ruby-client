  ...
  module Models
    module Operations
      ...
      class GetV1CompaniesCompanyIdPaySchedulesPayScheduleIdRequest
        ...
        sig { params(company_id: ::String, pay_schedule_id: ::String, x_gusto_api_version: T.nilable(Models::Shared::VersionHeader)).void }
        def initialize(company_id:, pay_schedule_id:, x_gusto_api_version: Models::Shared::VersionHeader::TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15)
