  ...
  module Models
    module Operations
      ...
      class PutV1WebhookSubscriptionUuidRequest
        ...
        sig { params(webhook_subscription_uuid: ::String, request_body: Models::Operations::PutV1WebhookSubscriptionUuidRequestBody, x_gusto_api_version: T.nilable(Models::Shared::VersionHeader)).void }
