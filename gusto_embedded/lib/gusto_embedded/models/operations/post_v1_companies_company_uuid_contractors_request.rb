  ...
  module Models
    module Operations
      ...
      class PostV1CompaniesCompanyUuidContractorsRequest
        ...
        field :request_body, Models::Operations::PostV1CompaniesCompanyUuidContractorsRequestBody, { 'request': { 'media_type': 'application/json' } }
        ...
        sig { params(company_uuid: ::String, request_body: Models::Operations::PostV1CompaniesCompanyUuidContractorsRequestBody, x_gusto_api_version: T.nilable(Models::Shared::VersionHeader)).void }
