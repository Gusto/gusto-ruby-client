...
module GustoEmbedded
  module Models
    module Operations
      ...
      class DeleteCompaniesCompanyUuidHolidayPayPolicyRequest
        extend T::Sig
        ...
        sig { params(company_uuid: ::String, x_gusto_api_version: T.nilable(Models::Shared::VersionHeader)).void }
        def initialize(company_uuid:, x_gusto_api_version: Models::Shared::VersionHeader::TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15)
