...
module GustoEmbedded
  module Models
    module Operations
      ...
      class PostV1EmployeesEmployeeIdBankAccountsRequestBody
        extend T::Sig
        ...
        field :account_type, Models::Operations::AccountType, { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('account_type'), required: true, 'decoder': Utils.enum_from_string(Models::Operations::AccountType, false) } }

        sig { params(name: ::String, routing_number: ::String, account_number: ::String, account_type: Models::Operations::AccountType).void }
