...
module GustoEmbedded
  module Operations
    ...
    class PostV1EmployeesEmployeeIdEmployeeBenefitsRequestBody < ::Crystalline::FieldAugmented
      extend T::Sig

      # The UUID of the company benefit.
      field :company_benefit_uuid, ::String, { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('company_benefit_uuid') } }
      ...
      field :contribution, T.nilable(::GustoEmbedded::Operations::Contribution), { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('contribution') } }
      ...
      field :deduction_reduces_taxable_income, T.nilable(::GustoEmbedded::Operations::DeductionReducesTaxableIncome), { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('deduction_reduces_taxable_income'), 'decoder': Utils.enum_from_string(::GustoEmbedded::Operations::DeductionReducesTaxableIncome, true) } }
      ...
      field :limit_option, T.nilable(::GustoEmbedded::Operations::LimitOption), { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('limit_option'), 'decoder': Utils.enum_from_string(::GustoEmbedded::Operations::LimitOption, true) } }


      sig { params(company_benefit_uuid: ::String, active: T.nilable(T::Boolean), catch_up: T.nilable(T::Boolean), company_contribution: T.nilable(::String), company_contribution_annual_maximum: T.nilable(::String), contribute_as_percentage: T.nilable(T::Boolean), contribution: T.nilable(::GustoEmbedded::Operations::Contribution), coverage_amount: T.nilable(::String), coverage_salary_multiplier: T.nilable(::String), deduct_as_percentage: T.nilable(T::Boolean), deduction_reduces_taxable_income: T.nilable(::GustoEmbedded::Operations::DeductionReducesTaxableIncome), elective: T.nilable(T::Boolean), employee_deduction: T.nilable(::String), employee_deduction_annual_maximum: T.nilable(::String), limit_option: T.nilable(::GustoEmbedded::Operations::LimitOption)).void }
      def initialize(company_benefit_uuid: nil, active: nil, catch_up: nil, company_contribution: nil, company_contribution_annual_maximum: nil, contribute_as_percentage: nil, contribution: nil, coverage_amount: nil, coverage_salary_multiplier: nil, deduct_as_percentage: nil, deduction_reduces_taxable_income: nil, elective: nil, employee_deduction: nil, employee_deduction_annual_maximum: nil, limit_option: nil)
