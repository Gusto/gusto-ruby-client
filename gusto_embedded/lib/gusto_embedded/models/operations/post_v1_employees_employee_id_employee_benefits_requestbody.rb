...
module GustoEmbedded
  module Models
    module Operations
      ...
      class PostV1EmployeesEmployeeIdEmployeeBenefitsRequestBody
        extend T::Sig
        ...
        field :contribution, Crystalline::Nilable.new(Models::Operations::Contribution), { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('contribution') } }
        ...
        field :limit_option, Crystalline::Nilable.new(Models::Operations::LimitOption), { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('limit_option'), 'decoder': Utils.enum_from_string(Models::Operations::LimitOption, true) } }
        ...
        field :deduction_reduces_taxable_income, Crystalline::Nilable.new(Models::Operations::DeductionReducesTaxableIncome), { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('deduction_reduces_taxable_income'), 'decoder': Utils.enum_from_string(Models::Operations::DeductionReducesTaxableIncome, true) } }
