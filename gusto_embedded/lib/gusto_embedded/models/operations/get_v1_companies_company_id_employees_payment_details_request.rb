  ...
  module Models
    module Operations
      ...
      class GetV1CompaniesCompanyIdEmployeesPaymentDetailsRequest
        ...
        sig { params(company_id: ::String, employee_uuid: T.nilable(::String), payroll_uuid: T.nilable(::String), page: T.nilable(::Integer), per: T.nilable(::Integer), x_gusto_api_version: T.nilable(Models::Shared::VersionHeader)).void }
        def initialize(company_id:, employee_uuid: nil, payroll_uuid: nil, page: nil, per: nil, x_gusto_api_version: Models::Shared::VersionHeader::TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15)
