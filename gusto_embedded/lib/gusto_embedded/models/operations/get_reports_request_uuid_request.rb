...
module GustoEmbedded
  module Operations
    ...
    class GetReportsRequestUuidRequest < ::Crystalline::FieldAugmented
      extend T::Sig
      ...
      sig { params(request_uuid: ::String, x_gusto_api_version: T.nilable(::GustoEmbedded::Shared::VersionHeader)).void }
      def initialize(request_uuid: nil, x_gusto_api_version: nil)
