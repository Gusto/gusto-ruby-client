  ...
  module Models
    module Operations
      ...
      class PostV1CompaniesCompanyIdPayrollsRequestBody
        ...
        field :off_cycle_reason, Models::Operations::OffCycleReason, { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('off_cycle_reason'), required: true, 'decoder': Utils.enum_from_string(Models::Operations::OffCycleReason, false) } }
        # Pay period start date.
        field :start_date, ::Date, { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('start_date'), required: true, 'decoder': Utils.date_from_iso_format(false) } }
        # Pay period end date.
        field :end_date, ::Date, { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('end_date'), required: true, 'decoder': Utils.date_from_iso_format(false) } }
        ...
        # Payment date.
        field :check_date, Crystalline::Nilable.new(::Date), { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('check_date'), 'decoder': Utils.date_from_iso_format(true) } }
        # The payment schedule tax rate the payroll is based on.
        field :withholding_pay_period, Crystalline::Nilable.new(Models::Operations::WithholdingPayPeriod), { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('withholding_pay_period'), 'decoder': Utils.enum_from_string(Models::Operations::WithholdingPayPeriod, true) } }
        ...
        sig { params(off_cycle: T::Boolean, off_cycle_reason: Models::Operations::OffCycleReason, start_date: ::Date, end_date: ::Date, pay_schedule_uuid: T.nilable(::String), employee_uuids: T.nilable(T::Array[::String]), check_date: T.nilable(::Date), withholding_pay_period: T.nilable(Models::Operations::WithholdingPayPeriod), skip_regular_deductions: T.nilable(T::Boolean), fixed_withholding_rate: T.nilable(T::Boolean)).void }
        def initialize(off_cycle:, off_cycle_reason:, start_date:, end_date:, pay_schedule_uuid: nil, employee_uuids: nil, check_date: nil, withholding_pay_period: nil, skip_regular_deductions: nil, fixed_withholding_rate: nil)
          @off_cycle = off_cycle
