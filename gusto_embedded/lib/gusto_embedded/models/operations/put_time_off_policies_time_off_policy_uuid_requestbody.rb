...
module GustoEmbedded
  module Models
    module Operations
      ...
      class PutTimeOffPoliciesTimeOffPolicyUuidRequestBody
        extend T::Sig
        ...
        field :accrual_method, Crystalline::Nilable.new(Models::Operations::AccrualMethod), { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('accrual_method'), 'decoder': Utils.enum_from_string(Models::Operations::AccrualMethod, true) } }
        ...
        sig { params(version: ::String, name: T.nilable(::String), accrual_method: T.nilable(Models::Operations::AccrualMethod), accrual_rate: T.nilable(::String), accrual_rate_unit: T.nilable(::String), paid_out_on_termination: T.nilable(T::Boolean), accrual_waiting_period_days: T.nilable(::Integer), carryover_limit_hours: T.nilable(::String), max_accrual_hours_per_year: T.nilable(::String), max_hours: T.nilable(::String)).void }
        def initialize(version:, name: nil, accrual_method: nil, accrual_rate: nil, accrual_rate_unit: nil, paid_out_on_termination: nil, accrual_waiting_period_days: nil, carryover_limit_hours: nil, max_accrual_hours_per_year: nil, max_hours: nil)
          @version = version
          @name = name
