  ...
  module Models
    module Operations
      ...
      class GetV1BenefitsCompanyBenefitIdSummaryRequest
        ...
        sig { params(company_benefit_id: ::String, start_date: T.nilable(::String), end_date: T.nilable(::String), detailed: T.nilable(T::Boolean), x_gusto_api_version: T.nilable(Models::Shared::VersionHeader)).void }
        def initialize(company_benefit_id:, start_date: nil, end_date: nil, detailed: nil, x_gusto_api_version: Models::Shared::VersionHeader::TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15)
