...
module GustoEmbedded
  module Operations
    ...
    class GetV1EmployeesEmployeeIdJobsRequest < ::Crystalline::FieldAugmented
      ...
      sig { params(employee_id: ::String, include: T.nilable(::GustoEmbedded::Operations::GetV1EmployeesEmployeeIdJobsQueryParamInclude), page: T.nilable(::Float), per: T.nilable(::Float), x_gusto_api_version: T.nilable(::GustoEmbedded::Shared::VersionHeader)).void }
