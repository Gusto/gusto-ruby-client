  ...
  module Models
    module Operations
      ...
      class GetV1EmployeesEmployeeIdJobsRequest
        ...
        sig { params(employee_id: ::String, page: T.nilable(::Integer), per: T.nilable(::Integer), include: T.nilable(Models::Operations::GetV1EmployeesEmployeeIdJobsQueryParamInclude), x_gusto_api_version: T.nilable(Models::Shared::VersionHeader)).void }
        def initialize(employee_id:, page: nil, per: nil, include: nil, x_gusto_api_version: Models::Shared::VersionHeader::TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15)
