...
module GustoEmbedded
  module Operations
    ...
    class GetV1EmployeesEmployeeIdJobsRequest < ::Crystalline::FieldAugmented
      extend T::Sig
      ...
      field :include, T.nilable(::GustoEmbedded::Operations::GetV1EmployeesEmployeeIdJobsQueryParamInclude), { 'query_param': { 'field_name': 'include', 'style': 'form', 'explode': true } }
      ...
      sig { params(employee_id: ::String, include: T.nilable(::GustoEmbedded::Operations::GetV1EmployeesEmployeeIdJobsQueryParamInclude), page: T.nilable(::Integer), per: T.nilable(::Integer), x_gusto_api_version: T.nilable(::GustoEmbedded::Shared::VersionHeader)).void }
