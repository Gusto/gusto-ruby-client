  ...
  module Models
    module Operations
      ...
      class GetNotificationsNotificationUuidRequest
        ...
        sig { params(notification_uuid: ::String, x_gusto_api_version: T.nilable(Models::Shared::VersionHeader)).void }
        def initialize(notification_uuid:, x_gusto_api_version: Models::Shared::VersionHeader::TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15)
