...
module GustoEmbedded
  module Operations
    ...
    class GetNotificationsNotificationUuidRequest < ::Crystalline::FieldAugmented
      extend T::Sig
      ...
      sig { params(notification_uuid: ::String, x_gusto_api_version: T.nilable(::GustoEmbedded::Shared::VersionHeader)).void }
