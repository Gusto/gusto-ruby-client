...
module GustoEmbedded
  module Models
    module Operations
      ...
      class PutVersionTimeOffPoliciesTimeOffPolicyUuidBalanceRequest
        extend T::Sig
        ...
        field :request_body, Models::Operations::PutVersionTimeOffPoliciesTimeOffPolicyUuidBalanceRequestBody, { 'request': { 'media_type': 'application/json' } }
        ...
        sig { params(time_off_policy_uuid: ::String, request_body: Models::Operations::PutVersionTimeOffPoliciesTimeOffPolicyUuidBalanceRequestBody, x_gusto_api_version: T.nilable(Models::Shared::VersionHeader)).void }
