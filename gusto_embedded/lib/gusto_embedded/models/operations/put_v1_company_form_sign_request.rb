  ...
  module Models
    module Operations
      ...
      class PutV1CompanyFormSignRequest
        ...
        sig { params(form_id: ::String, request_body: Models::Operations::PutV1CompanyFormSignRequestBody, x_gusto_client_ip: T.nilable(::String), x_gusto_api_version: T.nilable(Models::Shared::VersionHeader)).void }
        def initialize(form_id:, request_body:, x_gusto_client_ip: nil, x_gusto_api_version: Models::Shared::VersionHeader::TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15)
          @form_id = form_id
