  ...
  module Models
    module Operations
      ...
      class DeleteV1JobsJobIdRequest
        ...
        sig { params(job_id: ::String, x_gusto_api_version: T.nilable(Models::Shared::VersionHeader)).void }
        def initialize(job_id:, x_gusto_api_version: Models::Shared::VersionHeader::TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15)
          @job_id = job_id
