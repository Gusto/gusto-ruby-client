...
module GustoEmbedded
  module Models
    module Operations
      ...
      class PutV1GarnishmentsGarnishmentIdRequestBody
        extend T::Sig
        ...
        sig { params(version: ::String, amount: T.nilable(::String), description: T.nilable(::String), court_ordered: T.nilable(T::Boolean), active: T.nilable(T::Boolean), recurring: T.nilable(T::Boolean), deduct_as_percentage: T.nilable(T::Boolean), total_amount: T.nilable(::String), child_support: T.nilable(Models::Shared::GarnishmentChildSupport), times: T.nilable(::Integer), annual_maximum: T.nilable(::String), pay_period_maximum: T.nilable(::String)).void }
        def initialize(version:, amount: nil, description: nil, court_ordered: nil, active: true, recurring: false, deduct_as_percentage: false, total_amount: nil, child_support: nil, times: nil, annual_maximum: nil, pay_period_maximum: nil)
          @version = version
          @amount = amount
