...
module GustoEmbedded
  module Operations
    ...
    class GetV1CompanyBenefitsCompanyBenefitIdContributionExclusionsRequest < ::Crystalline::FieldAugmented
      extend T::Sig
      ...
      sig { params(company_benefit_id: ::String, x_gusto_api_version: T.nilable(::GustoEmbedded::Shared::VersionHeader)).void }
      def initialize(company_benefit_id: nil, x_gusto_api_version: nil)
