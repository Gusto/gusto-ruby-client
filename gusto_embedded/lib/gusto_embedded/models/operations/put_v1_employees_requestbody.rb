  ...
  module Models
    module Operations
      ...
      class PutV1EmployeesRequestBody
        ...
        sig { params(version: ::String, first_name: T.nilable(::String), last_name: T.nilable(::String), email: T.nilable(::String), date_of_birth: T.nilable(::String), ssn: T.nilable(::String), two_percent_shareholder: T.nilable(T::Boolean), work_email: T.nilable(::String), middle_initial: T.nilable(::String), preferred_first_name: T.nilable(::String)).void }
        def initialize(version:, first_name: nil, last_name: nil, email: nil, date_of_birth: nil, ssn: nil, two_percent_shareholder: nil, work_email: nil, middle_initial: nil, preferred_first_name: nil)
          @version = version
