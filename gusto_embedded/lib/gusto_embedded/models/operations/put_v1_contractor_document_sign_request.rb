  ...
  module Models
    module Operations
      ...
      class PutV1ContractorDocumentSignRequest
        ...
        sig { params(document_uuid: ::String, request_body: Models::Operations::PutV1ContractorDocumentSignRequestBody, x_gusto_client_ip: T.nilable(::String), x_gusto_api_version: T.nilable(Models::Shared::VersionHeader)).void }
        def initialize(document_uuid:, request_body:, x_gusto_client_ip: nil, x_gusto_api_version: Models::Shared::VersionHeader::TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15)
