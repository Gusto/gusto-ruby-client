  ...
  module Models
    module Shared
      ...
      class RefreshTokenAuthentication
        ...
        sig { params(access_token: ::String, created_at: ::Float, refresh_token: T.nilable(::String), scope: T.nilable(::String), token_type: T.nilable(::String), expires_in: T.nilable(::Float)).void }
