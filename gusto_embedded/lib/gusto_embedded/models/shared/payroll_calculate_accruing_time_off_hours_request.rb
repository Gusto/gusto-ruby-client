  ...
  module Models
    module Shared
      ...
      class PayrollCalculateAccruingTimeOffHoursRequest
        ...
        field :regular_hours_worked, Crystalline::Nilable.new(::String), { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('regular_hours_worked') } }
        # Overtime hours worked in this pay period
        field :overtime_hours_worked, Crystalline::Nilable.new(::String), { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('overtime_hours_worked') } }
        # Double overtime hours worked in this pay period
        field :double_overtime_hours_worked, Crystalline::Nilable.new(::String), { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('double_overtime_hours_worked') } }
        # Paid time off hours used in this pay period
        field :pto_hours_used, Crystalline::Nilable.new(::String), { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('pto_hours_used') } }
        # Sick hours used in this pay period
        field :sick_hours_used, Crystalline::Nilable.new(::String), { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('sick_hours_used') } }

        sig { params(regular_hours_worked: T.nilable(::String), overtime_hours_worked: T.nilable(::String), double_overtime_hours_worked: T.nilable(::String), pto_hours_used: T.nilable(::String), sick_hours_used: T.nilable(::String)).void }
