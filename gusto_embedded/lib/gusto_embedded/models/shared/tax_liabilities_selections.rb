  ...
  module Models
    module Shared
      ...
      class TaxLiabilitiesSelections
        ...
        sig { params(tax_id: T.nilable(::Integer), tax_name: T.nilable(::String), possible_liabilities: T.nilable(T::Array[Models::Shared::PossibleLiabilities]), last_unpaid_external_payroll_uuid: T.nilable(::String)).void }
        def initialize(tax_id: nil, tax_name: nil, possible_liabilities: nil, last_unpaid_external_payroll_uuid: nil)
          @tax_id = tax_id
          @tax_name = tax_name
