  ...
  module Models
    module Shared
      ...
      class I9AuthorizationDocumentOption
        ...
        field :section, Models::Shared::Section, { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('section'), required: true, 'decoder': ::GustoEmbedded::Utils.enum_from_string(Models::Shared::Section, false) } }
