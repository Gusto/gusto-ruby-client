  ...
  module Models
    module Shared
      ...
      class BenefitSummaryEmployees
        ...
        field :payroll_benefits, Crystalline::Nilable.new(Models::Shared::PayrollBenefits), { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('payroll_benefits') } }

        sig { params(uuid: T.nilable(::String), company_benefit_deduction: T.nilable(::String), company_benefit_contribution: T.nilable(::String), benefit_deduction: T.nilable(::String), benefit_contribution: T.nilable(::String), gross_pay: T.nilable(::String), imputed_pay: T.nilable(::String), payroll_benefits: T.nilable(Models::Shared::PayrollBenefits)).void }
