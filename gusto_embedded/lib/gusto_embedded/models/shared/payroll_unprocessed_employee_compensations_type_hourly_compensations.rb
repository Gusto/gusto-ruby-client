...
module GustoEmbedded
  module Models
    module Shared
      ...
      class PayrollUnprocessedEmployeeCompensationsTypeHourlyCompensations
        extend T::Sig
        ...
        #
        field :breakdowns, Crystalline::Nilable.new(Crystalline::Array.new(Models::Shared::PayrollUnprocessedEmployeeCompensationsTypeHourlyCompensationsBreakdowns)), { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('breakdowns') } }

        sig { params(name: T.nilable(::String), hours: T.nilable(::String), amount: T.nilable(::String), job_uuid: T.nilable(::String), compensation_multiplier: T.nilable(::Float), flsa_status: T.nilable(::String), breakdowns: T.nilable(T::Array[Models::Shared::PayrollUnprocessedEmployeeCompensationsTypeHourlyCompensationsBreakdowns])).void }
        def initialize(name: nil, hours: nil, amount: nil, job_uuid: nil, compensation_multiplier: nil, flsa_status: nil, breakdowns: nil)
          @name = name
          @hours = hours
          @amount = amount
          @job_uuid = job_uuid
