...
module GustoEmbedded
  module Shared
    ...
    class UnprocessedTerminationPayPeriod < ::Crystalline::FieldAugmented
      extend T::Sig
      ...
      field :employee_name, T.nilable(::String), { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('employee_name') } }
