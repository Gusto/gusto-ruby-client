  ...
  module Models
    module Shared
      ...
      class UnprocessedTerminationPayPeriod
        ...
        field :employee_name, Crystalline::Nilable.new(::String), { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('employee_name') } }
        ...
        sig { params(start_date: T.nilable(::String), end_date: T.nilable(::String), check_date: T.nilable(::String), debit_date: T.nilable(::String), employee_name: T.nilable(::String), employee_uuid: T.nilable(::String), pay_schedule_uuid: T.nilable(::String)).void }
        def initialize(start_date: nil, end_date: nil, check_date: nil, debit_date: nil, employee_name: nil, employee_uuid: nil, pay_schedule_uuid: nil)
