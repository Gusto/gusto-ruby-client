  ...
  module Models
    module Shared
      ...
      class ContractorPayments
        ...
        # The payment method.
        field :payment_method, Crystalline::Nilable.new(Models::Shared::ContractorPaymentReceiptPaymentMethod), { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('payment_method'), 'decoder': Utils.enum_from_string(Models::Shared::ContractorPaymentReceiptPaymentMethod, true) } }
