...
module GustoEmbedded
  module Shared
    ...
    class ContractorPayments < ::Crystalline::FieldAugmented
      ...
      field :contractor_business_name, T.nilable(::String), { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('contractor_business_name') } }
      # The first name of the contractor. Applies when `contractor_type` is `Individual`.
      field :contractor_first_name, T.nilable(::String), { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('contractor_first_name') } }
      # The last name of the contractor.  Applies when `contractor_type` is `Individual`.
      field :contractor_last_name, T.nilable(::String), { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('contractor_last_name') } }
      # The type of contractor.
      # 
      # `Individual` `Business`
      field :contractor_type, T.nilable(::String), { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('contractor_type') } }
