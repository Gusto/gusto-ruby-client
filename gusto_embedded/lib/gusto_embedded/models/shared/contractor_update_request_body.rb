  ...
  module Models
    module Shared
      ...
      class ContractorUpdateRequestBody
        ...
        #
        field :wage_type, Crystalline::Nilable.new(Models::Shared::ContractorUpdateRequestBodyWageType), { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('wage_type'), 'decoder': ::GustoEmbedded::Utils.enum_from_string(Models::Shared::ContractorUpdateRequestBodyWageType, true) } }
        ...
        # The contractor type.
        field :type, Crystalline::Nilable.new(Models::Shared::ContractorUpdateRequestBodyType), { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('type'), 'decoder': ::GustoEmbedded::Utils.enum_from_string(Models::Shared::ContractorUpdateRequestBodyType, true) } }
        ...
        sig { params(version: ::String, wage_type: T.nilable(Models::Shared::ContractorUpdateRequestBodyWageType), start_date: T.nilable(::String), hourly_rate: T.nilable(::String), email: T.nilable(::String), work_email: T.nilable(::String), first_name: T.nilable(::String), last_name: T.nilable(::String), middle_initial: T.nilable(::String), ssn: T.nilable(::String), business_name: T.nilable(::String), ein: T.nilable(::String), is_active: T.nilable(T::Boolean), type: T.nilable(Models::Shared::ContractorUpdateRequestBodyType), self_onboarding: T.nilable(T::Boolean), file_new_hire_report: T.nilable(T::Boolean), work_state: T.nilable(::String)).void }
        def initialize(version:, wage_type: nil, start_date: nil, hourly_rate: nil, email: nil, work_email: nil, first_name: nil, last_name: nil, middle_initial: nil, ssn: nil, business_name: nil, ein: nil, is_active: nil, type: Models::Shared::ContractorUpdateRequestBodyType::INDIVIDUAL, self_onboarding: false, file_new_hire_report: false, work_state: nil)
          @version = version
          @wage_type = wage_type
