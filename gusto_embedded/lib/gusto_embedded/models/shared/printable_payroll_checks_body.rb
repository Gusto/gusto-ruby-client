  ...
  module Models
    module Shared
      ...
      class PrintablePayrollChecksBody
        ...
        field :printing_format, Models::Shared::PrintingFormat, { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('printing_format'), required: true, 'decoder': ::GustoEmbedded::Utils.enum_from_string(Models::Shared::PrintingFormat, false) } }
        ...
        sig { params(printing_format: Models::Shared::PrintingFormat, starting_check_number: T.nilable(::Integer)).void }
