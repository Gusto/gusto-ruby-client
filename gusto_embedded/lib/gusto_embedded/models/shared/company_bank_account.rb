  ...
  module Models
    module Shared
      ...
      class CompanyBankAccount
        ...
        # Bank account type
        field :account_type, Crystalline::Nilable.new(Models::Shared::AccountType), { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('account_type'), 'decoder': Utils.enum_from_string(Models::Shared::AccountType, true) } }
        ...
        field :verification_status, Crystalline::Nilable.new(Models::Shared::VerificationStatus), { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('verification_status'), 'decoder': Utils.enum_from_string(Models::Shared::VerificationStatus, true) } }
        ...
        field :verification_type, Crystalline::Nilable.new(Models::Shared::VerificationType), { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('verification_type'), 'decoder': Utils.enum_from_string(Models::Shared::VerificationType, true) } }
        ...
        field :plaid_status, Crystalline::Nilable.new(Models::Shared::PlaidStatus), { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('plaid_status'), 'decoder': Utils.enum_from_string(Models::Shared::PlaidStatus, true) } }
        ...
        sig { params(uuid: ::String, company_uuid: T.nilable(::String), account_type: T.nilable(Models::Shared::AccountType), routing_number: T.nilable(::String), hidden_account_number: T.nilable(::String), verification_status: T.nilable(Models::Shared::VerificationStatus), verification_type: T.nilable(Models::Shared::VerificationType), name: T.nilable(::String), plaid_status: T.nilable(Models::Shared::PlaidStatus), last_cached_balance: T.nilable(::String), balance_fetched_date: T.nilable(::String)).void }
        def initialize(uuid:, company_uuid: nil, account_type: nil, routing_number: nil, hidden_account_number: nil, verification_status: nil, verification_type: nil, name: nil, plaid_status: nil, last_cached_balance: nil, balance_fetched_date: nil)
          @uuid = uuid
