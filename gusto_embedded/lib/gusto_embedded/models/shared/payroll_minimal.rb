...
module GustoEmbedded
  module Shared
    ...
    # Example response
    class PayrollMinimal < ::Crystalline::FieldAugmented
      extend T::Sig
      ...
      field :payroll_uuid, ::String, { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('payroll_uuid') } }
      ...
      field :processed, T::Boolean, { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('processed') } }
      # The UUID of the payroll.
