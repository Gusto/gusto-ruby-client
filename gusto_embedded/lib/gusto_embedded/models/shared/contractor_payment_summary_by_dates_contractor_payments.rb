  ...
  module Models
    module Shared
      ...
      class ContractorPaymentSummaryByDatesContractorPayments
        ...
        sig { params(contractor_uuid: T.nilable(::String), check_date: T.nilable(::String), reimbursement_total: T.nilable(::String), wage_total: T.nilable(::String), payments: T.nilable(T::Array[Models::Shared::ContractorPayment])).void }
