  ...
  module Models
    module Shared
      ...
      class Payrolls
        ...
        sig { params(payroll_type: T.nilable(::String), display_title: T.nilable(::String), auto_pilot: T.nilable(T::Boolean), status: T.nilable(::String), blockers: T.nilable(T::Array[Models::Shared::Blockers]), pay_period: T.nilable(Models::Shared::PayrollDigestResultsPayPeriod), payroll_uuid: T.nilable(::String), pay_schedule: T.nilable(Models::Shared::PaySchedule), totals: T.nilable(Models::Shared::PayrollDigestResultsTotals)).void }
        def initialize(payroll_type: nil, display_title: nil, auto_pilot: nil, status: nil, blockers: nil, pay_period: nil, payroll_uuid: nil, pay_schedule: nil, totals: nil)
