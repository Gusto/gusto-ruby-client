  ...
  module Models
    module Shared
      ...
      class PayrollDigestResultsResults
        ...
        sig { params(idx: T.nilable(::Integer), entity_type: T.nilable(Models::Shared::PayrollDigestResultsEntityType), uuid: T.nilable(::String), name: T.nilable(::String), status: T.nilable(Models::Shared::PayrollDigestResultsResultsStatus), payrolls: T.nilable(T::Array[Models::Shared::Payrolls])).void }
