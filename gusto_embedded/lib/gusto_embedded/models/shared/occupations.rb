  ...
  module Models
    module Shared
      ...
      class Occupations
        ...
        field :experience_level, Models::Shared::ExperienceLevel, { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('experience_level'), required: true, 'decoder': Utils.enum_from_string(Models::Shared::ExperienceLevel, false) } }
