  ...
  module Models
    module Shared
      ...
      class ContractorPaymentGroupWithBlockers
        ...
        field :status, Crystalline::Nilable.new(Models::Shared::ContractorPaymentGroupWithBlockersStatus), { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('status'), 'decoder': Utils.enum_from_string(Models::Shared::ContractorPaymentGroupWithBlockersStatus, true) } }
        ...
        sig { params(uuid: T.nilable(::String), company_uuid: T.nilable(::String), check_date: T.nilable(::String), debit_date: T.nilable(::String), status: T.nilable(Models::Shared::ContractorPaymentGroupWithBlockersStatus), submission_blockers: T.nilable(T::Array[T::Array[Models::Shared::PayrollSubmissionBlockersType]]), credit_blockers: T.nilable(T::Array[T::Array[Models::Shared::PayrollCreditBlockersType]]), totals: T.nilable(Models::Shared::ContractorPaymentGroupWithBlockersTotals), creation_token: T.nilable(::String), partner_owned_disbursement: T.nilable(T::Boolean)).void }
