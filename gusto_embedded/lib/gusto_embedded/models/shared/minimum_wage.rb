  ...
  module Models
    module Shared
      ...
      class MinimumWage
        ...
        field :wage, ::String, { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('wage'), required: true } }
        # The type of wage the minimum wage applies to, e.g. "Regular", "Regular-Industry-Specific".
        field :wage_type, ::String, { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('wage_type'), required: true } }
        # The date the minimum wage rule is effective on.
        field :effective_date, ::Date, { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('effective_date'), required: true, 'decoder': Utils.date_from_iso_format(false) } }
        # The governing authority that created the minimum wage, e.g. "City", "State", or "Federal".
        field :authority, ::String, { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('authority'), required: true } }
        # Description of parties the minimum wage applies to.
        field :notes, Crystalline::Nilable.new(::String), { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('notes') } }

        sig { params(uuid: ::String, wage: ::String, wage_type: ::String, effective_date: ::Date, authority: ::String, notes: T.nilable(::String)).void }
