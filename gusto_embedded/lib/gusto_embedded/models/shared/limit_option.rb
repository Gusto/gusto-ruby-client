...
module GustoEmbedded
  module Shared
    ...
    class LimitOption < ::Crystalline::FieldAugmented
      extend T::Sig


      field :choices, T.nilable(T::Array[::String]), { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('choices') } }

      field :default_value, T.nilable(::GustoEmbedded::Shared::BenefitTypeRequirementsLimitOptionDefaultValue), { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('default_value') } }
      ...
      sig { params(choices: T.nilable(T::Array[::String]), default_value: T.nilable(::GustoEmbedded::Shared::BenefitTypeRequirementsLimitOptionDefaultValue), editable: T.nilable(T::Boolean), required: T.nilable(T::Boolean)).void }
