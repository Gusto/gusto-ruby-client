  ...
  module Models
    module Shared
      ...
      class ShowEmployees
        ...
        field :all_home_addresses, Crystalline::Nilable.new(Crystalline::Array.new(Models::Shared::EmployeeHomeAddress)), { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('all_home_addresses') } }
        ...
        sig { params(uuid: ::String, first_name: ::String, last_name: ::String, company_uuid: T.nilable(::String), version: T.nilable(::String), terminated: T.nilable(T::Boolean), onboarded: T.nilable(T::Boolean), onboarding_documents_config: T.nilable(Models::Shared::ShowEmployeesOnboardingDocumentsConfig), jobs: T.nilable(T::Array[Models::Shared::Job]), eligible_paid_time_off: T.nilable(T::Array[Models::Shared::PaidTimeOff]), terminations: T.nilable(T::Array[Models::Shared::Termination]), garnishments: T.nilable(T::Array[Models::Shared::Garnishment]), custom_fields: T.nilable(T::Array[Models::Shared::EmployeeCustomField]), has_ssn: T.nilable(T::Boolean), ssn: T.nilable(::String), historical: T.nilable(T::Boolean), employee_code: T.nilable(::String), title: T.nilable(::String), hired_at: T.nilable(::Date), hidden_ssn: T.nilable(::String), flsa_status: T.nilable(Models::Shared::FlsaStatusType), applicable_tax_ids: T.nilable(T::Array[::Float]), current_home_address: T.nilable(Models::Shared::EmployeeHomeAddress), all_home_addresses: T.nilable(T::Array[Models::Shared::EmployeeHomeAddress]), additional_properties: T.nilable(T::Hash[Symbol, ::Object]), middle_initial: T.nilable(::String), email: T.nilable(::String), manager_uuid: T.nilable(::String), department: T.nilable(::String), two_percent_shareholder: T.nilable(T::Boolean), work_email: T.nilable(::String), onboarding_status: T.nilable(Models::Shared::ShowEmployeesOnboardingStatus), date_of_birth: T.nilable(::String), phone: T.nilable(::String), preferred_first_name: T.nilable(::String), payment_method: T.nilable(Models::Shared::ShowEmployeesPaymentMethod), current_employment_status: T.nilable(Models::Shared::ShowEmployeesCurrentEmploymentStatus), department_uuid: T.nilable(::String), member_portal_invitation_status: T.nilable(Models::Shared::ShowEmployeesMemberPortalInvitationStatus), partner_portal_invitation_sent: T.nilable(T::Boolean)).void }
