...
module GustoEmbedded
  module Shared
    ...
    class EmployeeCompensations < ::Crystalline::FieldAugmented
      ...
      field :deductions, T.nilable(T::Array[::GustoEmbedded::Shared::PayrollShowDeductions]), { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('deductions') } }
      ...
      field :reimbursements, T.nilable(T::Array[::GustoEmbedded::Shared::PayrollShowReimbursements]), { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('reimbursements') } }
      ...
      sig { params(benefits: T.nilable(T::Array[::GustoEmbedded::Shared::PayrollShowBenefits]), check_amount: T.nilable(::Float), deductions: T.nilable(T::Array[::GustoEmbedded::Shared::PayrollShowDeductions]), employee_uuid: T.nilable(::String), excluded: T.nilable(T::Boolean), first_name: T.nilable(::String), fixed_compensations: T.nilable(T::Array[::GustoEmbedded::Shared::PayrollShowFixedCompensations]), gross_pay: T.nilable(::Float), hourly_compensations: T.nilable(T::Array[::GustoEmbedded::Shared::PayrollShowHourlyCompensations]), last_name: T.nilable(::String), memo: T.nilable(::String), net_pay: T.nilable(::Float), paid_time_off: T.nilable(T::Array[::GustoEmbedded::Shared::PayrollShowPaidTimeOff]), payment_method: T.nilable(::GustoEmbedded::Shared::PayrollShowPaymentMethod), preferred_first_name: T.nilable(::String), reimbursements: T.nilable(T::Array[::GustoEmbedded::Shared::PayrollShowReimbursements]), taxes: T.nilable(T::Array[::GustoEmbedded::Shared::PayrollShowTaxes]), version: T.nilable(::String)).void }
      def initialize(benefits: nil, check_amount: nil, deductions: nil, employee_uuid: nil, excluded: nil, first_name: nil, fixed_compensations: nil, gross_pay: nil, hourly_compensations: nil, last_name: nil, memo: nil, net_pay: nil, paid_time_off: nil, payment_method: nil, preferred_first_name: nil, reimbursements: nil, taxes: nil, version: nil)
        @benefits = benefits
