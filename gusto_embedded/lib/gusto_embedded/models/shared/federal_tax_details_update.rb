  ...
  module Models
    module Shared
      ...
      class FederalTaxDetailsUpdate
        ...
        # - Joint venture
        # - Non-Profit
        field :tax_payer_type, Crystalline::Nilable.new(Models::Shared::FederalTaxDetailsUpdateTaxPayerType), { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('tax_payer_type'), 'decoder': ::GustoEmbedded::Utils.enum_from_string(Models::Shared::FederalTaxDetailsUpdateTaxPayerType, true) } }
        ...
        field :filing_form, Crystalline::Nilable.new(Models::Shared::FederalTaxDetailsUpdateFilingForm), { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('filing_form'), 'decoder': ::GustoEmbedded::Utils.enum_from_string(Models::Shared::FederalTaxDetailsUpdateFilingForm, true) } }
        ...
        sig { params(version: ::String, legal_name: T.nilable(::String), ein: T.nilable(::String), tax_payer_type: T.nilable(Models::Shared::FederalTaxDetailsUpdateTaxPayerType), filing_form: T.nilable(Models::Shared::FederalTaxDetailsUpdateFilingForm), taxable_as_scorp: T.nilable(T::Boolean)).void }
