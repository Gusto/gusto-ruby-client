  ...
  module Models
    module Shared
      ...
      class PayrollUnprocessed
        ...
        sig { params(payroll_deadline: T.nilable(::DateTime), check_date: T.nilable(::String), processed: T.nilable(T::Boolean), uuid: T.nilable(::String), payroll_uuid: T.nilable(::String), company_uuid: T.nilable(::String), off_cycle: T.nilable(T::Boolean), auto_pilot: T.nilable(T::Boolean), external: T.nilable(T::Boolean), final_termination_payroll: T.nilable(T::Boolean), pay_period: T.nilable(Models::Shared::PayrollPayPeriodType), payroll_status_meta: T.nilable(Models::Shared::PayrollPayrollStatusMetaType), employee_compensations: T.nilable(T::Array[Models::Shared::PayrollUnprocessedEmployeeCompensationsType]), payment_speed_changed: T.nilable(Models::Shared::PayrollPaymentSpeedChangedType), created_at: T.nilable(::DateTime), fixed_compensation_types: T.nilable(T::Array[Models::Shared::PayrollFixedCompensationTypesType]), processed_date: T.nilable(::String), calculated_at: T.nilable(::DateTime), off_cycle_reason: T.nilable(Models::Shared::OffCycleReasonType), withholding_pay_period: T.nilable(Models::Shared::PayrollWithholdingPayPeriodType), skip_regular_deductions: T.nilable(T::Boolean), fixed_withholding_rate: T.nilable(T::Boolean), workweeks: T.nilable(T::Array[Models::Shared::PayrollUnprocessedWorkweeks]), processing_request: T.nilable(Models::Shared::PayrollProcessingRequest), partner_owned_disbursement: T.nilable(T::Boolean)).void }
