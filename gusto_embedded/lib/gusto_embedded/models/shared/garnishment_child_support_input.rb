...
module GustoEmbedded
  module Shared
    ...
    class GarnishmentChildSupportInput < ::Crystalline::FieldAugmented
      extend T::Sig
      ...
      sig { params(case_number: T.nilable(::String), order_number: T.nilable(::String), payment_period: T.nilable(::GustoEmbedded::Shared::PaymentPeriod), remittance_number: T.nilable(::String), state: T.nilable(::String)).void }
