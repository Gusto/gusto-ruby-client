  ...
  module Models
    module Shared
      ...
      class Employee
        ...
        field :onboarding_status, Crystalline::Nilable.new(Models::Shared::EmployeeOnboardingStatus1), { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('onboarding_status'), 'decoder': Utils.enum_from_string(Models::Shared::EmployeeOnboardingStatus1, true) } }
        ...
        field :payment_method, Crystalline::Nilable.new(Models::Shared::EmployeePaymentMethod1), { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('payment_method'), 'decoder': Utils.enum_from_string(Models::Shared::EmployeePaymentMethod1, true) } }
        ...
        field :current_employment_status, Crystalline::Nilable.new(Models::Shared::EmployeeCurrentEmploymentStatus), { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('current_employment_status'), 'decoder': Utils.enum_from_string(Models::Shared::EmployeeCurrentEmploymentStatus, true) } }
        ...
        sig { params(uuid: ::String, first_name: ::String, last_name: ::String, company_uuid: T.nilable(::String), version: T.nilable(::String), terminated: T.nilable(T::Boolean), onboarded: T.nilable(T::Boolean), onboarding_documents_config: T.nilable(Models::Shared::EmployeeOnboardingDocumentsConfig), jobs: T.nilable(T::Array[Models::Shared::Job]), eligible_paid_time_off: T.nilable(T::Array[Models::Shared::PaidTimeOff]), terminations: T.nilable(T::Array[Models::Shared::Termination]), garnishments: T.nilable(T::Array[Models::Shared::Garnishment]), custom_fields: T.nilable(T::Array[Models::Shared::EmployeeCustomField]), has_ssn: T.nilable(T::Boolean), ssn: T.nilable(::String), historical: T.nilable(T::Boolean), employee_code: T.nilable(::String), title: T.nilable(::String), hired_at: T.nilable(::Date), hidden_ssn: T.nilable(::String), flsa_status: T.nilable(Models::Shared::FlsaStatusType), applicable_tax_ids: T.nilable(T::Array[::Float]), current_home_address: T.nilable(Models::Shared::EmployeeHomeAddress), all_home_addresses: T.nilable(T::Array[Models::Shared::EmployeeHomeAddress]), middle_initial: T.nilable(::String), email: T.nilable(::String), manager_uuid: T.nilable(::String), department: T.nilable(::String), two_percent_shareholder: T.nilable(T::Boolean), work_email: T.nilable(::String), onboarding_status: T.nilable(Models::Shared::EmployeeOnboardingStatus1), date_of_birth: T.nilable(::String), phone: T.nilable(::String), preferred_first_name: T.nilable(::String), payment_method: T.nilable(Models::Shared::EmployeePaymentMethod1), current_employment_status: T.nilable(Models::Shared::EmployeeCurrentEmploymentStatus), department_uuid: T.nilable(::String)).void }
        def initialize(uuid:, first_name:, last_name:, company_uuid: nil, version: nil, terminated: nil, onboarded: nil, onboarding_documents_config: nil, jobs: nil, eligible_paid_time_off: nil, terminations: nil, garnishments: nil, custom_fields: nil, has_ssn: nil, ssn: nil, historical: nil, employee_code: nil, title: nil, hired_at: nil, hidden_ssn: nil, flsa_status: nil, applicable_tax_ids: nil, current_home_address: nil, all_home_addresses: nil, middle_initial: nil, email: nil, manager_uuid: nil, department: nil, two_percent_shareholder: nil, work_email: nil, onboarding_status: nil, date_of_birth: nil, phone: nil, preferred_first_name: nil, payment_method: Models::Shared::EmployeePaymentMethod1::CHECK, current_employment_status: nil, department_uuid: nil)
          @uuid = uuid
