  ...
  module Models
    module Shared
      ...
      class PartnerManagedCompanyMigrateRequest
        ...
        field :ip_address, Crystalline::Nilable.new(::String), { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('ip_address') } }
        # The signatory's user ID on your platform.
        field :external_user_id, Crystalline::Nilable.new(::String), { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('external_user_id') } }
