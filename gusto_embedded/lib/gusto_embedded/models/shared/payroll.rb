...
module GustoEmbedded
  module Shared
    ...
    class Payroll < ::Crystalline::FieldAugmented
      ...
      field :payroll_deadline, T.nilable(::Date), { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('payroll_deadline'), 'decoder': Utils.date_from_iso_format(true) } }
      ...
      sig { params(auto_pilot: T.nilable(T::Boolean), calculated_at: T.nilable(::String), check_date: T.nilable(::String), company_taxes: T.nilable(T::Array[::GustoEmbedded::Shared::PayrollCompanyTaxesType]), company_uuid: T.nilable(::String), created_at: T.nilable(::DateTime), credit_blockers: T.nilable(T::Array[::GustoEmbedded::Shared::PayrollCreditBlockersType]), employee_compensations: T.nilable(T::Array[::GustoEmbedded::Shared::PayrollEmployeeCompensationsType]), external: T.nilable(T::Boolean), final_termination_payroll: T.nilable(T::Boolean), fixed_withholding_rate: T.nilable(T::Boolean), off_cycle: T.nilable(T::Boolean), off_cycle_reason: T.nilable(::GustoEmbedded::Shared::OffCycleReasonType), pay_period: T.nilable(::GustoEmbedded::Shared::PayrollPayPeriodType), payment_speed_changed: T.nilable(::GustoEmbedded::Shared::PayrollPaymentSpeedChangedType), payroll_deadline: T.nilable(::Date), payroll_status_meta: T.nilable(::GustoEmbedded::Shared::PayrollPayrollStatusMetaType), payroll_uuid: T.nilable(::String), processed: T.nilable(T::Boolean), processed_date: T.nilable(::String), processing_request: T.nilable(::GustoEmbedded::Shared::PayrollProcessingRequest), skip_regular_deductions: T.nilable(T::Boolean), submission_blockers: T.nilable(T::Array[::GustoEmbedded::Shared::PayrollSubmissionBlockersType]), totals: T.nilable(::GustoEmbedded::Shared::PayrollTotalsType), uuid: T.nilable(::String), withholding_pay_period: T.nilable(::GustoEmbedded::Shared::PayrollWithholdingPayPeriodType)).void }
