  ...
  module Models
    module Shared
      ...
      class ContractorPaymentGroupPreview
        ...
        field :status, Crystalline::Nilable.new(Models::Shared::ContractorPaymentGroupPreviewStatus), { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('status'), 'decoder': Utils.enum_from_string(Models::Shared::ContractorPaymentGroupPreviewStatus, true) } }
        ...
        sig { params(company_uuid: T.nilable(::String), check_date: T.nilable(::String), debit_date: T.nilable(::String), status: T.nilable(Models::Shared::ContractorPaymentGroupPreviewStatus), submission_blockers: T.nilable(T::Array[T::Array[Models::Shared::PayrollSubmissionBlockersType]]), credit_blockers: T.nilable(T::Array[T::Array[Models::Shared::PayrollCreditBlockersType]]), totals: T.nilable(Models::Shared::ContractorPaymentGroupPreviewTotals), contractor_payments: T.nilable(T::Array[Models::Shared::ContractorPaymentForGroupPreview]), uuid: T.nilable(::String), creation_token: T.nilable(::String), partner_owned_disbursement: T.nilable(T::Boolean)).void }
