  ...
  module Models
    module Shared
      ...
      class ContractorPaymentGroupPreview
        ...
        field :status, Crystalline::Nilable.new(Models::Shared::ContractorPaymentGroupPreviewStatus), { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('status'), 'decoder': ::GustoEmbedded::Utils.enum_from_string(Models::Shared::ContractorPaymentGroupPreviewStatus, true) } }
