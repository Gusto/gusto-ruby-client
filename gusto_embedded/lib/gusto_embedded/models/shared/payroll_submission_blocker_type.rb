  ...
  module Models
    module Shared
      ...
      class PayrollSubmissionBlockerType
        ...
        field :status, Crystalline::Nilable.new(Models::Shared::PayrollSubmissionBlockerTypeStatus), { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('status'), 'decoder': ::GustoEmbedded::Utils.enum_from_string(Models::Shared::PayrollSubmissionBlockerTypeStatus, true) } }
        ...
        sig { params(blocker_type: T.nilable(::String), blocker_name: T.nilable(::String), unblock_options: T.nilable(T::Array[Models::Shared::UnblockOptions]), status: T.nilable(Models::Shared::PayrollSubmissionBlockerTypeStatus), selected_option: T.nilable(::String)).void }
