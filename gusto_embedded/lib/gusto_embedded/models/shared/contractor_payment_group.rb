...
module GustoEmbedded
  module Shared
    ...
    class ContractorPaymentGroup < ::Crystalline::FieldAugmented
      ...
      sig { params(check_date: T.nilable(::String), company_uuid: T.nilable(::String), contractor_payments: T.nilable(T::Array[::GustoEmbedded::Shared::ContractorPaymentForGroup]), creation_token: T.nilable(::String), credit_blockers: T.nilable(T::Array[T::Array[::GustoEmbedded::Shared::PayrollCreditBlockersType]]), debit_date: T.nilable(::String), partner_owned_disbursement: T.nilable(T::Boolean), status: T.nilable(::GustoEmbedded::Shared::ContractorPaymentGroupStatus), submission_blockers: T.nilable(T::Array[T::Array[::GustoEmbedded::Shared::PayrollSubmissionBlockersType]]), totals: T.nilable(::GustoEmbedded::Shared::ContractorPaymentGroupTotals), uuid: T.nilable(::String)).void }
