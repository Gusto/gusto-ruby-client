  ...
  module Models
    module Shared
      ...
      class EntityErrorObject
        ...
        field :metadata, Crystalline::Nilable.new(Crystalline::Union.new(Models::Shared::MetadataWithMultipleEntities, Models::Shared::MetadataWithOneEntity)), { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('metadata') } }
        ...
        sig { params(error_key: ::String, category: ::String, message: T.nilable(::String), metadata: T.nilable(T.any(Models::Shared::MetadataWithMultipleEntities, Models::Shared::MetadataWithOneEntity)), errors: T.nilable(T::Array[Models::Shared::EntityErrorObject])).void }
