  ...
  module Models
    module Shared
      ...
      class DocumentSigned
        ...
        field :recipient_type, Crystalline::Nilable.new(Models::Shared::DocumentSignedRecipientType), { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('recipient_type'), 'decoder': Utils.enum_from_string(Models::Shared::DocumentSignedRecipientType, true) } }
        ...
        sig { params(uuid: T.nilable(::String), title: T.nilable(::String), name: T.nilable(::String), recipient_type: T.nilable(Models::Shared::DocumentSignedRecipientType), recipient_uuid: T.nilable(::String), description: T.nilable(::String), requires_signing: T.nilable(T::Boolean), draft: T.nilable(T::Boolean), signed_at: T.nilable(::String), year: T.nilable(::Integer), quarter: T.nilable(::Integer)).void }
        def initialize(uuid: nil, title: nil, name: nil, recipient_type: nil, recipient_uuid: nil, description: nil, requires_signing: nil, draft: nil, signed_at: nil, year: nil, quarter: nil)
          @uuid = uuid
          @title = title
          @name = name
