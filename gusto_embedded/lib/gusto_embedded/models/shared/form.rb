  ...
  module Models
    module Shared
      ...
      class Form
        ...
        sig { params(uuid: ::String, name: T.nilable(::String), title: T.nilable(::String), description: T.nilable(::String), draft: T.nilable(T::Boolean), requires_signing: T.nilable(T::Boolean), year: T.nilable(::Integer), quarter: T.nilable(::Integer), document_content_type: T.nilable(::String)).void }
        def initialize(uuid:, name: nil, title: nil, description: nil, draft: nil, requires_signing: nil, year: nil, quarter: nil, document_content_type: nil)
          @uuid = uuid
          @name = name
          @title = title
