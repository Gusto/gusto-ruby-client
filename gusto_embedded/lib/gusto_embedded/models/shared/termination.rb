  ...
  module Models
    module Shared
      ...
      class Termination
        ...
        field :cancelable, Crystalline::Nilable.new(Crystalline::Boolean.new), { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('cancelable') } }
        ...
        sig { params(uuid: ::String, version: T.nilable(::String), employee_uuid: T.nilable(::String), active: T.nilable(T::Boolean), cancelable: T.nilable(T::Boolean), effective_date: T.nilable(::String), run_termination_payroll: T.nilable(T::Boolean)).void }
        def initialize(uuid:, version: nil, employee_uuid: nil, active: nil, cancelable: nil, effective_date: nil, run_termination_payroll: nil)
          @uuid = uuid
          @version = version
