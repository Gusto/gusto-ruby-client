  ...
  module Models
    module Shared
      ...
      class AchTransaction
        ...
        sig { params(uuid: ::String, company_uuid: T.nilable(::String), payment_event_type: T.nilable(Models::Shared::PaymentEventType), payment_event_uuid: T.nilable(::String), recipient_uuid: T.nilable(::String), transaction_type: T.nilable(::String), payment_status: T.nilable(Models::Shared::PaymentStatus), payment_direction: T.nilable(Models::Shared::PaymentDirection), payment_event_check_date: T.nilable(::String), payment_date: T.nilable(::String), amount: T.nilable(::String), description: T.nilable(::String), recipient_type: T.nilable(Models::Shared::RecipientType), error_code: T.nilable(::String)).void }
