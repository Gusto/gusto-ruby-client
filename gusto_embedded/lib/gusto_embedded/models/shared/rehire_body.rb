  ...
  module Models
    module Shared
      ...
      class RehireBody
        ...
        field :employment_status, Crystalline::Nilable.new(Models::Shared::RehireBodyEmploymentStatus), { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('employment_status'), 'decoder': ::GustoEmbedded::Utils.enum_from_string(Models::Shared::RehireBodyEmploymentStatus, true) } }
        ...
        sig { params(effective_date: ::String, file_new_hire_report: T::Boolean, work_location_uuid: ::String, employment_status: T.nilable(Models::Shared::RehireBodyEmploymentStatus), two_percent_shareholder: T.nilable(T::Boolean)).void }
