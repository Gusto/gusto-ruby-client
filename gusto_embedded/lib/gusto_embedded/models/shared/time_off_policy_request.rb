  ...
  module Models
    module Shared
      ...
      class TimeOffPolicyRequest
        ...
        field :policy_type, Models::Shared::TimeOffPolicyRequestPolicyType, { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('policy_type'), required: true, 'decoder': ::GustoEmbedded::Utils.enum_from_string(Models::Shared::TimeOffPolicyRequestPolicyType, false) } }
        # Accrual method of the time off policy
        field :accrual_method, Models::Shared::AccrualMethod, { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('accrual_method'), required: true, 'decoder': ::GustoEmbedded::Utils.enum_from_string(Models::Shared::AccrualMethod, false) } }
        ...
        sig { params(name: ::String, policy_type: Models::Shared::TimeOffPolicyRequestPolicyType, accrual_method: Models::Shared::AccrualMethod, paid_out_on_termination: T.nilable(T::Boolean), complete: T.nilable(T::Boolean), accrual_rate: T.nilable(::String), accrual_rate_unit: T.nilable(::String), accrual_waiting_period_days: T.nilable(::Integer), carryover_limit_hours: T.nilable(::String), max_accrual_hours_per_year: T.nilable(::String), max_hours: T.nilable(::String), policy_reset_date: T.nilable(::String)).void }
