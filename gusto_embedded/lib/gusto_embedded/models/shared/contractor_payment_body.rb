  ...
  module Models
    module Shared
      ...
      class ContractorPaymentBody
        ...
        sig { params(contractor_uuid: ::String, date: ::Date, wage: T.nilable(::String), hours: T.nilable(::String), bonus: T.nilable(::String), reimbursement: T.nilable(::String), payment_method: T.nilable(Models::Shared::ContractorPaymentBodyPaymentMethod)).void }
