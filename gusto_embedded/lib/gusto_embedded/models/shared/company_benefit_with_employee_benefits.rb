  ...
  module Models
    module Shared
      ...
      class CompanyBenefitWithEmployeeBenefits
        ...
        field :source, Crystalline::Nilable.new(Models::Shared::CompanyBenefitWithEmployeeBenefitsSource), { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('source'), 'decoder': Utils.enum_from_string(Models::Shared::CompanyBenefitWithEmployeeBenefitsSource, true) } }
        ...
        sig { params(uuid: ::String, version: T.nilable(::String), company_uuid: T.nilable(::String), benefit_type: T.nilable(::Integer), description: T.nilable(::String), source: T.nilable(Models::Shared::CompanyBenefitWithEmployeeBenefitsSource), deletable: T.nilable(T::Boolean), supports_percentage_amounts: T.nilable(T::Boolean), responsible_for_employer_taxes: T.nilable(T::Boolean), responsible_for_employee_w2: T.nilable(T::Boolean), employee_benefits: T.nilable(T::Array[Models::Shared::EmployeeBenefits]), active: T.nilable(T::Boolean), partner_name: T.nilable(::String)).void }
        def initialize(uuid:, version: nil, company_uuid: nil, benefit_type: nil, description: nil, source: nil, deletable: nil, supports_percentage_amounts: nil, responsible_for_employer_taxes: nil, responsible_for_employee_w2: nil, employee_benefits: nil, active: true, partner_name: nil)
          @uuid = uuid
          @version = version
