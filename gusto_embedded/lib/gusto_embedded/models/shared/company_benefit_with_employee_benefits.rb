...
module GustoEmbedded
  module Shared
    ...
    class CompanyBenefitWithEmployeeBenefits < ::Crystalline::FieldAugmented
      ...
      sig { params(uuid: ::String, active: T.nilable(T::Boolean), benefit_type: T.nilable(::Integer), company_uuid: T.nilable(::String), deletable: T.nilable(T::Boolean), description: T.nilable(::String), employee_benefits: T.nilable(T::Array[::GustoEmbedded::Shared::EmployeeBenefits]), responsible_for_employee_w2: T.nilable(T::Boolean), responsible_for_employer_taxes: T.nilable(T::Boolean), supports_percentage_amounts: T.nilable(T::Boolean), version: T.nilable(::String)).void }
      def initialize(uuid: nil, active: nil, benefit_type: nil, company_uuid: nil, deletable: nil, description: nil, employee_benefits: nil, responsible_for_employee_w2: nil, responsible_for_employer_taxes: nil, supports_percentage_amounts: nil, version: nil)
        @uuid = uuid
        @active = active
