...
module GustoEmbedded
  module Shared
    ...
    class CompanyBenefitWithEmployeeBenefits < ::Crystalline::FieldAugmented
      ...
      sig { params(uuid: ::String, active: T.nilable(T::Boolean), benefit_type: T.nilable(::Float), deletable: T.nilable(T::Boolean), description: T.nilable(::String), employee_benefits: T.nilable(T::Array[::GustoEmbedded::Shared::EmployeeBenefits]), responsible_for_employee_w2: T.nilable(T::Boolean), responsible_for_employer_taxes: T.nilable(T::Boolean), supports_percentage_amounts: T.nilable(T::Boolean), version: T.nilable(::String)).void }
