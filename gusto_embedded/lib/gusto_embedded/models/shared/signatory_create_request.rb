  ...
  module Models
    module Shared
      ...
      class SignatoryCreateRequest
        ...
        field :birthday, ::Date, { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('birthday'), required: true, 'decoder': ::GustoEmbedded::Utils.date_from_iso_format(false) } }
        ...
        field :home_address, Models::Shared::SignatoryCreateRequestHomeAddress, { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('home_address'), required: true } }
        ...
        sig { params(first_name: ::String, last_name: ::String, title: ::String, phone: ::String, birthday: ::Date, email: ::String, ssn: ::String, home_address: Models::Shared::SignatoryCreateRequestHomeAddress, middle_initial: T.nilable(::String)).void }
        def initialize(first_name:, last_name:, title:, phone:, birthday:, email:, ssn:, home_address:, middle_initial: nil)
