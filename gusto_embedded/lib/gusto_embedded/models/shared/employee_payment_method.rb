  ...
  module Models
    module Shared
      ...
      class EmployeePaymentMethod
        ...
        field :type, Crystalline::Nilable.new(Models::Shared::EmployeePaymentMethodType), { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('type'), 'decoder': ::GustoEmbedded::Utils.enum_from_string(Models::Shared::EmployeePaymentMethodType, true) } }
        ...
        field :split_by, Crystalline::Nilable.new(Models::Shared::EmployeePaymentMethodSplitBy), { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('split_by'), 'decoder': ::GustoEmbedded::Utils.enum_from_string(Models::Shared::EmployeePaymentMethodSplitBy, true) } }
