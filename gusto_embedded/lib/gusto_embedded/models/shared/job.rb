...
module GustoEmbedded
  module Shared
    ...
    class Job < ::Crystalline::FieldAugmented
      ...
      field :compensations, T.nilable(T::Array[::GustoEmbedded::Shared::Compensation]), { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('compensations') } }
      # The UUID of the current compensation of the job.
      field :current_compensation_uuid, T.nilable(::String), { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('current_compensation_uuid') } }
