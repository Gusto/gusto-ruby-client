  ...
  module Models
    module Shared
      ...
      class PaymentConfigs
        ...
        field :payment_speed, Crystalline::Nilable.new(::String), { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('payment_speed') } }
        ...
        sig { params(company_uuid: T.nilable(::String), partner_uuid: T.nilable(::String), payment_speed: T.nilable(::String), partner_owned_disbursement: T.nilable(T::Boolean), earned_fast_ach_blockers: T.nilable(T::Array[Models::Shared::EarnedFastAchBlockers]), fast_payment_limit: T.nilable(::String)).void }
