...
module GustoEmbedded
  module Models
    module Shared
      ...
      class PeopleBatchResultsErrors
        extend T::Sig
        ...
        field :errors, Crystalline::Nilable.new(Crystalline::Array.new(Models::Shared::PeopleBatchResultsResultsErrors)), { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('errors') } }

        sig { params(error_key: T.nilable(::String), category: T.nilable(::String), message: T.nilable(::String), errors: T.nilable(T::Array[Models::Shared::PeopleBatchResultsResultsErrors])).void }
