  ...
  module Models
    module Shared
      ...
      class EmployeeHomeAddress
        ...
        field :effective_from, Crystalline::Nilable.new(::Date), { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('effective_from'), 'decoder': ::GustoEmbedded::Utils.date_from_iso_format(true) } }
        # The date the address became inactive.
        field :effective_to, Crystalline::Nilable.new(::Date), { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('effective_to'), 'decoder': ::GustoEmbedded::Utils.date_from_iso_format(true) } }
        # The date the address became effective.
