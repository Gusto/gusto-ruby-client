...
module GustoEmbedded
  module Shared
    ...
    class Notification < ::Crystalline::FieldAugmented
      ...
      sig { params(uuid: ::String, actionable: T.nilable(T::Boolean), can_block_payroll: T.nilable(T::Boolean), category: T.nilable(::String), company_uuid: T.nilable(::String), due_at: T.nilable(::String), message: T.nilable(::String), published_at: T.nilable(::String), resources: T.nilable(T::Array[::GustoEmbedded::Shared::Resources]), status: T.nilable(::GustoEmbedded::Shared::NotificationStatus), title: T.nilable(::String)).void }
      def initialize(uuid: nil, actionable: nil, can_block_payroll: nil, category: nil, company_uuid: nil, due_at: nil, message: nil, published_at: nil, resources: nil, status: nil, title: nil)
        @uuid = uuid
