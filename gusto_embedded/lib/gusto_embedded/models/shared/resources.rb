  ...
  module Models
    module Shared
      ...
      class Resources
        ...
        field :entity_type, Models::Shared::NotificationEntityType, { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('entity_type'), required: true, 'decoder': Utils.enum_from_string(Models::Shared::NotificationEntityType, false) } }
