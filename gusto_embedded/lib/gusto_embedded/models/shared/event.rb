  ...
  module Models
    module Shared
      ...
      class Event
        ...
        field :resource_type, Crystalline::Nilable.new(Models::Shared::ResourceType), { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('resource_type'), 'decoder': Utils.enum_from_string(Models::Shared::ResourceType, true) } }
