...
module GustoEmbedded
  module Shared
    ...
    class PayrollPaymentSpeedChangedType < ::Crystalline::FieldAugmented
      extend T::Sig

      # Current check date.
      field :current_check_date, T.nilable(::String), { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('current_check_date') } }
      # Current debit date.
      field :current_debit_date, T.nilable(::String), { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('current_debit_date') } }
      # Original check date when fast ach applies.
      field :original_check_date, T.nilable(::String), { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('original_check_date') } }
