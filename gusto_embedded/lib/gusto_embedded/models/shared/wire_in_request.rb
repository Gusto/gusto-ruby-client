...
module GustoEmbedded
  module Shared
    ...
    class WireInRequest < ::Crystalline::FieldAugmented
      ...
      field :payment_type, T.nilable(::GustoEmbedded::Shared::PaymentType), { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('payment_type'), 'decoder': Utils.enum_from_string(::GustoEmbedded::Shared::PaymentType, true) } }
      # Unique identifier of the payment
      field :payment_uuid, T.nilable(::String), { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('payment_uuid') } }
