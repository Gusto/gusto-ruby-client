  ...
  module Models
    module Shared
      ...
      class WireInRequest
        ...
        field :status, Crystalline::Nilable.new(Models::Shared::WireInRequestStatus), { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('status'), 'decoder': Utils.enum_from_string(Models::Shared::WireInRequestStatus, true) } }
        ...
        field :payment_type, Crystalline::Nilable.new(Models::Shared::PaymentType), { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('payment_type'), 'decoder': Utils.enum_from_string(Models::Shared::PaymentType, true) } }
