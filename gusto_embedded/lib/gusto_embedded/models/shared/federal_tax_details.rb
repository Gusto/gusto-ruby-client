  ...
  module Models
    module Shared
      ...
      class FederalTaxDetails
        ...
        field :filing_form, Crystalline::Nilable.new(::String), { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('filing_form') } }
        ...
        # - Joint venture
        # - Non-Profit
        field :tax_payer_type, Crystalline::Nilable.new(::String), { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('tax_payer_type') } }

        sig { params(version: T.nilable(::String), taxable_as_scorp: T.nilable(T::Boolean), filing_form: T.nilable(::String), has_ein: T.nilable(T::Boolean), ein_verified: T.nilable(T::Boolean), ein_verification: T.nilable(Models::Shared::EinVerification), legal_name: T.nilable(::String), effective_date: T.nilable(::String), deposit_schedule: T.nilable(::String), tax_payer_type: T.nilable(::String)).void }
