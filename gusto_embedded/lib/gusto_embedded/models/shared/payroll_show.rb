...
module GustoEmbedded
  module Shared
    ...
    class PayrollShow < ::Crystalline::FieldAugmented
      extend T::Sig
      ...
      field :payroll_taxes, T.nilable(T::Array[::GustoEmbedded::Shared::PayrollTaxesType]), { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('payroll_taxes') } }
      ...
      sig { params(auto_pilot: T.nilable(T::Boolean), calculated_at: T.nilable(::DateTime), check_date: T.nilable(::String), company_taxes: T.nilable(T::Array[::GustoEmbedded::Shared::PayrollCompanyTaxesType]), company_uuid: T.nilable(::String), created_at: T.nilable(::DateTime), credit_blockers: T.nilable(T::Array[::GustoEmbedded::Shared::PayrollCreditBlockersType]), employee_compensations: T.nilable(T::Array[::GustoEmbedded::Shared::EmployeeCompensations]), external: T.nilable(T::Boolean), final_termination_payroll: T.nilable(T::Boolean), fixed_withholding_rate: T.nilable(T::Boolean), off_cycle: T.nilable(T::Boolean), off_cycle_reason: T.nilable(::GustoEmbedded::Shared::OffCycleReasonType), partner_owned_disbursement: T.nilable(T::Boolean), pay_period: T.nilable(::GustoEmbedded::Shared::PayrollPayPeriodType), payment_speed_changed: T.nilable(::GustoEmbedded::Shared::PayrollPaymentSpeedChangedType), payroll_deadline: T.nilable(::DateTime), payroll_status_meta: T.nilable(::GustoEmbedded::Shared::PayrollPayrollStatusMetaType), payroll_taxes: T.nilable(T::Array[::GustoEmbedded::Shared::PayrollTaxesType]), payroll_uuid: T.nilable(::String), processed: T.nilable(T::Boolean), processed_date: T.nilable(::String), processing_request: T.nilable(::GustoEmbedded::Shared::PayrollProcessingRequest), skip_regular_deductions: T.nilable(T::Boolean), submission_blockers: T.nilable(T::Array[::GustoEmbedded::Shared::PayrollSubmissionBlockersType]), totals: T.nilable(::GustoEmbedded::Shared::PayrollTotalsType), uuid: T.nilable(::String), withholding_pay_period: T.nilable(::GustoEmbedded::Shared::PayrollWithholdingPayPeriodType)).void }
      def initialize(auto_pilot: nil, calculated_at: nil, check_date: nil, company_taxes: nil, company_uuid: nil, created_at: nil, credit_blockers: nil, employee_compensations: nil, external: nil, final_termination_payroll: nil, fixed_withholding_rate: nil, off_cycle: nil, off_cycle_reason: nil, partner_owned_disbursement: nil, pay_period: nil, payment_speed_changed: nil, payroll_deadline: nil, payroll_status_meta: nil, payroll_taxes: nil, payroll_uuid: nil, processed: nil, processed_date: nil, processing_request: nil, skip_regular_deductions: nil, submission_blockers: nil, totals: nil, uuid: nil, withholding_pay_period: nil)
