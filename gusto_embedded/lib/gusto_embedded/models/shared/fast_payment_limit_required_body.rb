...
module GustoEmbedded
  module Models
    module Shared
      ...
      class FastPaymentLimitRequiredBody
        extend T::Sig
        ...
        field :fast_payment_limit, ::String, { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('fast_payment_limit'), required: true } }
        ...
        field :payment_speed, Crystalline::Nilable.new(Models::Shared::PaymentSpeedParam), { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('payment_speed'), 'decoder': Utils.enum_from_string(Models::Shared::PaymentSpeedParam, true) } }

        sig { params(fast_payment_limit: ::String, payment_speed: T.nilable(Models::Shared::PaymentSpeedParam)).void }
        def initialize(fast_payment_limit:, payment_speed: nil)
