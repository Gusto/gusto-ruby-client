  ...
  module Models
    module Shared
      ...
      class EmployeeBenefitForCompanyBenefit
        ...
        sig { params(employee_uuid: ::String, version: T.nilable(::String), contribution: T.nilable(Models::Shared::EmployeeBenefitForCompanyBenefitContribution), retirement_loan_identifier: T.nilable(::String), active: T.nilable(T::Boolean), employee_deduction: T.nilable(::String), deduct_as_percentage: T.nilable(T::Boolean), employee_deduction_annual_maximum: T.nilable(::String), elective: T.nilable(T::Boolean), company_contribution_annual_maximum: T.nilable(::String), limit_option: T.nilable(::String), coverage_amount: T.nilable(::String), company_contribution: T.nilable(::String), contribute_as_percentage: T.nilable(T::Boolean), catch_up: T.nilable(T::Boolean), deduction_reduces_taxable_income: T.nilable(Models::Shared::EmployeeBenefitForCompanyBenefitDeductionReducesTaxableIncome), coverage_salary_multiplier: T.nilable(::String)).void }
        def initialize(employee_uuid:, version: nil, contribution: nil, retirement_loan_identifier: nil, active: true, employee_deduction: '0.00', deduct_as_percentage: false, employee_deduction_annual_maximum: nil, elective: false, company_contribution_annual_maximum: nil, limit_option: nil, coverage_amount: nil, company_contribution: '0.00', contribute_as_percentage: false, catch_up: false, deduction_reduces_taxable_income: Models::Shared::EmployeeBenefitForCompanyBenefitDeductionReducesTaxableIncome::UNSET, coverage_salary_multiplier: '0.00')
