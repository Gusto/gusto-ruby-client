  ...
  module Models
    module Shared
      ...
      class PayrollUpdateEmployeeCompensations
        ...
        field :payment_method, Crystalline::Nilable.new(Models::Shared::PayrollUpdatePaymentMethod), { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('payment_method'), 'decoder': Utils.enum_from_string(Models::Shared::PayrollUpdatePaymentMethod, true) } }
