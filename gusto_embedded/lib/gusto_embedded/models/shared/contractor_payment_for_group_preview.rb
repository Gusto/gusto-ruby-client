  ...
  module Models
    module Shared
      ...
      class ContractorPaymentForGroupPreview
        ...
        # The payment method.
        field :payment_method, Crystalline::Nilable.new(Models::Shared::ContractorPaymentForGroupPreviewPaymentMethod), { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('payment_method'), 'decoder': Utils.enum_from_string(Models::Shared::ContractorPaymentForGroupPreviewPaymentMethod, true) } }
        ...
        field :status, Crystalline::Nilable.new(Models::Shared::ContractorPaymentForGroupPreviewStatus), { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('status'), 'decoder': Utils.enum_from_string(Models::Shared::ContractorPaymentForGroupPreviewStatus, true) } }
        ...
        field :wage_type, Crystalline::Nilable.new(Models::Shared::ContractorPaymentForGroupPreviewWageType), { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('wage_type'), 'decoder': Utils.enum_from_string(Models::Shared::ContractorPaymentForGroupPreviewWageType, true) } }
