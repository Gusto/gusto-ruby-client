  ...
  module Models
    module Shared
      ...
      class EmployeeFederalTaxPre2020
        ...
        field :w4_data_type, Models::Shared::W4DataType, { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('w4_data_type'), required: true, 'decoder': ::GustoEmbedded::Utils.enum_from_string(Models::Shared::W4DataType, false) } }
        # An additional withholding dollar amount.
        field :additional_withholding, ::String, { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('additional_withholding'), required: true } }
        ...
        sig { params(version: ::String, w4_data_type: Models::Shared::W4DataType, additional_withholding: ::String, employee_uuid: T.nilable(::String), employee_id: T.nilable(::Integer), company_id: T.nilable(::Integer), filing_status: T.nilable(::String), federal_withholding_allowance: T.nilable(::Float)).void }
