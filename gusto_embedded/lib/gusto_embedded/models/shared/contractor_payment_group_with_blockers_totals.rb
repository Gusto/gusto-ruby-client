...
module GustoEmbedded
  module Shared
    ...
    class ContractorPaymentGroupWithBlockersTotals < ::Crystalline::FieldAugmented
      extend T::Sig
      ...
      field :reimbursement_amount, T.nilable(::String), { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('reimbursement_amount') } }
