...
module GustoEmbedded
  module Models
    module Shared
      ...
      class EmployeePaymentDetailsListSplits
        extend T::Sig
        ...
        sig { params(bank_account_uuid: T.nilable(::String), name: T.nilable(::String), hidden_account_number: T.nilable(::String), routing_number: T.nilable(::String), account_type: T.nilable(::String), priority: T.nilable(::Integer), encrypted_account_number: T.nilable(::String), split_amount: T.nilable(::Float)).void }
        def initialize(bank_account_uuid: nil, name: nil, hidden_account_number: nil, routing_number: nil, account_type: nil, priority: nil, encrypted_account_number: nil, split_amount: nil)
