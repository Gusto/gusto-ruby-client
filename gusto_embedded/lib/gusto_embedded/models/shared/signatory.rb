  ...
  module Models
    module Shared
      ...
      class Signatory
        ...
        field :identity_verification_status, Crystalline::Nilable.new(Models::Shared::IdentityVerificationStatus), { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('identity_verification_status'), 'decoder': Utils.enum_from_string(Models::Shared::IdentityVerificationStatus, true) } }
