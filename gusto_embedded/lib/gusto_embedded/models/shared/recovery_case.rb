  ...
  module Models
    module Shared
      ...
      class RecoveryCase
        ...
        field :status, Crystalline::Nilable.new(Models::Shared::RecoveryCaseStatus), { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('status'), 'decoder': ::GustoEmbedded::Utils.enum_from_string(Models::Shared::RecoveryCaseStatus, true) } }
        ...
        sig { params(uuid: ::String, company_uuid: T.nilable(::String), status: T.nilable(Models::Shared::RecoveryCaseStatus), check_date: T.nilable(::String), amount_outstanding: T.nilable(::String), event_total_amount: T.nilable(::String), latest_error_code: T.nilable(::String), original_debit_date: T.nilable(::String), payroll_uuid: T.nilable(::String), contractor_payment_uuids: T.nilable(T::Array[::String])).void }
        def initialize(uuid:, company_uuid: nil, status: nil, check_date: nil, amount_outstanding: nil, event_total_amount: nil, latest_error_code: nil, original_debit_date: nil, payroll_uuid: nil, contractor_payment_uuids: nil)
          @uuid = uuid
