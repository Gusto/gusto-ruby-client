  ...
  module Models
    module Shared
      ...
      class PayrollEmployeeCompensationsType
        ...
        field :payment_method, Crystalline::Nilable.new(Models::Shared::PayrollEmployeeCompensationsTypePaymentMethod), { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('payment_method'), 'decoder': Utils.enum_from_string(Models::Shared::PayrollEmployeeCompensationsTypePaymentMethod, true) } }
        ...
        sig { params(employee_uuid: T.nilable(::String), excluded: T.nilable(T::Boolean), version: T.nilable(::String), fixed_compensations: T.nilable(T::Array[Models::Shared::FixedCompensations]), hourly_compensations: T.nilable(T::Array[Models::Shared::HourlyCompensations]), paid_time_off: T.nilable(T::Array[Models::Shared::PayrollEmployeeCompensationsTypePaidTimeOff]), deductions: T.nilable(T::Array[Models::Shared::Deductions]), reimbursements: T.nilable(T::Array[Models::Shared::Reimbursements]), first_name: T.nilable(::String), preferred_first_name: T.nilable(::String), last_name: T.nilable(::String), gross_pay: T.nilable(::Float), net_pay: T.nilable(::Float), check_amount: T.nilable(::Float), payment_method: T.nilable(Models::Shared::PayrollEmployeeCompensationsTypePaymentMethod), memo: T.nilable(::String)).void }
        def initialize(employee_uuid: nil, excluded: nil, version: nil, fixed_compensations: nil, hourly_compensations: nil, paid_time_off: nil, deductions: nil, reimbursements: nil, first_name: nil, preferred_first_name: nil, last_name: nil, gross_pay: nil, net_pay: nil, check_amount: nil, payment_method: nil, memo: nil)
