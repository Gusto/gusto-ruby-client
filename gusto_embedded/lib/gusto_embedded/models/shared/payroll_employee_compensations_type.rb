...
module GustoEmbedded
  module Shared
    ...
    class PayrollEmployeeCompensationsType < ::Crystalline::FieldAugmented
      ...
      def initialize(check_amount: nil, deductions: nil, employee_uuid: nil, excluded: nil, first_name: nil, fixed_compensations: nil, gross_pay: nil, hourly_compensations: nil, last_name: nil, memo: nil, net_pay: nil, paid_time_off: nil, payment_method: nil, preferred_first_name: nil, version: nil)
