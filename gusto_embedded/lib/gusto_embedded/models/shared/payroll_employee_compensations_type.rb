  ...
  module Models
    module Shared
      ...
      class PayrollEmployeeCompensationsType
        ...
        field :fixed_compensations, Crystalline::Nilable.new(Crystalline::Array.new(Models::Shared::PayrollEmployeeCompensationsTypeFixedCompensations)), { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('fixed_compensations') } }
        ...
        field :hourly_compensations, Crystalline::Nilable.new(Crystalline::Array.new(Models::Shared::PayrollEmployeeCompensationsTypeHourlyCompensations)), { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('hourly_compensations') } }
        ...
        field :reimbursements, Crystalline::Nilable.new(Crystalline::Array.new(Models::Shared::PayrollEmployeeCompensationsTypeReimbursements)), { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('reimbursements') } }
        ...
        field :deductions, Crystalline::Nilable.new(Crystalline::Array.new(Models::Shared::Deductions)), { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('deductions') } }
        ...
        field :payment_method, Crystalline::Nilable.new(Models::Shared::PayrollEmployeeCompensationsTypePaymentMethod), { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('payment_method'), 'decoder': ::GustoEmbedded::Utils.enum_from_string(Models::Shared::PayrollEmployeeCompensationsTypePaymentMethod, true) } }
        ...
        sig { params(employee_uuid: T.nilable(::String), excluded: T.nilable(T::Boolean), fixed_compensations: T.nilable(T::Array[Models::Shared::PayrollEmployeeCompensationsTypeFixedCompensations]), hourly_compensations: T.nilable(T::Array[Models::Shared::PayrollEmployeeCompensationsTypeHourlyCompensations]), paid_time_off: T.nilable(T::Array[Models::Shared::PayrollEmployeeCompensationsTypePaidTimeOff]), reimbursements: T.nilable(T::Array[Models::Shared::PayrollEmployeeCompensationsTypeReimbursements]), version: T.nilable(::Object), deductions: T.nilable(T::Array[Models::Shared::Deductions]), first_name: T.nilable(::String), preferred_first_name: T.nilable(::String), last_name: T.nilable(::String), gross_pay: T.nilable(::Float), net_pay: T.nilable(::Float), check_amount: T.nilable(::Float), payment_method: T.nilable(Models::Shared::PayrollEmployeeCompensationsTypePaymentMethod), memo: T.nilable(::String)).void }
