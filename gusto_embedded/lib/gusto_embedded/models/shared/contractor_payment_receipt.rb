  ...
  module Models
    module Shared
      ...
      class ContractorPaymentReceipt
        ...
        field :debit_date, Crystalline::Nilable.new(::Date), { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('debit_date'), 'decoder': Utils.date_from_iso_format(true) } }
