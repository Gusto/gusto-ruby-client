...
module GustoEmbedded
  module Shared
    ...
    # Example response
    class ContractorPaymentReceipt < ::Crystalline::FieldAugmented
      extend T::Sig
      ...
      field :contractor_payments, T.nilable(T::Array[::GustoEmbedded::Shared::ContractorPayments]), { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('contractor_payments') } }
      # The debit date for the contractor payment.
      field :debit_date, T.nilable(::Date), { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('debit_date'), 'decoder': Utils.date_from_iso_format(true) } }
      ...
      field :licensee, T.nilable(::GustoEmbedded::Shared::ContractorPaymentReceiptLicensee), { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('licensee') } }
      ...
      field :totals, T.nilable(::GustoEmbedded::Shared::ContractorPaymentReceiptTotals), { 'format_json': { 'letter_case': ::GustoEmbedded::Utils.field_name('totals') } }


      sig { params(company_uuid: T.nilable(::String), contractor_payment_uuid: T.nilable(::String), contractor_payments: T.nilable(T::Array[::GustoEmbedded::Shared::ContractorPayments]), debit_date: T.nilable(::Date), liability_of_licensee: T.nilable(::String), license: T.nilable(::String), license_uri: T.nilable(::String), licensee: T.nilable(::GustoEmbedded::Shared::ContractorPaymentReceiptLicensee), name_of_recipient: T.nilable(::String), name_of_sender: T.nilable(::String), right_to_refund: T.nilable(::String), totals: T.nilable(::GustoEmbedded::Shared::ContractorPaymentReceiptTotals)).void }
