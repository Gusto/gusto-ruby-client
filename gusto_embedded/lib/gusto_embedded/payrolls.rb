...
module GustoEmbedded
  ...
  class Payrolls
    ...
    sig { params(request: T.nilable(::GustoEmbedded::Operations::GetV1CompaniesCompanyIdPayrollsPayrollIdRequest)).returns(::GustoEmbedded::Operations::GetV1CompaniesCompanyIdPayrollsPayrollIdResponse) }
    def get(request)
      ...
      if r.status == 200
        if Utils.match_content_type(content_type, 'application/json')
          out = Crystalline.unmarshal_json(JSON.parse(r.env.response_body), ::GustoEmbedded::Shared::PayrollShow)
          res.payroll_show = out
        end
      elsif r.status == 404
        if Utils.match_content_type(content_type, 'application/json')
          out = Crystalline.unmarshal_json(JSON.parse(r.env.response_body), ::GustoEmbedded::Shared::UnprocessableEntityErrorObject)
    ...
    sig { params(company_id: ::String, payroll_id: ::String, payroll_update: ::GustoEmbedded::Shared::PayrollUpdate, x_gusto_api_version: T.nilable(::GustoEmbedded::Operations::PutV1CompaniesCompanyIdPayrollsHeaderXGustoAPIVersion)).returns(::GustoEmbedded::Operations::PutV1CompaniesCompanyIdPayrollsResponse) }
    def update(company_id, payroll_id, payroll_update, x_gusto_api_version = nil)
      ...
      headers = Utils.get_headers(request)
      req_content_type, data, form = Utils.serialize_request_body(request, :payroll_update, :json)
      headers['content-type'] = req_content_type
    ...
    sig { params(company_id: ::String, payroll_id: ::String, async: T.nilable(T::Boolean), x_gusto_api_version: T.nilable(::GustoEmbedded::Operations::DeleteV1CompaniesCompanyIdPayrollsHeaderXGustoAPIVersion)).returns(::GustoEmbedded::Operations::DeleteV1CompaniesCompanyIdPayrollsResponse) }
    ...
    sig { params(request: T.nilable(::GustoEmbedded::Operations::PutV1CompaniesCompanyIdPayrollsPayrollIdPrepareRequest)).returns(::GustoEmbedded::Operations::PutV1CompaniesCompanyIdPayrollsPayrollIdPrepareResponse) }
    def prepare(request)
      ...
      req_content_type, data, form = Utils.serialize_request_body(request, :request_body, :json)
      headers['content-type'] = req_content_type
      query_params = Utils.get_query_params(::GustoEmbedded::Operations::PutV1CompaniesCompanyIdPayrollsPayrollIdPrepareRequest, request)
      headers['Accept'] = 'application/json'
      headers['user-agent'] = @sdk_configuration.user_agent
    ...
    sig { params(company_uuid: ::String, x_gusto_api_version: T.nilable(::GustoEmbedded::Shared::VersionHeader)).returns(::GustoEmbedded::Operations::GetV1CompaniesPayrollBlockersCompanyUuidResponse) }
    ...
    sig { params(company_uuid: ::String, request_body: ::GustoEmbedded::Operations::PostCompaniesPayrollSkipCompanyUuidRequestBody, x_gusto_api_version: T.nilable(::GustoEmbedded::Shared::VersionHeader)).returns(::GustoEmbedded::Operations::PostCompaniesPayrollSkipCompanyUuidResponse) }
    ...
    sig { params(payroll_uuid: ::String, request_body: ::GustoEmbedded::Operations::PostPayrollsGrossUpPayrollUuidRequestBody, x_gusto_api_version: T.nilable(::GustoEmbedded::Shared::VersionHeader)).returns(::GustoEmbedded::Operations::PostPayrollsGrossUpPayrollUuidResponse) }
    ...
    sig { params(company_id: ::String, payroll_id: ::String, x_gusto_api_version: T.nilable(::GustoEmbedded::Shared::VersionHeader)).returns(::GustoEmbedded::Operations::PutV1CompaniesCompanyIdPayrollsPayrollIdCalculateResponse) }
    ...
    sig { params(company_id: ::String, payroll_id: ::String, request_body: ::GustoEmbedded::Operations::PutV1CompaniesCompanyIdPayrollsPayrollIdSubmitRequestBody, x_gusto_api_version: T.nilable(::GustoEmbedded::Shared::VersionHeader)).returns(::GustoEmbedded::Operations::PutV1CompaniesCompanyIdPayrollsPayrollIdSubmitResponse) }
    ...
    sig { params(company_id: ::String, payroll_id: ::String, x_gusto_api_version: T.nilable(::GustoEmbedded::Shared::VersionHeader)).returns(::GustoEmbedded::Operations::PutApiV1CompaniesCompanyIdPayrollsPayrollIdCancelResponse) }
    ...
    def get_pay_stub(payroll_id, employee_id, x_gusto_api_version = nil)
      ...
      if r.status == 200
        res.bytes = r.env.response_body if Utils.match_content_type(content_type, 'application/pdf')
      elsif r.status == 404
        if Utils.match_content_type(content_type, 'application/json')
          out = Crystalline.unmarshal_json(JSON.parse(r.env.response_body), ::GustoEmbedded::Shared::UnprocessableEntityErrorObject)
          res.unprocessable_entity_error_object = out
    ...
    sig { params(employee_id: ::String, x_gusto_api_version: T.nilable(::GustoEmbedded::Operations::GetV1EmployeesEmployeeUuidPayStubsHeaderXGustoAPIVersion), page: T.nilable(::Integer), per: T.nilable(::Integer)).returns(::GustoEmbedded::Operations::GetV1EmployeesEmployeeUuidPayStubsResponse) }
    def get_pay_stubs(employee_id, x_gusto_api_version = nil, page = nil, per = nil)
      ...
      headers = Utils.get_headers(request)
      query_params = Utils.get_query_params(::GustoEmbedded::Operations::GetV1EmployeesEmployeeUuidPayStubsRequest, request)
      headers['Accept'] = 'application/json'
      headers['user-agent'] = @sdk_configuration.user_agent
    ...
    sig { params(payroll_uuid: ::String, request_body: ::GustoEmbedded::Operations::PostV1PayrollsPayrollUuidGeneratedDocumentsPrintablePayrollChecksRequestBody, x_gusto_api_version: T.nilable(::GustoEmbedded::Shared::VersionHeader)).returns(::GustoEmbedded::Operations::PostV1PayrollsPayrollUuidGeneratedDocumentsPrintablePayrollChecksResponse) }
    ...
    sig { params(company_id: ::String, id: ::String, x_gusto_api_version: T.nilable(::GustoEmbedded::Operations::GetV1CompaniesCompanyIdPayrollsIdPartnerDisbursementsHeaderXGustoAPIVersion)).returns(::GustoEmbedded::Operations::GetV1CompaniesCompanyIdPayrollsIdPartnerDisbursementsResponse) }
    def get_v1_companies_company_id_payrolls_id_partner_disbursements(company_id, id, x_gusto_api_version = nil)
      ...
      # 
      request = ::GustoEmbedded::Operations::GetV1CompaniesCompanyIdPayrollsIdPartnerDisbursementsRequest.new(
      ...
      base_url = Utils.template_url(url, params)
      url = Utils.generate_url(
        ::GustoEmbedded::Operations::GetV1CompaniesCompanyIdPayrollsIdPartnerDisbursementsRequest,
        base_url,
      ...
      res = ::GustoEmbedded::Operations::GetV1CompaniesCompanyIdPayrollsIdPartnerDisbursementsResponse.new(
        status_code: r.status, content_type: content_type, raw_response: r
      )
      if r.status == 200
        if Utils.match_content_type(content_type, 'application/json')
          out = Crystalline.unmarshal_json(JSON.parse(r.env.response_body), ::GustoEmbedded::Shared::PayrollPartnerDisbursements)
          res.payroll_partner_disbursements = out
        end
      elsif r.status == 404
        if Utils.match_content_type(content_type, 'application/json')
          out = Crystalline.unmarshal_json(JSON.parse(r.env.response_body), ::GustoEmbedded::Shared::UnprocessableEntityErrorObject)
    ...
    sig { params(company_id: ::String, id: ::String, x_gusto_api_version: T.nilable(::GustoEmbedded::Operations::PatchV1CompaniesCompanyIdPayrollsIdPartnerDisbursementsHeaderXGustoAPIVersion), request_body: T.nilable(::GustoEmbedded::Operations::PatchV1CompaniesCompanyIdPayrollsIdPartnerDisbursementsRequestBody)).returns(::GustoEmbedded::Operations::PatchV1CompaniesCompanyIdPayrollsIdPartnerDisbursementsResponse) }
    def patch_v1_companies_company_id_payrolls_id_partner_disbursements(company_id, id, x_gusto_api_version = nil, request_body = nil)
      ...
      # 
      request = ::GustoEmbedded::Operations::PatchV1CompaniesCompanyIdPayrollsIdPartnerDisbursementsRequest.new(
      ...
      base_url = Utils.template_url(url, params)
      url = Utils.generate_url(
        ::GustoEmbedded::Operations::PatchV1CompaniesCompanyIdPayrollsIdPartnerDisbursementsRequest,
        base_url,
        '/v1/companies/{company_id}/payrolls/{id}/partner_disbursements',
        request
      )
      ...
      res = ::GustoEmbedded::Operations::PatchV1CompaniesCompanyIdPayrollsIdPartnerDisbursementsResponse.new(
        status_code: r.status, content_type: content_type, raw_response: r
      )
      if r.status == 200
        if Utils.match_content_type(content_type, 'application/json')
