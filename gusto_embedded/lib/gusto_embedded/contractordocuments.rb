...
module GustoEmbedded
  ...
  class ContractorDocuments
    ...
    sig { params(contractor_uuid: ::String, x_gusto_api_version: T.nilable(Models::Operations::GetV1ContractorDocumentsHeaderXGustoAPIVersion), timeout_ms: T.nilable(Integer), http_headers: T.nilable(T::Hash[T.any(String, Symbol), String])).returns(Models::Operations::GetV1ContractorDocumentsResponse) }
    def get_all(contractor_uuid:, x_gusto_api_version: nil, timeout_ms: nil, http_headers: nil)
    ...
    sig { params(document_uuid: ::String, x_gusto_api_version: T.nilable(Models::Operations::GetV1ContractorDocumentHeaderXGustoAPIVersion), timeout_ms: T.nilable(Integer), http_headers: T.nilable(T::Hash[T.any(String, Symbol), String])).returns(Models::Operations::GetV1ContractorDocumentResponse) }
    def get(document_uuid:, x_gusto_api_version: nil, timeout_ms: nil, http_headers: nil)
    ...
    sig { params(document_uuid: ::String, x_gusto_api_version: T.nilable(Models::Operations::GetV1ContractorDocumentPdfHeaderXGustoAPIVersion), timeout_ms: T.nilable(Integer), http_headers: T.nilable(T::Hash[T.any(String, Symbol), String])).returns(Models::Operations::GetV1ContractorDocumentPdfResponse) }
    def get_pdf(document_uuid:, x_gusto_api_version: nil, timeout_ms: nil, http_headers: nil)
    ...
    sig { params(request_body: Models::Operations::PutV1ContractorDocumentSignRequestBody, document_uuid: ::String, x_gusto_api_version: T.nilable(Models::Operations::PutV1ContractorDocumentSignHeaderXGustoAPIVersion), x_gusto_client_ip: T.nilable(::String), timeout_ms: T.nilable(Integer), http_headers: T.nilable(T::Hash[T.any(String, Symbol), String])).returns(Models::Operations::PutV1ContractorDocumentSignResponse) }
    def sign(request_body:, document_uuid:, x_gusto_api_version: nil, x_gusto_client_ip: nil, timeout_ms: nil, http_headers: nil)
