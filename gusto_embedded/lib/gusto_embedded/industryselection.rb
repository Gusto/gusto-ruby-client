...
module GustoEmbedded
  ...
  class IndustrySelection
    ...
    sig { params(company_id: ::String, x_gusto_api_version: T.nilable(Models::Shared::VersionHeader), timeout_ms: T.nilable(Integer)).returns(Models::Operations::GetV1CompanyIndustryResponse) }
    ...
    sig { params(request_body: Models::Operations::PutV1CompanyIndustryRequestBody, company_id: ::String, x_gusto_api_version: T.nilable(Models::Shared::VersionHeader), timeout_ms: T.nilable(Integer)).returns(Models::Operations::PutV1CompanyIndustryResponse) }
