...
module GustoEmbedded
  ...
  class Webhooks
    ...
    sig { params(security: Models::Operations::GetV1WebhookSubscriptionsSecurity, x_gusto_api_version: T.nilable(Models::Operations::GetV1WebhookSubscriptionsHeaderXGustoAPIVersion), timeout_ms: T.nilable(Integer), http_headers: T.nilable(T::Hash[T.any(String, Symbol), String])).returns(Models::Operations::GetV1WebhookSubscriptionsResponse) }
    def list_subscriptions(security:, x_gusto_api_version: nil, timeout_ms: nil, http_headers: nil)
      ...
      if Utils.match_status_code(http_response.status, ['200'])
        if Utils.match_content_type(content_type, 'application/json')
          ...
          response = Models::Operations::GetV1WebhookSubscriptionsResponse.new(
            ...
            webhook_subscriptions: T.unsafe(obj)
          )
    ...
    sig { params(security: Models::Operations::PostV1WebhookSubscriptionSecurity, request_body: Models::Operations::PostV1WebhookSubscriptionRequestBody, x_gusto_api_version: T.nilable(Models::Operations::PostV1WebhookSubscriptionHeaderXGustoAPIVersion), timeout_ms: T.nilable(Integer), http_headers: T.nilable(T::Hash[T.any(String, Symbol), String])).returns(Models::Operations::PostV1WebhookSubscriptionResponse) }
    def create_subscription(security:, request_body:, x_gusto_api_version: nil, timeout_ms: nil, http_headers: nil)
    ...
    sig { params(security: Models::Operations::GetV1WebhookSubscriptionUuidSecurity, webhook_subscription_uuid: ::String, x_gusto_api_version: T.nilable(Models::Operations::GetV1WebhookSubscriptionUuidHeaderXGustoAPIVersion), timeout_ms: T.nilable(Integer), http_headers: T.nilable(T::Hash[T.any(String, Symbol), String])).returns(Models::Operations::GetV1WebhookSubscriptionUuidResponse) }
    def get_subscription(security:, webhook_subscription_uuid:, x_gusto_api_version: nil, timeout_ms: nil, http_headers: nil)
    ...
    sig { params(security: Models::Operations::PutV1WebhookSubscriptionUuidSecurity, request_body: Models::Operations::PutV1WebhookSubscriptionUuidRequestBody, webhook_subscription_uuid: ::String, x_gusto_api_version: T.nilable(Models::Operations::PutV1WebhookSubscriptionUuidHeaderXGustoAPIVersion), timeout_ms: T.nilable(Integer), http_headers: T.nilable(T::Hash[T.any(String, Symbol), String])).returns(Models::Operations::PutV1WebhookSubscriptionUuidResponse) }
    def update_subscription(security:, request_body:, webhook_subscription_uuid:, x_gusto_api_version: nil, timeout_ms: nil, http_headers: nil)
    ...
    sig { params(security: Models::Operations::DeleteV1WebhookSubscriptionUuidSecurity, webhook_subscription_uuid: ::String, x_gusto_api_version: T.nilable(Models::Operations::DeleteV1WebhookSubscriptionUuidHeaderXGustoAPIVersion), timeout_ms: T.nilable(Integer), http_headers: T.nilable(T::Hash[T.any(String, Symbol), String])).returns(Models::Operations::DeleteV1WebhookSubscriptionUuidResponse) }
    def delete_subscription(security:, webhook_subscription_uuid:, x_gusto_api_version: nil, timeout_ms: nil, http_headers: nil)
    ...
    sig { params(security: Models::Operations::PutV1VerifyWebhookSubscriptionUuidSecurity, request_body: Models::Operations::PutV1VerifyWebhookSubscriptionUuidRequestBody, webhook_subscription_uuid: ::String, x_gusto_api_version: T.nilable(Models::Operations::PutV1VerifyWebhookSubscriptionUuidHeaderXGustoAPIVersion), timeout_ms: T.nilable(Integer), http_headers: T.nilable(T::Hash[T.any(String, Symbol), String])).returns(Models::Operations::PutV1VerifyWebhookSubscriptionUuidResponse) }
    def verify(security:, request_body:, webhook_subscription_uuid:, x_gusto_api_version: nil, timeout_ms: nil, http_headers: nil)
    ...
    sig { params(security: Models::Operations::GetV1WebhookSubscriptionVerificationTokenUuidSecurity, webhook_subscription_uuid: ::String, x_gusto_api_version: T.nilable(Models::Operations::GetV1WebhookSubscriptionVerificationTokenUuidHeaderXGustoAPIVersion), timeout_ms: T.nilable(Integer), http_headers: T.nilable(T::Hash[T.any(String, Symbol), String])).returns(Models::Operations::GetV1WebhookSubscriptionVerificationTokenUuidResponse) }
    def request_verification_token(security:, webhook_subscription_uuid:, x_gusto_api_version: nil, timeout_ms: nil, http_headers: nil)
      # request_verification_token - Request a verification token for a webhook subscription
      ...
      if Utils.match_status_code(http_response.status, ['200'])
        if Utils.match_content_type(content_type, 'application/json')
          ...
          response_data = http_response.env.response_body
          obj = Crystalline.unmarshal_json(JSON.parse(response_data), Models::Shared::WebhookVerificationTokenResponse)
          response = Models::Operations::GetV1WebhookSubscriptionVerificationTokenUuidResponse.new(
            status_code: http_response.status,
            content_type: content_type,
            raw_response: http_response,
            webhook_verification_token_response: T.unsafe(obj)
          )
    ...
    sig { params(security: Models::Operations::GetV1WebhooksHealthCheckSecurity, x_gusto_api_version: T.nilable(Models::Operations::GetV1WebhooksHealthCheckHeaderXGustoAPIVersion), timeout_ms: T.nilable(Integer), http_headers: T.nilable(T::Hash[T.any(String, Symbol), String])).returns(Models::Operations::GetV1WebhooksHealthCheckResponse) }
    def get_v1_webhooks_health_check(security:, x_gusto_api_version: nil, timeout_ms: nil, http_headers: nil)
