...
module GustoEmbedded
  ...
  class Notifications
    ...
    sig { params(notification_uuid: ::String, x_gusto_api_version: T.nilable(Models::Shared::VersionHeader), timeout_ms: T.nilable(Integer)).returns(Models::Operations::GetNotificationsNotificationUuidResponse) }
    def get_details(notification_uuid:, x_gusto_api_version: nil, timeout_ms: nil)
    ...
    sig { params(request: Models::Operations::GetCompanyNotificationsRequest, timeout_ms: T.nilable(Integer)).returns(Models::Operations::GetCompanyNotificationsResponse) }
    def get_company_notifications(request:, timeout_ms: nil)
