...
module GustoEmbedded
  ...
  class PaymentConfigs
    ...
    sig { params(company_uuid: ::String, x_gusto_api_version: T.nilable(Models::Shared::VersionHeader), timeout_ms: T.nilable(Integer)).returns(Models::Operations::GetV1CompanyPaymentConfigsResponse) }
    ...
    sig { params(request_body: T.any(Models::Shared::FastPaymentLimitRequiredBody, Models::Shared::PaymentSpeedRequiredBody), company_uuid: ::String, x_gusto_api_version: T.nilable(Models::Shared::VersionHeader), timeout_ms: T.nilable(Integer)).returns(Models::Operations::PutV1CompanyPaymentConfigsResponse) }
