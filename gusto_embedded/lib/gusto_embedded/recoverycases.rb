...
module GustoEmbedded
  ...
  class RecoveryCases
    ...
    sig { params(company_uuid: ::String, x_gusto_api_version: T.nilable(Models::Shared::VersionHeader), timeout_ms: T.nilable(Integer)).returns(Models::Operations::GetRecoveryCasesResponse) }
      ...
      if Utils.match_status_code(http_response.status, ['200'])
        if Utils.match_content_type(content_type, 'application/json')
          ...
          response = Models::Operations::GetRecoveryCasesResponse.new(
            ...
            recovery_case_list: T.unsafe(obj)
          )
    ...
    sig { params(recovery_case_uuid: ::String, x_gusto_api_version: T.nilable(Models::Shared::VersionHeader), timeout_ms: T.nilable(Integer)).returns(Models::Operations::RedebitRecoveryCaseResponse) }
    def redebit(recovery_case_uuid:, x_gusto_api_version: nil, timeout_ms: nil)
