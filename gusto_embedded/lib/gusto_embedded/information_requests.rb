...
module GustoEmbedded
  ...
  class InformationRequests
    ...
    sig { params(company_uuid: ::String, x_gusto_api_version: T.nilable(Models::Shared::VersionHeader), timeout_ms: T.nilable(Integer)).returns(Models::Operations::GetInformationRequestsResponse) }
    def get_information_requests(company_uuid:, x_gusto_api_version: nil, timeout_ms: nil)
      ...
      if Utils.match_status_code(http_response.status, ['200'])
        if Utils.match_content_type(content_type, 'application/json')
          ...
          response = Models::Operations::GetInformationRequestsResponse.new(
            ...
            information_request_list: T.unsafe(obj)
          )
