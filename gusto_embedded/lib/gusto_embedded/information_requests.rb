  ...
  class InformationRequests
    ...
    def get_information_requests(company_uuid:, x_gusto_api_version: nil, timeout_ms: nil, http_headers: nil)
      ...
      url = Utils.generate_url(
        Models::Operations::GetInformationRequestsRequest,
        base_url,
      ...
      if Utils.match_status_code(http_response.status, ['200'])
        if Utils.match_content_type(content_type, 'application/json')
          ...
          obj = Crystalline.unmarshal_json(JSON.parse(response_data), Crystalline::Array.new(Models::Shared::InformationRequest))
          response = Models::Operations::GetInformationRequestsResponse.new(
            status_code: http_response.status,
            content_type: content_type,
            raw_response: http_response,
            information_requests: T.unsafe(obj)
          )
    ...
    sig { params(request_body: Models::Operations::SubmitInformationRequestRequestBody, information_request_uuid: ::String, timeout_ms: T.nilable(Integer), http_headers: T.nilable(T::Hash[T.any(String, Symbol), String])).returns(Models::Operations::SubmitInformationRequestResponse) }
    def submit(request_body:, information_request_uuid:, timeout_ms: nil, http_headers: nil)
      ...
      request = Models::Operations::SubmitInformationRequestRequest.new(
      ...
      base_url = Utils.template_url(url, params)
      url = Utils.generate_url(
        Models::Operations::SubmitInformationRequestRequest,
        base_url,
      ...
      if Utils.match_status_code(http_response.status, ['200'])
        if Utils.match_content_type(content_type, 'application/json')
          ...
          response_data = http_response.env.response_body
          obj = Crystalline.unmarshal_json(JSON.parse(response_data), Models::Shared::InformationRequest)
          response = Models::Operations::SubmitInformationRequestResponse.new(
            status_code: http_response.status,
            content_type: content_type,
            raw_response: http_response,
            information_request: T.unsafe(obj)
          )
