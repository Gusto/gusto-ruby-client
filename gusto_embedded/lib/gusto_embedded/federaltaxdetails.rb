...
module GustoEmbedded
  ...
  class FederalTaxDetails
    ...
    sig { params(company_id: ::String, x_gusto_api_version: T.nilable(Models::Shared::VersionHeader), timeout_ms: T.nilable(Integer)).returns(Models::Operations::GetV1CompaniesCompanyIdFederalTaxDetailsResponse) }
    ...
    sig { params(request_body: Models::Operations::PutV1CompaniesCompanyIdFederalTaxDetailsRequestBody, company_id: ::String, x_gusto_api_version: T.nilable(Models::Shared::VersionHeader), timeout_ms: T.nilable(Integer)).returns(Models::Operations::PutV1CompaniesCompanyIdFederalTaxDetailsResponse) }
