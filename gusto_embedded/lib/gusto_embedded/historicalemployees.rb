...
module GustoEmbedded
  ...
  class HistoricalEmployees
    ...
    sig { params(request_body: Models::Operations::PutV1HistoricalEmployeesRequestBody, company_uuid: ::String, historical_employee_uuid: ::String, x_gusto_api_version: T.nilable(Models::Shared::VersionHeader), timeout_ms: T.nilable(Integer)).returns(Models::Operations::PutV1HistoricalEmployeesResponse) }
    def update(request_body:, company_uuid:, historical_employee_uuid:, x_gusto_api_version: nil, timeout_ms: nil)
