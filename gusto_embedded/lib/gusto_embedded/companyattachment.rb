...
module GustoEmbedded
  ...
  class CompanyAttachment
    ...
    sig { params(company_id: ::String, company_attachment_uuid: ::String, x_gusto_api_version: T.nilable(Models::Operations::GetV1CompaniesAttachmentUrlHeaderXGustoAPIVersion), timeout_ms: T.nilable(Integer), http_headers: T.nilable(T::Hash[T.any(String, Symbol), String])).returns(Models::Operations::GetV1CompaniesAttachmentUrlResponse) }
    def get_download_url(company_id:, company_attachment_uuid:, x_gusto_api_version: nil, timeout_ms: nil, http_headers: nil)
