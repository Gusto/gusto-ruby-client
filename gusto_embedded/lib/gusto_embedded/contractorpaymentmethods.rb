...
module GustoEmbedded
  ...
  class ContractorPaymentMethods
    ...
    sig { params(request_body: Models::Operations::PostV1ContractorsContractorUuidBankAccountsRequestBody, contractor_uuid: ::String, x_gusto_api_version: T.nilable(Models::Shared::VersionHeader), timeout_ms: T.nilable(Integer)).returns(Models::Operations::PostV1ContractorsContractorUuidBankAccountsResponse) }
    def create_bank_account(request_body:, contractor_uuid:, x_gusto_api_version: nil, timeout_ms: nil)
