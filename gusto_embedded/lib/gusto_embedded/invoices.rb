...
module GustoEmbedded
  ...
  class Invoices
    ...
    sig { params(security: Models::Operations::GetInvoicesInvoicePeriodSecurity, request: Models::Operations::GetInvoicesInvoicePeriodRequest, timeout_ms: T.nilable(Integer)).returns(Models::Operations::GetInvoicesInvoicePeriodResponse) }
    def get(security:, request:, timeout_ms: nil)
