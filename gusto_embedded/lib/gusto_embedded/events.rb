...
module GustoEmbedded
  ...
  class Events
    ...
    sig { params(security: Models::Operations::GetEventsSecurity, request: Models::Operations::GetEventsRequest, timeout_ms: T.nilable(Integer), http_headers: T.nilable(T::Hash[T.any(String, Symbol), String])).returns(Models::Operations::GetEventsResponse) }
    def get(security:, request:, timeout_ms: nil, http_headers: nil)
      ...
      query_params = Utils.get_query_params(Models::Operations::GetEventsRequest, request, nil)
      ...
      if Utils.match_status_code(http_response.status, ['200'])
        if Utils.match_content_type(content_type, 'application/json')
          ...
          obj = Crystalline.unmarshal_json(JSON.parse(response_data), Crystalline::Array.new(Models::Shared::Event))
          response = Models::Operations::GetEventsResponse.new(
            status_code: http_response.status,
            content_type: content_type,
            raw_response: http_response,
            event_list: T.unsafe(obj)
          )
