...
module GustoEmbedded
  ...
  class Events
    ...
    sig { params(security: Models::Operations::GetEventsSecurity, request: Models::Operations::GetEventsRequest, timeout_ms: T.nilable(Integer)).returns(Models::Operations::GetEventsResponse) }
