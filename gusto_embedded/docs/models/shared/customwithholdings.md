...
| ----------------------------------------------------------------------- | ----------------------------------------------------------------------- | ----------------------------------------------------------------------- | ----------------------------------------------------------------------- |
| `federal`                                                               | [T.nilable(Models::Shared::Federal)](../../models/shared/federal.md)    | :heavy_minus_sign:                                                      | Federal one-time custom withholding override.                           |
| `state`                                                                 | T::Array<[Models::Shared::State](../../models/shared/state.md)>         | :heavy_minus_sign:                                                      | State one-time custom withholding overrides, one entry per state field. |