...
res = s.information_requests.get_information_requests(company_uuid: '<id>', x_gusto_api_version: Models::Operations::GetInformationRequestsHeaderXGustoAPIVersion::TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15)
