...
res = s.reports.post_payrolls_payroll_uuid_reports_general_ledger(payroll_uuid="<id>", request_body=::GustoEmbedded::Operations::PostPayrollsPayrollUuidReportsGeneralLedgerRequestBody.new(
  aggregation: ::GustoEmbedded::Operations::Aggregation::INTEGRATION,
), x_gusto_api_version=::GustoEmbedded::Shared::VersionHeader::TWO_THOUSAND_AND_TWENTY_FIVE_06_15)
...
res = s.reports.get_reports_request_uuid(request_uuid="<id>", x_gusto_api_version=::GustoEmbedded::Shared::VersionHeader::TWO_THOUSAND_AND_TWENTY_FIVE_06_15)
...
res = s.reports.get_template(company_uuid="<id>", report_type="<value>", x_gusto_api_version=::GustoEmbedded::Shared::VersionHeader::TWO_THOUSAND_AND_TWENTY_FIVE_06_15)
