...
res = s.payrolls.get(company_id="<id>", payroll_id="<id>", x_gusto_api_version=::GustoEmbedded::Operations::GetV1CompaniesCompanyIdPayrollsPayrollIdHeaderXGustoAPIVersion::TWO_THOUSAND_AND_TWENTY_FOUR_04_01, include=[
  ::GustoEmbedded::Operations::GetV1CompaniesCompanyIdPayrollsPayrollIdQueryParamInclude::RISK_BLOCKERS,
])
