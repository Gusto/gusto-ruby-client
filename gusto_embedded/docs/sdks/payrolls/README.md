...
res = s.payrolls.get_approved_reversals(company_id="<id>", page=8807.41, per=8323.68, x_gusto_api_version=::GustoEmbedded::Shared::VersionHeader::TWO_THOUSAND_AND_TWENTY_FOUR_04_01)
