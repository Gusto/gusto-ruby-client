...
* [list_reversals](#list_reversals) - Get approved payroll reversals
...
* [get_employee_pay_stubs](#get_employee_pay_stubs) - Get an employee's pay stubs
...
res = s.payrolls.create(company_id="<id>", x_gusto_api_version=::OpenApiSDK::Shared::VersionHeader::TWO_THOUSAND_AND_TWENTY_FOUR_04_01, request_body=::OpenApiSDK::Operations::PostV1CompaniesCompanyIdPayrollsRequestBody.new(
  off_cycle: false,
...
res = s.payrolls.list_reversals(company_id="<id>", page=8289.27, per=5002.19, x_gusto_api_version=::OpenApiSDK::Shared::VersionHeader::TWO_THOUSAND_AND_TWENTY_FOUR_04_01)
...
res = s.payrolls.prepare_for_update(company_id="<id>", payroll_id="<id>", x_gusto_api_version=::OpenApiSDK::Shared::VersionHeader::TWO_THOUSAND_AND_TWENTY_FOUR_04_01)
...
res = s.payrolls.calculate_gross_up(payroll_uuid="<id>", x_gusto_api_version=::OpenApiSDK::Shared::VersionHeader::TWO_THOUSAND_AND_TWENTY_FOUR_04_01, request_body=::OpenApiSDK::Operations::PostPayrollsGrossUpPayrollUuidRequestBody.new(
  employee_uuid: "<id>",
  net_pay: "<value>",
))
...
res = s.payrolls.get_employee_pay_stubs(employee_id="<id>", x_gusto_api_version=::OpenApiSDK::Shared::VersionHeader::TWO_THOUSAND_AND_TWENTY_FOUR_04_01)
...
res = s.payrolls.generate_printable_checks(payroll_uuid="<id>", x_gusto_api_version=::OpenApiSDK::Shared::VersionHeader::TWO_THOUSAND_AND_TWENTY_FOUR_04_01, request_body=::OpenApiSDK::Operations::PostV1PayrollsPayrollUuidGeneratedDocumentsPrintablePayrollChecksRequestBody.new(
