...
* [list_by_employee](#list_by_employee) - Get garnishments for an employee
...
res = s.garnishments.list_by_employee(employee_id="<id>", page=2485.35, per=5891.96, x_gusto_api_version=::OpenApiSDK::Shared::VersionHeader::TWO_THOUSAND_AND_TWENTY_FOUR_04_01)
...
res = s.garnishments.get_child_support(x_gusto_api_version=::OpenApiSDK::Shared::VersionHeader::TWO_THOUSAND_AND_TWENTY_FOUR_04_01)
