...
res = s.employee_payment_methods.get_bank_accounts(employee_id: '<id>', x_gusto_api_version: Models::Shared::VersionHeader::TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15)

unless res.employee_bank_account_list.nil?
  # handle response
end
