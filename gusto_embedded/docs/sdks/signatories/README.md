...
res = s.signatories.list(company_uuid: '<id>', x_gusto_api_version: Models::Operations::GetV1CompaniesCompanyUuidSignatoriesHeaderXGustoAPIVersion::TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15)
...
), x_gusto_api_version: Models::Operations::PostV1CompanySignatoriesHeaderXGustoAPIVersion::TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15)
...
), x_gusto_api_version: Models::Operations::PostV1CompaniesCompanyUuidSignatoriesInviteHeaderXGustoAPIVersion::TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15)
...
res = s.signatories.update(company_uuid: '<id>', signatory_uuid: '<id>', signatory_update_request: Models::Shared::SignatoryUpdateRequest.new(
  version: '<value>'
), x_gusto_api_version: Models::Operations::PutV1CompaniesCompanyUuidSignatoriesSignatoryUuidHeaderXGustoAPIVersion::TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15)
...
res = s.signatories.delete(company_uuid: '<id>', signatory_uuid: '<id>', x_gusto_api_version: Models::Operations::DeleteV1CompaniesCompanyUuidSignatoriesSignatoryUuidHeaderXGustoAPIVersion::TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15)
