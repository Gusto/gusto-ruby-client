...
res = s.notifications.get_details(notification_uuid: '<id>', x_gusto_api_version: Models::Operations::GetNotificationsNotificationUuidHeaderXGustoAPIVersion::TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15)
