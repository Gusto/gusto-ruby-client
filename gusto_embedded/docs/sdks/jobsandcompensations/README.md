...
res = s.jobs_and_compensations.get(job_id="<id>", include=::OpenApiSDK::Operations::GetV1JobsJobIdQueryParamInclude::ALL_COMPENSATIONS, x_gusto_api_version=::OpenApiSDK::Shared::VersionHeader::TWO_THOUSAND_AND_TWENTY_FOUR_04_01)
...
res = s.jobs_and_compensations.update(job_id="<id>", x_gusto_api_version=::OpenApiSDK::Shared::VersionHeader::TWO_THOUSAND_AND_TWENTY_FOUR_04_01, request_body=::OpenApiSDK::Operations::PutV1JobsJobIdRequestBody.new(
  version: "<value>",
))
