...
res = s.tax_requirements.get(company_uuid: '<id>', state: 'CA', x_gusto_api_version: Models::Operations::GetV1CompaniesCompanyUuidTaxRequirementsStateHeaderXGustoAPIVersion::TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15)
...
), x_gusto_api_version: Models::Operations::PutV1CompaniesCompanyUuidTaxRequirementsStateHeaderXGustoAPIVersion::TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15)
...
res = s.tax_requirements.get_all(company_uuid: '<id>', x_gusto_api_version: Models::Operations::GetV1CompaniesCompanyUuidTaxRequirementsHeaderXGustoAPIVersion::TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15)
