...
res = s.locations.get(company_id: '7b1d0df1-6403-4a06-8768-c1dd7d24d27a', x_gusto_api_version: Models::Operations::GetV1CompaniesCompanyIdLocationsHeaderXGustoAPIVersion::TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15)
...
), x_gusto_api_version: Models::Operations::PostV1CompaniesCompanyIdLocationsHeaderXGustoAPIVersion::TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15)
...
res = s.locations.retrieve(location_id: '<id>', x_gusto_api_version: Models::Operations::GetV1LocationsLocationIdHeaderXGustoAPIVersion::TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15)
...
res = s.locations.update(location_id: '<id>', request_body: Models::Operations::PutV1LocationsLocationIdRequestBody.new(
  ...
  city: 'San Francisco',
  zip: '94107'
), x_gusto_api_version: Models::Operations::PutV1LocationsLocationIdHeaderXGustoAPIVersion::TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15)
