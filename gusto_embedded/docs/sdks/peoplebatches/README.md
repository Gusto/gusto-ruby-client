...
res = s.people_batches.post_v1_companies_company_id_people_batches(company_id: '<id>', request_body: Models::Operations::PostV1CompaniesCompanyIdPeopleBatchesRequestBody.new(
  ...
  batch: []
), x_gusto_api_version: Models::Operations::PostV1CompaniesCompanyIdPeopleBatchesHeaderXGustoAPIVersion::TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15)
...
res = s.people_batches.get_v1_people_batches_people_batch_uuid(people_batch_uuid: '<id>', x_gusto_api_version: Models::Operations::GetV1PeopleBatchesPeopleBatchUuidHeaderXGustoAPIVersion::TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15)
