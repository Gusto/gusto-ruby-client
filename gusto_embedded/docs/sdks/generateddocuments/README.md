...
res = s.generated_documents.get(document_type: Models::Operations::DocumentType::PRINTABLE_PAYROLL_CHECKS, request_uuid: '<id>', x_gusto_api_version: Models::Operations::GetV1GeneratedDocumentsDocumentTypeRequestUuidHeaderXGustoAPIVersion::TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15)
