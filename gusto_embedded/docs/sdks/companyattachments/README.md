...
**[T.nilable(::GustoEmbedded::Operations::GetV1CompaniesAttachmentResponse)](../../models/operations/getv1companiesattachmentresponse.md)**
...
**[T.nilable(::GustoEmbedded::Operations::GetV1CompaniesAttachmentsResponse)](../../models/operations/getv1companiesattachmentsresponse.md)**
...
res = s.company_attachments.create(company_id="<id>", request_body=::GustoEmbedded::Operations::PostV1CompaniesAttachmentRequestBody.new(
  document: ::GustoEmbedded::Operations::Document.new(
...
| ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `company_id`                                                                                                                                                                                                                 | *::String*                                                                                                                                                                                                                   | :heavy_check_mark:                                                                                                                                                                                                           | The UUID of the company                                                                                                                                                                                                      |
| `request_body`                                                                                                                                                                                                               | [::GustoEmbedded::Operations::PostV1CompaniesAttachmentRequestBody](../../models/operations/postv1companiesattachmentrequestbody.md)                                                                                         | :heavy_check_mark:                                                                                                                                                                                                           | N/A                                                                                                                                                                                                                          |
| `x_gusto_api_version`                                                                                                                                                                                                        | [T.nilable(::GustoEmbedded::Shared::VersionHeader)](../../models/shared/versionheader.md)                                                                                                                                    | :heavy_minus_sign:                                                                                                                                                                                                           | Determines the date-based API version associated with your API call. If none is provided, your application's [minimum API version](https://docs.gusto.com/embedded-payroll/docs/api-versioning#minimum-api-version) is used. |

### Response

**[T.nilable(::GustoEmbedded::Operations::PostV1CompaniesAttachmentResponse)](../../models/operations/postv1companiesattachmentresponse.md)**
