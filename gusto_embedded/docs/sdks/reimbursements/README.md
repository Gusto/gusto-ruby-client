...
res = s.reimbursements.get_v1_employees_employee_id_recurring_reimbursements(employee_id: '<id>', x_gusto_api_version: Models::Operations::GetV1EmployeesEmployeeIdRecurringReimbursementsHeaderXGustoAPIVersion::TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15)
...
res = s.reimbursements.post_v1_employees_employee_id_recurring_reimbursements(employee_id: '<id>', request_body: Models::Operations::PostV1EmployeesEmployeeIdRecurringReimbursementsRequestBody.new(
  ...
  amount: 2610.77
), x_gusto_api_version: Models::Operations::PostV1EmployeesEmployeeIdRecurringReimbursementsHeaderXGustoAPIVersion::TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15)
...
res = s.reimbursements.get_v1_recurring_reimbursements(id: '<id>', x_gusto_api_version: Models::Operations::GetV1RecurringReimbursementsHeaderXGustoAPIVersion::TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15)
...
), x_gusto_api_version: Models::Operations::PutV1RecurringReimbursementsHeaderXGustoAPIVersion::TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15)
...
res = s.reimbursements.delete_v1_recurring_reimbursements(id: '<id>', x_gusto_api_version: Models::Operations::DeleteV1RecurringReimbursementsHeaderXGustoAPIVersion::TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15)
