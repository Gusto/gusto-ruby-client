...
* [get_paid_holidays](#get_paid_holidays) - Preview a company's paid holidays
...
res = s.holiday_pay_policies.get_paid_holidays(company_uuid="<id>", x_gusto_api_version=::OpenApiSDK::Shared::VersionHeader::TWO_THOUSAND_AND_TWENTY_FOUR_04_01, request_body=::OpenApiSDK::Operations::GetCompaniesCompanyUuidPaidHolidaysRequestBody.new())
