...
res = s.employee_benefits.get(employee_id="<id>", page=7003.47, per=5588.34, x_gusto_api_version=::GustoEmbedded::Shared::VersionHeader::TWO_THOUSAND_AND_TWENTY_FOUR_04_01)
