...
res = s.company_attachment.get_download_url(company_id: '<id>', company_attachment_uuid: '<id>', x_gusto_api_version: Models::Shared::VersionHeader::TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15)
