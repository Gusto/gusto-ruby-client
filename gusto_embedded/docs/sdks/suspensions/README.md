...
res = s.companies.suspensions.get(company_uuid: '<id>', x_gusto_api_version: Models::Operations::GetCompaniesCompanyUuidSuspensionsHeaderXGustoAPIVersion::TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15)
...
), x_gusto_api_version: Models::Operations::PostCompaniesCompanyUuidSuspensionsHeaderXGustoAPIVersion::TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15)
