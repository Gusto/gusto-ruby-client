...
res = s.employee_tax_setup.get_state_taxes(employee_uuid="<id>", x_gusto_api_version=::GustoEmbedded::Operations::GetV1EmployeesEmployeeIdStateTaxesHeaderXGustoAPIVersion::TWO_THOUSAND_AND_TWENTY_FOUR_04_01)
...
res = s.employee_tax_setup.update_state_taxes(employee_uuid="<id>", request_body=::GustoEmbedded::Operations::PutV1EmployeesEmployeeIdStateTaxesRequestBody.new(
  version: "<value>",
  type: ::GustoEmbedded::Operations::Type::DIRECT_DEPOSIT,
), x_gusto_api_version=::GustoEmbedded::Operations::PutV1EmployeesEmployeeIdStateTaxesHeaderXGustoAPIVersion::TWO_THOUSAND_AND_TWENTY_FOUR_04_01)
