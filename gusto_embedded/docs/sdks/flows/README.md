...
res = s.flows.create(company_uuid: '<id>', request_body: Models::Operations::PostV1CompanyFlowsRequestBody.new(
...
| `request_body`                                                                                                                                                                                                               | [Models::Operations::PostV1CompanyFlowsRequestBody](../../models/operations/postv1companyflowsrequestbody.md)                                                                                                                | :heavy_check_mark:                                                                                                                                                                                                           | N/A                                                                                                                                                                                                                          |
