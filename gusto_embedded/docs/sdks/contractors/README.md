...
res = s.contractors.get(contractor_uuid="<id>", x_gusto_api_version=::GustoEmbedded::Shared::VersionHeader::TWO_THOUSAND_AND_TWENTY_FIVE_06_15)
...
res = s.contractors.delete(contractor_uuid="<id>", x_gusto_api_version=::GustoEmbedded::Shared::VersionHeader::TWO_THOUSAND_AND_TWENTY_FIVE_06_15)
...
res = s.contractors.get_onboarding_status(contractor_uuid="<id>", x_gusto_api_version=::GustoEmbedded::Shared::VersionHeader::TWO_THOUSAND_AND_TWENTY_FIVE_06_15)
...
res = s.contractors.get_address(contractor_uuid="<id>", x_gusto_api_version=::GustoEmbedded::Shared::VersionHeader::TWO_THOUSAND_AND_TWENTY_FIVE_06_15)
...
res = s.contractors.get_v1_companies_company_id_contractors_payment_details(company_id="<id>", contractor_uuid="<id>", contractor_payment_group_uuid="<id>", x_gusto_api_version=::GustoEmbedded::Operations::GetV1CompaniesCompanyIdContractorsPaymentDetailsHeaderXGustoAPIVersion::TWO_THOUSAND_AND_TWENTY_FIVE_06_15)
