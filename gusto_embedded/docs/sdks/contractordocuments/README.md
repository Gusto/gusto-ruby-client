...
res = s.contractor_documents.get_all(contractor_uuid: '<id>', x_gusto_api_version: Models::Operations::GetV1ContractorDocumentsHeaderXGustoAPIVersion::TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15)
...
res = s.contractor_documents.get(document_uuid: '<id>', x_gusto_api_version: Models::Operations::GetV1ContractorDocumentHeaderXGustoAPIVersion::TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15)
...
res = s.contractor_documents.get_pdf(document_uuid: '<id>', x_gusto_api_version: Models::Operations::GetV1ContractorDocumentPdfHeaderXGustoAPIVersion::TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15)
...
res = s.contractor_documents.sign(document_uuid: '<id>', request_body: Models::Operations::PutV1ContractorDocumentSignRequestBody.new(
  fields_: [],
  agree: false
), x_gusto_api_version: Models::Operations::PutV1ContractorDocumentSignHeaderXGustoAPIVersion::TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15)
