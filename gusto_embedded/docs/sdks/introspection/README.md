...
res = s.introspection.refresh_token(x_gusto_api_version=::OpenApiSDK::Shared::VersionHeader::TWO_THOUSAND_AND_TWENTY_FOUR_04_01, request_body=::OpenApiSDK::Operations::RefreshAccessTokenRequestBody.new(
  client_id: "<id>",
  client_secret: "<value>",
  refresh_token: "<value>",
  grant_type: "<value>",
